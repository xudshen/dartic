...
abstract final class ListBindings {
  ...
  ///
  /// The keys match the suffix after `'dart:core::List::'` used in [register].
  ...
  ///
  /// The keys match the suffix after `'dart:core::_GrowableList::'` used in [register].
  ...
  ///
  /// The keys match the suffix after `'dart:core::_List::'` used in [register].
