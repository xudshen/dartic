...
abstract final class ZoneBindings {
  ...
  ///
  /// The keys match the suffix after `'dart:async::Zone::'` used in [register].
  ...
  /// (or `'dart:async::_ZoneSpecification::'`) used in [register].
  ...
  ///
  /// The keys match the suffix after `'dart:async::::'` used in [register].
