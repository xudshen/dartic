...
abstract final class QueueBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'remove#1': (args) => (args[0] as Queue).remove(args[1] as Object?),
        ...
        'contains#1': (args) => (args[0] as Queue).contains(args[1] as Object?),
        ...
        'join#0': (args) => (args[0] as Queue).join(),
        'join#1': (args) => (args[0] as Queue).join(args[1] as String),
        'any#1': (args) => (args[0] as Queue).any((a) => (args[1] as Function)(a) as bool),
        'toList#1': (args) => (args[0] as Queue).toList(growable: args[1] as bool),
        ...
        'firstWhere#2': (args) => (args[0] as Queue).firstWhere((a) => (args[1] as Function)(a) as bool, orElse: (args[2] as Function?) == null ? null : () => (args[2] as Function?)!()),
        'lastWhere#2': (args) => (args[0] as Queue).lastWhere((a) => (args[1] as Function)(a) as bool, orElse: (args[2] as Function?) == null ? null : () => (args[2] as Function?)!()),
        'singleWhere#2': (args) => (args[0] as Queue).singleWhere((a) => (args[1] as Function)(a) as bool, orElse: (args[2] as Function?) == null ? null : () => (args[2] as Function?)!()),
