...
class _$X509Certificate implements X509Certificate, DarticObjectHolder {
  ...
  @override
  Uint8List get der {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'der');
  ...
  @override
  String get pem {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'pem');
    if (identical(r, notOverridden)) {
  ...
  @override
  Uint8List get sha1 {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'sha1');
    if (identical(r, notOverridden)) {
  ...
  @override
  String get subject {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'subject');
    if (identical(r, notOverridden)) {
  ...
  @override
  String get issuer {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'issuer');
    if (identical(r, notOverridden)) {
  ...
  DateTime get startValidity {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'startValidity');
    if (identical(r, notOverridden)) {
  ...
  DateTime get endValidity {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'endValidity');
    if (identical(r, notOverridden)) {
