...
class _$SecureSocket implements SecureSocket, DarticObjectHolder {
  _$SecureSocket(this._dispatch, this.$darticObject, List<Object?> superArgs);
  ...
  void renegotiate({bool useSessionCache = true, bool requestClientCertificate = false, bool requireClientCertificate = false}) {
    final _$r = _dispatch.invoke($darticObject, 'renegotiate', [useSessionCache, requestClientCertificate, requireClientCertificate]);
  ...
  bool setOption(SocketOption option, bool enabled) {
    final _$r = _dispatch.invoke($darticObject, 'setOption', [option, enabled]);
    if (identical(_$r, notOverridden)) {
  ...
  Uint8List getRawOption(RawSocketOption option) {
    final _$r = _dispatch.invoke($darticObject, 'getRawOption', [option]);
    if (identical(_$r, notOverridden)) {
  ...
  void setRawOption(RawSocketOption option) {
    final _$r = _dispatch.invoke($darticObject, 'setRawOption', [option]);
    if (identical(_$r, notOverridden)) {
  ...
  X509Certificate? get peerCertificate {
    final r = _dispatch.get($darticObject, 'peerCertificate');
  ...
  String? get selectedProtocol {
    final r = _dispatch.get($darticObject, 'selectedProtocol');
    if (identical(r, notOverridden)) {
...
/// private class.
Object createSecureSocketBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$SecureSocket(dispatch, obj, superArgs);

abstract final class SecureSocketBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      name: 'dart:io::SecureSocket',
      type: SecureSocket,
      test: (o) => o is SecureSocket,
      methods: methodMap(),
      superclasses: ['dart:io::Socket', 'dart:async::Stream', 'dart:io::IOSink', 'dart:async::StreamSink', 'dart:async::EventSink', 'dart:core::Sink', 'dart:async::StreamConsumer', 'dart:core::StringSink'],
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$SecureSocket(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('dart:io::SecureSocket::connect#7', (args) => SecureSocket.connect(args[0], args[1] as int, context: identical(args[2], darticAbsent) ? null : args[2] as SecurityContext?, onBadCertificate: identical(args[3], darticAbsent) ? null : (args[3] as Function?) == null ? null : (a) => (args[3] as Function?)!(a), keyLog: identical(args[4], darticAbsent) ? null : (args[4] as Function?) == null ? null : (a) => (args[4] as Function?)!(a), supportedProtocols: identical(args[5], darticAbsent) ? null : args[5] == null ? null : (args[5] as List).cast<String>(), timeout: identical(args[6], darticAbsent) ? null : args[6] as Duration?));
    ctx.registerBinding('dart:io::SecureSocket::startConnect#6', (args) => SecureSocket.startConnect(args[0], args[1] as int, context: identical(args[2], darticAbsent) ? null : args[2] as SecurityContext?, onBadCertificate: identical(args[3], darticAbsent) ? null : (args[3] as Function?) == null ? null : (a) => (args[3] as Function?)!(a), keyLog: identical(args[4], darticAbsent) ? null : (args[4] as Function?) == null ? null : (a) => (args[4] as Function?)!(a), supportedProtocols: identical(args[5], darticAbsent) ? null : args[5] == null ? null : (args[5] as List).cast<String>()));
    ctx.registerBinding('dart:io::SecureSocket::secure#6', (args) => SecureSocket.secure(args[0] as Socket, host: identical(args[1], darticAbsent) ? null : args[1], context: identical(args[2], darticAbsent) ? null : args[2] as SecurityContext?, onBadCertificate: identical(args[3], darticAbsent) ? null : (args[3] as Function?) == null ? null : (a) => (args[3] as Function?)!(a), keyLog: identical(args[4], darticAbsent) ? null : (args[4] as Function?) == null ? null : (a) => (args[4] as Function?)!(a), supportedProtocols: identical(args[5], darticAbsent) ? null : args[5] == null ? null : (args[5] as List).cast<String>()));
    ctx.registerBinding('dart:io::SecureSocket::secureServer#6', (args) => SecureSocket.secureServer(args[0] as Socket, args[1] as SecurityContext?, bufferedData: identical(args[2], darticAbsent) ? null : args[2] == null ? null : (args[2] as List).cast<int>(), requestClientCertificate: identical(args[3], darticAbsent) ? false : args[3] as bool, requireClientCertificate: identical(args[4], darticAbsent) ? false : args[4] as bool, supportedProtocols: identical(args[5], darticAbsent) ? null : args[5] == null ? null : (args[5] as List).cast<String>()));
  }

  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        'renegotiate#3': (args) { (args[0] as SecureSocket).renegotiate(useSessionCache: identical(args[1], darticAbsent) ? true : args[1] as bool, requestClientCertificate: identical(args[2], darticAbsent) ? false : args[2] as bool, requireClientCertificate: identical(args[3], darticAbsent) ? false : args[3] as bool); return null; },
        'toString#0': (args) => (args[0] as SecureSocket).toString(),
        'destroy#0': (args) { (args[0] as SecureSocket).destroy(); return null; },
        'setOption#2': (args) => (args[0] as SecureSocket).setOption(args[1] as SocketOption, args[2] as bool),
        'getRawOption#1': (args) => (args[0] as SecureSocket).getRawOption(args[1] as RawSocketOption),
        'setRawOption#1': (args) { (args[0] as SecureSocket).setRawOption(args[1] as RawSocketOption); return null; },
        'addError#2': (args) { (args[0] as SecureSocket).addError(args[1] as Object, identical(args[2], darticAbsent) ? null : args[2] as StackTrace?); return null; },
        'close#0': (args) => (args[0] as SecureSocket).close(),
        'asBroadcastStream#2': (args) => (args[0] as SecureSocket).asBroadcastStream(onListen: identical(args[1], darticAbsent) ? null : (args[1] as Function?) == null ? null : (a) => (args[1] as Function?)!(a), onCancel: identical(args[2], darticAbsent) ? null : (args[2] as Function?) == null ? null : (a) => (args[2] as Function?)!(a)),
        'listen#4': (args) => (args[0] as SecureSocket).listen((args[1] as Function?) == null ? null : (a) => (args[1] as Function?)!(a), onError: identical(args[2], darticAbsent) ? null : args[2] as Function?, onDone: identical(args[3], darticAbsent) ? null : (args[3] as Function?) == null ? null : () => (args[3] as Function?)!(), cancelOnError: identical(args[4], darticAbsent) ? null : args[4] as bool?),
        'where#1': (args) => (args[0] as SecureSocket).where((a) => (args[1] as Function)(a) as bool),
        'map#1': (args) => (args[0] as SecureSocket).map((a) => (args[1] as Function)(a)),
        'asyncMap#1': (args) => (args[0] as SecureSocket).asyncMap((a) => (args[1] as Function)(a) as FutureOr),
        'asyncExpand#1': (args) => (args[0] as SecureSocket).asyncExpand((a) => (args[1] as Function)(a) as Stream?),
        'handleError#2': (args) => (args[0] as SecureSocket).handleError(args[1] as Function, test: identical(args[2], darticAbsent) ? null : (args[2] as Function?) == null ? null : (a) => (args[2] as Function?)!(a)),
        'expand#1': (args) => (args[0] as SecureSocket).expand((a) => (args[1] as Function)(a) as Iterable),
        'pipe#1': (args) => (args[0] as SecureSocket).pipe(args[1] as StreamConsumer<Uint8List>),
        'transform#1': (args) => (args[0] as SecureSocket).transform(args[1] as StreamTransformer<Uint8List, List<int>>),
        'reduce#1': (args) => (args[0] as SecureSocket).reduce((a, b) => (args[1] as Function)(a, b) as Uint8List),
        'fold#2': (args) => (args[0] as SecureSocket).fold((args[1] as List).cast<int>(), (a, b) => (args[2] as Function)(a, b)),
        'join#1': (args) => (args[0] as SecureSocket).join(identical(args[1], darticAbsent) ? "" : args[1] as String),
        'contains#1': (args) => (args[0] as SecureSocket).contains(args[1]),
        'forEach#1': (args) => (args[0] as SecureSocket).forEach((a) => (args[1] as Function)(a)),
        'every#1': (args) => (args[0] as SecureSocket).every((a) => (args[1] as Function)(a) as bool),
        'any#1': (args) => (args[0] as SecureSocket).any((a) => (args[1] as Function)(a) as bool),
        'cast#0': (args) => (args[0] as SecureSocket).cast(),
        'toList#0': (args) => (args[0] as SecureSocket).toList(),
        'toSet#0': (args) => (args[0] as SecureSocket).toSet(),
        'drain#1': (args) => (args[0] as SecureSocket).drain(identical(args[1], darticAbsent) ? null : args[1]),
        'take#1': (args) => (args[0] as SecureSocket).take(args[1] as int),
        'takeWhile#1': (args) => (args[0] as SecureSocket).takeWhile((a) => (args[1] as Function)(a) as bool),
        'skip#1': (args) => (args[0] as SecureSocket).skip(args[1] as int),
        'skipWhile#1': (args) => (args[0] as SecureSocket).skipWhile((a) => (args[1] as Function)(a) as bool),
        'distinct#1': (args) => (args[0] as SecureSocket).distinct(identical(args[1], darticAbsent) ? null : (args[1] as Function?) == null ? null : (a, b) => (args[1] as Function?)!(a, b)),
        'firstWhere#2': (args) => (args[0] as SecureSocket).firstWhere((a) => (args[1] as Function)(a) as bool, orElse: identical(args[2], darticAbsent) ? null : (args[2] as Function?) == null ? null : () => (args[2] as Function?)!()),
        'lastWhere#2': (args) => (args[0] as SecureSocket).lastWhere((a) => (args[1] as Function)(a) as bool, orElse: identical(args[2], darticAbsent) ? null : (args[2] as Function?) == null ? null : () => (args[2] as Function?)!()),
        'singleWhere#2': (args) => (args[0] as SecureSocket).singleWhere((a) => (args[1] as Function)(a) as bool, orElse: identical(args[2], darticAbsent) ? null : (args[2] as Function?) == null ? null : () => (args[2] as Function?)!()),
        'elementAt#1': (args) => (args[0] as SecureSocket).elementAt(args[1] as int),
        'timeout#2': (args) => (args[0] as SecureSocket).timeout(args[1] as Duration, onTimeout: identical(args[2], darticAbsent) ? null : (args[2] as Function?) == null ? null : (a) => (args[2] as Function?)!(a)),
        'add#1': (args) { (args[0] as SecureSocket).add((args[1] as List).cast<int>()); return null; },
        'write#1': (args) { (args[0] as SecureSocket).write(args[1]); return null; },
        'writeAll#2': (args) { (args[0] as SecureSocket).writeAll(args[1] as Iterable<dynamic>, identical(args[2], darticAbsent) ? "" : args[2] as String); return null; },
        'writeln#1': (args) { (args[0] as SecureSocket).writeln(identical(args[1], darticAbsent) ? null : args[1]); return null; },
        'writeCharCode#1': (args) { (args[0] as SecureSocket).writeCharCode(args[1] as int); return null; },
        'addStream#1': (args) => (args[0] as SecureSocket).addStream(args[1] as Stream<List<int>>),
        'flush#0': (args) => (args[0] as SecureSocket).flush(),
        'peerCertificate#0': (args) => (args[0] as SecureSocket).peerCertificate,
        'selectedProtocol#0': (args) => (args[0] as SecureSocket).selectedProtocol,
        'hashCode#0': (args) => (args[0] as SecureSocket).hashCode,
        'port#0': (args) => (args[0] as SecureSocket).port,
        'remotePort#0': (args) => (args[0] as SecureSocket).remotePort,
        'address#0': (args) => (args[0] as SecureSocket).address,
        'remoteAddress#0': (args) => (args[0] as SecureSocket).remoteAddress,
        'done#0': (args) => (args[0] as SecureSocket).done,
        'isBroadcast#0': (args) => (args[0] as SecureSocket).isBroadcast,
        'length#0': (args) => (args[0] as SecureSocket).length,
        'isEmpty#0': (args) => (args[0] as SecureSocket).isEmpty,
        'first#0': (args) => (args[0] as SecureSocket).first,
        'last#0': (args) => (args[0] as SecureSocket).last,
        'single#0': (args) => (args[0] as SecureSocket).single,
        'encoding#0': (args) => (args[0] as SecureSocket).encoding,
        'encoding=#1': (args) { (args[0] as SecureSocket).encoding = args[1] as Encoding; return args[1]; },
        '==#1': (args) => (args[0] as SecureSocket) == (args[1] as Object),
      };
}
