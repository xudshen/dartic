...
abstract final class ZoneSpecificationBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'hashCode#0': (args) => (args[0] as ZoneSpecification).hashCode,
        '==#1': (args) => (args[0] as ZoneSpecification) == (args[1] as Object),
        'from#14': (args) => ZoneSpecification.from(args[0] as ZoneSpecification, handleUncaughtError: identical(args[1], darticAbsent) ? null : (args[1] as Function?) == null ? null : (a, b, c, d, e) => (args[1] as Function?)!(a, b, c, d, e), run: identical(args[2], darticAbsent) ? null : args[2] as RunHandler?, runUnary: identical(args[3], darticAbsent) ? null : args[3] as RunUnaryHandler?, runBinary: identical(args[4], darticAbsent) ? null : args[4] as RunBinaryHandler?, registerCallback: identical(args[5], darticAbsent) ? null : args[5] as RegisterCallbackHandler?, registerUnaryCallback: identical(args[6], darticAbsent) ? null : args[6] as RegisterUnaryCallbackHandler?, registerBinaryCallback: identical(args[7], darticAbsent) ? null : args[7] as RegisterBinaryCallbackHandler?, errorCallback: identical(args[8], darticAbsent) ? null : (args[8] as Function?) == null ? null : (a, b, c, d, e) => (args[8] as Function?)!(a, b, c, d, e), scheduleMicrotask: identical(args[9], darticAbsent) ? null : (args[9] as Function?) == null ? null : (a, b, c, d) => (args[9] as Function?)!(a, b, c, d), createTimer: identical(args[10], darticAbsent) ? null : (args[10] as Function?) == null ? null : (a, b, c, d, e) => (args[10] as Function?)!(a, b, c, d, e), createPeriodicTimer: identical(args[11], darticAbsent) ? null : (args[11] as Function?) == null ? null : (a, b, c, d, e) => (args[11] as Function?)!(a, b, c, d, e), print: identical(args[12], darticAbsent) ? null : (args[12] as Function?) == null ? null : (a, b, c, d) => (args[12] as Function?)!(a, b, c, d), fork: identical(args[13], darticAbsent) ? null : (args[13] as Function?) == null ? null : (a, b, c, d, e) => (args[13] as Function?)!(a, b, c, d, e)),
        '#13': (args) {
