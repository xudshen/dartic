...
abstract final class DateTimeBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        '==#1': (args) => (args[0] as DateTime) == (args[1] as Object),
        '#8': (args) => DateTime(args[0] as int, identical(args[1], darticAbsent) ? 1 : args[1] as int, identical(args[2], darticAbsent) ? 1 : args[2] as int, identical(args[3], darticAbsent) ? 0 : args[3] as int, identical(args[4], darticAbsent) ? 0 : args[4] as int, identical(args[5], darticAbsent) ? 0 : args[5] as int, identical(args[6], darticAbsent) ? 0 : args[6] as int, identical(args[7], darticAbsent) ? 0 : args[7] as int),
        'utc#8': (args) => DateTime.utc(args[0] as int, identical(args[1], darticAbsent) ? 1 : args[1] as int, identical(args[2], darticAbsent) ? 1 : args[2] as int, identical(args[3], darticAbsent) ? 0 : args[3] as int, identical(args[4], darticAbsent) ? 0 : args[4] as int, identical(args[5], darticAbsent) ? 0 : args[5] as int, identical(args[6], darticAbsent) ? 0 : args[6] as int, identical(args[7], darticAbsent) ? 0 : args[7] as int),
        'now#0': (args) => DateTime.now(),
        'timestamp#0': (args) => DateTime.timestamp(),
        'fromMillisecondsSinceEpoch#2': (args) => DateTime.fromMillisecondsSinceEpoch(args[0] as int, isUtc: identical(args[1], darticAbsent) ? false : args[1] as bool),
        'fromMicrosecondsSinceEpoch#2': (args) => DateTime.fromMicrosecondsSinceEpoch(args[0] as int, isUtc: identical(args[1], darticAbsent) ? false : args[1] as bool),
      };
}
