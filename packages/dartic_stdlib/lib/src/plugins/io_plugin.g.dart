...
import '../bindings/io/i_o_overrides_bindings.g.dart';
...
import '../bindings/io/pipe_bindings.g.dart';
import '../bindings/io/platform_bindings.g.dart';
import '../bindings/io/process_bindings.g.dart';
...
class IoPlugin extends DarticPlugin {
  ...
  void register(DarticPluginContext ctx) {
    ...
    IOOverridesBindings.register(ctx);
    ...
    PipeBindings.register(ctx);
    PlatformBindings.register(ctx);
    ProcessBindings.register(ctx);
