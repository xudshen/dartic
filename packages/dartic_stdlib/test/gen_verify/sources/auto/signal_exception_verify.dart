...
class _VerifySignalException extends SignalException {
  _VerifySignalException(String message, [dynamic osError]) : super(message, osError);
...
void main() {
  final v = _VerifySignalException('');
  v.runAllSuperCalls();
  print('OK');
}
