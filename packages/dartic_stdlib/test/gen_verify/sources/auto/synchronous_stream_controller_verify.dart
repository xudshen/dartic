...
class _VerifySynchronousStreamController implements SynchronousStreamController {
  _VerifySynchronousStreamController();
...
void main() {
  final v = _VerifySynchronousStreamController();
  print('OK');
}
