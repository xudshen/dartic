...
class _VerifyUnmodifiableListView extends UnmodifiableListView {
  _VerifyUnmodifiableListView(Iterable source) : super(source);
...
void main() {
  final v = _VerifyUnmodifiableListView([]);
  v.runAllSuperCalls();
  print('OK');
}
