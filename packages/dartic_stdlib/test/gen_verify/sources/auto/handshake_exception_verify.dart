...
class _VerifyHandshakeException extends HandshakeException {
  _VerifyHandshakeException([String message = "", OSError? osError]) : super(message, osError);
...
void main() {
  final v = _VerifyHandshakeException();
  v.runAllSuperCalls();
  print('OK');
}
