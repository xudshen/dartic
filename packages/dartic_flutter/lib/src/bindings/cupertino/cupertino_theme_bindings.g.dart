...
class _$CupertinoTheme extends CupertinoTheme implements DarticObjectHolder {
  _$CupertinoTheme(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, data: superArgs[1] as CupertinoThemeData, child: superArgs[2] as Widget);
...
/// private class.
Object createCupertinoThemeBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$CupertinoTheme(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$CupertinoTheme(dispatch, darticObject, superArgs),
    );
    ...
    ctx.registerBinding('package:flutter/src/cupertino/theme.dart::CupertinoTheme::\$super\$build#1', (args) => (args[0] as _$CupertinoTheme)._super$build(args[1] as BuildContext));
    ctx.registerBinding('package:flutter/src/cupertino/theme.dart::CupertinoTheme::\$super\$debugFillProperties#1', (args) { (args[0] as _$CupertinoTheme)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/cupertino/theme.dart::CupertinoTheme::\$super\$toString#1', (args) => (args[0] as _$CupertinoTheme)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/cupertino/theme.dart::CupertinoTheme::\$super\$createElement#0', (args) => (args[0] as _$CupertinoTheme)._super$createElement());
    ctx.registerBinding('package:flutter/src/cupertino/theme.dart::CupertinoTheme::\$super\$toStringShort#0', (args) => (args[0] as _$CupertinoTheme)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/cupertino/theme.dart::CupertinoTheme::\$super\$toStringShallow#2', (args) => (args[0] as _$CupertinoTheme)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/cupertino/theme.dart::CupertinoTheme::\$super\$toStringDeep#4', (args) => (args[0] as _$CupertinoTheme)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/cupertino/theme.dart::CupertinoTheme::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$CupertinoTheme)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
