...
class _$CupertinoTextSelectionControls extends CupertinoTextSelectionControls implements DarticObjectHolder {
  _$CupertinoTextSelectionControls(this._dispatch, this.$darticObject, List<Object?> superArgs);
  ...
  Widget buildHandle(BuildContext context, TextSelectionHandleType type, double textLineHeight, [VoidCallback? onTap]) {
    ...
    if (identical(r, notOverridden)) return super.buildHandle(context, type, textLineHeight, onTap != null ? () => onTap() : null);
    return r as Widget;
  }
...
/// private class.
Object createCupertinoTextSelectionControlsBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$CupertinoTextSelectionControls(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$CupertinoTextSelectionControls(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/cupertino/text_selection.dart::CupertinoTextSelectionControls::\$super\$getHandleSize#1', (args) => (args[0] as _$CupertinoTextSelectionControls)._super$getHandleSize(args[1] as double));
    ctx.registerBinding('package:flutter/src/cupertino/text_selection.dart::CupertinoTextSelectionControls::\$super\$buildToolbar#8', (args) => (args[0] as _$CupertinoTextSelectionControls)._super$buildToolbar(args[1] as BuildContext, args[2] as Rect, args[3] as double, args[4] as Offset, (args[5] as List).cast<TextSelectionPoint>(), args[6] as TextSelectionDelegate, args[7] as ValueListenable<ClipboardStatus>?, args[8] as Offset?));
    ctx.registerBinding('package:flutter/src/cupertino/text_selection.dart::CupertinoTextSelectionControls::\$super\$buildHandle#4', (args) => (args[0] as _$CupertinoTextSelectionControls)._super$buildHandle(args[1] as BuildContext, args[2] as TextSelectionHandleType, args[3] as double, identical(args[4], darticAbsent) ? null : (args[4] as Function?) == null ? null : () => (args[4] as Function?)!()));
    ctx.registerBinding('package:flutter/src/cupertino/text_selection.dart::CupertinoTextSelectionControls::\$super\$getHandleAnchor#2', (args) => (args[0] as _$CupertinoTextSelectionControls)._super$getHandleAnchor(args[1] as TextSelectionHandleType, args[2] as double));
    ctx.registerBinding('package:flutter/src/cupertino/text_selection.dart::CupertinoTextSelectionControls::\$super\$toString#0', (args) => (args[0] as _$CupertinoTextSelectionControls)._super$toString());
    ctx.registerBinding('package:flutter/src/cupertino/text_selection.dart::CupertinoTextSelectionControls::\$super\$canCut#1', (args) => (args[0] as _$CupertinoTextSelectionControls)._super$canCut(args[1] as TextSelectionDelegate));
    ctx.registerBinding('package:flutter/src/cupertino/text_selection.dart::CupertinoTextSelectionControls::\$super\$canCopy#1', (args) => (args[0] as _$CupertinoTextSelectionControls)._super$canCopy(args[1] as TextSelectionDelegate));
    ctx.registerBinding('package:flutter/src/cupertino/text_selection.dart::CupertinoTextSelectionControls::\$super\$canPaste#1', (args) => (args[0] as _$CupertinoTextSelectionControls)._super$canPaste(args[1] as TextSelectionDelegate));
    ctx.registerBinding('package:flutter/src/cupertino/text_selection.dart::CupertinoTextSelectionControls::\$super\$canSelectAll#1', (args) => (args[0] as _$CupertinoTextSelectionControls)._super$canSelectAll(args[1] as TextSelectionDelegate));
    ctx.registerBinding('package:flutter/src/cupertino/text_selection.dart::CupertinoTextSelectionControls::\$super\$handleCut#1', (args) { (args[0] as _$CupertinoTextSelectionControls)._super$handleCut(args[1] as TextSelectionDelegate); return null; });
    ctx.registerBinding('package:flutter/src/cupertino/text_selection.dart::CupertinoTextSelectionControls::\$super\$handleCopy#1', (args) { (args[0] as _$CupertinoTextSelectionControls)._super$handleCopy(args[1] as TextSelectionDelegate); return null; });
