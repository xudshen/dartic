...
class _$CupertinoTextSelectionHandleControls extends CupertinoTextSelectionHandleControls implements DarticObjectHolder {
  ...
  void handleCut(TextSelectionDelegate delegate, [ClipboardStatusNotifier? clipboardStatus]) {
    ...
    if (identical(r, notOverridden)) { super.handleCut(delegate, clipboardStatus); return; }
  }
  ...
  void handleCopy(TextSelectionDelegate delegate, [ClipboardStatusNotifier? clipboardStatus]) {
    ...
    if (identical(r, notOverridden)) { super.handleCopy(delegate, clipboardStatus); return; }
  }
