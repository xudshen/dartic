...
abstract final class CupertinoSliderBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        '#10': (args) => CupertinoSlider(key: identical(args[0], darticAbsent) ? null : args[0] as Key?, value: args[1] as double, onChanged: args[2] as void Function(double)?, onChangeStart: identical(args[3], darticAbsent) ? null : args[3] as void Function(double)?, onChangeEnd: identical(args[4], darticAbsent) ? null : args[4] as void Function(double)?, min: identical(args[5], darticAbsent) ? 0.0 : args[5] as double, max: identical(args[6], darticAbsent) ? 1.0 : args[6] as double, divisions: identical(args[7], darticAbsent) ? null : args[7] as int?, activeColor: identical(args[8], darticAbsent) ? null : args[8] as Color?, thumbColor: identical(args[9], darticAbsent) ? CupertinoColors.white : args[9] as Color),
