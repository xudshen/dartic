...
abstract final class CupertinoSwitchBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        '#25': (args) => CupertinoSwitch(key: identical(args[0], darticAbsent) ? null : args[0] as Key?, value: args[1] as bool, onChanged: args[2] as void Function(bool)?, activeColor: identical(args[3], darticAbsent) ? null : args[3] as Color?, trackColor: identical(args[4], darticAbsent) ? null : args[4] as Color?, activeTrackColor: identical(args[5], darticAbsent) ? null : args[5] as Color?, inactiveTrackColor: identical(args[6], darticAbsent) ? null : args[6] as Color?, thumbColor: identical(args[7], darticAbsent) ? null : args[7] as Color?, inactiveThumbColor: identical(args[8], darticAbsent) ? null : args[8] as Color?, applyTheme: identical(args[9], darticAbsent) ? null : args[9] as bool?, focusColor: identical(args[10], darticAbsent) ? null : args[10] as Color?, onLabelColor: identical(args[11], darticAbsent) ? null : args[11] as Color?, offLabelColor: identical(args[12], darticAbsent) ? null : args[12] as Color?, activeThumbImage: identical(args[13], darticAbsent) ? null : args[13] as ImageProvider<Object>?, onActiveThumbImageError: identical(args[14], darticAbsent) ? null : args[14] as void Function(Object, StackTrace?)?, inactiveThumbImage: identical(args[15], darticAbsent) ? null : args[15] as ImageProvider<Object>?, onInactiveThumbImageError: identical(args[16], darticAbsent) ? null : args[16] as void Function(Object, StackTrace?)?, trackOutlineColor: identical(args[17], darticAbsent) ? null : args[17] as WidgetStateProperty<Color?>?, trackOutlineWidth: identical(args[18], darticAbsent) ? null : args[18] as WidgetStateProperty<double?>?, thumbIcon: identical(args[19], darticAbsent) ? null : args[19] as WidgetStateProperty<Icon?>?, mouseCursor: identical(args[20], darticAbsent) ? null : args[20] as WidgetStateProperty<MouseCursor>?, focusNode: identical(args[21], darticAbsent) ? null : args[21] as FocusNode?, onFocusChange: identical(args[22], darticAbsent) ? null : args[22] as void Function(bool)?, autofocus: identical(args[23], darticAbsent) ? false : args[23] as bool, dragStartBehavior: identical(args[24], darticAbsent) ? DragStartBehavior.start : args[24] as DragStartBehavior),
      };
}
