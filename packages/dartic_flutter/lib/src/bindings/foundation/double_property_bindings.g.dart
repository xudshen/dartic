...
class _$DoubleProperty extends DoubleProperty implements DarticObjectHolder {
  _$DoubleProperty(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(superArgs[0] as String, superArgs[1] as double?, ifNull: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as String?, unit: identical(superArgs[3], darticAbsent) ? null : superArgs[3] as String?, tooltip: identical(superArgs[4], darticAbsent) ? null : superArgs[4] as String?, defaultValue: identical(superArgs[5], darticAbsent) ? null : superArgs[5], showName: superArgs[6] as bool, style: superArgs[7] as DiagnosticsTreeStyle, level: superArgs[8] as DiagnosticLevel);
  ...
  String numberToString() {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'numberToString', const []);
    if (identical(r, notOverridden)) return super.numberToString();
    return r as String;
  }
...
/// private class.
Object createDoublePropertyBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$DoubleProperty(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$DoubleProperty(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$numberToString#0', (args) => (args[0] as _$DoubleProperty)._super$numberToString());
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$toString#2', (args) => (args[0] as _$DoubleProperty)._super$toString(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.info : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$toJsonMap#1', (args) => (args[0] as _$DoubleProperty)._super$toJsonMap(args[1] as DiagnosticsSerializationDelegate));
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$valueToString#1', (args) => (args[0] as _$DoubleProperty)._super$valueToString(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?));
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$toDescription#1', (args) => (args[0] as _$DoubleProperty)._super$toDescription(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?));
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$getProperties#0', (args) => (args[0] as _$DoubleProperty)._super$getProperties());
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$getChildren#0', (args) => (args[0] as _$DoubleProperty)._super$getChildren());
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$isFiltered#1', (args) => (args[0] as _$DoubleProperty)._super$isFiltered(args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$toTimelineArguments#0', (args) => (args[0] as _$DoubleProperty)._super$toTimelineArguments());
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$toJsonMapIterative#1', (args) => (args[0] as _$DoubleProperty)._super$toJsonMapIterative(args[1] as DiagnosticsSerializationDelegate));
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$toStringDeep#5', (args) => (args[0] as _$DoubleProperty)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, parentConfiguration: identical(args[3], darticAbsent) ? null : args[3] as TextTreeConfiguration?, minLevel: identical(args[4], darticAbsent) ? DiagnosticLevel.debug : args[4] as DiagnosticLevel, wrapWidth: identical(args[5], darticAbsent) ? 65 : args[5] as int));
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$hashCode#0', (args) => (args[0] as _$DoubleProperty)._super$hashCode);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$unit#0', (args) => (args[0] as _$DoubleProperty)._super$unit);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$expandableValue#0', (args) => (args[0] as _$DoubleProperty)._super$expandableValue);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$allowWrap#0', (args) => (args[0] as _$DoubleProperty)._super$allowWrap);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$allowNameWrap#0', (args) => (args[0] as _$DoubleProperty)._super$allowNameWrap);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$ifNull#0', (args) => (args[0] as _$DoubleProperty)._super$ifNull);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$ifEmpty#0', (args) => (args[0] as _$DoubleProperty)._super$ifEmpty);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$tooltip#0', (args) => (args[0] as _$DoubleProperty)._super$tooltip);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$missingIfNull#0', (args) => (args[0] as _$DoubleProperty)._super$missingIfNull);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$propertyType#0', (args) => (args[0] as _$DoubleProperty)._super$propertyType);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$value#0', (args) => (args[0] as _$DoubleProperty)._super$value);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$exception#0', (args) => (args[0] as _$DoubleProperty)._super$exception);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$defaultValue#0', (args) => (args[0] as _$DoubleProperty)._super$defaultValue);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$isInteresting#0', (args) => (args[0] as _$DoubleProperty)._super$isInteresting);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$level#0', (args) => (args[0] as _$DoubleProperty)._super$level);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$name#0', (args) => (args[0] as _$DoubleProperty)._super$name);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$showSeparator#0', (args) => (args[0] as _$DoubleProperty)._super$showSeparator);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$showName#0', (args) => (args[0] as _$DoubleProperty)._super$showName);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$linePrefix#0', (args) => (args[0] as _$DoubleProperty)._super$linePrefix);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$emptyBodyDescription#0', (args) => (args[0] as _$DoubleProperty)._super$emptyBodyDescription);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$style#0', (args) => (args[0] as _$DoubleProperty)._super$style);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$allowTruncate#0', (args) => (args[0] as _$DoubleProperty)._super$allowTruncate);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::DoubleProperty::\$super\$textTreeConfiguration#0', (args) => (args[0] as _$DoubleProperty)._super$textTreeConfiguration);
  }
