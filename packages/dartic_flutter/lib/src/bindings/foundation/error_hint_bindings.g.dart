...
class _$ErrorHint extends ErrorHint implements DarticObjectHolder {
  _$ErrorHint(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(superArgs[0] as String);
...
/// private class.
Object createErrorHintBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$ErrorHint(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$ErrorHint(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$toString#2', (args) => (args[0] as _$ErrorHint)._super$toString(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.info : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$valueToString#1', (args) => (args[0] as _$ErrorHint)._super$valueToString(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?));
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$toJsonMap#1', (args) => (args[0] as _$ErrorHint)._super$toJsonMap(args[1] as DiagnosticsSerializationDelegate));
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$toDescription#1', (args) => (args[0] as _$ErrorHint)._super$toDescription(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?));
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$getProperties#0', (args) => (args[0] as _$ErrorHint)._super$getProperties());
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$getChildren#0', (args) => (args[0] as _$ErrorHint)._super$getChildren());
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$isFiltered#1', (args) => (args[0] as _$ErrorHint)._super$isFiltered(args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$toTimelineArguments#0', (args) => (args[0] as _$ErrorHint)._super$toTimelineArguments());
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$toJsonMapIterative#1', (args) => (args[0] as _$ErrorHint)._super$toJsonMapIterative(args[1] as DiagnosticsSerializationDelegate));
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$toStringDeep#5', (args) => (args[0] as _$ErrorHint)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, parentConfiguration: identical(args[3], darticAbsent) ? null : args[3] as TextTreeConfiguration?, minLevel: identical(args[4], darticAbsent) ? DiagnosticLevel.debug : args[4] as DiagnosticLevel, wrapWidth: identical(args[5], darticAbsent) ? 65 : args[5] as int));
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$hashCode#0', (args) => (args[0] as _$ErrorHint)._super$hashCode);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$value#0', (args) => (args[0] as _$ErrorHint)._super$value);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$expandableValue#0', (args) => (args[0] as _$ErrorHint)._super$expandableValue);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$allowWrap#0', (args) => (args[0] as _$ErrorHint)._super$allowWrap);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$allowNameWrap#0', (args) => (args[0] as _$ErrorHint)._super$allowNameWrap);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$ifNull#0', (args) => (args[0] as _$ErrorHint)._super$ifNull);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$ifEmpty#0', (args) => (args[0] as _$ErrorHint)._super$ifEmpty);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$tooltip#0', (args) => (args[0] as _$ErrorHint)._super$tooltip);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$missingIfNull#0', (args) => (args[0] as _$ErrorHint)._super$missingIfNull);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$propertyType#0', (args) => (args[0] as _$ErrorHint)._super$propertyType);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$exception#0', (args) => (args[0] as _$ErrorHint)._super$exception);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$defaultValue#0', (args) => (args[0] as _$ErrorHint)._super$defaultValue);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$isInteresting#0', (args) => (args[0] as _$ErrorHint)._super$isInteresting);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$level#0', (args) => (args[0] as _$ErrorHint)._super$level);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$name#0', (args) => (args[0] as _$ErrorHint)._super$name);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$showSeparator#0', (args) => (args[0] as _$ErrorHint)._super$showSeparator);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$showName#0', (args) => (args[0] as _$ErrorHint)._super$showName);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$linePrefix#0', (args) => (args[0] as _$ErrorHint)._super$linePrefix);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$emptyBodyDescription#0', (args) => (args[0] as _$ErrorHint)._super$emptyBodyDescription);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$style#0', (args) => (args[0] as _$ErrorHint)._super$style);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$allowTruncate#0', (args) => (args[0] as _$ErrorHint)._super$allowTruncate);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorHint::\$super\$textTreeConfiguration#0', (args) => (args[0] as _$ErrorHint)._super$textTreeConfiguration);
  }
