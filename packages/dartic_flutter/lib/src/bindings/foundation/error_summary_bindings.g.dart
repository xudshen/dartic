...
class _$ErrorSummary extends ErrorSummary implements DarticObjectHolder {
  _$ErrorSummary(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(superArgs[0] as String);
...
/// private class.
Object createErrorSummaryBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$ErrorSummary(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$ErrorSummary(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorSummary::\$super\$toString#2', (args) => (args[0] as _$ErrorSummary)._super$toString(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.info : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorSummary::\$super\$valueToString#1', (args) => (args[0] as _$ErrorSummary)._super$valueToString(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?));
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorSummary::\$super\$toJsonMap#1', (args) => (args[0] as _$ErrorSummary)._super$toJsonMap(args[1] as DiagnosticsSerializationDelegate));
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorSummary::\$super\$toDescription#1', (args) => (args[0] as _$ErrorSummary)._super$toDescription(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?));
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorSummary::\$super\$getProperties#0', (args) => (args[0] as _$ErrorSummary)._super$getProperties());
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorSummary::\$super\$getChildren#0', (args) => (args[0] as _$ErrorSummary)._super$getChildren());
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorSummary::\$super\$isFiltered#1', (args) => (args[0] as _$ErrorSummary)._super$isFiltered(args[1] as DiagnosticLevel));
    ...
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorSummary::\$super\$allowNameWrap#0', (args) => (args[0] as _$ErrorSummary)._super$allowNameWrap);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorSummary::\$super\$ifNull#0', (args) => (args[0] as _$ErrorSummary)._super$ifNull);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorSummary::\$super\$ifEmpty#0', (args) => (args[0] as _$ErrorSummary)._super$ifEmpty);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorSummary::\$super\$tooltip#0', (args) => (args[0] as _$ErrorSummary)._super$tooltip);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorSummary::\$super\$missingIfNull#0', (args) => (args[0] as _$ErrorSummary)._super$missingIfNull);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorSummary::\$super\$propertyType#0', (args) => (args[0] as _$ErrorSummary)._super$propertyType);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorSummary::\$super\$exception#0', (args) => (args[0] as _$ErrorSummary)._super$exception);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorSummary::\$super\$defaultValue#0', (args) => (args[0] as _$ErrorSummary)._super$defaultValue);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorSummary::\$super\$isInteresting#0', (args) => (args[0] as _$ErrorSummary)._super$isInteresting);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorSummary::\$super\$level#0', (args) => (args[0] as _$ErrorSummary)._super$level);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorSummary::\$super\$name#0', (args) => (args[0] as _$ErrorSummary)._super$name);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorSummary::\$super\$showSeparator#0', (args) => (args[0] as _$ErrorSummary)._super$showSeparator);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorSummary::\$super\$showName#0', (args) => (args[0] as _$ErrorSummary)._super$showName);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorSummary::\$super\$linePrefix#0', (args) => (args[0] as _$ErrorSummary)._super$linePrefix);
    ctx.registerBinding('package:flutter/src/foundation/assertions.dart::ErrorSummary::\$super\$emptyBodyDescription#0', (args) => (args[0] as _$ErrorSummary)._super$emptyBodyDescription);
