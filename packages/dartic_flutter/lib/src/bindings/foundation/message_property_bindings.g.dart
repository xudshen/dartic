...
class _$MessageProperty extends MessageProperty implements DarticObjectHolder {
  _$MessageProperty(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(superArgs[0] as String, superArgs[1] as String, style: superArgs[2] as DiagnosticsTreeStyle, level: superArgs[3] as DiagnosticLevel);
  ...
  void get _super$value => super.value;
...
/// private class.
Object createMessagePropertyBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$MessageProperty(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$MessageProperty(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$toString#2', (args) => (args[0] as _$MessageProperty)._super$toString(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.info : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$toJsonMap#1', (args) => (args[0] as _$MessageProperty)._super$toJsonMap(args[1] as DiagnosticsSerializationDelegate));
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$valueToString#1', (args) => (args[0] as _$MessageProperty)._super$valueToString(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?));
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$toDescription#1', (args) => (args[0] as _$MessageProperty)._super$toDescription(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?));
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$getProperties#0', (args) => (args[0] as _$MessageProperty)._super$getProperties());
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$getChildren#0', (args) => (args[0] as _$MessageProperty)._super$getChildren());
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$isFiltered#1', (args) => (args[0] as _$MessageProperty)._super$isFiltered(args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$toTimelineArguments#0', (args) => (args[0] as _$MessageProperty)._super$toTimelineArguments());
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$toJsonMapIterative#1', (args) => (args[0] as _$MessageProperty)._super$toJsonMapIterative(args[1] as DiagnosticsSerializationDelegate));
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$toStringDeep#5', (args) => (args[0] as _$MessageProperty)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, parentConfiguration: identical(args[3], darticAbsent) ? null : args[3] as TextTreeConfiguration?, minLevel: identical(args[4], darticAbsent) ? DiagnosticLevel.debug : args[4] as DiagnosticLevel, wrapWidth: identical(args[5], darticAbsent) ? 65 : args[5] as int));
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$expandableValue#0', (args) => (args[0] as _$MessageProperty)._super$expandableValue);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$allowWrap#0', (args) => (args[0] as _$MessageProperty)._super$allowWrap);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$allowNameWrap#0', (args) => (args[0] as _$MessageProperty)._super$allowNameWrap);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$ifNull#0', (args) => (args[0] as _$MessageProperty)._super$ifNull);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$ifEmpty#0', (args) => (args[0] as _$MessageProperty)._super$ifEmpty);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$tooltip#0', (args) => (args[0] as _$MessageProperty)._super$tooltip);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$missingIfNull#0', (args) => (args[0] as _$MessageProperty)._super$missingIfNull);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$propertyType#0', (args) => (args[0] as _$MessageProperty)._super$propertyType);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$value#0', (args) => (args[0] as _$MessageProperty)._super$value);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$exception#0', (args) => (args[0] as _$MessageProperty)._super$exception);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$defaultValue#0', (args) => (args[0] as _$MessageProperty)._super$defaultValue);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$isInteresting#0', (args) => (args[0] as _$MessageProperty)._super$isInteresting);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$level#0', (args) => (args[0] as _$MessageProperty)._super$level);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$name#0', (args) => (args[0] as _$MessageProperty)._super$name);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$showSeparator#0', (args) => (args[0] as _$MessageProperty)._super$showSeparator);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$showName#0', (args) => (args[0] as _$MessageProperty)._super$showName);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$linePrefix#0', (args) => (args[0] as _$MessageProperty)._super$linePrefix);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$emptyBodyDescription#0', (args) => (args[0] as _$MessageProperty)._super$emptyBodyDescription);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$style#0', (args) => (args[0] as _$MessageProperty)._super$style);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$allowTruncate#0', (args) => (args[0] as _$MessageProperty)._super$allowTruncate);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$textTreeConfiguration#0', (args) => (args[0] as _$MessageProperty)._super$textTreeConfiguration);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::MessageProperty::\$super\$hashCode#0', (args) => (args[0] as _$MessageProperty)._super$hashCode);
  }
