...
class _$FlagProperty extends FlagProperty implements DarticObjectHolder {
  _$FlagProperty(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(superArgs[0] as String, value: superArgs[1] as bool?, ifTrue: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as String?, ifFalse: identical(superArgs[3], darticAbsent) ? null : superArgs[3] as String?, showName: superArgs[4] as bool, defaultValue: identical(superArgs[5], darticAbsent) ? null : superArgs[5], level: superArgs[6] as DiagnosticLevel);
  ...
  @override
  String? get ifTrue {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'ifTrue');
    if (identical(r, notOverridden)) return super.ifTrue;
    return r as String?;
  }

  @override
  String? get ifFalse {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'ifFalse');
    if (identical(r, notOverridden)) return super.ifFalse;
    return r as String?;
  }
  ...
  String? get _super$ifTrue => super.ifTrue;
...
/// private class.
Object createFlagPropertyBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$FlagProperty(dispatch, obj, superArgs);

abstract final class FlagPropertyBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      name: 'package:flutter/src/foundation/diagnostics.dart::FlagProperty',
      type: FlagProperty,
      test: (o) => o is FlagProperty,
      methods: methodMap(),
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$FlagProperty(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$toJsonMap#1', (args) => (args[0] as _$FlagProperty)._super$toJsonMap(args[1] as DiagnosticsSerializationDelegate));
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$valueToString#1', (args) => (args[0] as _$FlagProperty)._super$valueToString(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?));
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$toString#2', (args) => (args[0] as _$FlagProperty)._super$toString(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.info : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$toDescription#1', (args) => (args[0] as _$FlagProperty)._super$toDescription(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?));
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$getProperties#0', (args) => (args[0] as _$FlagProperty)._super$getProperties());
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$getChildren#0', (args) => (args[0] as _$FlagProperty)._super$getChildren());
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$isFiltered#1', (args) => (args[0] as _$FlagProperty)._super$isFiltered(args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$toTimelineArguments#0', (args) => (args[0] as _$FlagProperty)._super$toTimelineArguments());
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$toJsonMapIterative#1', (args) => (args[0] as _$FlagProperty)._super$toJsonMapIterative(args[1] as DiagnosticsSerializationDelegate));
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$toStringDeep#5', (args) => (args[0] as _$FlagProperty)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, parentConfiguration: identical(args[3], darticAbsent) ? null : args[3] as TextTreeConfiguration?, minLevel: identical(args[4], darticAbsent) ? DiagnosticLevel.debug : args[4] as DiagnosticLevel, wrapWidth: identical(args[5], darticAbsent) ? 65 : args[5] as int));
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$ifTrue#0', (args) => (args[0] as _$FlagProperty)._super$ifTrue);
    ...
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$ifNull#0', (args) => (args[0] as _$FlagProperty)._super$ifNull);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$ifEmpty#0', (args) => (args[0] as _$FlagProperty)._super$ifEmpty);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$tooltip#0', (args) => (args[0] as _$FlagProperty)._super$tooltip);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$missingIfNull#0', (args) => (args[0] as _$FlagProperty)._super$missingIfNull);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$propertyType#0', (args) => (args[0] as _$FlagProperty)._super$propertyType);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$value#0', (args) => (args[0] as _$FlagProperty)._super$value);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$exception#0', (args) => (args[0] as _$FlagProperty)._super$exception);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$defaultValue#0', (args) => (args[0] as _$FlagProperty)._super$defaultValue);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$isInteresting#0', (args) => (args[0] as _$FlagProperty)._super$isInteresting);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$name#0', (args) => (args[0] as _$FlagProperty)._super$name);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$showSeparator#0', (args) => (args[0] as _$FlagProperty)._super$showSeparator);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$linePrefix#0', (args) => (args[0] as _$FlagProperty)._super$linePrefix);
    ctx.registerBinding('package:flutter/src/foundation/diagnostics.dart::FlagProperty::\$super\$emptyBodyDescription#0', (args) => (args[0] as _$FlagProperty)._super$emptyBodyDescription);
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        'toJsonMap#1': (args) => (args[0] as FlagProperty).toJsonMap(args[1] as DiagnosticsSerializationDelegate),
        'valueToString#1': (args) => (args[0] as FlagProperty).valueToString(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?),
        'toString#2': (args) => (args[0] as FlagProperty).toString(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.info : args[2] as DiagnosticLevel),
        'toDescription#1': (args) => (args[0] as FlagProperty).toDescription(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?),
        'getProperties#0': (args) => (args[0] as FlagProperty).getProperties(),
        'getChildren#0': (args) => (args[0] as FlagProperty).getChildren(),
        'isFiltered#1': (args) => (args[0] as FlagProperty).isFiltered(args[1] as DiagnosticLevel),
        'toTimelineArguments#0': (args) => (args[0] as FlagProperty).toTimelineArguments(),
        'toJsonMapIterative#1': (args) => (args[0] as FlagProperty).toJsonMapIterative(args[1] as DiagnosticsSerializationDelegate),
        'toStringDeep#5': (args) => (args[0] as FlagProperty).toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, parentConfiguration: identical(args[3], darticAbsent) ? null : args[3] as TextTreeConfiguration?, minLevel: identical(args[4], darticAbsent) ? DiagnosticLevel.debug : args[4] as DiagnosticLevel, wrapWidth: identical(args[5], darticAbsent) ? 65 : args[5] as int),
        'ifTrue#0': (args) => (args[0] as FlagProperty).ifTrue,
        'ifFalse#0': (args) => (args[0] as FlagProperty).ifFalse,
        'showName#0': (args) => (args[0] as FlagProperty).showName,
        'level#0': (args) => (args[0] as FlagProperty).level,
        'hashCode#0': (args) => (args[0] as FlagProperty).hashCode,
        'expandableValue#0': (args) => (args[0] as FlagProperty).expandableValue,
        'allowWrap#0': (args) => (args[0] as FlagProperty).allowWrap,
        'allowNameWrap#0': (args) => (args[0] as FlagProperty).allowNameWrap,
        'ifNull#0': (args) => (args[0] as FlagProperty).ifNull,
        'ifEmpty#0': (args) => (args[0] as FlagProperty).ifEmpty,
        'tooltip#0': (args) => (args[0] as FlagProperty).tooltip,
        'missingIfNull#0': (args) => (args[0] as FlagProperty).missingIfNull,
        'propertyType#0': (args) => (args[0] as FlagProperty).propertyType,
        'value#0': (args) => (args[0] as FlagProperty).value,
        'exception#0': (args) => (args[0] as FlagProperty).exception,
        'defaultValue#0': (args) => (args[0] as FlagProperty).defaultValue,
        'isInteresting#0': (args) => (args[0] as FlagProperty).isInteresting,
        'name#0': (args) => (args[0] as FlagProperty).name,
        'showSeparator#0': (args) => (args[0] as FlagProperty).showSeparator,
        'linePrefix#0': (args) => (args[0] as FlagProperty).linePrefix,
        'emptyBodyDescription#0': (args) => (args[0] as FlagProperty).emptyBodyDescription,
        'style#0': (args) => (args[0] as FlagProperty).style,
        'allowTruncate#0': (args) => (args[0] as FlagProperty).allowTruncate,
        'textTreeConfiguration#0': (args) => (args[0] as FlagProperty).textTreeConfiguration,
        '==#1': (args) => (args[0] as FlagProperty) == (args[1] as Object),
        '#7': (args) => FlagProperty(args[0] as String, value: args[1] as bool?, ifTrue: identical(args[2], darticAbsent) ? null : args[2] as String?, ifFalse: identical(args[3], darticAbsent) ? null : args[3] as String?, showName: identical(args[4], darticAbsent) ? false : args[4] as bool, defaultValue: identical(args[5], darticAbsent) ? null : args[5], level: identical(args[6], darticAbsent) ? DiagnosticLevel.info : args[6] as DiagnosticLevel),
      };
}
