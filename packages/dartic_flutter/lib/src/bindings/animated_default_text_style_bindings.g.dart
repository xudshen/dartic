...
abstract final class AnimatedDefaultTextStyleBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        '_#fromFields#8': (args) => AnimatedDefaultTextStyle(child: args[0] as Widget, maxLines: args[1] as int?, overflow: args[2] as TextOverflow, softWrap: args[3] as bool, style: args[4] as TextStyle, textAlign: args[5] as TextAlign?, textHeightBehavior: args[6] as TextHeightBehavior?, textWidthBasis: args[7] as TextWidthBasis),
      };
}
