...
abstract final class CircleAvatarBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        '#11': (args) => CircleAvatar(key: identical(args[0], darticAbsent) ? null : args[0] as Key?, child: identical(args[1], darticAbsent) ? null : args[1] as Widget?, backgroundColor: identical(args[2], darticAbsent) ? null : args[2] as Color?, backgroundImage: identical(args[3], darticAbsent) ? null : args[3] as ImageProvider<Object>?, foregroundImage: identical(args[4], darticAbsent) ? null : args[4] as ImageProvider<Object>?, onBackgroundImageError: identical(args[5], darticAbsent) ? null : args[5] as void Function(Object, StackTrace?)?, onForegroundImageError: identical(args[6], darticAbsent) ? null : args[6] as void Function(Object, StackTrace?)?, foregroundColor: identical(args[7], darticAbsent) ? null : args[7] as Color?, radius: identical(args[8], darticAbsent) ? null : args[8] as double?, minRadius: identical(args[9], darticAbsent) ? null : args[9] as double?, maxRadius: identical(args[10], darticAbsent) ? null : args[10] as double?),
      };
}
