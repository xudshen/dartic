...
abstract final class ClipRectBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        '#4': (args) => ClipRect(key: identical(args[0], darticAbsent) ? null : args[0] as Key?, clipper: identical(args[1], darticAbsent) ? null : args[1] as CustomClipper<Rect>?, clipBehavior: identical(args[2], darticAbsent) ? Clip.hardEdge : args[2] as Clip, child: identical(args[3], darticAbsent) ? null : args[3] as Widget?),
        '_#fromFields#2': (args) => ClipRect(clipBehavior: args[0] as Clip, clipper: args[1] as CustomClipper<Rect>?),
      };
}
