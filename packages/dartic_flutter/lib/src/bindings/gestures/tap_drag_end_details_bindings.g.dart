...
class _$TapDragEndDetails extends TapDragEndDetails implements DarticObjectHolder {
  _$TapDragEndDetails(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(globalPosition: superArgs[0] as Offset, localPosition: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as Offset?, velocity: superArgs[2] as Velocity, primaryVelocity: identical(superArgs[3], darticAbsent) ? null : superArgs[3] as double?, consecutiveTapCount: superArgs[4] as int);
...
/// private class.
Object createTapDragEndDetailsBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$TapDragEndDetails(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$TapDragEndDetails(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapDragEndDetails::\$super\$debugFillProperties#1', (args) { (args[0] as _$TapDragEndDetails)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapDragEndDetails::\$super\$toString#1', (args) => (args[0] as _$TapDragEndDetails)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapDragEndDetails::\$super\$toStringShort#0', (args) => (args[0] as _$TapDragEndDetails)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapDragEndDetails::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$TapDragEndDetails)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapDragEndDetails::\$super\$globalPosition#0', (args) => (args[0] as _$TapDragEndDetails)._super$globalPosition);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapDragEndDetails::\$super\$localPosition#0', (args) => (args[0] as _$TapDragEndDetails)._super$localPosition);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapDragEndDetails::\$super\$velocity#0', (args) => (args[0] as _$TapDragEndDetails)._super$velocity);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapDragEndDetails::\$super\$primaryVelocity#0', (args) => (args[0] as _$TapDragEndDetails)._super$primaryVelocity);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapDragEndDetails::\$super\$consecutiveTapCount#0', (args) => (args[0] as _$TapDragEndDetails)._super$consecutiveTapCount);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapDragEndDetails::\$super\$hashCode#0', (args) => (args[0] as _$TapDragEndDetails)._super$hashCode);
  }
