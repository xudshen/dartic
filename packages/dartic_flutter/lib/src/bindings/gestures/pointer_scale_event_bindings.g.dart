...
class _$PointerScaleEvent extends PointerScaleEvent implements DarticObjectHolder {
  _$PointerScaleEvent(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(viewId: superArgs[0] as int, timeStamp: superArgs[1] as Duration, kind: superArgs[2] as PointerDeviceKind, device: superArgs[3] as int, position: superArgs[4] as Offset, embedderId: superArgs[5] as int, scale: superArgs[6] as double);
  ...
  PointerScaleEvent transformed(Matrix4? transform) {
    ...
    return _$r as PointerScaleEvent;
  }
  ...
  @override
  PointerScaleEvent copyWith({int? viewId, Duration? timeStamp, int? pointer, PointerDeviceKind? kind, int? device, Offset? position, Offset? delta, int? buttons, bool? obscured, double? pressure, double? pressureMin, double? pressureMax, double? distance, double? distanceMax, double? size, double? radiusMajor, double? radiusMinor, double? radiusMin, double? radiusMax, double? orientation, double? tilt, bool? synthesized, int? embedderId, double? scale}) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'copyWith', [viewId, timeStamp, pointer, kind, device, position, delta, buttons, obscured, pressure, pressureMin, pressureMax, distance, distanceMax, size, radiusMajor, radiusMinor, radiusMin, radiusMax, orientation, tilt, synthesized, embedderId, scale]);
  ...
  // ── Super trampolines ──
  PointerScaleEvent _super$transformed(Matrix4? transform) => super.transformed(transform);
  String _super$toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) => super.toString(minLevel: minLevel);
  PointerScaleEvent _super$copyWith({int? viewId, Duration? timeStamp, int? pointer, PointerDeviceKind? kind, int? device, Offset? position, Offset? delta, int? buttons, bool? obscured, double? pressure, double? pressureMin, double? pressureMax, double? distance, double? distanceMax, double? size, double? radiusMajor, double? radiusMinor, double? radiusMin, double? radiusMax, double? orientation, double? tilt, bool? synthesized, int? embedderId, double? scale}) => super.copyWith(viewId: viewId, timeStamp: timeStamp, pointer: pointer, kind: kind, device: device, position: position, delta: delta, buttons: buttons, obscured: obscured, pressure: pressure, pressureMin: pressureMin, pressureMax: pressureMax, distance: distance, distanceMax: distanceMax, size: size, radiusMajor: radiusMajor, radiusMinor: radiusMinor, radiusMin: radiusMin, radiusMax: radiusMax, orientation: orientation, tilt: tilt, synthesized: synthesized, embedderId: embedderId, scale: scale);
...
/// private class.
Object createPointerScaleEventBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$PointerScaleEvent(dispatch, obj, superArgs);

abstract final class PointerScaleEventBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      name: 'package:flutter/src/gestures/events.dart::PointerScaleEvent',
      type: PointerScaleEvent,
      test: (o) => o is PointerScaleEvent,
      methods: methodMap(),
      superclasses: ['package:flutter/src/gestures/events.dart::PointerSignalEvent', 'package:flutter/src/gestures/events.dart::PointerEvent', 'package:flutter/src/foundation/diagnostics.dart::Diagnosticable', 'package:flutter/src/gestures/events.dart::_RespondablePointerEvent', 'package:flutter/src/gestures/events.dart::_PointerEventDescription', 'package:flutter/src/gestures/events.dart::_CopyPointerScaleEvent'],
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$PointerScaleEvent(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$transformed#1', (args) => (args[0] as _$PointerScaleEvent)._super$transformed(args[1] as Matrix4?));
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$toString#1', (args) => (args[0] as _$PointerScaleEvent)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$copyWith#24', (args) => (args[0] as _$PointerScaleEvent)._super$copyWith(viewId: identical(args[1], darticAbsent) ? null : args[1] as int?, timeStamp: identical(args[2], darticAbsent) ? null : args[2] as Duration?, pointer: identical(args[3], darticAbsent) ? null : args[3] as int?, kind: identical(args[4], darticAbsent) ? null : args[4] as PointerDeviceKind?, device: identical(args[5], darticAbsent) ? null : args[5] as int?, position: identical(args[6], darticAbsent) ? null : args[6] as Offset?, delta: identical(args[7], darticAbsent) ? null : args[7] as Offset?, buttons: identical(args[8], darticAbsent) ? null : args[8] as int?, obscured: identical(args[9], darticAbsent) ? null : args[9] as bool?, pressure: identical(args[10], darticAbsent) ? null : args[10] as double?, pressureMin: identical(args[11], darticAbsent) ? null : args[11] as double?, pressureMax: identical(args[12], darticAbsent) ? null : args[12] as double?, distance: identical(args[13], darticAbsent) ? null : args[13] as double?, distanceMax: identical(args[14], darticAbsent) ? null : args[14] as double?, size: identical(args[15], darticAbsent) ? null : args[15] as double?, radiusMajor: identical(args[16], darticAbsent) ? null : args[16] as double?, radiusMinor: identical(args[17], darticAbsent) ? null : args[17] as double?, radiusMin: identical(args[18], darticAbsent) ? null : args[18] as double?, radiusMax: identical(args[19], darticAbsent) ? null : args[19] as double?, orientation: identical(args[20], darticAbsent) ? null : args[20] as double?, tilt: identical(args[21], darticAbsent) ? null : args[21] as double?, synthesized: identical(args[22], darticAbsent) ? null : args[22] as bool?, embedderId: identical(args[23], darticAbsent) ? null : args[23] as int?, scale: identical(args[24], darticAbsent) ? null : args[24] as double?));
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$toStringShort#0', (args) => (args[0] as _$PointerScaleEvent)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$PointerScaleEvent)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$debugFillProperties#1', (args) { (args[0] as _$PointerScaleEvent)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$respond#1', (args) { (args[0] as _$PointerScaleEvent)._super$respond(allowPlatformDefault: args[1] as bool); return null; });
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$toStringFull#0', (args) => (args[0] as _$PointerScaleEvent)._super$toStringFull());
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$scale#0', (args) => (args[0] as _$PointerScaleEvent)._super$scale);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$hashCode#0', (args) => (args[0] as _$PointerScaleEvent)._super$hashCode);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$viewId#0', (args) => (args[0] as _$PointerScaleEvent)._super$viewId);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$embedderId#0', (args) => (args[0] as _$PointerScaleEvent)._super$embedderId);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$timeStamp#0', (args) => (args[0] as _$PointerScaleEvent)._super$timeStamp);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$pointer#0', (args) => (args[0] as _$PointerScaleEvent)._super$pointer);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$kind#0', (args) => (args[0] as _$PointerScaleEvent)._super$kind);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$device#0', (args) => (args[0] as _$PointerScaleEvent)._super$device);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$position#0', (args) => (args[0] as _$PointerScaleEvent)._super$position);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$localPosition#0', (args) => (args[0] as _$PointerScaleEvent)._super$localPosition);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$delta#0', (args) => (args[0] as _$PointerScaleEvent)._super$delta);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$localDelta#0', (args) => (args[0] as _$PointerScaleEvent)._super$localDelta);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$buttons#0', (args) => (args[0] as _$PointerScaleEvent)._super$buttons);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$down#0', (args) => (args[0] as _$PointerScaleEvent)._super$down);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$obscured#0', (args) => (args[0] as _$PointerScaleEvent)._super$obscured);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$pressure#0', (args) => (args[0] as _$PointerScaleEvent)._super$pressure);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$pressureMin#0', (args) => (args[0] as _$PointerScaleEvent)._super$pressureMin);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$pressureMax#0', (args) => (args[0] as _$PointerScaleEvent)._super$pressureMax);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$distance#0', (args) => (args[0] as _$PointerScaleEvent)._super$distance);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$distanceMin#0', (args) => (args[0] as _$PointerScaleEvent)._super$distanceMin);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$distanceMax#0', (args) => (args[0] as _$PointerScaleEvent)._super$distanceMax);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$size#0', (args) => (args[0] as _$PointerScaleEvent)._super$size);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$radiusMajor#0', (args) => (args[0] as _$PointerScaleEvent)._super$radiusMajor);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$radiusMinor#0', (args) => (args[0] as _$PointerScaleEvent)._super$radiusMinor);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$radiusMin#0', (args) => (args[0] as _$PointerScaleEvent)._super$radiusMin);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$radiusMax#0', (args) => (args[0] as _$PointerScaleEvent)._super$radiusMax);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$orientation#0', (args) => (args[0] as _$PointerScaleEvent)._super$orientation);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$tilt#0', (args) => (args[0] as _$PointerScaleEvent)._super$tilt);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$platformData#0', (args) => (args[0] as _$PointerScaleEvent)._super$platformData);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$synthesized#0', (args) => (args[0] as _$PointerScaleEvent)._super$synthesized);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$transform#0', (args) => (args[0] as _$PointerScaleEvent)._super$transform);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerScaleEvent::\$super\$original#0', (args) => (args[0] as _$PointerScaleEvent)._super$original);
  }

  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        'transformed#1': (args) => (args[0] as PointerScaleEvent).transformed(args[1] as Matrix4?),
        'toString#1': (args) => (args[0] as PointerScaleEvent).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
        ...
        'debugFillProperties#1': (args) { (args[0] as PointerScaleEvent).debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; },
        ...
        'pointer#0': (args) => (args[0] as PointerScaleEvent).pointer,
        'kind#0': (args) => (args[0] as PointerScaleEvent).kind,
        'device#0': (args) => (args[0] as PointerScaleEvent).device,
        'position#0': (args) => (args[0] as PointerScaleEvent).position,
        'localPosition#0': (args) => (args[0] as PointerScaleEvent).localPosition,
        'delta#0': (args) => (args[0] as PointerScaleEvent).delta,
        'localDelta#0': (args) => (args[0] as PointerScaleEvent).localDelta,
        'buttons#0': (args) => (args[0] as PointerScaleEvent).buttons,
        'down#0': (args) => (args[0] as PointerScaleEvent).down,
        'obscured#0': (args) => (args[0] as PointerScaleEvent).obscured,
        'pressure#0': (args) => (args[0] as PointerScaleEvent).pressure,
        'pressureMin#0': (args) => (args[0] as PointerScaleEvent).pressureMin,
        'pressureMax#0': (args) => (args[0] as PointerScaleEvent).pressureMax,
        'distance#0': (args) => (args[0] as PointerScaleEvent).distance,
        'distanceMin#0': (args) => (args[0] as PointerScaleEvent).distanceMin,
        'distanceMax#0': (args) => (args[0] as PointerScaleEvent).distanceMax,
        'size#0': (args) => (args[0] as PointerScaleEvent).size,
        'radiusMajor#0': (args) => (args[0] as PointerScaleEvent).radiusMajor,
        'radiusMinor#0': (args) => (args[0] as PointerScaleEvent).radiusMinor,
        'radiusMin#0': (args) => (args[0] as PointerScaleEvent).radiusMin,
        'radiusMax#0': (args) => (args[0] as PointerScaleEvent).radiusMax,
        'orientation#0': (args) => (args[0] as PointerScaleEvent).orientation,
        'tilt#0': (args) => (args[0] as PointerScaleEvent).tilt,
        'platformData#0': (args) => (args[0] as PointerScaleEvent).platformData,
