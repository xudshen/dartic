...
class _$VerticalMultiDragGestureRecognizer extends VerticalMultiDragGestureRecognizer implements DarticObjectHolder {
  _$VerticalMultiDragGestureRecognizer(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(debugOwner: identical(superArgs[0], darticAbsent) ? null : superArgs[0], supportedDevices: identical(superArgs[1], darticAbsent) ? null : superArgs[1] == null ? null : (superArgs[1] as Set).cast<PointerDeviceKind>(), allowedButtonsFilter: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as AllowedButtonsFilter?);
...
/// private class.
Object createVerticalMultiDragGestureRecognizerBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$VerticalMultiDragGestureRecognizer(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$VerticalMultiDragGestureRecognizer(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$createNewPointerState#1', (args) => (args[0] as _$VerticalMultiDragGestureRecognizer)._super$createNewPointerState(args[1] as PointerDownEvent));
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$toString#1', (args) => (args[0] as _$VerticalMultiDragGestureRecognizer)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$addAllowedPointer#1', (args) { (args[0] as _$VerticalMultiDragGestureRecognizer)._super$addAllowedPointer(args[1] as PointerDownEvent); return null; });
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$acceptGesture#1', (args) { (args[0] as _$VerticalMultiDragGestureRecognizer)._super$acceptGesture(args[1] as int); return null; });
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$rejectGesture#1', (args) { (args[0] as _$VerticalMultiDragGestureRecognizer)._super$rejectGesture(args[1] as int); return null; });
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$dispose#0', (args) { (args[0] as _$VerticalMultiDragGestureRecognizer)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$addPointerPanZoom#1', (args) { (args[0] as _$VerticalMultiDragGestureRecognizer)._super$addPointerPanZoom(args[1] as PointerPanZoomStartEvent); return null; });
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$addAllowedPointerPanZoom#1', (args) { (args[0] as _$VerticalMultiDragGestureRecognizer)._super$addAllowedPointerPanZoom(args[1] as PointerPanZoomStartEvent); return null; });
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$addPointer#1', (args) { (args[0] as _$VerticalMultiDragGestureRecognizer)._super$addPointer(args[1] as PointerDownEvent); return null; });
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$handleNonAllowedPointer#1', (args) { (args[0] as _$VerticalMultiDragGestureRecognizer)._super$handleNonAllowedPointer(args[1] as PointerDownEvent); return null; });
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$isPointerAllowed#1', (args) => (args[0] as _$VerticalMultiDragGestureRecognizer)._super$isPointerAllowed(args[1] as PointerDownEvent));
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$handleNonAllowedPointerPanZoom#1', (args) { (args[0] as _$VerticalMultiDragGestureRecognizer)._super$handleNonAllowedPointerPanZoom(args[1] as PointerPanZoomStartEvent); return null; });
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$isPointerPanZoomAllowed#1', (args) => (args[0] as _$VerticalMultiDragGestureRecognizer)._super$isPointerPanZoomAllowed(args[1] as PointerPanZoomStartEvent));
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$getKindForPointer#1', (args) => (args[0] as _$VerticalMultiDragGestureRecognizer)._super$getKindForPointer(args[1] as int));
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$debugFillProperties#1', (args) { (args[0] as _$VerticalMultiDragGestureRecognizer)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$toStringShallow#2', (args) => (args[0] as _$VerticalMultiDragGestureRecognizer)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$toStringDeep#4', (args) => (args[0] as _$VerticalMultiDragGestureRecognizer)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$toStringShort#0', (args) => (args[0] as _$VerticalMultiDragGestureRecognizer)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$VerticalMultiDragGestureRecognizer)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$VerticalMultiDragGestureRecognizer)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$debugDescription#0', (args) => (args[0] as _$VerticalMultiDragGestureRecognizer)._super$debugDescription);
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$hashCode#0', (args) => (args[0] as _$VerticalMultiDragGestureRecognizer)._super$hashCode);
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$onStart#0', (args) => (args[0] as _$VerticalMultiDragGestureRecognizer)._super$onStart);
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$debugOwner#0', (args) => (args[0] as _$VerticalMultiDragGestureRecognizer)._super$debugOwner);
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$gestureSettings#0', (args) => (args[0] as _$VerticalMultiDragGestureRecognizer)._super$gestureSettings);
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$supportedDevices#0', (args) => (args[0] as _$VerticalMultiDragGestureRecognizer)._super$supportedDevices);
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$allowedButtonsFilter#0', (args) => (args[0] as _$VerticalMultiDragGestureRecognizer)._super$allowedButtonsFilter);
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$onStart=#1', (args) { (args[0] as _$VerticalMultiDragGestureRecognizer)._super$onStart = args[1] as GestureMultiDragStartCallback?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$gestureSettings=#1', (args) { (args[0] as _$VerticalMultiDragGestureRecognizer)._super$gestureSettings = args[1] as DeviceGestureSettings?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/multidrag.dart::VerticalMultiDragGestureRecognizer::\$super\$supportedDevices=#1', (args) { (args[0] as _$VerticalMultiDragGestureRecognizer)._super$supportedDevices = args[1] == null ? null : (args[1] as Set).cast<PointerDeviceKind>(); return args[1]; });
  }
