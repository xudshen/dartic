...
class _$PointerRemovedEvent extends PointerRemovedEvent implements DarticObjectHolder {
  _$PointerRemovedEvent(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(viewId: superArgs[0] as int, timeStamp: superArgs[1] as Duration, pointer: superArgs[2] as int, kind: superArgs[3] as PointerDeviceKind, device: superArgs[4] as int, position: superArgs[5] as Offset, obscured: superArgs[6] as bool, pressureMin: superArgs[7] as double, pressureMax: superArgs[8] as double, distanceMax: superArgs[9] as double, radiusMin: superArgs[10] as double, radiusMax: superArgs[11] as double, original: identical(superArgs[12], darticAbsent) ? null : superArgs[12] as PointerRemovedEvent?, embedderId: superArgs[13] as int);
  ...
  PointerRemovedEvent transformed(Matrix4? transform) {
    ...
    return _$r as PointerRemovedEvent;
  }
  ...
  // ── Super trampolines ──
  PointerRemovedEvent _super$transformed(Matrix4? transform) => super.transformed(transform);
...
/// private class.
Object createPointerRemovedEventBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$PointerRemovedEvent(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$PointerRemovedEvent(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$transformed#1', (args) => (args[0] as _$PointerRemovedEvent)._super$transformed(args[1] as Matrix4?));
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$toString#1', (args) => (args[0] as _$PointerRemovedEvent)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$copyWith#23', (args) => (args[0] as _$PointerRemovedEvent)._super$copyWith(viewId: identical(args[1], darticAbsent) ? null : args[1] as int?, timeStamp: identical(args[2], darticAbsent) ? null : args[2] as Duration?, pointer: identical(args[3], darticAbsent) ? null : args[3] as int?, kind: identical(args[4], darticAbsent) ? null : args[4] as PointerDeviceKind?, device: identical(args[5], darticAbsent) ? null : args[5] as int?, position: identical(args[6], darticAbsent) ? null : args[6] as Offset?, delta: identical(args[7], darticAbsent) ? null : args[7] as Offset?, buttons: identical(args[8], darticAbsent) ? null : args[8] as int?, obscured: identical(args[9], darticAbsent) ? null : args[9] as bool?, pressure: identical(args[10], darticAbsent) ? null : args[10] as double?, pressureMin: identical(args[11], darticAbsent) ? null : args[11] as double?, pressureMax: identical(args[12], darticAbsent) ? null : args[12] as double?, distance: identical(args[13], darticAbsent) ? null : args[13] as double?, distanceMax: identical(args[14], darticAbsent) ? null : args[14] as double?, size: identical(args[15], darticAbsent) ? null : args[15] as double?, radiusMajor: identical(args[16], darticAbsent) ? null : args[16] as double?, radiusMinor: identical(args[17], darticAbsent) ? null : args[17] as double?, radiusMin: identical(args[18], darticAbsent) ? null : args[18] as double?, radiusMax: identical(args[19], darticAbsent) ? null : args[19] as double?, orientation: identical(args[20], darticAbsent) ? null : args[20] as double?, tilt: identical(args[21], darticAbsent) ? null : args[21] as double?, synthesized: identical(args[22], darticAbsent) ? null : args[22] as bool?, embedderId: identical(args[23], darticAbsent) ? null : args[23] as int?));
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$toStringShort#0', (args) => (args[0] as _$PointerRemovedEvent)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$PointerRemovedEvent)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$debugFillProperties#1', (args) { (args[0] as _$PointerRemovedEvent)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$toStringFull#0', (args) => (args[0] as _$PointerRemovedEvent)._super$toStringFull());
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$viewId#0', (args) => (args[0] as _$PointerRemovedEvent)._super$viewId);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$embedderId#0', (args) => (args[0] as _$PointerRemovedEvent)._super$embedderId);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$timeStamp#0', (args) => (args[0] as _$PointerRemovedEvent)._super$timeStamp);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$pointer#0', (args) => (args[0] as _$PointerRemovedEvent)._super$pointer);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$kind#0', (args) => (args[0] as _$PointerRemovedEvent)._super$kind);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$device#0', (args) => (args[0] as _$PointerRemovedEvent)._super$device);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$position#0', (args) => (args[0] as _$PointerRemovedEvent)._super$position);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$localPosition#0', (args) => (args[0] as _$PointerRemovedEvent)._super$localPosition);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$delta#0', (args) => (args[0] as _$PointerRemovedEvent)._super$delta);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$localDelta#0', (args) => (args[0] as _$PointerRemovedEvent)._super$localDelta);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$buttons#0', (args) => (args[0] as _$PointerRemovedEvent)._super$buttons);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$down#0', (args) => (args[0] as _$PointerRemovedEvent)._super$down);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$obscured#0', (args) => (args[0] as _$PointerRemovedEvent)._super$obscured);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$pressure#0', (args) => (args[0] as _$PointerRemovedEvent)._super$pressure);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$pressureMin#0', (args) => (args[0] as _$PointerRemovedEvent)._super$pressureMin);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$pressureMax#0', (args) => (args[0] as _$PointerRemovedEvent)._super$pressureMax);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$distance#0', (args) => (args[0] as _$PointerRemovedEvent)._super$distance);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$distanceMin#0', (args) => (args[0] as _$PointerRemovedEvent)._super$distanceMin);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$distanceMax#0', (args) => (args[0] as _$PointerRemovedEvent)._super$distanceMax);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$size#0', (args) => (args[0] as _$PointerRemovedEvent)._super$size);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$radiusMajor#0', (args) => (args[0] as _$PointerRemovedEvent)._super$radiusMajor);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$radiusMinor#0', (args) => (args[0] as _$PointerRemovedEvent)._super$radiusMinor);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$radiusMin#0', (args) => (args[0] as _$PointerRemovedEvent)._super$radiusMin);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$radiusMax#0', (args) => (args[0] as _$PointerRemovedEvent)._super$radiusMax);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$orientation#0', (args) => (args[0] as _$PointerRemovedEvent)._super$orientation);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$tilt#0', (args) => (args[0] as _$PointerRemovedEvent)._super$tilt);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$platformData#0', (args) => (args[0] as _$PointerRemovedEvent)._super$platformData);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$synthesized#0', (args) => (args[0] as _$PointerRemovedEvent)._super$synthesized);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$transform#0', (args) => (args[0] as _$PointerRemovedEvent)._super$transform);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$original#0', (args) => (args[0] as _$PointerRemovedEvent)._super$original);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerRemovedEvent::\$super\$hashCode#0', (args) => (args[0] as _$PointerRemovedEvent)._super$hashCode);
  }

  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        'transformed#1': (args) => (args[0] as PointerRemovedEvent).transformed(args[1] as Matrix4?),
        'toString#1': (args) => (args[0] as PointerRemovedEvent).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
        ...
        'hashCode#0': (args) => (args[0] as PointerRemovedEvent).hashCode,
        ...
        '==#1': (args) => (args[0] as PointerRemovedEvent) == (args[1] as Object),
