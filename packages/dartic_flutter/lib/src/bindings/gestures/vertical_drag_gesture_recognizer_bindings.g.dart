...
class _$VerticalDragGestureRecognizer extends VerticalDragGestureRecognizer implements DarticObjectHolder {
  _$VerticalDragGestureRecognizer(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(debugOwner: identical(superArgs[0], darticAbsent) ? null : superArgs[0], supportedDevices: identical(superArgs[1], darticAbsent) ? null : superArgs[1] == null ? null : (superArgs[1] as Set).cast<PointerDeviceKind>(), allowedButtonsFilter: superArgs[2] as AllowedButtonsFilter);
...
/// private class.
Object createVerticalDragGestureRecognizerBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$VerticalDragGestureRecognizer(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$VerticalDragGestureRecognizer(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$isFlingGesture#2', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$isFlingGesture(args[1] as VelocityEstimate, args[2] as PointerDeviceKind));
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$considerFling#2', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$considerFling(args[1] as VelocityEstimate, args[2] as PointerDeviceKind));
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$hasSufficientGlobalDistanceToAccept#2', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$hasSufficientGlobalDistanceToAccept(args[1] as PointerDeviceKind, args[2] as double?));
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$toString#1', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$isPointerAllowed#1', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$isPointerAllowed(args[1] as PointerEvent));
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$addAllowedPointer#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$addAllowedPointer(args[1] as PointerDownEvent); return null; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$addAllowedPointerPanZoom#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$addAllowedPointerPanZoom(args[1] as PointerPanZoomStartEvent); return null; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$handleEvent#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$handleEvent(args[1] as PointerEvent); return null; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$acceptGesture#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$acceptGesture(args[1] as int); return null; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$rejectGesture#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$rejectGesture(args[1] as int); return null; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$didStopTrackingLastPointer#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$didStopTrackingLastPointer(args[1] as int); return null; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$dispose#0', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$debugFillProperties#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$handleNonAllowedPointer#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$handleNonAllowedPointer(args[1] as PointerDownEvent); return null; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$resolve#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$resolve(args[1] as GestureDisposition); return null; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$resolvePointer#2', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$resolvePointer(args[1] as int, args[2] as GestureDisposition); return null; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$startTrackingPointer#2', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$startTrackingPointer(args[1] as int, identical(args[2], darticAbsent) ? null : args[2] as Matrix4?); return null; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$stopTrackingPointer#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$stopTrackingPointer(args[1] as int); return null; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$stopTrackingIfPointerNoLongerDown#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$stopTrackingIfPointerNoLongerDown(args[1] as PointerEvent); return null; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$addPointerPanZoom#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$addPointerPanZoom(args[1] as PointerPanZoomStartEvent); return null; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$addPointer#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$addPointer(args[1] as PointerDownEvent); return null; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$handleNonAllowedPointerPanZoom#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$handleNonAllowedPointerPanZoom(args[1] as PointerPanZoomStartEvent); return null; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$isPointerPanZoomAllowed#1', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$isPointerPanZoomAllowed(args[1] as PointerPanZoomStartEvent));
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$getKindForPointer#1', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$getKindForPointer(args[1] as int));
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$toStringShallow#2', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$toStringDeep#4', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$toStringShort#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$debugDescription#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$debugDescription);
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$hashCode#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$hashCode);
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$dragStartBehavior#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$dragStartBehavior);
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$multitouchDragStrategy#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$multitouchDragStrategy);
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$onDown#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$onDown);
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$onStart#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$onStart);
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$onUpdate#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$onUpdate);
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$onEnd#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$onEnd);
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$onCancel#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$onCancel);
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$minFlingDistance#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$minFlingDistance);
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$minFlingVelocity#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$minFlingVelocity);
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$maxFlingVelocity#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$maxFlingVelocity);
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$onlyAcceptDragOnThreshold#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$onlyAcceptDragOnThreshold);
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$velocityTrackerBuilder#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$velocityTrackerBuilder);
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$lastPosition#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$lastPosition);
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$debugLastPendingEventTimestamp#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$debugLastPendingEventTimestamp);
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$globalDistanceMoved#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$globalDistanceMoved);
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$team#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$team);
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$debugOwner#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$debugOwner);
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$gestureSettings#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$gestureSettings);
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$supportedDevices#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$supportedDevices);
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$allowedButtonsFilter#0', (args) => (args[0] as _$VerticalDragGestureRecognizer)._super$allowedButtonsFilter);
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$dragStartBehavior=#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$dragStartBehavior = args[1] as DragStartBehavior; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$multitouchDragStrategy=#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$multitouchDragStrategy = args[1] as MultitouchDragStrategy; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$onDown=#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$onDown = args[1] as GestureDragDownCallback?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$onStart=#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$onStart = args[1] as GestureDragStartCallback?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$onUpdate=#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$onUpdate = args[1] as GestureDragUpdateCallback?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$onEnd=#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$onEnd = args[1] as GestureDragEndCallback?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$onCancel=#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$onCancel = args[1] as GestureDragCancelCallback?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$minFlingDistance=#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$minFlingDistance = args[1] as double?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$minFlingVelocity=#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$minFlingVelocity = args[1] as double?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$maxFlingVelocity=#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$maxFlingVelocity = args[1] as double?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$onlyAcceptDragOnThreshold=#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$onlyAcceptDragOnThreshold = args[1] as bool; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$velocityTrackerBuilder=#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$velocityTrackerBuilder = args[1] as GestureVelocityTrackerBuilder; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$team=#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$team = args[1] as GestureArenaTeam?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$gestureSettings=#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$gestureSettings = args[1] as DeviceGestureSettings?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/monodrag.dart::VerticalDragGestureRecognizer::\$super\$supportedDevices=#1', (args) { (args[0] as _$VerticalDragGestureRecognizer)._super$supportedDevices = args[1] == null ? null : (args[1] as Set).cast<PointerDeviceKind>(); return args[1]; });
  }
