...
class _$TapAndHorizontalDragGestureRecognizer extends TapAndHorizontalDragGestureRecognizer implements DarticObjectHolder {
  _$TapAndHorizontalDragGestureRecognizer(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(debugOwner: identical(superArgs[0], darticAbsent) ? null : superArgs[0], supportedDevices: identical(superArgs[1], darticAbsent) ? null : superArgs[1] == null ? null : (superArgs[1] as Set).cast<PointerDeviceKind>());
...
/// private class.
Object createTapAndHorizontalDragGestureRecognizerBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$TapAndHorizontalDragGestureRecognizer(dispatch, obj, superArgs);
...
abstract final class TapAndHorizontalDragGestureRecognizerBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$TapAndHorizontalDragGestureRecognizer(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$toString#1', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$isPointerAllowed#1', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$isPointerAllowed(args[1] as PointerEvent));
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$addAllowedPointer#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$addAllowedPointer(args[1] as PointerDownEvent); return null; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$handleNonAllowedPointer#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$handleNonAllowedPointer(args[1] as PointerDownEvent); return null; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$acceptGesture#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$acceptGesture(args[1] as int); return null; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$didStopTrackingLastPointer#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$didStopTrackingLastPointer(args[1] as int); return null; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$handleEvent#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$handleEvent(args[1] as PointerEvent); return null; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$rejectGesture#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$rejectGesture(args[1] as int); return null; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$dispose#0', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$resolve#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$resolve(args[1] as GestureDisposition); return null; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$resolvePointer#2', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$resolvePointer(args[1] as int, args[2] as GestureDisposition); return null; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$startTrackingPointer#2', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$startTrackingPointer(args[1] as int, identical(args[2], darticAbsent) ? null : args[2] as Matrix4?); return null; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$stopTrackingPointer#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$stopTrackingPointer(args[1] as int); return null; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$stopTrackingIfPointerNoLongerDown#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$stopTrackingIfPointerNoLongerDown(args[1] as PointerEvent); return null; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$addPointerPanZoom#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$addPointerPanZoom(args[1] as PointerPanZoomStartEvent); return null; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$addAllowedPointerPanZoom#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$addAllowedPointerPanZoom(args[1] as PointerPanZoomStartEvent); return null; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$addPointer#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$addPointer(args[1] as PointerDownEvent); return null; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$handleNonAllowedPointerPanZoom#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$handleNonAllowedPointerPanZoom(args[1] as PointerPanZoomStartEvent); return null; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$isPointerPanZoomAllowed#1', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$isPointerPanZoomAllowed(args[1] as PointerPanZoomStartEvent));
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$getKindForPointer#1', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$getKindForPointer(args[1] as int));
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$debugFillProperties#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$toStringShallow#2', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$toStringDeep#4', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$toStringShort#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$debugDescription#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$debugDescription);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$dragStartBehavior#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$dragStartBehavior);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$dragUpdateThrottleFrequency#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$dragUpdateThrottleFrequency);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$maxConsecutiveTap#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$maxConsecutiveTap);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$eagerVictoryOnDrag#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$eagerVictoryOnDrag);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$onTapDown#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$onTapDown);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$onTapUp#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$onTapUp);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$onDragStart#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$onDragStart);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$onDragUpdate#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$onDragUpdate);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$onDragEnd#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$onDragEnd);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$onCancel#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$onCancel);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$team#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$team);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$debugOwner#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$debugOwner);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$gestureSettings#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$gestureSettings);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$supportedDevices#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$supportedDevices);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$allowedButtonsFilter#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$allowedButtonsFilter);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$currentDown#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$currentDown);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$currentUp#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$currentUp);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$consecutiveTapCount#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$consecutiveTapCount);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$onTapTrackStart#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$onTapTrackStart);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$onTapTrackReset#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$onTapTrackReset);
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$dragStartBehavior=#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$dragStartBehavior = args[1] as DragStartBehavior; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$dragUpdateThrottleFrequency=#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$dragUpdateThrottleFrequency = args[1] as Duration?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$maxConsecutiveTap=#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$maxConsecutiveTap = args[1] as int?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$eagerVictoryOnDrag=#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$eagerVictoryOnDrag = args[1] as bool; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$onTapDown=#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$onTapDown = args[1] as GestureTapDragDownCallback?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$onTapUp=#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$onTapUp = args[1] as GestureTapDragUpCallback?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$onDragStart=#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$onDragStart = args[1] as GestureTapDragStartCallback?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$onDragUpdate=#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$onDragUpdate = args[1] as GestureTapDragUpdateCallback?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$onDragEnd=#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$onDragEnd = args[1] as GestureTapDragEndCallback?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$onCancel=#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$onCancel = args[1] as GestureCancelCallback?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$team=#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$team = args[1] as GestureArenaTeam?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$gestureSettings=#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$gestureSettings = args[1] as DeviceGestureSettings?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$supportedDevices=#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$supportedDevices = args[1] == null ? null : (args[1] as Set).cast<PointerDeviceKind>(); return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$onTapTrackStart=#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$onTapTrackStart = args[1] as VoidCallback?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$onTapTrackReset=#1', (args) { (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$onTapTrackReset = args[1] as VoidCallback?; return args[1]; });
    ctx.registerBinding('package:flutter/src/gestures/tap_and_drag.dart::TapAndHorizontalDragGestureRecognizer::\$super\$hashCode#0', (args) => (args[0] as _$TapAndHorizontalDragGestureRecognizer)._super$hashCode);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'hashCode#0': (args) => (args[0] as TapAndHorizontalDragGestureRecognizer).hashCode,
        ...
        '==#1': (args) => (args[0] as TapAndHorizontalDragGestureRecognizer) == (args[1] as Object),
