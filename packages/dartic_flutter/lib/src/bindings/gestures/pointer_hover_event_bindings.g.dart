...
class _$PointerHoverEvent extends PointerHoverEvent implements DarticObjectHolder {
  ...
  PointerHoverEvent transformed(Matrix4? transform) {
    ...
    return _$r as PointerHoverEvent;
  }
  ...
  // ── Super trampolines ──
  PointerHoverEvent _super$transformed(Matrix4? transform) => super.transformed(transform);
  String _super$toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) => super.toString(minLevel: minLevel);
  PointerHoverEvent _super$copyWith({int? viewId, Duration? timeStamp, int? pointer, PointerDeviceKind? kind, int? device, Offset? position, Offset? delta, int? buttons, bool? obscured, double? pressure, double? pressureMin, double? pressureMax, double? distance, double? distanceMax, double? size, double? radiusMajor, double? radiusMinor, double? radiusMin, double? radiusMax, double? orientation, double? tilt, bool? synthesized, int? embedderId}) => super.copyWith(viewId: viewId, timeStamp: timeStamp, pointer: pointer, kind: kind, device: device, position: position, delta: delta, buttons: buttons, obscured: obscured, pressure: pressure, pressureMin: pressureMin, pressureMax: pressureMax, distance: distance, distanceMax: distanceMax, size: size, radiusMajor: radiusMajor, radiusMinor: radiusMinor, radiusMin: radiusMin, radiusMax: radiusMax, orientation: orientation, tilt: tilt, synthesized: synthesized, embedderId: embedderId);
...
/// private class.
Object createPointerHoverEventBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$PointerHoverEvent(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$PointerHoverEvent(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$transformed#1', (args) => (args[0] as _$PointerHoverEvent)._super$transformed(args[1] as Matrix4?));
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$toString#1', (args) => (args[0] as _$PointerHoverEvent)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$copyWith#23', (args) => (args[0] as _$PointerHoverEvent)._super$copyWith(viewId: identical(args[1], darticAbsent) ? null : args[1] as int?, timeStamp: identical(args[2], darticAbsent) ? null : args[2] as Duration?, pointer: identical(args[3], darticAbsent) ? null : args[3] as int?, kind: identical(args[4], darticAbsent) ? null : args[4] as PointerDeviceKind?, device: identical(args[5], darticAbsent) ? null : args[5] as int?, position: identical(args[6], darticAbsent) ? null : args[6] as Offset?, delta: identical(args[7], darticAbsent) ? null : args[7] as Offset?, buttons: identical(args[8], darticAbsent) ? null : args[8] as int?, obscured: identical(args[9], darticAbsent) ? null : args[9] as bool?, pressure: identical(args[10], darticAbsent) ? null : args[10] as double?, pressureMin: identical(args[11], darticAbsent) ? null : args[11] as double?, pressureMax: identical(args[12], darticAbsent) ? null : args[12] as double?, distance: identical(args[13], darticAbsent) ? null : args[13] as double?, distanceMax: identical(args[14], darticAbsent) ? null : args[14] as double?, size: identical(args[15], darticAbsent) ? null : args[15] as double?, radiusMajor: identical(args[16], darticAbsent) ? null : args[16] as double?, radiusMinor: identical(args[17], darticAbsent) ? null : args[17] as double?, radiusMin: identical(args[18], darticAbsent) ? null : args[18] as double?, radiusMax: identical(args[19], darticAbsent) ? null : args[19] as double?, orientation: identical(args[20], darticAbsent) ? null : args[20] as double?, tilt: identical(args[21], darticAbsent) ? null : args[21] as double?, synthesized: identical(args[22], darticAbsent) ? null : args[22] as bool?, embedderId: identical(args[23], darticAbsent) ? null : args[23] as int?));
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$toStringShort#0', (args) => (args[0] as _$PointerHoverEvent)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$PointerHoverEvent)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$debugFillProperties#1', (args) { (args[0] as _$PointerHoverEvent)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$toStringFull#0', (args) => (args[0] as _$PointerHoverEvent)._super$toStringFull());
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$hashCode#0', (args) => (args[0] as _$PointerHoverEvent)._super$hashCode);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$viewId#0', (args) => (args[0] as _$PointerHoverEvent)._super$viewId);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$embedderId#0', (args) => (args[0] as _$PointerHoverEvent)._super$embedderId);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$timeStamp#0', (args) => (args[0] as _$PointerHoverEvent)._super$timeStamp);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$pointer#0', (args) => (args[0] as _$PointerHoverEvent)._super$pointer);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$kind#0', (args) => (args[0] as _$PointerHoverEvent)._super$kind);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$device#0', (args) => (args[0] as _$PointerHoverEvent)._super$device);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$position#0', (args) => (args[0] as _$PointerHoverEvent)._super$position);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$localPosition#0', (args) => (args[0] as _$PointerHoverEvent)._super$localPosition);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$delta#0', (args) => (args[0] as _$PointerHoverEvent)._super$delta);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$localDelta#0', (args) => (args[0] as _$PointerHoverEvent)._super$localDelta);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$buttons#0', (args) => (args[0] as _$PointerHoverEvent)._super$buttons);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$down#0', (args) => (args[0] as _$PointerHoverEvent)._super$down);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$obscured#0', (args) => (args[0] as _$PointerHoverEvent)._super$obscured);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$pressure#0', (args) => (args[0] as _$PointerHoverEvent)._super$pressure);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$pressureMin#0', (args) => (args[0] as _$PointerHoverEvent)._super$pressureMin);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$pressureMax#0', (args) => (args[0] as _$PointerHoverEvent)._super$pressureMax);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$distance#0', (args) => (args[0] as _$PointerHoverEvent)._super$distance);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$distanceMin#0', (args) => (args[0] as _$PointerHoverEvent)._super$distanceMin);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$distanceMax#0', (args) => (args[0] as _$PointerHoverEvent)._super$distanceMax);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$size#0', (args) => (args[0] as _$PointerHoverEvent)._super$size);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$radiusMajor#0', (args) => (args[0] as _$PointerHoverEvent)._super$radiusMajor);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$radiusMinor#0', (args) => (args[0] as _$PointerHoverEvent)._super$radiusMinor);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$radiusMin#0', (args) => (args[0] as _$PointerHoverEvent)._super$radiusMin);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$radiusMax#0', (args) => (args[0] as _$PointerHoverEvent)._super$radiusMax);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$orientation#0', (args) => (args[0] as _$PointerHoverEvent)._super$orientation);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$tilt#0', (args) => (args[0] as _$PointerHoverEvent)._super$tilt);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$platformData#0', (args) => (args[0] as _$PointerHoverEvent)._super$platformData);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$synthesized#0', (args) => (args[0] as _$PointerHoverEvent)._super$synthesized);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$transform#0', (args) => (args[0] as _$PointerHoverEvent)._super$transform);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerHoverEvent::\$super\$original#0', (args) => (args[0] as _$PointerHoverEvent)._super$original);
  }
