...
class _$PointerPanZoomStartEvent extends PointerPanZoomStartEvent implements DarticObjectHolder {
  _$PointerPanZoomStartEvent(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(viewId: superArgs[0] as int, timeStamp: superArgs[1] as Duration, device: superArgs[2] as int, pointer: superArgs[3] as int, position: superArgs[4] as Offset, embedderId: superArgs[5] as int, synthesized: superArgs[6] as bool);
  ...
  PointerPanZoomStartEvent transformed(Matrix4? transform) {
    ...
    return _$r as PointerPanZoomStartEvent;
  }
  ...
  // ── Super trampolines ──
  PointerPanZoomStartEvent _super$transformed(Matrix4? transform) => super.transformed(transform);
  String _super$toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) => super.toString(minLevel: minLevel);
  PointerPanZoomStartEvent _super$copyWith({int? viewId, Duration? timeStamp, int? pointer, PointerDeviceKind? kind, int? device, Offset? position, Offset? delta, int? buttons, bool? obscured, double? pressure, double? pressureMin, double? pressureMax, double? distance, double? distanceMax, double? size, double? radiusMajor, double? radiusMinor, double? radiusMin, double? radiusMax, double? orientation, double? tilt, bool? synthesized, int? embedderId}) => super.copyWith(viewId: viewId, timeStamp: timeStamp, pointer: pointer, kind: kind, device: device, position: position, delta: delta, buttons: buttons, obscured: obscured, pressure: pressure, pressureMin: pressureMin, pressureMax: pressureMax, distance: distance, distanceMax: distanceMax, size: size, radiusMajor: radiusMajor, radiusMinor: radiusMinor, radiusMin: radiusMin, radiusMax: radiusMax, orientation: orientation, tilt: tilt, synthesized: synthesized, embedderId: embedderId);
...
/// private class.
Object createPointerPanZoomStartEventBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$PointerPanZoomStartEvent(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$PointerPanZoomStartEvent(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$transformed#1', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$transformed(args[1] as Matrix4?));
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$toString#1', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$copyWith#23', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$copyWith(viewId: identical(args[1], darticAbsent) ? null : args[1] as int?, timeStamp: identical(args[2], darticAbsent) ? null : args[2] as Duration?, pointer: identical(args[3], darticAbsent) ? null : args[3] as int?, kind: identical(args[4], darticAbsent) ? null : args[4] as PointerDeviceKind?, device: identical(args[5], darticAbsent) ? null : args[5] as int?, position: identical(args[6], darticAbsent) ? null : args[6] as Offset?, delta: identical(args[7], darticAbsent) ? null : args[7] as Offset?, buttons: identical(args[8], darticAbsent) ? null : args[8] as int?, obscured: identical(args[9], darticAbsent) ? null : args[9] as bool?, pressure: identical(args[10], darticAbsent) ? null : args[10] as double?, pressureMin: identical(args[11], darticAbsent) ? null : args[11] as double?, pressureMax: identical(args[12], darticAbsent) ? null : args[12] as double?, distance: identical(args[13], darticAbsent) ? null : args[13] as double?, distanceMax: identical(args[14], darticAbsent) ? null : args[14] as double?, size: identical(args[15], darticAbsent) ? null : args[15] as double?, radiusMajor: identical(args[16], darticAbsent) ? null : args[16] as double?, radiusMinor: identical(args[17], darticAbsent) ? null : args[17] as double?, radiusMin: identical(args[18], darticAbsent) ? null : args[18] as double?, radiusMax: identical(args[19], darticAbsent) ? null : args[19] as double?, orientation: identical(args[20], darticAbsent) ? null : args[20] as double?, tilt: identical(args[21], darticAbsent) ? null : args[21] as double?, synthesized: identical(args[22], darticAbsent) ? null : args[22] as bool?, embedderId: identical(args[23], darticAbsent) ? null : args[23] as int?));
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$toStringShort#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$debugFillProperties#1', (args) { (args[0] as _$PointerPanZoomStartEvent)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$toStringFull#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$toStringFull());
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$viewId#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$viewId);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$embedderId#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$embedderId);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$timeStamp#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$timeStamp);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$pointer#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$pointer);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$kind#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$kind);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$device#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$device);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$position#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$position);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$localPosition#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$localPosition);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$delta#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$delta);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$localDelta#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$localDelta);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$buttons#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$buttons);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$down#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$down);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$obscured#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$obscured);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$pressure#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$pressure);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$pressureMin#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$pressureMin);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$pressureMax#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$pressureMax);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$distance#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$distance);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$distanceMin#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$distanceMin);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$distanceMax#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$distanceMax);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$size#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$size);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$radiusMajor#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$radiusMajor);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$radiusMinor#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$radiusMinor);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$radiusMin#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$radiusMin);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$radiusMax#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$radiusMax);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$orientation#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$orientation);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$tilt#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$tilt);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$platformData#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$platformData);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$synthesized#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$synthesized);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$transform#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$transform);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$original#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$original);
    ctx.registerBinding('package:flutter/src/gestures/events.dart::PointerPanZoomStartEvent::\$super\$hashCode#0', (args) => (args[0] as _$PointerPanZoomStartEvent)._super$hashCode);
  }
