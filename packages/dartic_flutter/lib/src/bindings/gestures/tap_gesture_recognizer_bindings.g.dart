...
class _$TapGestureRecognizer extends TapGestureRecognizer implements DarticObjectHolder {
  ...
  void handleTapDown({required PointerDownEvent down}) {
    ...
    if (identical(r, notOverridden)) { super.handleTapDown(down: down); return; }
  }

  @override
  void handleTapUp({required PointerDownEvent down, required PointerUpEvent up}) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'handleTapUp', [down, up]);
    if (identical(r, notOverridden)) { super.handleTapUp(down: down, up: up); return; }
  }
  ...
  void handleTapCancel({required PointerDownEvent down, PointerCancelEvent? cancel, required String reason}) {
    ...
    if (identical(r, notOverridden)) { super.handleTapCancel(down: down, cancel: cancel, reason: reason); return; }
  }
