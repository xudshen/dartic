...
class _$FocusScopeNode extends FocusScopeNode implements DarticObjectHolder {
  ...
  void setFirstFocus(FocusScopeNode scope) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'setFirstFocus', [scope]);
    if (identical(_$r, notOverridden)) { super.setFirstFocus(scope); return; }
  }

  @override
  void autofocus(FocusNode node) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'autofocus', [node]);
    if (identical(_$r, notOverridden)) { super.autofocus(node); return; }
  }

  @override
  void requestScopeFocus() {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'requestScopeFocus', const []);
    if (identical(_$r, notOverridden)) { super.requestScopeFocus(); return; }
  }
  ...
  void unfocus({UnfocusDisposition disposition = UnfocusDisposition.scope}) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'unfocus', [disposition]);
    if (identical(_$r, notOverridden)) { super.unfocus(disposition: disposition); return; }
  }

  @override
  bool consumeKeyboardToken() {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'consumeKeyboardToken', const []);
    if (identical(_$r, notOverridden)) return super.consumeKeyboardToken();
    return _$r as bool;
  }

  @override
  FocusAttachment attach(BuildContext? context, {FocusOnKeyEventCallback? onKeyEvent, FocusOnKeyCallback? onKey}) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'attach', [context, onKeyEvent, onKey]);
    if (identical(_$r, notOverridden)) return super.attach(context, onKeyEvent: onKeyEvent != null ? (a, b) => onKeyEvent(a, b) as KeyEventResult : null, onKey: onKey != null ? (a, b) => onKey(a, b) as KeyEventResult : null);
    return _$r as FocusAttachment;
  }
  ...
  void requestFocus([FocusNode? node]) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'requestFocus', [node]);
    if (identical(_$r, notOverridden)) { super.requestFocus(node); return; }
  }

  @override
  bool nextFocus() {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'nextFocus', const []);
    if (identical(_$r, notOverridden)) return super.nextFocus();
    return _$r as bool;
  }

  @override
  bool previousFocus() {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'previousFocus', const []);
    if (identical(_$r, notOverridden)) return super.previousFocus();
    return _$r as bool;
  }

  @override
  bool focusInDirection(TraversalDirection direction) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'focusInDirection', [direction]);
    if (identical(_$r, notOverridden)) return super.focusInDirection(direction);
    return _$r as bool;
  }
