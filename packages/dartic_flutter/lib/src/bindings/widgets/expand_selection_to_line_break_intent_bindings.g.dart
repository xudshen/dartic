...
class _$ExpandSelectionToLineBreakIntent extends ExpandSelectionToLineBreakIntent implements DarticObjectHolder {
  _$ExpandSelectionToLineBreakIntent(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(forward: superArgs[0] as bool);
...
/// private class.
Object createExpandSelectionToLineBreakIntentBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$ExpandSelectionToLineBreakIntent(dispatch, obj, superArgs);

abstract final class ExpandSelectionToLineBreakIntentBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      name: 'package:flutter/src/widgets/text_editing_intents.dart::ExpandSelectionToLineBreakIntent',
      type: ExpandSelectionToLineBreakIntent,
      test: (o) => o is ExpandSelectionToLineBreakIntent,
      methods: methodMap(),
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$ExpandSelectionToLineBreakIntent(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/text_editing_intents.dart::ExpandSelectionToLineBreakIntent::\$super\$toString#1', (args) => (args[0] as _$ExpandSelectionToLineBreakIntent)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        'toString#1': (args) => (args[0] as ExpandSelectionToLineBreakIntent).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
