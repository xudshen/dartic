...
class _$PageRouteBuilder extends PageRouteBuilder<dynamic> implements DarticObjectHolder {
  _$PageRouteBuilder(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(settings: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RouteSettings?, requestFocus: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as bool?, pageBuilder: superArgs[2] as RoutePageBuilder, transitionsBuilder: superArgs[3] as RouteTransitionsBuilder, transitionDuration: superArgs[4] as Duration, reverseTransitionDuration: superArgs[5] as Duration, opaque: superArgs[6] as bool, barrierDismissible: superArgs[7] as bool, barrierColor: identical(superArgs[8], darticAbsent) ? null : superArgs[8] as Color?, barrierLabel: identical(superArgs[9], darticAbsent) ? null : superArgs[9] as String?, maintainState: superArgs[10] as bool, fullscreenDialog: superArgs[11] as bool, allowSnapshotting: superArgs[12] as bool);
  ...
  RoutePageBuilder get pageBuilder {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'pageBuilder');
    if (identical(r, notOverridden)) return super.pageBuilder;
    return r as RoutePageBuilder;
  }

  @override
  RouteTransitionsBuilder get transitionsBuilder {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'transitionsBuilder');
    if (identical(r, notOverridden)) return super.transitionsBuilder;
  ...
  RoutePageBuilder get _super$pageBuilder => super.pageBuilder;
  RouteTransitionsBuilder get _super$transitionsBuilder => super.transitionsBuilder;
...
/// private class.
Object createPageRouteBuilderBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$PageRouteBuilder(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$PageRouteBuilder(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$buildPage#3', (args) => (args[0] as _$PageRouteBuilder)._super$buildPage(args[1] as BuildContext, args[2] as Animation<double>, args[3] as Animation<double>));
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$buildTransitions#4', (args) => (args[0] as _$PageRouteBuilder)._super$buildTransitions(args[1] as BuildContext, args[2] as Animation<double>, args[3] as Animation<double>, args[4] as Widget));
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$toString#0', (args) => (args[0] as _$PageRouteBuilder)._super$toString());
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$canTransitionTo#1', (args) => (args[0] as _$PageRouteBuilder)._super$canTransitionTo(args[1] as TransitionRoute<dynamic>));
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$canTransitionFrom#1', (args) => (args[0] as _$PageRouteBuilder)._super$canTransitionFrom(args[1] as TransitionRoute<dynamic>));
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$setState#1', (args) { (args[0] as _$PageRouteBuilder)._super$setState(() => (args[1] as Function)()); return null; });
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$install#0', (args) { (args[0] as _$PageRouteBuilder)._super$install(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$didPush#0', (args) => (args[0] as _$PageRouteBuilder)._super$didPush());
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$didAdd#0', (args) { (args[0] as _$PageRouteBuilder)._super$didAdd(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$willPop#0', (args) => (args[0] as _$PageRouteBuilder)._super$willPop());
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$onPopInvokedWithResult#2', (args) { (args[0] as _$PageRouteBuilder)._super$onPopInvokedWithResult(args[1] as bool, args[2]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$addScopedWillPopCallback#1', (args) { (args[0] as _$PageRouteBuilder)._super$addScopedWillPopCallback(() => (args[1] as Function)() as Future<bool>); return null; });
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$removeScopedWillPopCallback#1', (args) { (args[0] as _$PageRouteBuilder)._super$removeScopedWillPopCallback(() => (args[1] as Function)() as Future<bool>); return null; });
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$registerPopEntry#1', (args) { (args[0] as _$PageRouteBuilder)._super$registerPopEntry(args[1] as PopEntry<Object?>); return null; });
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$unregisterPopEntry#1', (args) { (args[0] as _$PageRouteBuilder)._super$unregisterPopEntry(args[1] as PopEntry<Object?>); return null; });
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$didChangePrevious#1', (args) { (args[0] as _$PageRouteBuilder)._super$didChangePrevious(args[1] as Route<dynamic>?); return null; });
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$didChangeNext#1', (args) { (args[0] as _$PageRouteBuilder)._super$didChangeNext(args[1] as Route<dynamic>?); return null; });
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$didPopNext#1', (args) { (args[0] as _$PageRouteBuilder)._super$didPopNext(args[1] as Route<dynamic>); return null; });
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$changedInternalState#0', (args) { (args[0] as _$PageRouteBuilder)._super$changedInternalState(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$changedExternalState#0', (args) { (args[0] as _$PageRouteBuilder)._super$changedExternalState(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$buildModalBarrier#0', (args) => (args[0] as _$PageRouteBuilder)._super$buildModalBarrier());
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$createOverlayEntries#0', (args) => (args[0] as _$PageRouteBuilder)._super$createOverlayEntries());
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$debugTransitionCompleted#0', (args) => (args[0] as _$PageRouteBuilder)._super$debugTransitionCompleted());
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$createAnimationController#0', (args) => (args[0] as _$PageRouteBuilder)._super$createAnimationController());
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$createAnimation#0', (args) => (args[0] as _$PageRouteBuilder)._super$createAnimation());
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$createSimulation#1', (args) => (args[0] as _$PageRouteBuilder)._super$createSimulation(forward: args[1] as bool));
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$didReplace#1', (args) { (args[0] as _$PageRouteBuilder)._super$didReplace(args[1] as Route<dynamic>?); return null; });
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$didPop#1', (args) => (args[0] as _$PageRouteBuilder)._super$didPop(args[1]));
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$handleStartBackGesture#1', (args) { (args[0] as _$PageRouteBuilder)._super$handleStartBackGesture(progress: identical(args[1], darticAbsent) ? 0.0 : args[1] as double); return null; });
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$handleUpdateBackGestureProgress#1', (args) { (args[0] as _$PageRouteBuilder)._super$handleUpdateBackGestureProgress(progress: args[1] as double); return null; });
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$handleCancelBackGesture#0', (args) { (args[0] as _$PageRouteBuilder)._super$handleCancelBackGesture(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$handleCommitBackGesture#0', (args) { (args[0] as _$PageRouteBuilder)._super$handleCommitBackGesture(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$dispose#0', (args) { (args[0] as _$PageRouteBuilder)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$onPopInvoked#1', (args) { (args[0] as _$PageRouteBuilder)._super$onPopInvoked(args[1] as bool); return null; });
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$didComplete#1', (args) { (args[0] as _$PageRouteBuilder)._super$didComplete(args[1]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$noSuchMethod#1', (args) => (args[0] as _$PageRouteBuilder)._super$noSuchMethod(args[1] as Invocation));
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$addLocalHistoryEntry#1', (args) { (args[0] as _$PageRouteBuilder)._super$addLocalHistoryEntry(args[1] as LocalHistoryEntry); return null; });
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$removeLocalHistoryEntry#1', (args) { (args[0] as _$PageRouteBuilder)._super$removeLocalHistoryEntry(args[1] as LocalHistoryEntry); return null; });
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$pageBuilder#0', (args) => (args[0] as _$PageRouteBuilder)._super$pageBuilder);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$transitionsBuilder#0', (args) => (args[0] as _$PageRouteBuilder)._super$transitionsBuilder);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$transitionDuration#0', (args) => (args[0] as _$PageRouteBuilder)._super$transitionDuration);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$reverseTransitionDuration#0', (args) => (args[0] as _$PageRouteBuilder)._super$reverseTransitionDuration);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$opaque#0', (args) => (args[0] as _$PageRouteBuilder)._super$opaque);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$barrierDismissible#0', (args) => (args[0] as _$PageRouteBuilder)._super$barrierDismissible);
    ...
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$filter#0', (args) => (args[0] as _$PageRouteBuilder)._super$filter);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$traversalEdgeBehavior#0', (args) => (args[0] as _$PageRouteBuilder)._super$traversalEdgeBehavior);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$directionalTraversalEdgeBehavior#0', (args) => (args[0] as _$PageRouteBuilder)._super$directionalTraversalEdgeBehavior);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$delegatedTransition#0', (args) => (args[0] as _$PageRouteBuilder)._super$delegatedTransition);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$receivedTransition#0', (args) => (args[0] as _$PageRouteBuilder)._super$receivedTransition);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$semanticsDismissible#0', (args) => (args[0] as _$PageRouteBuilder)._super$semanticsDismissible);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$barrierCurve#0', (args) => (args[0] as _$PageRouteBuilder)._super$barrierCurve);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$popGestureInProgress#0', (args) => (args[0] as _$PageRouteBuilder)._super$popGestureInProgress);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$offstage#0', (args) => (args[0] as _$PageRouteBuilder)._super$offstage);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$subtreeContext#0', (args) => (args[0] as _$PageRouteBuilder)._super$subtreeContext);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$animation#0', (args) => (args[0] as _$PageRouteBuilder)._super$animation);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$secondaryAnimation#0', (args) => (args[0] as _$PageRouteBuilder)._super$secondaryAnimation);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$popDisposition#0', (args) => (args[0] as _$PageRouteBuilder)._super$popDisposition);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$hasScopedWillPopCallback#0', (args) => (args[0] as _$PageRouteBuilder)._super$hasScopedWillPopCallback);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$canPop#0', (args) => (args[0] as _$PageRouteBuilder)._super$canPop);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$impliesAppBarDismissal#0', (args) => (args[0] as _$PageRouteBuilder)._super$impliesAppBarDismissal);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$completed#0', (args) => (args[0] as _$PageRouteBuilder)._super$completed);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$finishedWhenPopped#0', (args) => (args[0] as _$PageRouteBuilder)._super$finishedWhenPopped);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$controller#0', (args) => (args[0] as _$PageRouteBuilder)._super$controller);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$willDisposeAnimationController#0', (args) => (args[0] as _$PageRouteBuilder)._super$willDisposeAnimationController);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$debugLabel#0', (args) => (args[0] as _$PageRouteBuilder)._super$debugLabel);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$overlayEntries#0', (args) => (args[0] as _$PageRouteBuilder)._super$overlayEntries);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$requestFocus#0', (args) => (args[0] as _$PageRouteBuilder)._super$requestFocus);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$navigator#0', (args) => (args[0] as _$PageRouteBuilder)._super$navigator);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$settings#0', (args) => (args[0] as _$PageRouteBuilder)._super$settings);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$restorationScopeId#0', (args) => (args[0] as _$PageRouteBuilder)._super$restorationScopeId);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$willHandlePopInternally#0', (args) => (args[0] as _$PageRouteBuilder)._super$willHandlePopInternally);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$currentResult#0', (args) => (args[0] as _$PageRouteBuilder)._super$currentResult);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$popped#0', (args) => (args[0] as _$PageRouteBuilder)._super$popped);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$isCurrent#0', (args) => (args[0] as _$PageRouteBuilder)._super$isCurrent);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$isFirst#0', (args) => (args[0] as _$PageRouteBuilder)._super$isFirst);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$hasActiveRouteBelow#0', (args) => (args[0] as _$PageRouteBuilder)._super$hasActiveRouteBelow);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$isActive#0', (args) => (args[0] as _$PageRouteBuilder)._super$isActive);
    ctx.registerBinding('package:flutter/src/widgets/pages.dart::PageRouteBuilder::\$super\$runtimeType#0', (args) => (args[0] as _$PageRouteBuilder)._super$runtimeType);
