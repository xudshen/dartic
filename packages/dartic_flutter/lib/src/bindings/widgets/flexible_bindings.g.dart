...
class _$Flexible extends Flexible implements DarticObjectHolder {
  _$Flexible(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, flex: superArgs[1] as int, fit: superArgs[2] as FlexFit, child: superArgs[3] as Widget);
  ...
  ParentDataElement<FlexParentData> createElement() {
    ...
    return _$r as ParentDataElement<FlexParentData>;
  }
...
/// private class.
Object createFlexibleBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$Flexible(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$Flexible(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Flexible::\$super\$applyParentData#1', (args) { (args[0] as _$Flexible)._super$applyParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Flexible::\$super\$debugFillProperties#1', (args) { (args[0] as _$Flexible)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Flexible::\$super\$toString#1', (args) => (args[0] as _$Flexible)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Flexible::\$super\$createElement#0', (args) => (args[0] as _$Flexible)._super$createElement());
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Flexible::\$super\$debugIsValidRenderObject#1', (args) => (args[0] as _$Flexible)._super$debugIsValidRenderObject(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Flexible::\$super\$debugCanApplyOutOfTurn#0', (args) => (args[0] as _$Flexible)._super$debugCanApplyOutOfTurn());
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Flexible::\$super\$toStringShort#0', (args) => (args[0] as _$Flexible)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Flexible::\$super\$toStringShallow#2', (args) => (args[0] as _$Flexible)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Flexible::\$super\$toStringDeep#4', (args) => (args[0] as _$Flexible)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Flexible::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$Flexible)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Flexible::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$Flexible)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Flexible::\$super\$flex#0', (args) => (args[0] as _$Flexible)._super$flex);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Flexible::\$super\$fit#0', (args) => (args[0] as _$Flexible)._super$fit);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Flexible::\$super\$debugTypicalAncestorWidgetClass#0', (args) => (args[0] as _$Flexible)._super$debugTypicalAncestorWidgetClass);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Flexible::\$super\$hashCode#0', (args) => (args[0] as _$Flexible)._super$hashCode);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Flexible::\$super\$debugTypicalAncestorWidgetDescription#0', (args) => (args[0] as _$Flexible)._super$debugTypicalAncestorWidgetDescription);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Flexible::\$super\$child#0', (args) => (args[0] as _$Flexible)._super$child);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Flexible::\$super\$key#0', (args) => (args[0] as _$Flexible)._super$key);
  }
