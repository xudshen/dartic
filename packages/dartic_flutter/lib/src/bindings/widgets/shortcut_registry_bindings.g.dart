...
class _$ShortcutRegistry extends ShortcutRegistry implements DarticObjectHolder {
  ...
  ShortcutRegistryEntry addAll(Map<ShortcutActivator, Intent> value) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'addAll', [value]);
    if (identical(_$r, notOverridden)) return super.addAll(value);
    return _$r as ShortcutRegistryEntry;
  }
