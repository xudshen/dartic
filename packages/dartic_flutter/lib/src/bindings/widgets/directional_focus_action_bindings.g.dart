...
class _$DirectionalFocusAction extends DirectionalFocusAction implements DarticObjectHolder {
  _$DirectionalFocusAction(this._dispatch, this.$darticObject, List<Object?> superArgs);
  ...
  @override
  bool consumesKey(DirectionalFocusIntent intent) {
  ...
  @override
  KeyEventResult toKeyEventResult(DirectionalFocusIntent intent, Object? invokeResult) {
  ...
  Action<DirectionalFocusIntent>? get callingAction {
    ...
    return r as Action<DirectionalFocusIntent>?;
  }
  ...
  // ── Super trampolines ──
  void _super$invoke(DirectionalFocusIntent intent) { super.invoke(intent); }
  String _super$toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) => super.toString(minLevel: minLevel);
  bool _super$isEnabled(DirectionalFocusIntent intent) => super.isEnabled(intent);
  bool _super$consumesKey(DirectionalFocusIntent intent) => super.consumesKey(intent);
  KeyEventResult _super$toKeyEventResult(DirectionalFocusIntent intent, Object? invokeResult) => super.toKeyEventResult(intent, invokeResult);
...
/// private class.
Object createDirectionalFocusActionBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$DirectionalFocusAction(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$DirectionalFocusAction(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/focus_traversal.dart::DirectionalFocusAction::\$super\$invoke#1', (args) { (args[0] as _$DirectionalFocusAction)._super$invoke(args[1] as DirectionalFocusIntent); return null; });
    ctx.registerBinding('package:flutter/src/widgets/focus_traversal.dart::DirectionalFocusAction::\$super\$toString#1', (args) => (args[0] as _$DirectionalFocusAction)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/focus_traversal.dart::DirectionalFocusAction::\$super\$isEnabled#1', (args) => (args[0] as _$DirectionalFocusAction)._super$isEnabled(args[1] as DirectionalFocusIntent));
    ctx.registerBinding('package:flutter/src/widgets/focus_traversal.dart::DirectionalFocusAction::\$super\$consumesKey#1', (args) => (args[0] as _$DirectionalFocusAction)._super$consumesKey(args[1] as DirectionalFocusIntent));
    ctx.registerBinding('package:flutter/src/widgets/focus_traversal.dart::DirectionalFocusAction::\$super\$toKeyEventResult#2', (args) => (args[0] as _$DirectionalFocusAction)._super$toKeyEventResult(args[1] as DirectionalFocusIntent, args[2]));
    ctx.registerBinding('package:flutter/src/widgets/focus_traversal.dart::DirectionalFocusAction::\$super\$addActionListener#1', (args) { (args[0] as _$DirectionalFocusAction)._super$addActionListener((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/focus_traversal.dart::DirectionalFocusAction::\$super\$removeActionListener#1', (args) { (args[0] as _$DirectionalFocusAction)._super$removeActionListener((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/focus_traversal.dart::DirectionalFocusAction::\$super\$notifyActionListeners#0', (args) { (args[0] as _$DirectionalFocusAction)._super$notifyActionListeners(); return null; });
