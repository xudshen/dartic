...
class _$SingleChildRenderObjectElement extends SingleChildRenderObjectElement implements DarticObjectHolder {
  _$SingleChildRenderObjectElement(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(superArgs[0] as SingleChildRenderObjectWidget);
  ...
  void _super$update(SingleChildRenderObjectWidget newWidget) { super.update(newWidget); }
...
/// private class.
Object createSingleChildRenderObjectElementBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$SingleChildRenderObjectElement(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$SingleChildRenderObjectElement(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$visitChildren#1', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$forgetChild#1', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$forgetChild(args[1] as Element); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$mount#2', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$mount(args[1] as Element?, args[2]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$update#1', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$update(args[1] as SingleChildRenderObjectWidget); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$insertRenderObjectChild#2', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$insertRenderObjectChild(args[1] as RenderObject, args[2]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$moveRenderObjectChild#3', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$moveRenderObjectChild(args[1] as RenderObject, args[2], args[3]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$removeRenderObjectChild#2', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$removeRenderObjectChild(args[1] as RenderObject, args[2]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$toString#1', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$performRebuild#0', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$performRebuild(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$deactivate#0', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$deactivate(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$unmount#0', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$unmount(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$updateSlot#1', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$updateSlot(args[1]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$attachRenderObject#1', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$attachRenderObject(args[1]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$detachRenderObject#0', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$detachRenderObject(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$debugFillProperties#1', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$reassemble#0', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$describeMissingAncestor#1', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$describeMissingAncestor(expectedAncestorType: args[1] as Type));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$describeElement#2', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$describeElement(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.errorProperty : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$describeWidget#2', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$describeWidget(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.errorProperty : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$describeOwnershipChain#1', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$describeOwnershipChain(args[1] as String));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$debugVisitOnstageChildren#1', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$debugVisitOnstageChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$visitChildElements#1', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$visitChildElements((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$updateChild#3', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$updateChild(args[1] as Element?, args[2] as Widget?, args[3]));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$updateChildren#4', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$updateChildren((args[1] as List).cast<Element>(), (args[2] as List).cast<Widget>(), forgottenChildren: identical(args[3], darticAbsent) ? null : args[3] == null ? null : (args[3] as Set).cast<Element>(), slots: identical(args[4], darticAbsent) ? null : args[4] as List<Object?>?));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$updateSlotForChild#2', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$updateSlotForChild(args[1] as Element, args[2]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$inflateWidget#2', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$inflateWidget(args[1] as Widget, args[2]));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$deactivateChild#1', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$deactivateChild(args[1] as Element); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$activate#0', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$activate(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$debugDeactivated#0', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$debugDeactivated(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$debugExpectsRenderObjectForSlot#1', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$debugExpectsRenderObjectForSlot(args[1]));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$findRenderObject#0', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$findRenderObject());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$doesDependOnInheritedElement#1', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$doesDependOnInheritedElement(args[1] as InheritedElement));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$dependOnInheritedElement#2', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$dependOnInheritedElement(args[1] as InheritedElement, aspect: identical(args[2], darticAbsent) ? null : args[2]));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$attachNotificationTree#0', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$attachNotificationTree(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$visitAncestorElements#1', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$visitAncestorElements((a) => (args[1] as Function)(a) as bool); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$didChangeDependencies#0', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$didChangeDependencies(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$debugGetCreatorChain#1', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$debugGetCreatorChain(args[1] as int));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$debugGetDiagnosticChain#0', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$debugGetDiagnosticChain());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$dispatchNotification#1', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$dispatchNotification(args[1] as Notification); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$toStringShort#0', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$markNeedsBuild#0', (args) { (args[0] as _$SingleChildRenderObjectElement)._super$markNeedsBuild(); return null; });
    ...
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$slot#0', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$slot);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$depth#0', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$depth);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$widget#0', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$widget);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$mounted#0', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$mounted);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$debugIsDefunct#0', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$debugIsDefunct);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$debugIsActive#0', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$debugIsActive);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::SingleChildRenderObjectElement::\$super\$owner#0', (args) => (args[0] as _$SingleChildRenderObjectElement)._super$owner);
