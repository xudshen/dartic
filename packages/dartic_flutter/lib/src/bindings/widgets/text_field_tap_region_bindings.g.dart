...
abstract final class TextFieldTapRegionBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        '_#fromFields#11': (args) => TextFieldTapRegion(key: args[6] as Key?, child: args[1] as Widget?, enabled: args[4] as bool, onTapOutside: args[8] as TapRegionCallback?, onTapInside: args[7] as TapRegionCallback?, onTapUpOutside: args[10] as TapRegionUpCallback?, onTapUpInside: args[9] as TapRegionUpCallback?, consumeOutsideTaps: args[2] as bool, debugLabel: args[3] as String?, groupId: args[5]),
      };
}
