...
class _$FittedBox extends FittedBox implements DarticObjectHolder {
  _$FittedBox(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, fit: superArgs[1] as BoxFit, alignment: superArgs[2] as AlignmentGeometry, clipBehavior: superArgs[3] as ui.Clip, child: identical(superArgs[4], darticAbsent) ? null : superArgs[4] as Widget?);
  ...
  // ── Super trampolines ──
  RenderFittedBox _super$createRenderObject(BuildContext context) => super.createRenderObject(context);
  void _super$updateRenderObject(BuildContext context, RenderFittedBox renderObject) { super.updateRenderObject(context, renderObject); }
...
/// private class.
Object createFittedBoxBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$FittedBox(dispatch, obj, superArgs);
...
abstract final class FittedBoxBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$FittedBox(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::FittedBox::\$super\$createRenderObject#1', (args) => (args[0] as _$FittedBox)._super$createRenderObject(args[1] as BuildContext));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::FittedBox::\$super\$updateRenderObject#2', (args) { (args[0] as _$FittedBox)._super$updateRenderObject(args[1] as BuildContext, args[2] as RenderFittedBox); return null; });
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::FittedBox::\$super\$debugFillProperties#1', (args) { (args[0] as _$FittedBox)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::FittedBox::\$super\$toString#1', (args) => (args[0] as _$FittedBox)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::FittedBox::\$super\$createElement#0', (args) => (args[0] as _$FittedBox)._super$createElement());
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::FittedBox::\$super\$didUnmountRenderObject#1', (args) { (args[0] as _$FittedBox)._super$didUnmountRenderObject(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::FittedBox::\$super\$toStringShort#0', (args) => (args[0] as _$FittedBox)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::FittedBox::\$super\$toStringShallow#2', (args) => (args[0] as _$FittedBox)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::FittedBox::\$super\$toStringDeep#4', (args) => (args[0] as _$FittedBox)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::FittedBox::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$FittedBox)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::FittedBox::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$FittedBox)._super$debugDescribeChildren());
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#1': (args) => (args[0] as FittedBox).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
