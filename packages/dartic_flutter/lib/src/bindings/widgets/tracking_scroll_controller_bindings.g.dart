...
class _$TrackingScrollController extends TrackingScrollController implements DarticObjectHolder {
  _$TrackingScrollController(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(initialScrollOffset: superArgs[0] as double, keepScrollOffset: superArgs[1] as bool, debugLabel: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as String?, onAttach: identical(superArgs[3], darticAbsent) ? null : superArgs[3] as ScrollControllerCallback?, onDetach: identical(superArgs[4], darticAbsent) ? null : superArgs[4] as ScrollControllerCallback?);
  ...
  ScrollPosition? get mostRecentlyUpdatedPosition {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'mostRecentlyUpdatedPosition');
    if (identical(r, notOverridden)) return super.mostRecentlyUpdatedPosition;
...
/// private class.
Object createTrackingScrollControllerBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$TrackingScrollController(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$TrackingScrollController(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/scroll_controller.dart::TrackingScrollController::\$super\$attach#1', (args) { (args[0] as _$TrackingScrollController)._super$attach(args[1] as ScrollPosition); return null; });
    ctx.registerBinding('package:flutter/src/widgets/scroll_controller.dart::TrackingScrollController::\$super\$detach#1', (args) { (args[0] as _$TrackingScrollController)._super$detach(args[1] as ScrollPosition); return null; });
    ctx.registerBinding('package:flutter/src/widgets/scroll_controller.dart::TrackingScrollController::\$super\$dispose#0', (args) { (args[0] as _$TrackingScrollController)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/scroll_controller.dart::TrackingScrollController::\$super\$toString#0', (args) => (args[0] as _$TrackingScrollController)._super$toString());
    ctx.registerBinding('package:flutter/src/widgets/scroll_controller.dart::TrackingScrollController::\$super\$animateTo#3', (args) => (args[0] as _$TrackingScrollController)._super$animateTo(args[1] as double, duration: args[2] as Duration, curve: args[3] as Curve));
    ctx.registerBinding('package:flutter/src/widgets/scroll_controller.dart::TrackingScrollController::\$super\$jumpTo#1', (args) { (args[0] as _$TrackingScrollController)._super$jumpTo(args[1] as double); return null; });
    ctx.registerBinding('package:flutter/src/widgets/scroll_controller.dart::TrackingScrollController::\$super\$createScrollPosition#3', (args) => (args[0] as _$TrackingScrollController)._super$createScrollPosition(args[1] as ScrollPhysics, args[2] as ScrollContext, args[3] as ScrollPosition?));
    ctx.registerBinding('package:flutter/src/widgets/scroll_controller.dart::TrackingScrollController::\$super\$debugFillDescription#1', (args) { (args[0] as _$TrackingScrollController)._super$debugFillDescription((args[1] as List).cast<String>()); return null; });
    ctx.registerBinding('package:flutter/src/widgets/scroll_controller.dart::TrackingScrollController::\$super\$addListener#1', (args) { (args[0] as _$TrackingScrollController)._super$addListener(() => (args[1] as Function)()); return null; });
    ctx.registerBinding('package:flutter/src/widgets/scroll_controller.dart::TrackingScrollController::\$super\$removeListener#1', (args) { (args[0] as _$TrackingScrollController)._super$removeListener(() => (args[1] as Function)()); return null; });
    ...
    ctx.registerBinding('package:flutter/src/widgets/scroll_controller.dart::TrackingScrollController::\$super\$debugLabel#0', (args) => (args[0] as _$TrackingScrollController)._super$debugLabel);
    ctx.registerBinding('package:flutter/src/widgets/scroll_controller.dart::TrackingScrollController::\$super\$positions#0', (args) => (args[0] as _$TrackingScrollController)._super$positions);
    ctx.registerBinding('package:flutter/src/widgets/scroll_controller.dart::TrackingScrollController::\$super\$hasClients#0', (args) => (args[0] as _$TrackingScrollController)._super$hasClients);
