...
class _$ExtendSelectionToLineBreakIntent extends ExtendSelectionToLineBreakIntent implements DarticObjectHolder {
  _$ExtendSelectionToLineBreakIntent(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(forward: superArgs[0] as bool, collapseSelection: superArgs[1] as bool, collapseAtReversal: superArgs[2] as bool, continuesAtWrap: superArgs[3] as bool);
...
/// private class.
Object createExtendSelectionToLineBreakIntentBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$ExtendSelectionToLineBreakIntent(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$ExtendSelectionToLineBreakIntent(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/text_editing_intents.dart::ExtendSelectionToLineBreakIntent::\$super\$toString#1', (args) => (args[0] as _$ExtendSelectionToLineBreakIntent)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/text_editing_intents.dart::ExtendSelectionToLineBreakIntent::\$super\$toStringShort#0', (args) => (args[0] as _$ExtendSelectionToLineBreakIntent)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/text_editing_intents.dart::ExtendSelectionToLineBreakIntent::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$ExtendSelectionToLineBreakIntent)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/widgets/text_editing_intents.dart::ExtendSelectionToLineBreakIntent::\$super\$debugFillProperties#1', (args) { (args[0] as _$ExtendSelectionToLineBreakIntent)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/text_editing_intents.dart::ExtendSelectionToLineBreakIntent::\$super\$hashCode#0', (args) => (args[0] as _$ExtendSelectionToLineBreakIntent)._super$hashCode);
    ctx.registerBinding('package:flutter/src/widgets/text_editing_intents.dart::ExtendSelectionToLineBreakIntent::\$super\$collapseSelection#0', (args) => (args[0] as _$ExtendSelectionToLineBreakIntent)._super$collapseSelection);
    ctx.registerBinding('package:flutter/src/widgets/text_editing_intents.dart::ExtendSelectionToLineBreakIntent::\$super\$collapseAtReversal#0', (args) => (args[0] as _$ExtendSelectionToLineBreakIntent)._super$collapseAtReversal);
    ctx.registerBinding('package:flutter/src/widgets/text_editing_intents.dart::ExtendSelectionToLineBreakIntent::\$super\$continuesAtWrap#0', (args) => (args[0] as _$ExtendSelectionToLineBreakIntent)._super$continuesAtWrap);
    ctx.registerBinding('package:flutter/src/widgets/text_editing_intents.dart::ExtendSelectionToLineBreakIntent::\$super\$forward#0', (args) => (args[0] as _$ExtendSelectionToLineBreakIntent)._super$forward);
  }
