...
class _$ViewportElementMixin implements ViewportElementMixin, DarticObjectHolder {
  _$ViewportElementMixin(this._dispatch, this.$darticObject, List<Object?> superArgs);
...
/// private class.
Object createViewportElementMixinBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$ViewportElementMixin(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$ViewportElementMixin(dispatch, darticObject, superArgs),
    );
  }
