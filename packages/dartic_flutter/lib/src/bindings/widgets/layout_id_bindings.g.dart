...
class _$LayoutId extends LayoutId implements DarticObjectHolder {
  _$LayoutId(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, id: superArgs[1] as Object, child: superArgs[2] as Widget);
  ...
  ParentDataElement<MultiChildLayoutParentData> createElement() {
    ...
    return _$r as ParentDataElement<MultiChildLayoutParentData>;
  }
  ...
  ParentDataElement<MultiChildLayoutParentData> _super$createElement() => super.createElement();
...
/// private class.
Object createLayoutIdBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$LayoutId(dispatch, obj, superArgs);
...
abstract final class LayoutIdBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$LayoutId(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::LayoutId::\$super\$applyParentData#1', (args) { (args[0] as _$LayoutId)._super$applyParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::LayoutId::\$super\$debugFillProperties#1', (args) { (args[0] as _$LayoutId)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::LayoutId::\$super\$toString#1', (args) => (args[0] as _$LayoutId)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::LayoutId::\$super\$createElement#0', (args) => (args[0] as _$LayoutId)._super$createElement());
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::LayoutId::\$super\$debugIsValidRenderObject#1', (args) => (args[0] as _$LayoutId)._super$debugIsValidRenderObject(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::LayoutId::\$super\$debugCanApplyOutOfTurn#0', (args) => (args[0] as _$LayoutId)._super$debugCanApplyOutOfTurn());
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::LayoutId::\$super\$toStringShort#0', (args) => (args[0] as _$LayoutId)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::LayoutId::\$super\$toStringShallow#2', (args) => (args[0] as _$LayoutId)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::LayoutId::\$super\$toStringDeep#4', (args) => (args[0] as _$LayoutId)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::LayoutId::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$LayoutId)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#1': (args) => (args[0] as LayoutId).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
