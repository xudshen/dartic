...
class _$NavigatorState extends NavigatorState implements DarticObjectHolder {
  ...
  @override
  bool canPop() {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'canPop', const []);
  ...
  void popUntil(RoutePredicate predicate) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'popUntil', [predicate]);
    if (identical(r, notOverridden)) { super.popUntil((a) => predicate(a) as bool); return; }
  }

  @override
  void finalizeRoute(Route<dynamic> route) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'finalizeRoute', [route]);
    if (identical(r, notOverridden)) { super.finalizeRoute(route); return; }
  }

  @override
  void didStartUserGesture() {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'didStartUserGesture', const []);
    if (identical(r, notOverridden)) { super.didStartUserGesture(); return; }
  }
