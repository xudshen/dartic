...
class _$RootElement extends RootElement implements DarticObjectHolder {
  _$RootElement(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(superArgs[0] as RootWidget);
  ...
  void _super$update(RootWidget newWidget) { super.update(newWidget); }
...
/// private class.
Object createRootElementBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RootElement(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RootElement(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$visitChildren#1', (args) { (args[0] as _$RootElement)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$forgetChild#1', (args) { (args[0] as _$RootElement)._super$forgetChild(args[1] as Element); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$mount#2', (args) { (args[0] as _$RootElement)._super$mount(args[1] as Element?, args[2]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$update#1', (args) { (args[0] as _$RootElement)._super$update(args[1] as RootWidget); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$performRebuild#0', (args) { (args[0] as _$RootElement)._super$performRebuild(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$debugExpectsRenderObjectForSlot#1', (args) => (args[0] as _$RootElement)._super$debugExpectsRenderObjectForSlot(args[1]));
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$toString#1', (args) => (args[0] as _$RootElement)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$reassemble#0', (args) { (args[0] as _$RootElement)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$describeMissingAncestor#1', (args) => (args[0] as _$RootElement)._super$describeMissingAncestor(expectedAncestorType: args[1] as Type));
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$describeElement#2', (args) => (args[0] as _$RootElement)._super$describeElement(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.errorProperty : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$describeWidget#2', (args) => (args[0] as _$RootElement)._super$describeWidget(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.errorProperty : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$describeOwnershipChain#1', (args) => (args[0] as _$RootElement)._super$describeOwnershipChain(args[1] as String));
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$debugVisitOnstageChildren#1', (args) { (args[0] as _$RootElement)._super$debugVisitOnstageChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$visitChildElements#1', (args) { (args[0] as _$RootElement)._super$visitChildElements((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$updateChild#3', (args) => (args[0] as _$RootElement)._super$updateChild(args[1] as Element?, args[2] as Widget?, args[3]));
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$updateChildren#4', (args) => (args[0] as _$RootElement)._super$updateChildren((args[1] as List).cast<Element>(), (args[2] as List).cast<Widget>(), forgottenChildren: identical(args[3], darticAbsent) ? null : args[3] == null ? null : (args[3] as Set).cast<Element>(), slots: identical(args[4], darticAbsent) ? null : args[4] as List<Object?>?));
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$updateSlotForChild#2', (args) { (args[0] as _$RootElement)._super$updateSlotForChild(args[1] as Element, args[2]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$updateSlot#1', (args) { (args[0] as _$RootElement)._super$updateSlot(args[1]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$detachRenderObject#0', (args) { (args[0] as _$RootElement)._super$detachRenderObject(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$attachRenderObject#1', (args) { (args[0] as _$RootElement)._super$attachRenderObject(args[1]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$inflateWidget#2', (args) => (args[0] as _$RootElement)._super$inflateWidget(args[1] as Widget, args[2]));
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$deactivateChild#1', (args) { (args[0] as _$RootElement)._super$deactivateChild(args[1] as Element); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$activate#0', (args) { (args[0] as _$RootElement)._super$activate(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$deactivate#0', (args) { (args[0] as _$RootElement)._super$deactivate(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$debugDeactivated#0', (args) { (args[0] as _$RootElement)._super$debugDeactivated(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$unmount#0', (args) { (args[0] as _$RootElement)._super$unmount(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$findRenderObject#0', (args) => (args[0] as _$RootElement)._super$findRenderObject());
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$doesDependOnInheritedElement#1', (args) => (args[0] as _$RootElement)._super$doesDependOnInheritedElement(args[1] as InheritedElement));
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$dependOnInheritedElement#2', (args) => (args[0] as _$RootElement)._super$dependOnInheritedElement(args[1] as InheritedElement, aspect: identical(args[2], darticAbsent) ? null : args[2]));
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$attachNotificationTree#0', (args) { (args[0] as _$RootElement)._super$attachNotificationTree(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$visitAncestorElements#1', (args) { (args[0] as _$RootElement)._super$visitAncestorElements((a) => (args[1] as Function)(a) as bool); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$didChangeDependencies#0', (args) { (args[0] as _$RootElement)._super$didChangeDependencies(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$debugGetCreatorChain#1', (args) => (args[0] as _$RootElement)._super$debugGetCreatorChain(args[1] as int));
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$debugGetDiagnosticChain#0', (args) => (args[0] as _$RootElement)._super$debugGetDiagnosticChain());
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$dispatchNotification#1', (args) { (args[0] as _$RootElement)._super$dispatchNotification(args[1] as Notification); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$toStringShort#0', (args) => (args[0] as _$RootElement)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RootElement)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$debugFillProperties#1', (args) { (args[0] as _$RootElement)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RootElement)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$markNeedsBuild#0', (args) { (args[0] as _$RootElement)._super$markNeedsBuild(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$rebuild#1', (args) { (args[0] as _$RootElement)._super$rebuild(force: identical(args[1], darticAbsent) ? false : args[1] as bool); return null; });
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$toStringShallow#2', (args) => (args[0] as _$RootElement)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ...
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$mounted#0', (args) => (args[0] as _$RootElement)._super$mounted);
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$debugIsDefunct#0', (args) => (args[0] as _$RootElement)._super$debugIsDefunct);
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$debugIsActive#0', (args) => (args[0] as _$RootElement)._super$debugIsActive);
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$owner#0', (args) => (args[0] as _$RootElement)._super$owner);
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$buildScope#0', (args) => (args[0] as _$RootElement)._super$buildScope);
    ctx.registerBinding('package:flutter/src/widgets/binding.dart::RootElement::\$super\$renderObject#0', (args) => (args[0] as _$RootElement)._super$renderObject);
