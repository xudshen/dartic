...
class _$ActionDispatcher extends ActionDispatcher implements DarticObjectHolder {
  ...
  Object? invokeAction(Action<Intent> action, Intent intent, [BuildContext? context]) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'invokeAction', [action, intent, context]);
    if (identical(_$r, notOverridden)) return super.invokeAction(action, intent, context);
    return _$r as Object?;
  }

  @override
  (bool, Object?) invokeActionIfEnabled(Action<Intent> action, Intent intent, [BuildContext? context]) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'invokeActionIfEnabled', [action, intent, context]);
    if (identical(_$r, notOverridden)) return super.invokeActionIfEnabled(action, intent, context);
    return _$r as (bool, Object?);
  }
