...
class _$DirectionalCaretMovementIntent extends DirectionalCaretMovementIntent implements DarticObjectHolder {
  _$DirectionalCaretMovementIntent(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(superArgs[0] as bool, superArgs[1] as bool, superArgs[2] as bool, superArgs[3] as bool);
...
/// private class.
Object createDirectionalCaretMovementIntentBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$DirectionalCaretMovementIntent(dispatch, obj, superArgs);
...
abstract final class DirectionalCaretMovementIntentBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$DirectionalCaretMovementIntent(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/text_editing_intents.dart::DirectionalCaretMovementIntent::\$super\$toString#1', (args) => (args[0] as _$DirectionalCaretMovementIntent)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/text_editing_intents.dart::DirectionalCaretMovementIntent::\$super\$toStringShort#0', (args) => (args[0] as _$DirectionalCaretMovementIntent)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/text_editing_intents.dart::DirectionalCaretMovementIntent::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$DirectionalCaretMovementIntent)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/widgets/text_editing_intents.dart::DirectionalCaretMovementIntent::\$super\$debugFillProperties#1', (args) { (args[0] as _$DirectionalCaretMovementIntent)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        'toString#1': (args) => (args[0] as DirectionalCaretMovementIntent).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
