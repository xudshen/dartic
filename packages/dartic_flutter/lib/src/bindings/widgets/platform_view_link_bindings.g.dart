...
class _$PlatformViewLink extends PlatformViewLink implements DarticObjectHolder {
  _$PlatformViewLink(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, surfaceFactory: superArgs[1] as PlatformViewSurfaceFactory, onCreatePlatformView: superArgs[2] as CreatePlatformViewCallback, viewType: superArgs[3] as String);
...
/// private class.
Object createPlatformViewLinkBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$PlatformViewLink(dispatch, obj, superArgs);
...
abstract final class PlatformViewLinkBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$PlatformViewLink(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/platform_view.dart::PlatformViewLink::\$super\$createState#0', (args) => (args[0] as _$PlatformViewLink)._super$createState());
    ctx.registerBinding('package:flutter/src/widgets/platform_view.dart::PlatformViewLink::\$super\$toString#1', (args) => (args[0] as _$PlatformViewLink)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/platform_view.dart::PlatformViewLink::\$super\$createElement#0', (args) => (args[0] as _$PlatformViewLink)._super$createElement());
    ctx.registerBinding('package:flutter/src/widgets/platform_view.dart::PlatformViewLink::\$super\$toStringShort#0', (args) => (args[0] as _$PlatformViewLink)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/platform_view.dart::PlatformViewLink::\$super\$debugFillProperties#1', (args) { (args[0] as _$PlatformViewLink)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/platform_view.dart::PlatformViewLink::\$super\$toStringShallow#2', (args) => (args[0] as _$PlatformViewLink)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/platform_view.dart::PlatformViewLink::\$super\$toStringDeep#4', (args) => (args[0] as _$PlatformViewLink)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#1': (args) => (args[0] as PlatformViewLink).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
