...
class _$SliverSemantics extends SliverSemantics implements DarticObjectHolder {
  ...
  RenderSliverSemanticsAnnotations createRenderObject(BuildContext context) {
    ...
    return _$r as RenderSliverSemanticsAnnotations;
  }
  ...
  // ── Super trampolines ──
  RenderSliverSemanticsAnnotations _super$createRenderObject(BuildContext context) => super.createRenderObject(context);
  void _super$updateRenderObject(BuildContext context, RenderSliverSemanticsAnnotations renderObject) { super.updateRenderObject(context, renderObject); }
...
/// private class.
Object createSliverSemanticsBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$SliverSemantics(dispatch, obj, superArgs);
...
abstract final class SliverSemanticsBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$SliverSemantics(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::SliverSemantics::\$super\$createRenderObject#1', (args) => (args[0] as _$SliverSemantics)._super$createRenderObject(args[1] as BuildContext));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::SliverSemantics::\$super\$updateRenderObject#2', (args) { (args[0] as _$SliverSemantics)._super$updateRenderObject(args[1] as BuildContext, args[2] as RenderSliverSemanticsAnnotations); return null; });
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::SliverSemantics::\$super\$toString#1', (args) => (args[0] as _$SliverSemantics)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::SliverSemantics::\$super\$createElement#0', (args) => (args[0] as _$SliverSemantics)._super$createElement());
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::SliverSemantics::\$super\$didUnmountRenderObject#1', (args) { (args[0] as _$SliverSemantics)._super$didUnmountRenderObject(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::SliverSemantics::\$super\$toStringShort#0', (args) => (args[0] as _$SliverSemantics)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::SliverSemantics::\$super\$debugFillProperties#1', (args) { (args[0] as _$SliverSemantics)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::SliverSemantics::\$super\$toStringShallow#2', (args) => (args[0] as _$SliverSemantics)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::SliverSemantics::\$super\$toStringDeep#4', (args) => (args[0] as _$SliverSemantics)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::SliverSemantics::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$SliverSemantics)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::SliverSemantics::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$SliverSemantics)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::SliverSemantics::\$super\$properties#0', (args) => (args[0] as _$SliverSemantics)._super$properties);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::SliverSemantics::\$super\$container#0', (args) => (args[0] as _$SliverSemantics)._super$container);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::SliverSemantics::\$super\$explicitChildNodes#0', (args) => (args[0] as _$SliverSemantics)._super$explicitChildNodes);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::SliverSemantics::\$super\$localeForSubtree#0', (args) => (args[0] as _$SliverSemantics)._super$localeForSubtree);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::SliverSemantics::\$super\$excludeSemantics#0', (args) => (args[0] as _$SliverSemantics)._super$excludeSemantics);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::SliverSemantics::\$super\$blockUserActions#0', (args) => (args[0] as _$SliverSemantics)._super$blockUserActions);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::SliverSemantics::\$super\$child#0', (args) => (args[0] as _$SliverSemantics)._super$child);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::SliverSemantics::\$super\$key#0', (args) => (args[0] as _$SliverSemantics)._super$key);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::SliverSemantics::\$super\$hashCode#0', (args) => (args[0] as _$SliverSemantics)._super$hashCode);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'hashCode#0': (args) => (args[0] as SliverSemantics).hashCode,
        ...
        '==#1': (args) => (args[0] as SliverSemantics) == (args[1] as Object),
