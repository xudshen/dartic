...
class _$ScrollableState extends ScrollableState implements DarticObjectHolder {
  ...
  void saveOffset(double offset) {
    ...
    if (identical(r, notOverridden)) { super.saveOffset(offset); return; }
  }
  ...
  void setSemanticsActions(Set<SemanticsAction> actions) {
    ...
    if (identical(r, notOverridden)) { super.setSemanticsActions(actions); return; }
  }

  @override
  void setCanDrag(bool value) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'setCanDrag', [value]);
    if (identical(r, notOverridden)) { super.setCanDrag(value); return; }
  }

  @override
  void setIgnorePointer(bool value) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'setIgnorePointer', [value]);
    if (identical(r, notOverridden)) { super.setIgnorePointer(value); return; }
  }
