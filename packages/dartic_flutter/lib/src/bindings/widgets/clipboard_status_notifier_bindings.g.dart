...
class _$ClipboardStatusNotifier extends ClipboardStatusNotifier implements DarticObjectHolder {
  _$ClipboardStatusNotifier(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(value: superArgs[0] as ClipboardStatus);
  ...
  @override
  Future<void> update() {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'update', const []);
    if (identical(r, notOverridden)) return super.update();
  ...
  @override
  ClipboardStatus get value {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'value');
    if (identical(r, notOverridden)) return super.value;
    return r as ClipboardStatus;
  }
  ...
  @override
  set value(ClipboardStatus value) {
  ...
  ClipboardStatus get _super$value => super.value;
  bool get _super$hasListeners => super.hasListeners;
  set _super$value(ClipboardStatus value) { super.value = value; }
}

/// Test-only factory to create Bridge instances without exposing the
/// private class.
Object createClipboardStatusNotifierBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$ClipboardStatusNotifier(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$ClipboardStatusNotifier(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$update#0', (args) => (args[0] as _$ClipboardStatusNotifier)._super$update());
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$addListener#1', (args) { (args[0] as _$ClipboardStatusNotifier)._super$addListener(() => (args[1] as Function)()); return null; });
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$removeListener#1', (args) { (args[0] as _$ClipboardStatusNotifier)._super$removeListener(() => (args[1] as Function)()); return null; });
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$didChangeAppLifecycleState#1', (args) { (args[0] as _$ClipboardStatusNotifier)._super$didChangeAppLifecycleState(args[1] as AppLifecycleState); return null; });
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$dispose#0', (args) { (args[0] as _$ClipboardStatusNotifier)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$toString#0', (args) => (args[0] as _$ClipboardStatusNotifier)._super$toString());
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$notifyListeners#0', (args) { (args[0] as _$ClipboardStatusNotifier)._super$notifyListeners(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$didPopRoute#0', (args) => (args[0] as _$ClipboardStatusNotifier)._super$didPopRoute());
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$handleStartBackGesture#1', (args) => (args[0] as _$ClipboardStatusNotifier)._super$handleStartBackGesture(args[1] as PredictiveBackEvent));
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$handleUpdateBackGestureProgress#1', (args) { (args[0] as _$ClipboardStatusNotifier)._super$handleUpdateBackGestureProgress(args[1] as PredictiveBackEvent); return null; });
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$handleCommitBackGesture#0', (args) { (args[0] as _$ClipboardStatusNotifier)._super$handleCommitBackGesture(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$handleCancelBackGesture#0', (args) { (args[0] as _$ClipboardStatusNotifier)._super$handleCancelBackGesture(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$didPushRoute#1', (args) => (args[0] as _$ClipboardStatusNotifier)._super$didPushRoute(args[1] as String));
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$didPushRouteInformation#1', (args) => (args[0] as _$ClipboardStatusNotifier)._super$didPushRouteInformation(args[1] as RouteInformation));
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$didChangeMetrics#0', (args) { (args[0] as _$ClipboardStatusNotifier)._super$didChangeMetrics(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$didChangeTextScaleFactor#0', (args) { (args[0] as _$ClipboardStatusNotifier)._super$didChangeTextScaleFactor(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$didChangePlatformBrightness#0', (args) { (args[0] as _$ClipboardStatusNotifier)._super$didChangePlatformBrightness(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$didChangeLocales#1', (args) { (args[0] as _$ClipboardStatusNotifier)._super$didChangeLocales(args[1] == null ? null : (args[1] as List).cast<Locale>()); return null; });
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$didChangeViewFocus#1', (args) { (args[0] as _$ClipboardStatusNotifier)._super$didChangeViewFocus(args[1] as ViewFocusEvent); return null; });
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$didRequestAppExit#0', (args) => (args[0] as _$ClipboardStatusNotifier)._super$didRequestAppExit());
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$didHaveMemoryPressure#0', (args) { (args[0] as _$ClipboardStatusNotifier)._super$didHaveMemoryPressure(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$didChangeAccessibilityFeatures#0', (args) { (args[0] as _$ClipboardStatusNotifier)._super$didChangeAccessibilityFeatures(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$hashCode#0', (args) => (args[0] as _$ClipboardStatusNotifier)._super$hashCode);
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$value#0', (args) => (args[0] as _$ClipboardStatusNotifier)._super$value);
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$hasListeners#0', (args) => (args[0] as _$ClipboardStatusNotifier)._super$hasListeners);
    ctx.registerBinding('package:flutter/src/widgets/text_selection.dart::ClipboardStatusNotifier::\$super\$value=#1', (args) { (args[0] as _$ClipboardStatusNotifier)._super$value = args[1] as ClipboardStatus; return args[1]; });
  }
