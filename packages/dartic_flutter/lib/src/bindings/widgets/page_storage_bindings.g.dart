...
class _$PageStorage extends PageStorage implements DarticObjectHolder {
  _$PageStorage(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, bucket: superArgs[1] as PageStorageBucket, child: superArgs[2] as Widget);
...
/// private class.
Object createPageStorageBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$PageStorage(dispatch, obj, superArgs);
...
abstract final class PageStorageBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$PageStorage(dispatch, darticObject, superArgs),
    );
    ...
    ctx.registerBinding('package:flutter/src/widgets/page_storage.dart::PageStorage::\$super\$build#1', (args) => (args[0] as _$PageStorage)._super$build(args[1] as BuildContext));
    ctx.registerBinding('package:flutter/src/widgets/page_storage.dart::PageStorage::\$super\$toString#1', (args) => (args[0] as _$PageStorage)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/page_storage.dart::PageStorage::\$super\$createElement#0', (args) => (args[0] as _$PageStorage)._super$createElement());
    ctx.registerBinding('package:flutter/src/widgets/page_storage.dart::PageStorage::\$super\$toStringShort#0', (args) => (args[0] as _$PageStorage)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/page_storage.dart::PageStorage::\$super\$debugFillProperties#1', (args) { (args[0] as _$PageStorage)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/page_storage.dart::PageStorage::\$super\$toStringShallow#2', (args) => (args[0] as _$PageStorage)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/page_storage.dart::PageStorage::\$super\$toStringDeep#4', (args) => (args[0] as _$PageStorage)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/widgets/page_storage.dart::PageStorage::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$PageStorage)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#1': (args) => (args[0] as PageStorage).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
