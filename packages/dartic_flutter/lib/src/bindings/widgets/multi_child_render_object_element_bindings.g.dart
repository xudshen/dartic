...
class _$MultiChildRenderObjectElement extends MultiChildRenderObjectElement implements DarticObjectHolder {
  _$MultiChildRenderObjectElement(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(superArgs[0] as MultiChildRenderObjectWidget);
  ...
  ContainerRenderObjectMixin<RenderObject, ContainerParentDataMixin<RenderObject>> get renderObject {
    ...
    return r as ContainerRenderObjectMixin<RenderObject, ContainerParentDataMixin<RenderObject>>;
  }
  ...
  // ── Super trampolines ──
  void _super$insertRenderObjectChild(RenderObject child, IndexedSlot<Element?> slot) { super.insertRenderObjectChild(child, slot); }
  void _super$moveRenderObjectChild(RenderObject child, IndexedSlot<Element?> oldSlot, IndexedSlot<Element?> newSlot) { super.moveRenderObjectChild(child, oldSlot, newSlot); }
  ...
  void _super$update(MultiChildRenderObjectWidget newWidget) { super.update(newWidget); }
...
/// private class.
Object createMultiChildRenderObjectElementBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$MultiChildRenderObjectElement(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$MultiChildRenderObjectElement(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$insertRenderObjectChild#2', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$insertRenderObjectChild(args[1] as RenderObject, args[2] as IndexedSlot<Element?>); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$moveRenderObjectChild#3', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$moveRenderObjectChild(args[1] as RenderObject, args[2] as IndexedSlot<Element?>, args[3] as IndexedSlot<Element?>); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$removeRenderObjectChild#2', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$removeRenderObjectChild(args[1] as RenderObject, args[2]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$visitChildren#1', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$forgetChild#1', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$forgetChild(args[1] as Element); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$inflateWidget#2', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$inflateWidget(args[1] as Widget, args[2]));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$mount#2', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$mount(args[1] as Element?, args[2]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$update#1', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$update(args[1] as MultiChildRenderObjectWidget); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$toString#1', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$performRebuild#0', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$performRebuild(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$deactivate#0', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$deactivate(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$unmount#0', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$unmount(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$updateSlot#1', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$updateSlot(args[1]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$attachRenderObject#1', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$attachRenderObject(args[1]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$detachRenderObject#0', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$detachRenderObject(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$debugFillProperties#1', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$reassemble#0', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$describeMissingAncestor#1', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$describeMissingAncestor(expectedAncestorType: args[1] as Type));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$describeElement#2', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$describeElement(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.errorProperty : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$describeWidget#2', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$describeWidget(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.errorProperty : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$describeOwnershipChain#1', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$describeOwnershipChain(args[1] as String));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$debugVisitOnstageChildren#1', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$debugVisitOnstageChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$visitChildElements#1', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$visitChildElements((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$updateChild#3', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$updateChild(args[1] as Element?, args[2] as Widget?, args[3]));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$updateChildren#4', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$updateChildren((args[1] as List).cast<Element>(), (args[2] as List).cast<Widget>(), forgottenChildren: identical(args[3], darticAbsent) ? null : args[3] == null ? null : (args[3] as Set).cast<Element>(), slots: identical(args[4], darticAbsent) ? null : args[4] as List<Object?>?));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$updateSlotForChild#2', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$updateSlotForChild(args[1] as Element, args[2]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$deactivateChild#1', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$deactivateChild(args[1] as Element); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$activate#0', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$activate(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$debugDeactivated#0', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$debugDeactivated(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$debugExpectsRenderObjectForSlot#1', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$debugExpectsRenderObjectForSlot(args[1]));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$findRenderObject#0', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$findRenderObject());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$doesDependOnInheritedElement#1', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$doesDependOnInheritedElement(args[1] as InheritedElement));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$dependOnInheritedElement#2', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$dependOnInheritedElement(args[1] as InheritedElement, aspect: identical(args[2], darticAbsent) ? null : args[2]));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$attachNotificationTree#0', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$attachNotificationTree(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$visitAncestorElements#1', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$visitAncestorElements((a) => (args[1] as Function)(a) as bool); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$didChangeDependencies#0', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$didChangeDependencies(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$debugGetCreatorChain#1', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$debugGetCreatorChain(args[1] as int));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$debugGetDiagnosticChain#0', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$debugGetDiagnosticChain());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$dispatchNotification#1', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$dispatchNotification(args[1] as Notification); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$toStringShort#0', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$markNeedsBuild#0', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$markNeedsBuild(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$rebuild#1', (args) { (args[0] as _$MultiChildRenderObjectElement)._super$rebuild(force: identical(args[1], darticAbsent) ? false : args[1] as bool); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$toStringShallow#2', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ...
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$depth#0', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$depth);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$widget#0', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$widget);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$mounted#0', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$mounted);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$debugIsDefunct#0', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$debugIsDefunct);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$debugIsActive#0', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$debugIsActive);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectElement::\$super\$owner#0', (args) => (args[0] as _$MultiChildRenderObjectElement)._super$owner);
