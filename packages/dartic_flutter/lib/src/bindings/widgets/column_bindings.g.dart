...
class _$Column extends Column implements DarticObjectHolder {
  _$Column(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, mainAxisAlignment: superArgs[1] as MainAxisAlignment, mainAxisSize: superArgs[2] as MainAxisSize, crossAxisAlignment: superArgs[3] as CrossAxisAlignment, textDirection: identical(superArgs[4], darticAbsent) ? null : superArgs[4] as ui.TextDirection?, verticalDirection: superArgs[5] as VerticalDirection, textBaseline: identical(superArgs[6], darticAbsent) ? null : superArgs[6] as ui.TextBaseline?, spacing: superArgs[7] as double, children: (superArgs[8] as List).cast<Widget>());
  ...
  ui.TextDirection? getEffectiveTextDirection(BuildContext context) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'getEffectiveTextDirection', [context]);
    if (identical(_$r, notOverridden)) return super.getEffectiveTextDirection(context);
    return _$r as ui.TextDirection?;
  }
...
/// private class.
Object createColumnBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$Column(dispatch, obj, superArgs);
...
abstract final class ColumnBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$Column(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$toString#1', (args) => (args[0] as _$Column)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$getEffectiveTextDirection#1', (args) => (args[0] as _$Column)._super$getEffectiveTextDirection(args[1] as BuildContext));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$createRenderObject#1', (args) => (args[0] as _$Column)._super$createRenderObject(args[1] as BuildContext));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$updateRenderObject#2', (args) { (args[0] as _$Column)._super$updateRenderObject(args[1] as BuildContext, args[2] as RenderFlex); return null; });
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$debugFillProperties#1', (args) { (args[0] as _$Column)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$createElement#0', (args) => (args[0] as _$Column)._super$createElement());
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$didUnmountRenderObject#1', (args) { (args[0] as _$Column)._super$didUnmountRenderObject(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$toStringShort#0', (args) => (args[0] as _$Column)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$toStringShallow#2', (args) => (args[0] as _$Column)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$toStringDeep#4', (args) => (args[0] as _$Column)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$Column)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$Column)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$hashCode#0', (args) => (args[0] as _$Column)._super$hashCode);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$direction#0', (args) => (args[0] as _$Column)._super$direction);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$mainAxisAlignment#0', (args) => (args[0] as _$Column)._super$mainAxisAlignment);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$mainAxisSize#0', (args) => (args[0] as _$Column)._super$mainAxisSize);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$crossAxisAlignment#0', (args) => (args[0] as _$Column)._super$crossAxisAlignment);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$textDirection#0', (args) => (args[0] as _$Column)._super$textDirection);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$verticalDirection#0', (args) => (args[0] as _$Column)._super$verticalDirection);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$textBaseline#0', (args) => (args[0] as _$Column)._super$textBaseline);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$clipBehavior#0', (args) => (args[0] as _$Column)._super$clipBehavior);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$spacing#0', (args) => (args[0] as _$Column)._super$spacing);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$children#0', (args) => (args[0] as _$Column)._super$children);
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Column::\$super\$key#0', (args) => (args[0] as _$Column)._super$key);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'hashCode#0': (args) => (args[0] as Column).hashCode,
        ...
        '==#1': (args) => (args[0] as Column) == (args[1] as Object),
