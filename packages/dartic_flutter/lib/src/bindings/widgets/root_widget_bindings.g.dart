...
class _$RootWidget extends RootWidget implements DarticObjectHolder {
  ...
  RootElement createElement() {
    ...
    return r as RootElement;
  }

  @override
  RootElement attach(BuildOwner owner, [RootElement? element]) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'attach', [owner, element]);
    if (identical(r, notOverridden)) return super.attach(owner, element);
    return r as RootElement;
  }
