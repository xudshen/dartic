...
class _$DecoratedBoxTransition extends DecoratedBoxTransition implements DarticObjectHolder {
  _$DecoratedBoxTransition(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, decoration: superArgs[1] as Animation<Decoration>, position: superArgs[2] as DecorationPosition, child: superArgs[3] as Widget);
  ...
  @override
  Animation<Decoration> get decoration {
    ...
    return r as Animation<Decoration>;
  }
...
/// private class.
Object createDecoratedBoxTransitionBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$DecoratedBoxTransition(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$DecoratedBoxTransition(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/transitions.dart::DecoratedBoxTransition::\$super\$build#1', (args) => (args[0] as _$DecoratedBoxTransition)._super$build(args[1] as BuildContext));
    ctx.registerBinding('package:flutter/src/widgets/transitions.dart::DecoratedBoxTransition::\$super\$toString#1', (args) => (args[0] as _$DecoratedBoxTransition)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/transitions.dart::DecoratedBoxTransition::\$super\$createState#0', (args) => (args[0] as _$DecoratedBoxTransition)._super$createState());
    ctx.registerBinding('package:flutter/src/widgets/transitions.dart::DecoratedBoxTransition::\$super\$debugFillProperties#1', (args) { (args[0] as _$DecoratedBoxTransition)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/transitions.dart::DecoratedBoxTransition::\$super\$createElement#0', (args) => (args[0] as _$DecoratedBoxTransition)._super$createElement());
    ctx.registerBinding('package:flutter/src/widgets/transitions.dart::DecoratedBoxTransition::\$super\$toStringShort#0', (args) => (args[0] as _$DecoratedBoxTransition)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/transitions.dart::DecoratedBoxTransition::\$super\$toStringShallow#2', (args) => (args[0] as _$DecoratedBoxTransition)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/transitions.dart::DecoratedBoxTransition::\$super\$toStringDeep#4', (args) => (args[0] as _$DecoratedBoxTransition)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/widgets/transitions.dart::DecoratedBoxTransition::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$DecoratedBoxTransition)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/widgets/transitions.dart::DecoratedBoxTransition::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$DecoratedBoxTransition)._super$debugDescribeChildren());
