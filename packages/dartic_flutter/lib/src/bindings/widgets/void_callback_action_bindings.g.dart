...
class _$VoidCallbackAction extends VoidCallbackAction implements DarticObjectHolder {
  _$VoidCallbackAction(this._dispatch, this.$darticObject, List<Object?> superArgs);
  ...
  @override
  bool consumesKey(VoidCallbackIntent intent) {
  ...
  @override
  KeyEventResult toKeyEventResult(VoidCallbackIntent intent, Object? invokeResult) {
  ...
  @override
  Action<VoidCallbackIntent>? get callingAction {
    ...
    return r as Action<VoidCallbackIntent>?;
  }
  ...
  // ── Super trampolines ──
  Object? _super$invoke(VoidCallbackIntent intent) => super.invoke(intent);
  String _super$toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) => super.toString(minLevel: minLevel);
  bool _super$isEnabled(VoidCallbackIntent intent) => super.isEnabled(intent);
  bool _super$consumesKey(VoidCallbackIntent intent) => super.consumesKey(intent);
  KeyEventResult _super$toKeyEventResult(VoidCallbackIntent intent, Object? invokeResult) => super.toKeyEventResult(intent, invokeResult);
  ...
  Action<VoidCallbackIntent>? get _super$callingAction => super.callingAction;
...
/// private class.
Object createVoidCallbackActionBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$VoidCallbackAction(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$VoidCallbackAction(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/actions.dart::VoidCallbackAction::\$super\$invoke#1', (args) => (args[0] as _$VoidCallbackAction)._super$invoke(args[1] as VoidCallbackIntent));
    ctx.registerBinding('package:flutter/src/widgets/actions.dart::VoidCallbackAction::\$super\$toString#1', (args) => (args[0] as _$VoidCallbackAction)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/actions.dart::VoidCallbackAction::\$super\$isEnabled#1', (args) => (args[0] as _$VoidCallbackAction)._super$isEnabled(args[1] as VoidCallbackIntent));
    ctx.registerBinding('package:flutter/src/widgets/actions.dart::VoidCallbackAction::\$super\$consumesKey#1', (args) => (args[0] as _$VoidCallbackAction)._super$consumesKey(args[1] as VoidCallbackIntent));
    ctx.registerBinding('package:flutter/src/widgets/actions.dart::VoidCallbackAction::\$super\$toKeyEventResult#2', (args) => (args[0] as _$VoidCallbackAction)._super$toKeyEventResult(args[1] as VoidCallbackIntent, args[2]));
    ctx.registerBinding('package:flutter/src/widgets/actions.dart::VoidCallbackAction::\$super\$addActionListener#1', (args) { (args[0] as _$VoidCallbackAction)._super$addActionListener((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/actions.dart::VoidCallbackAction::\$super\$removeActionListener#1', (args) { (args[0] as _$VoidCallbackAction)._super$removeActionListener((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/actions.dart::VoidCallbackAction::\$super\$notifyActionListeners#0', (args) { (args[0] as _$VoidCallbackAction)._super$notifyActionListeners(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/actions.dart::VoidCallbackAction::\$super\$toStringShort#0', (args) => (args[0] as _$VoidCallbackAction)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/actions.dart::VoidCallbackAction::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$VoidCallbackAction)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/widgets/actions.dart::VoidCallbackAction::\$super\$debugFillProperties#1', (args) { (args[0] as _$VoidCallbackAction)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/actions.dart::VoidCallbackAction::\$super\$hashCode#0', (args) => (args[0] as _$VoidCallbackAction)._super$hashCode);
    ctx.registerBinding('package:flutter/src/widgets/actions.dart::VoidCallbackAction::\$super\$callingAction#0', (args) => (args[0] as _$VoidCallbackAction)._super$callingAction);
    ctx.registerBinding('package:flutter/src/widgets/actions.dart::VoidCallbackAction::\$super\$intentType#0', (args) => (args[0] as _$VoidCallbackAction)._super$intentType);
    ctx.registerBinding('package:flutter/src/widgets/actions.dart::VoidCallbackAction::\$super\$isActionEnabled#0', (args) => (args[0] as _$VoidCallbackAction)._super$isActionEnabled);
  }
