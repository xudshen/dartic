...
class _$SelectionListener extends SelectionListener implements DarticObjectHolder {
  _$SelectionListener(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, selectionNotifier: superArgs[1] as SelectionListenerNotifier, child: superArgs[2] as Widget);
  ...
  State<SelectionListener> createState() {
    ...
    return _$r as State<SelectionListener>;
  }
  ...
  @override
  SelectionListenerNotifier get selectionNotifier {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'selectionNotifier');
    if (identical(r, notOverridden)) return super.selectionNotifier;
    return r as SelectionListenerNotifier;
  }
  ...
  // ── Super trampolines ──
  State<SelectionListener> _super$createState() => super.createState();
...
/// private class.
Object createSelectionListenerBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$SelectionListener(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$SelectionListener(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/selectable_region.dart::SelectionListener::\$super\$createState#0', (args) => (args[0] as _$SelectionListener)._super$createState());
    ctx.registerBinding('package:flutter/src/widgets/selectable_region.dart::SelectionListener::\$super\$toString#1', (args) => (args[0] as _$SelectionListener)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/selectable_region.dart::SelectionListener::\$super\$createElement#0', (args) => (args[0] as _$SelectionListener)._super$createElement());
    ctx.registerBinding('package:flutter/src/widgets/selectable_region.dart::SelectionListener::\$super\$toStringShort#0', (args) => (args[0] as _$SelectionListener)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/selectable_region.dart::SelectionListener::\$super\$debugFillProperties#1', (args) { (args[0] as _$SelectionListener)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/selectable_region.dart::SelectionListener::\$super\$toStringShallow#2', (args) => (args[0] as _$SelectionListener)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/selectable_region.dart::SelectionListener::\$super\$toStringDeep#4', (args) => (args[0] as _$SelectionListener)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/widgets/selectable_region.dart::SelectionListener::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$SelectionListener)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
