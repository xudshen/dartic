...
abstract final class IOSSystemContextMenuItemCutBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      name: 'package:flutter/src/widgets/system_context_menu.dart::IOSSystemContextMenuItemCut',
      type: IOSSystemContextMenuItemCut,
      test: (o) => o is IOSSystemContextMenuItemCut,
      methods: methodMap(),
