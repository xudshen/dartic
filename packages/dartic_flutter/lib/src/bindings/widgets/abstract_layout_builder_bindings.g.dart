...
class _$AbstractLayoutBuilder extends AbstractLayoutBuilder<dynamic> implements DarticObjectHolder {
  ...
  bool updateShouldRebuild(AbstractLayoutBuilder oldWidget) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'updateShouldRebuild', [oldWidget]);
    if (identical(_$r, notOverridden)) return super.updateShouldRebuild(oldWidget);
    return _$r as bool;
  }
  ...
  RenderAbstractLayoutBuilderMixin<dynamic, RenderObject> createRenderObject(BuildContext context) {
    ...
    return _$r as RenderAbstractLayoutBuilderMixin<dynamic, RenderObject>;
  }
