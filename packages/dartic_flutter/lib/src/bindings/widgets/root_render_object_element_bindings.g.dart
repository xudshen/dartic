...
class _$RootRenderObjectElement extends RootRenderObjectElement implements DarticObjectHolder {
  _$RootRenderObjectElement(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(superArgs[0] as RenderObjectWidget);
  ...
  void assignOwner(BuildOwner owner) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'assignOwner', [owner]);
    if (identical(r, notOverridden)) { super.assignOwner(owner); return; }
  }
...
/// private class.
Object createRootRenderObjectElementBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RootRenderObjectElement(dispatch, obj, superArgs);
...
abstract final class RootRenderObjectElementBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RootRenderObjectElement(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$toString#1', (args) => (args[0] as _$RootRenderObjectElement)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$mount#2', (args) { (args[0] as _$RootRenderObjectElement)._super$mount(args[1] as Element?, args[2]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$update#1', (args) { (args[0] as _$RootRenderObjectElement)._super$update(args[1] as RenderObjectWidget); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$performRebuild#0', (args) { (args[0] as _$RootRenderObjectElement)._super$performRebuild(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$deactivate#0', (args) { (args[0] as _$RootRenderObjectElement)._super$deactivate(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$unmount#0', (args) { (args[0] as _$RootRenderObjectElement)._super$unmount(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$updateSlot#1', (args) { (args[0] as _$RootRenderObjectElement)._super$updateSlot(args[1]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$attachRenderObject#1', (args) { (args[0] as _$RootRenderObjectElement)._super$attachRenderObject(args[1]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$detachRenderObject#0', (args) { (args[0] as _$RootRenderObjectElement)._super$detachRenderObject(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$debugFillProperties#1', (args) { (args[0] as _$RootRenderObjectElement)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$reassemble#0', (args) { (args[0] as _$RootRenderObjectElement)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$describeMissingAncestor#1', (args) => (args[0] as _$RootRenderObjectElement)._super$describeMissingAncestor(expectedAncestorType: args[1] as Type));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$describeElement#2', (args) => (args[0] as _$RootRenderObjectElement)._super$describeElement(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.errorProperty : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$describeWidget#2', (args) => (args[0] as _$RootRenderObjectElement)._super$describeWidget(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.errorProperty : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$describeOwnershipChain#1', (args) => (args[0] as _$RootRenderObjectElement)._super$describeOwnershipChain(args[1] as String));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$visitChildren#1', (args) { (args[0] as _$RootRenderObjectElement)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$debugVisitOnstageChildren#1', (args) { (args[0] as _$RootRenderObjectElement)._super$debugVisitOnstageChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$visitChildElements#1', (args) { (args[0] as _$RootRenderObjectElement)._super$visitChildElements((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$updateChild#3', (args) => (args[0] as _$RootRenderObjectElement)._super$updateChild(args[1] as Element?, args[2] as Widget?, args[3]));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$updateChildren#4', (args) => (args[0] as _$RootRenderObjectElement)._super$updateChildren((args[1] as List).cast<Element>(), (args[2] as List).cast<Widget>(), forgottenChildren: identical(args[3], darticAbsent) ? null : args[3] == null ? null : (args[3] as Set).cast<Element>(), slots: identical(args[4], darticAbsent) ? null : args[4] as List<Object?>?));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$updateSlotForChild#2', (args) { (args[0] as _$RootRenderObjectElement)._super$updateSlotForChild(args[1] as Element, args[2]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$inflateWidget#2', (args) => (args[0] as _$RootRenderObjectElement)._super$inflateWidget(args[1] as Widget, args[2]));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$deactivateChild#1', (args) { (args[0] as _$RootRenderObjectElement)._super$deactivateChild(args[1] as Element); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$forgetChild#1', (args) { (args[0] as _$RootRenderObjectElement)._super$forgetChild(args[1] as Element); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$activate#0', (args) { (args[0] as _$RootRenderObjectElement)._super$activate(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$debugDeactivated#0', (args) { (args[0] as _$RootRenderObjectElement)._super$debugDeactivated(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$debugExpectsRenderObjectForSlot#1', (args) => (args[0] as _$RootRenderObjectElement)._super$debugExpectsRenderObjectForSlot(args[1]));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$findRenderObject#0', (args) => (args[0] as _$RootRenderObjectElement)._super$findRenderObject());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$doesDependOnInheritedElement#1', (args) => (args[0] as _$RootRenderObjectElement)._super$doesDependOnInheritedElement(args[1] as InheritedElement));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$dependOnInheritedElement#2', (args) => (args[0] as _$RootRenderObjectElement)._super$dependOnInheritedElement(args[1] as InheritedElement, aspect: identical(args[2], darticAbsent) ? null : args[2]));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$attachNotificationTree#0', (args) { (args[0] as _$RootRenderObjectElement)._super$attachNotificationTree(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$visitAncestorElements#1', (args) { (args[0] as _$RootRenderObjectElement)._super$visitAncestorElements((a) => (args[1] as Function)(a) as bool); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$didChangeDependencies#0', (args) { (args[0] as _$RootRenderObjectElement)._super$didChangeDependencies(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$debugGetCreatorChain#1', (args) => (args[0] as _$RootRenderObjectElement)._super$debugGetCreatorChain(args[1] as int));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$debugGetDiagnosticChain#0', (args) => (args[0] as _$RootRenderObjectElement)._super$debugGetDiagnosticChain());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$dispatchNotification#1', (args) { (args[0] as _$RootRenderObjectElement)._super$dispatchNotification(args[1] as Notification); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$toStringShort#0', (args) => (args[0] as _$RootRenderObjectElement)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RootRenderObjectElement)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RootRenderObjectElement)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$markNeedsBuild#0', (args) { (args[0] as _$RootRenderObjectElement)._super$markNeedsBuild(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$rebuild#1', (args) { (args[0] as _$RootRenderObjectElement)._super$rebuild(force: identical(args[1], darticAbsent) ? false : args[1] as bool); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$toStringShallow#2', (args) => (args[0] as _$RootRenderObjectElement)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$toStringDeep#4', (args) => (args[0] as _$RootRenderObjectElement)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$assignOwner#1', (args) { (args[0] as _$RootRenderObjectElement)._super$assignOwner(args[1] as BuildOwner); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$hashCode#0', (args) => (args[0] as _$RootRenderObjectElement)._super$hashCode);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$renderObject#0', (args) => (args[0] as _$RootRenderObjectElement)._super$renderObject);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$renderObjectAttachingChild#0', (args) => (args[0] as _$RootRenderObjectElement)._super$renderObjectAttachingChild);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$debugDoingBuild#0', (args) => (args[0] as _$RootRenderObjectElement)._super$debugDoingBuild);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$slot#0', (args) => (args[0] as _$RootRenderObjectElement)._super$slot);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$depth#0', (args) => (args[0] as _$RootRenderObjectElement)._super$depth);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$widget#0', (args) => (args[0] as _$RootRenderObjectElement)._super$widget);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$mounted#0', (args) => (args[0] as _$RootRenderObjectElement)._super$mounted);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$debugIsDefunct#0', (args) => (args[0] as _$RootRenderObjectElement)._super$debugIsDefunct);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$debugIsActive#0', (args) => (args[0] as _$RootRenderObjectElement)._super$debugIsActive);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$owner#0', (args) => (args[0] as _$RootRenderObjectElement)._super$owner);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$buildScope#0', (args) => (args[0] as _$RootRenderObjectElement)._super$buildScope);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$size#0', (args) => (args[0] as _$RootRenderObjectElement)._super$size);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::RootRenderObjectElement::\$super\$dirty#0', (args) => (args[0] as _$RootRenderObjectElement)._super$dirty);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'update#1': (args) { (args[0] as RootRenderObjectElement).update(args[1] as RenderObjectWidget); return null; },
