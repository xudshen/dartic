...
class _$Element extends Element implements DarticObjectHolder {
  _$Element(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(superArgs[0] as Widget);
  ...
  bool get debugDoingBuild {
    ...
    if (identical(r, notOverridden)) {
      throw UnsupportedError('Abstract getter debugDoingBuild must be overridden in dartic code');
    }
    return r as bool;
  }
...
/// private class.
Object createElementBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$Element(dispatch, obj, superArgs);
...
abstract final class ElementBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$Element(dispatch, darticObject, superArgs),
    );
    ...
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$reassemble#0', (args) { (args[0] as _$Element)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$describeMissingAncestor#1', (args) => (args[0] as _$Element)._super$describeMissingAncestor(expectedAncestorType: args[1] as Type));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$describeElement#2', (args) => (args[0] as _$Element)._super$describeElement(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.errorProperty : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$describeWidget#2', (args) => (args[0] as _$Element)._super$describeWidget(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.errorProperty : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$describeOwnershipChain#1', (args) => (args[0] as _$Element)._super$describeOwnershipChain(args[1] as String));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$visitChildren#1', (args) { (args[0] as _$Element)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$debugVisitOnstageChildren#1', (args) { (args[0] as _$Element)._super$debugVisitOnstageChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$visitChildElements#1', (args) { (args[0] as _$Element)._super$visitChildElements((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$updateChild#3', (args) => (args[0] as _$Element)._super$updateChild(args[1] as Element?, args[2] as Widget?, args[3]));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$updateChildren#4', (args) => (args[0] as _$Element)._super$updateChildren((args[1] as List).cast<Element>(), (args[2] as List).cast<Widget>(), forgottenChildren: identical(args[3], darticAbsent) ? null : args[3] == null ? null : (args[3] as Set).cast<Element>(), slots: identical(args[4], darticAbsent) ? null : args[4] as List<Object?>?));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$mount#2', (args) { (args[0] as _$Element)._super$mount(args[1] as Element?, args[2]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$update#1', (args) { (args[0] as _$Element)._super$update(args[1] as Widget); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$updateSlotForChild#2', (args) { (args[0] as _$Element)._super$updateSlotForChild(args[1] as Element, args[2]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$updateSlot#1', (args) { (args[0] as _$Element)._super$updateSlot(args[1]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$detachRenderObject#0', (args) { (args[0] as _$Element)._super$detachRenderObject(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$attachRenderObject#1', (args) { (args[0] as _$Element)._super$attachRenderObject(args[1]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$inflateWidget#2', (args) => (args[0] as _$Element)._super$inflateWidget(args[1] as Widget, args[2]));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$deactivateChild#1', (args) { (args[0] as _$Element)._super$deactivateChild(args[1] as Element); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$forgetChild#1', (args) { (args[0] as _$Element)._super$forgetChild(args[1] as Element); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$activate#0', (args) { (args[0] as _$Element)._super$activate(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$deactivate#0', (args) { (args[0] as _$Element)._super$deactivate(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$debugDeactivated#0', (args) { (args[0] as _$Element)._super$debugDeactivated(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$unmount#0', (args) { (args[0] as _$Element)._super$unmount(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$debugExpectsRenderObjectForSlot#1', (args) => (args[0] as _$Element)._super$debugExpectsRenderObjectForSlot(args[1]));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$findRenderObject#0', (args) => (args[0] as _$Element)._super$findRenderObject());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$doesDependOnInheritedElement#1', (args) => (args[0] as _$Element)._super$doesDependOnInheritedElement(args[1] as InheritedElement));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$dependOnInheritedElement#2', (args) => (args[0] as _$Element)._super$dependOnInheritedElement(args[1] as InheritedElement, aspect: identical(args[2], darticAbsent) ? null : args[2]));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$attachNotificationTree#0', (args) { (args[0] as _$Element)._super$attachNotificationTree(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$visitAncestorElements#1', (args) { (args[0] as _$Element)._super$visitAncestorElements((a) => (args[1] as Function)(a) as bool); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$didChangeDependencies#0', (args) { (args[0] as _$Element)._super$didChangeDependencies(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$debugGetCreatorChain#1', (args) => (args[0] as _$Element)._super$debugGetCreatorChain(args[1] as int));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$debugGetDiagnosticChain#0', (args) => (args[0] as _$Element)._super$debugGetDiagnosticChain());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$dispatchNotification#1', (args) { (args[0] as _$Element)._super$dispatchNotification(args[1] as Notification); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$toStringShort#0', (args) => (args[0] as _$Element)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$Element)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$debugFillProperties#1', (args) { (args[0] as _$Element)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$Element)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$markNeedsBuild#0', (args) { (args[0] as _$Element)._super$markNeedsBuild(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$rebuild#1', (args) { (args[0] as _$Element)._super$rebuild(force: identical(args[1], darticAbsent) ? false : args[1] as bool); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$performRebuild#0', (args) { (args[0] as _$Element)._super$performRebuild(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$toString#1', (args) => (args[0] as _$Element)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$toStringShallow#2', (args) => (args[0] as _$Element)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$toStringDeep#4', (args) => (args[0] as _$Element)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$slot#0', (args) => (args[0] as _$Element)._super$slot);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$depth#0', (args) => (args[0] as _$Element)._super$depth);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$widget#0', (args) => (args[0] as _$Element)._super$widget);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$mounted#0', (args) => (args[0] as _$Element)._super$mounted);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$debugIsDefunct#0', (args) => (args[0] as _$Element)._super$debugIsDefunct);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$debugIsActive#0', (args) => (args[0] as _$Element)._super$debugIsActive);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$owner#0', (args) => (args[0] as _$Element)._super$owner);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$buildScope#0', (args) => (args[0] as _$Element)._super$buildScope);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$renderObject#0', (args) => (args[0] as _$Element)._super$renderObject);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$renderObjectAttachingChild#0', (args) => (args[0] as _$Element)._super$renderObjectAttachingChild);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$size#0', (args) => (args[0] as _$Element)._super$size);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$dirty#0', (args) => (args[0] as _$Element)._super$dirty);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::Element::\$super\$hashCode#0', (args) => (args[0] as _$Element)._super$hashCode);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'hashCode#0': (args) => (args[0] as Element).hashCode,
        'debugDoingBuild#0': (args) => (args[0] as Element).debugDoingBuild,
        '==#1': (args) => (args[0] as Element) == (args[1] as Object),
      };
}
