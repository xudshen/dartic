...
class _$PageController extends PageController implements DarticObjectHolder {
  ...
  Future<void> animateToPage(int page, {required Duration duration, required Curve curve}) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'animateToPage', [page, duration, curve]);
    if (identical(r, notOverridden)) return super.animateToPage(page, duration: duration, curve: curve);
    return r as Future<void>;
  }

  @override
  void jumpToPage(int page) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'jumpToPage', [page]);
    if (identical(r, notOverridden)) { super.jumpToPage(page); return; }
  }

  @override
  Future<void> nextPage({required Duration duration, required Curve curve}) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'nextPage', [duration, curve]);
    if (identical(r, notOverridden)) return super.nextPage(duration: duration, curve: curve);
    return r as Future<void>;
  }

  @override
  Future<void> previousPage({required Duration duration, required Curve curve}) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'previousPage', [duration, curve]);
    if (identical(r, notOverridden)) return super.previousPage(duration: duration, curve: curve);
    return r as Future<void>;
  }
