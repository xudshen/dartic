...
class _$PopupRoute extends PopupRoute<dynamic> implements DarticObjectHolder {
  _$PopupRoute(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(settings: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RouteSettings?, requestFocus: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as bool?, filter: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as ui.ImageFilter?, traversalEdgeBehavior: identical(superArgs[3], darticAbsent) ? null : superArgs[3] as TraversalEdgeBehavior?, directionalTraversalEdgeBehavior: identical(superArgs[4], darticAbsent) ? null : superArgs[4] as TraversalEdgeBehavior?);
...
/// private class.
Object createPopupRouteBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$PopupRoute(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$PopupRoute(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$toString#0', (args) => (args[0] as _$PopupRoute)._super$toString());
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$setState#1', (args) { (args[0] as _$PopupRoute)._super$setState(() => (args[1] as Function)()); return null; });
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$buildTransitions#4', (args) => (args[0] as _$PopupRoute)._super$buildTransitions(args[1] as BuildContext, args[2] as Animation<double>, args[3] as Animation<double>, args[4] as Widget));
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$install#0', (args) { (args[0] as _$PopupRoute)._super$install(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$didPush#0', (args) => (args[0] as _$PopupRoute)._super$didPush());
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$didAdd#0', (args) { (args[0] as _$PopupRoute)._super$didAdd(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$willPop#0', (args) => (args[0] as _$PopupRoute)._super$willPop());
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$onPopInvokedWithResult#2', (args) { (args[0] as _$PopupRoute)._super$onPopInvokedWithResult(args[1] as bool, args[2]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$addScopedWillPopCallback#1', (args) { (args[0] as _$PopupRoute)._super$addScopedWillPopCallback(() => (args[1] as Function)() as Future<bool>); return null; });
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$removeScopedWillPopCallback#1', (args) { (args[0] as _$PopupRoute)._super$removeScopedWillPopCallback(() => (args[1] as Function)() as Future<bool>); return null; });
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$registerPopEntry#1', (args) { (args[0] as _$PopupRoute)._super$registerPopEntry(args[1] as PopEntry<Object?>); return null; });
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$unregisterPopEntry#1', (args) { (args[0] as _$PopupRoute)._super$unregisterPopEntry(args[1] as PopEntry<Object?>); return null; });
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$didChangePrevious#1', (args) { (args[0] as _$PopupRoute)._super$didChangePrevious(args[1] as Route<dynamic>?); return null; });
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$didChangeNext#1', (args) { (args[0] as _$PopupRoute)._super$didChangeNext(args[1] as Route<dynamic>?); return null; });
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$didPopNext#1', (args) { (args[0] as _$PopupRoute)._super$didPopNext(args[1] as Route<dynamic>); return null; });
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$changedInternalState#0', (args) { (args[0] as _$PopupRoute)._super$changedInternalState(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$changedExternalState#0', (args) { (args[0] as _$PopupRoute)._super$changedExternalState(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$buildModalBarrier#0', (args) => (args[0] as _$PopupRoute)._super$buildModalBarrier());
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$createOverlayEntries#0', (args) => (args[0] as _$PopupRoute)._super$createOverlayEntries());
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$debugTransitionCompleted#0', (args) => (args[0] as _$PopupRoute)._super$debugTransitionCompleted());
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$createAnimationController#0', (args) => (args[0] as _$PopupRoute)._super$createAnimationController());
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$createAnimation#0', (args) => (args[0] as _$PopupRoute)._super$createAnimation());
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$createSimulation#1', (args) => (args[0] as _$PopupRoute)._super$createSimulation(forward: args[1] as bool));
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$didReplace#1', (args) { (args[0] as _$PopupRoute)._super$didReplace(args[1] as Route<dynamic>?); return null; });
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$didPop#1', (args) => (args[0] as _$PopupRoute)._super$didPop(args[1]));
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$canTransitionTo#1', (args) => (args[0] as _$PopupRoute)._super$canTransitionTo(args[1] as TransitionRoute<dynamic>));
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$canTransitionFrom#1', (args) => (args[0] as _$PopupRoute)._super$canTransitionFrom(args[1] as TransitionRoute<dynamic>));
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$handleStartBackGesture#1', (args) { (args[0] as _$PopupRoute)._super$handleStartBackGesture(progress: identical(args[1], darticAbsent) ? 0.0 : args[1] as double); return null; });
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$handleUpdateBackGestureProgress#1', (args) { (args[0] as _$PopupRoute)._super$handleUpdateBackGestureProgress(progress: args[1] as double); return null; });
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$handleCancelBackGesture#0', (args) { (args[0] as _$PopupRoute)._super$handleCancelBackGesture(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$handleCommitBackGesture#0', (args) { (args[0] as _$PopupRoute)._super$handleCommitBackGesture(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$dispose#0', (args) { (args[0] as _$PopupRoute)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$onPopInvoked#1', (args) { (args[0] as _$PopupRoute)._super$onPopInvoked(args[1] as bool); return null; });
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$didComplete#1', (args) { (args[0] as _$PopupRoute)._super$didComplete(args[1]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$addLocalHistoryEntry#1', (args) { (args[0] as _$PopupRoute)._super$addLocalHistoryEntry(args[1] as LocalHistoryEntry); return null; });
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$removeLocalHistoryEntry#1', (args) { (args[0] as _$PopupRoute)._super$removeLocalHistoryEntry(args[1] as LocalHistoryEntry); return null; });
    ...
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$delegatedTransition#0', (args) => (args[0] as _$PopupRoute)._super$delegatedTransition);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$receivedTransition#0', (args) => (args[0] as _$PopupRoute)._super$receivedTransition);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$semanticsDismissible#0', (args) => (args[0] as _$PopupRoute)._super$semanticsDismissible);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$barrierCurve#0', (args) => (args[0] as _$PopupRoute)._super$barrierCurve);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$popGestureInProgress#0', (args) => (args[0] as _$PopupRoute)._super$popGestureInProgress);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$popGestureEnabled#0', (args) => (args[0] as _$PopupRoute)._super$popGestureEnabled);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$offstage#0', (args) => (args[0] as _$PopupRoute)._super$offstage);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$subtreeContext#0', (args) => (args[0] as _$PopupRoute)._super$subtreeContext);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$animation#0', (args) => (args[0] as _$PopupRoute)._super$animation);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$secondaryAnimation#0', (args) => (args[0] as _$PopupRoute)._super$secondaryAnimation);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$popDisposition#0', (args) => (args[0] as _$PopupRoute)._super$popDisposition);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$hasScopedWillPopCallback#0', (args) => (args[0] as _$PopupRoute)._super$hasScopedWillPopCallback);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$canPop#0', (args) => (args[0] as _$PopupRoute)._super$canPop);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$impliesAppBarDismissal#0', (args) => (args[0] as _$PopupRoute)._super$impliesAppBarDismissal);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$fullscreenDialog#0', (args) => (args[0] as _$PopupRoute)._super$fullscreenDialog);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$completed#0', (args) => (args[0] as _$PopupRoute)._super$completed);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$reverseTransitionDuration#0', (args) => (args[0] as _$PopupRoute)._super$reverseTransitionDuration);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$finishedWhenPopped#0', (args) => (args[0] as _$PopupRoute)._super$finishedWhenPopped);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$controller#0', (args) => (args[0] as _$PopupRoute)._super$controller);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$willDisposeAnimationController#0', (args) => (args[0] as _$PopupRoute)._super$willDisposeAnimationController);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$debugLabel#0', (args) => (args[0] as _$PopupRoute)._super$debugLabel);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$overlayEntries#0', (args) => (args[0] as _$PopupRoute)._super$overlayEntries);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$requestFocus#0', (args) => (args[0] as _$PopupRoute)._super$requestFocus);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$navigator#0', (args) => (args[0] as _$PopupRoute)._super$navigator);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$settings#0', (args) => (args[0] as _$PopupRoute)._super$settings);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$restorationScopeId#0', (args) => (args[0] as _$PopupRoute)._super$restorationScopeId);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$willHandlePopInternally#0', (args) => (args[0] as _$PopupRoute)._super$willHandlePopInternally);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$currentResult#0', (args) => (args[0] as _$PopupRoute)._super$currentResult);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$popped#0', (args) => (args[0] as _$PopupRoute)._super$popped);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$isCurrent#0', (args) => (args[0] as _$PopupRoute)._super$isCurrent);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$isFirst#0', (args) => (args[0] as _$PopupRoute)._super$isFirst);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$hasActiveRouteBelow#0', (args) => (args[0] as _$PopupRoute)._super$hasActiveRouteBelow);
    ctx.registerBinding('package:flutter/src/widgets/routes.dart::PopupRoute::\$super\$isActive#0', (args) => (args[0] as _$PopupRoute)._super$isActive);
