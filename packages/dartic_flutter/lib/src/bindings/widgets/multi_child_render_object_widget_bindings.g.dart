...
class _$MultiChildRenderObjectWidget extends MultiChildRenderObjectWidget implements DarticObjectHolder {
  _$MultiChildRenderObjectWidget(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, children: (superArgs[1] as List).cast<Widget>());
...
/// private class.
Object createMultiChildRenderObjectWidgetBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$MultiChildRenderObjectWidget(dispatch, obj, superArgs);

abstract final class MultiChildRenderObjectWidgetBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      name: 'package:flutter/src/widgets/framework.dart::MultiChildRenderObjectWidget',
      type: MultiChildRenderObjectWidget,
      test: (o) => o is MultiChildRenderObjectWidget,
      methods: methodMap(),
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$MultiChildRenderObjectWidget(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectWidget::\$super\$createElement#0', (args) => (args[0] as _$MultiChildRenderObjectWidget)._super$createElement());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectWidget::\$super\$toString#1', (args) => (args[0] as _$MultiChildRenderObjectWidget)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectWidget::\$super\$updateRenderObject#2', (args) { (args[0] as _$MultiChildRenderObjectWidget)._super$updateRenderObject(args[1] as BuildContext, args[2] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectWidget::\$super\$didUnmountRenderObject#1', (args) { (args[0] as _$MultiChildRenderObjectWidget)._super$didUnmountRenderObject(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectWidget::\$super\$toStringShort#0', (args) => (args[0] as _$MultiChildRenderObjectWidget)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectWidget::\$super\$debugFillProperties#1', (args) { (args[0] as _$MultiChildRenderObjectWidget)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectWidget::\$super\$toStringShallow#2', (args) => (args[0] as _$MultiChildRenderObjectWidget)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::MultiChildRenderObjectWidget::\$super\$toStringDeep#4', (args) => (args[0] as _$MultiChildRenderObjectWidget)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toStringShort#0': (args) => (args[0] as MultiChildRenderObjectWidget).toStringShort(),
        'debugFillProperties#1': (args) { (args[0] as MultiChildRenderObjectWidget).debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; },
        'toStringShallow#2': (args) => (args[0] as MultiChildRenderObjectWidget).toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel),
        'toStringDeep#4': (args) => (args[0] as MultiChildRenderObjectWidget).toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int),
