...
class _$RadioGroup extends RadioGroup<dynamic> implements DarticObjectHolder {
  _$RadioGroup(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, groupValue: superArgs[1], onChanged: superArgs[2] as void Function(dynamic), child: superArgs[3] as Widget);
...
/// private class.
Object createRadioGroupBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RadioGroup(dispatch, obj, superArgs);
...
abstract final class RadioGroupBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RadioGroup(dispatch, darticObject, superArgs),
    );
    ...
    ctx.registerBinding('package:flutter/src/widgets/radio_group.dart::RadioGroup::\$super\$createState#0', (args) => (args[0] as _$RadioGroup)._super$createState());
    ctx.registerBinding('package:flutter/src/widgets/radio_group.dart::RadioGroup::\$super\$toString#1', (args) => (args[0] as _$RadioGroup)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/radio_group.dart::RadioGroup::\$super\$createElement#0', (args) => (args[0] as _$RadioGroup)._super$createElement());
    ctx.registerBinding('package:flutter/src/widgets/radio_group.dart::RadioGroup::\$super\$toStringShort#0', (args) => (args[0] as _$RadioGroup)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/radio_group.dart::RadioGroup::\$super\$debugFillProperties#1', (args) { (args[0] as _$RadioGroup)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/radio_group.dart::RadioGroup::\$super\$toStringShallow#2', (args) => (args[0] as _$RadioGroup)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/radio_group.dart::RadioGroup::\$super\$toStringDeep#4', (args) => (args[0] as _$RadioGroup)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/widgets/radio_group.dart::RadioGroup::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RadioGroup)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/widgets/radio_group.dart::RadioGroup::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RadioGroup)._super$debugDescribeChildren());
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        '_#fromFields#4': (args) => RadioGroup<dynamic>(key: args[2] as Key?, groupValue: args[1], onChanged: args[3] as void Function(dynamic), child: args[0] as Widget),
      };
}
