...
class _$RenderTwoDimensionalViewport extends RenderTwoDimensionalViewport implements DarticObjectHolder {
  ...
  TwoDimensionalViewportParentData parentDataOf(RenderBox child) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'parentDataOf', [child]);
    if (identical(r, notOverridden)) return super.parentDataOf(child);
    return r as TwoDimensionalViewportParentData;
  }

  @override
  RenderBox? getChildFor(ChildVicinity vicinity) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'getChildFor', [vicinity]);
    if (identical(r, notOverridden)) return super.getChildFor(vicinity);
    return r as RenderBox?;
  }
  ...
  void markNeedsLayout({bool withDelegateRebuild = false}) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'markNeedsLayout', [withDelegateRebuild]);
    if (identical(r, notOverridden)) { super.markNeedsLayout(withDelegateRebuild: withDelegateRebuild); return; }
  }

  @override
  void layoutChildSequence() {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'layoutChildSequence', const []);
  ...
  RenderBox? buildOrObtainChildFor(ChildVicinity vicinity) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'buildOrObtainChildFor', [vicinity]);
    if (identical(r, notOverridden)) return super.buildOrObtainChildFor(vicinity);
    return r as RenderBox?;
  }

  @override
  void updateChildPaintData(RenderBox child) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'updateChildPaintData', [child]);
    if (identical(r, notOverridden)) { super.updateChildPaintData(child); return; }
  }

  @override
  Size computeChildPaintExtent(Offset layoutOffset, Size childSize) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'computeChildPaintExtent', [layoutOffset, childSize]);
    if (identical(r, notOverridden)) return super.computeChildPaintExtent(layoutOffset, childSize);
    return r as Size;
  }

  @override
  Offset computeAbsolutePaintOffsetFor(RenderBox child, {required Offset layoutOffset}) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'computeAbsolutePaintOffsetFor', [child, layoutOffset]);
    if (identical(r, notOverridden)) return super.computeAbsolutePaintOffsetFor(child, layoutOffset: layoutOffset);
    return r as Offset;
  }
