...
class _$RenderAbstractLayoutBuilderMixin implements RenderAbstractLayoutBuilderMixin<dynamic, RenderObject>, DarticObjectHolder {
  _$RenderAbstractLayoutBuilderMixin(this._dispatch, this.$darticObject, List<Object?> superArgs);
  ...
  @override
  void layoutCallback() {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'layoutCallback', const []);
  ...
  void runLayoutCallback() {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'runLayoutCallback', const []);
    if (identical(r, notOverridden)) {
  ...
  void scheduleLayoutCallback() {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'scheduleLayoutCallback', const []);
    if (identical(r, notOverridden)) {
  ...
  @override
  dynamic get layoutInfo {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'layoutInfo');
    if (identical(r, notOverridden)) {
      throw UnsupportedError('Abstract getter layoutInfo must be overridden in dartic code');
    }
    return r as dynamic;
  }
...
/// private class.
Object createRenderAbstractLayoutBuilderMixinBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderAbstractLayoutBuilderMixin(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderAbstractLayoutBuilderMixin(dispatch, darticObject, superArgs),
    );
  }
