...
class _$IconDataProperty extends IconDataProperty implements DarticObjectHolder {
  _$IconDataProperty(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(superArgs[0] as String, superArgs[1] as IconData?, ifNull: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as String?, showName: superArgs[3] as bool, style: superArgs[4] as DiagnosticsTreeStyle, level: superArgs[5] as DiagnosticLevel);
  ...
  IconData? get _super$value => super.value;
...
/// private class.
Object createIconDataPropertyBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$IconDataProperty(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$IconDataProperty(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/icon_data.dart::IconDataProperty::\$super\$toJsonMap#1', (args) => (args[0] as _$IconDataProperty)._super$toJsonMap(args[1] as DiagnosticsSerializationDelegate));
    ctx.registerBinding('package:flutter/src/widgets/icon_data.dart::IconDataProperty::\$super\$toString#2', (args) => (args[0] as _$IconDataProperty)._super$toString(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.info : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/icon_data.dart::IconDataProperty::\$super\$valueToString#1', (args) => (args[0] as _$IconDataProperty)._super$valueToString(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?));
    ctx.registerBinding('package:flutter/src/widgets/icon_data.dart::IconDataProperty::\$super\$toDescription#1', (args) => (args[0] as _$IconDataProperty)._super$toDescription(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?));
    ctx.registerBinding('package:flutter/src/widgets/icon_data.dart::IconDataProperty::\$super\$getProperties#0', (args) => (args[0] as _$IconDataProperty)._super$getProperties());
    ctx.registerBinding('package:flutter/src/widgets/icon_data.dart::IconDataProperty::\$super\$getChildren#0', (args) => (args[0] as _$IconDataProperty)._super$getChildren());
    ctx.registerBinding('package:flutter/src/widgets/icon_data.dart::IconDataProperty::\$super\$isFiltered#1', (args) => (args[0] as _$IconDataProperty)._super$isFiltered(args[1] as DiagnosticLevel));
    ...
    ctx.registerBinding('package:flutter/src/widgets/icon_data.dart::IconDataProperty::\$super\$ifNull#0', (args) => (args[0] as _$IconDataProperty)._super$ifNull);
    ctx.registerBinding('package:flutter/src/widgets/icon_data.dart::IconDataProperty::\$super\$ifEmpty#0', (args) => (args[0] as _$IconDataProperty)._super$ifEmpty);
    ctx.registerBinding('package:flutter/src/widgets/icon_data.dart::IconDataProperty::\$super\$tooltip#0', (args) => (args[0] as _$IconDataProperty)._super$tooltip);
    ctx.registerBinding('package:flutter/src/widgets/icon_data.dart::IconDataProperty::\$super\$missingIfNull#0', (args) => (args[0] as _$IconDataProperty)._super$missingIfNull);
    ctx.registerBinding('package:flutter/src/widgets/icon_data.dart::IconDataProperty::\$super\$propertyType#0', (args) => (args[0] as _$IconDataProperty)._super$propertyType);
    ctx.registerBinding('package:flutter/src/widgets/icon_data.dart::IconDataProperty::\$super\$value#0', (args) => (args[0] as _$IconDataProperty)._super$value);
    ctx.registerBinding('package:flutter/src/widgets/icon_data.dart::IconDataProperty::\$super\$exception#0', (args) => (args[0] as _$IconDataProperty)._super$exception);
    ctx.registerBinding('package:flutter/src/widgets/icon_data.dart::IconDataProperty::\$super\$defaultValue#0', (args) => (args[0] as _$IconDataProperty)._super$defaultValue);
    ctx.registerBinding('package:flutter/src/widgets/icon_data.dart::IconDataProperty::\$super\$isInteresting#0', (args) => (args[0] as _$IconDataProperty)._super$isInteresting);
    ctx.registerBinding('package:flutter/src/widgets/icon_data.dart::IconDataProperty::\$super\$level#0', (args) => (args[0] as _$IconDataProperty)._super$level);
    ctx.registerBinding('package:flutter/src/widgets/icon_data.dart::IconDataProperty::\$super\$name#0', (args) => (args[0] as _$IconDataProperty)._super$name);
    ctx.registerBinding('package:flutter/src/widgets/icon_data.dart::IconDataProperty::\$super\$showSeparator#0', (args) => (args[0] as _$IconDataProperty)._super$showSeparator);
    ctx.registerBinding('package:flutter/src/widgets/icon_data.dart::IconDataProperty::\$super\$showName#0', (args) => (args[0] as _$IconDataProperty)._super$showName);
    ctx.registerBinding('package:flutter/src/widgets/icon_data.dart::IconDataProperty::\$super\$linePrefix#0', (args) => (args[0] as _$IconDataProperty)._super$linePrefix);
    ctx.registerBinding('package:flutter/src/widgets/icon_data.dart::IconDataProperty::\$super\$emptyBodyDescription#0', (args) => (args[0] as _$IconDataProperty)._super$emptyBodyDescription);
