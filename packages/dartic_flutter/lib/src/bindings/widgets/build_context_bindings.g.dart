...
class _$BuildContext extends BuildContext implements DarticObjectHolder {
  _$BuildContext(this._dispatch, this.$darticObject, List<Object?> superArgs);
...
/// private class.
Object createBuildContextBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$BuildContext(dispatch, obj, superArgs);
...
abstract final class BuildContextBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$BuildContext(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::BuildContext::\$super\$toString#0', (args) => (args[0] as _$BuildContext)._super$toString());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::BuildContext::\$super\$hashCode#0', (args) => (args[0] as _$BuildContext)._super$hashCode);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'hashCode#0': (args) => (args[0] as BuildContext).hashCode,
        '==#1': (args) => (args[0] as BuildContext) == (args[1] as Object),
