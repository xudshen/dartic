...
class _$HoldScrollActivity extends HoldScrollActivity implements DarticObjectHolder {
  _$HoldScrollActivity(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(delegate: superArgs[0] as ScrollActivityDelegate, onHoldCanceled: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as VoidCallback?);
  ...
  @override
  VoidCallback? get onHoldCanceled {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'onHoldCanceled');
    if (identical(r, notOverridden)) return super.onHoldCanceled;
  ...
  VoidCallback? get _super$onHoldCanceled => super.onHoldCanceled;
...
/// private class.
Object createHoldScrollActivityBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$HoldScrollActivity(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$HoldScrollActivity(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/scroll_activity.dart::HoldScrollActivity::\$super\$cancel#0', (args) { (args[0] as _$HoldScrollActivity)._super$cancel(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/scroll_activity.dart::HoldScrollActivity::\$super\$dispose#0', (args) { (args[0] as _$HoldScrollActivity)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/scroll_activity.dart::HoldScrollActivity::\$super\$toString#0', (args) => (args[0] as _$HoldScrollActivity)._super$toString());
    ctx.registerBinding('package:flutter/src/widgets/scroll_activity.dart::HoldScrollActivity::\$super\$updateDelegate#1', (args) { (args[0] as _$HoldScrollActivity)._super$updateDelegate(args[1] as ScrollActivityDelegate); return null; });
    ctx.registerBinding('package:flutter/src/widgets/scroll_activity.dart::HoldScrollActivity::\$super\$resetActivity#0', (args) { (args[0] as _$HoldScrollActivity)._super$resetActivity(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/scroll_activity.dart::HoldScrollActivity::\$super\$dispatchScrollStartNotification#2', (args) { (args[0] as _$HoldScrollActivity)._super$dispatchScrollStartNotification(args[1] as ScrollMetrics, args[2] as BuildContext?); return null; });
    ctx.registerBinding('package:flutter/src/widgets/scroll_activity.dart::HoldScrollActivity::\$super\$dispatchScrollUpdateNotification#3', (args) { (args[0] as _$HoldScrollActivity)._super$dispatchScrollUpdateNotification(args[1] as ScrollMetrics, args[2] as BuildContext, args[3] as double); return null; });
    ctx.registerBinding('package:flutter/src/widgets/scroll_activity.dart::HoldScrollActivity::\$super\$dispatchOverscrollNotification#3', (args) { (args[0] as _$HoldScrollActivity)._super$dispatchOverscrollNotification(args[1] as ScrollMetrics, args[2] as BuildContext, args[3] as double); return null; });
    ctx.registerBinding('package:flutter/src/widgets/scroll_activity.dart::HoldScrollActivity::\$super\$dispatchScrollEndNotification#2', (args) { (args[0] as _$HoldScrollActivity)._super$dispatchScrollEndNotification(args[1] as ScrollMetrics, args[2] as BuildContext); return null; });
    ctx.registerBinding('package:flutter/src/widgets/scroll_activity.dart::HoldScrollActivity::\$super\$applyNewDimensions#0', (args) { (args[0] as _$HoldScrollActivity)._super$applyNewDimensions(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/scroll_activity.dart::HoldScrollActivity::\$super\$onHoldCanceled#0', (args) => (args[0] as _$HoldScrollActivity)._super$onHoldCanceled);
