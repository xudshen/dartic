...
abstract final class IOSSystemContextMenuItemLiveTextBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      name: 'package:flutter/src/widgets/system_context_menu.dart::IOSSystemContextMenuItemLiveText',
      type: IOSSystemContextMenuItemLiveText,
      test: (o) => o is IOSSystemContextMenuItemLiveText,
      methods: methodMap(),
