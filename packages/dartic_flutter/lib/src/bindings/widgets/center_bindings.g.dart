...
class _$Center extends Center implements DarticObjectHolder {
  _$Center(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, widthFactor: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as double?, heightFactor: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as double?, child: identical(superArgs[3], darticAbsent) ? null : superArgs[3] as Widget?);
  ...
  RenderPositionedBox createRenderObject(BuildContext context) {
    ...
    return _$r as RenderPositionedBox;
  }
...
/// private class.
Object createCenterBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$Center(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$Center(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Center::\$super\$toString#1', (args) => (args[0] as _$Center)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Center::\$super\$createRenderObject#1', (args) => (args[0] as _$Center)._super$createRenderObject(args[1] as BuildContext));
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Center::\$super\$updateRenderObject#2', (args) { (args[0] as _$Center)._super$updateRenderObject(args[1] as BuildContext, args[2] as RenderPositionedBox); return null; });
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Center::\$super\$debugFillProperties#1', (args) { (args[0] as _$Center)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Center::\$super\$createElement#0', (args) => (args[0] as _$Center)._super$createElement());
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Center::\$super\$didUnmountRenderObject#1', (args) { (args[0] as _$Center)._super$didUnmountRenderObject(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Center::\$super\$toStringShort#0', (args) => (args[0] as _$Center)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/basic.dart::Center::\$super\$toStringShallow#2', (args) => (args[0] as _$Center)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
