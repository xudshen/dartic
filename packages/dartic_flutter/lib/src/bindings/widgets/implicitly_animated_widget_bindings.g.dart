...
class _$ImplicitlyAnimatedWidget extends ImplicitlyAnimatedWidget implements DarticObjectHolder {
  _$ImplicitlyAnimatedWidget(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, curve: superArgs[1] as Curve, duration: superArgs[2] as Duration, onEnd: identical(superArgs[3], darticAbsent) ? null : superArgs[3] as ui.VoidCallback?);
  ...
  ImplicitlyAnimatedWidgetState<ImplicitlyAnimatedWidget> createState() {
    ...
    return r as ImplicitlyAnimatedWidgetState<ImplicitlyAnimatedWidget>;
  }
...
/// private class.
Object createImplicitlyAnimatedWidgetBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$ImplicitlyAnimatedWidget(dispatch, obj, superArgs);
...
abstract final class ImplicitlyAnimatedWidgetBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$ImplicitlyAnimatedWidget(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/implicit_animations.dart::ImplicitlyAnimatedWidget::\$super\$debugFillProperties#1', (args) { (args[0] as _$ImplicitlyAnimatedWidget)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/implicit_animations.dart::ImplicitlyAnimatedWidget::\$super\$toString#1', (args) => (args[0] as _$ImplicitlyAnimatedWidget)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/implicit_animations.dart::ImplicitlyAnimatedWidget::\$super\$createElement#0', (args) => (args[0] as _$ImplicitlyAnimatedWidget)._super$createElement());
    ctx.registerBinding('package:flutter/src/widgets/implicit_animations.dart::ImplicitlyAnimatedWidget::\$super\$toStringShort#0', (args) => (args[0] as _$ImplicitlyAnimatedWidget)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/implicit_animations.dart::ImplicitlyAnimatedWidget::\$super\$toStringShallow#2', (args) => (args[0] as _$ImplicitlyAnimatedWidget)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/implicit_animations.dart::ImplicitlyAnimatedWidget::\$super\$toStringDeep#4', (args) => (args[0] as _$ImplicitlyAnimatedWidget)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/widgets/implicit_animations.dart::ImplicitlyAnimatedWidget::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$ImplicitlyAnimatedWidget)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/widgets/implicit_animations.dart::ImplicitlyAnimatedWidget::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$ImplicitlyAnimatedWidget)._super$debugDescribeChildren());
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#1': (args) => (args[0] as ImplicitlyAnimatedWidget).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
