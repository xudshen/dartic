...
class _$ParentDataElement extends ParentDataElement<ParentData> implements DarticObjectHolder {
  ...
  void applyWidgetOutOfTurn(ParentDataWidget<ParentData> newWidget) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'applyWidgetOutOfTurn', [newWidget]);
    if (identical(_$r, notOverridden)) { super.applyWidgetOutOfTurn(newWidget); return; }
  }
