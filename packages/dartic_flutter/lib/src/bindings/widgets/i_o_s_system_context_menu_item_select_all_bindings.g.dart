...
abstract final class IOSSystemContextMenuItemSelectAllBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      name: 'package:flutter/src/widgets/system_context_menu.dart::IOSSystemContextMenuItemSelectAll',
      type: IOSSystemContextMenuItemSelectAll,
      test: (o) => o is IOSSystemContextMenuItemSelectAll,
      methods: methodMap(),
