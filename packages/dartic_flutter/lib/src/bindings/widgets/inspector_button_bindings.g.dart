...
class _$InspectorButton extends InspectorButton implements DarticObjectHolder {
  ...
  ui.Color foregroundColor(BuildContext context) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'foregroundColor', [context]);
  ...
  ui.Color backgroundColor(BuildContext context) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'backgroundColor', [context]);
    if (identical(r, notOverridden)) {
