...
class _$SliverSafeArea extends SliverSafeArea implements DarticObjectHolder {
  _$SliverSafeArea(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, left: superArgs[1] as bool, top: superArgs[2] as bool, right: superArgs[3] as bool, bottom: superArgs[4] as bool, minimum: superArgs[5] as EdgeInsets, sliver: superArgs[6] as Widget);
  ...
  EdgeInsets get minimum {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'minimum');
    if (identical(r, notOverridden)) return super.minimum;
  ...
  bool get _super$left => super.left;
  bool get _super$top => super.top;
  bool get _super$right => super.right;
...
/// private class.
Object createSliverSafeAreaBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$SliverSafeArea(dispatch, obj, superArgs);
...
abstract final class SliverSafeAreaBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$SliverSafeArea(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/safe_area.dart::SliverSafeArea::\$super\$build#1', (args) => (args[0] as _$SliverSafeArea)._super$build(args[1] as BuildContext));
    ctx.registerBinding('package:flutter/src/widgets/safe_area.dart::SliverSafeArea::\$super\$debugFillProperties#1', (args) { (args[0] as _$SliverSafeArea)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/safe_area.dart::SliverSafeArea::\$super\$toString#1', (args) => (args[0] as _$SliverSafeArea)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/safe_area.dart::SliverSafeArea::\$super\$createElement#0', (args) => (args[0] as _$SliverSafeArea)._super$createElement());
    ctx.registerBinding('package:flutter/src/widgets/safe_area.dart::SliverSafeArea::\$super\$toStringShort#0', (args) => (args[0] as _$SliverSafeArea)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/safe_area.dart::SliverSafeArea::\$super\$toStringShallow#2', (args) => (args[0] as _$SliverSafeArea)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/safe_area.dart::SliverSafeArea::\$super\$toStringDeep#4', (args) => (args[0] as _$SliverSafeArea)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/widgets/safe_area.dart::SliverSafeArea::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$SliverSafeArea)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/widgets/safe_area.dart::SliverSafeArea::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$SliverSafeArea)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/widgets/safe_area.dart::SliverSafeArea::\$super\$left#0', (args) => (args[0] as _$SliverSafeArea)._super$left);
    ctx.registerBinding('package:flutter/src/widgets/safe_area.dart::SliverSafeArea::\$super\$top#0', (args) => (args[0] as _$SliverSafeArea)._super$top);
    ctx.registerBinding('package:flutter/src/widgets/safe_area.dart::SliverSafeArea::\$super\$right#0', (args) => (args[0] as _$SliverSafeArea)._super$right);
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#1': (args) => (args[0] as SliverSafeArea).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
