...
class _$StatefulElement extends StatefulElement implements DarticObjectHolder {
  _$StatefulElement(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(superArgs[0] as StatefulWidget);
  ...
  void _super$update(StatefulWidget newWidget) { super.update(newWidget); }
  void _super$activate() { super.activate(); }
  void _super$deactivate() { super.deactivate(); }
  void _super$unmount() { super.unmount(); }
  InheritedWidget _super$dependOnInheritedElement(Element ancestor, {Object? aspect}) => super.dependOnInheritedElement(ancestor, aspect: aspect);
...
/// private class.
Object createStatefulElementBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$StatefulElement(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$StatefulElement(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$build#0', (args) => (args[0] as _$StatefulElement)._super$build());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$reassemble#0', (args) { (args[0] as _$StatefulElement)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$performRebuild#0', (args) { (args[0] as _$StatefulElement)._super$performRebuild(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$update#1', (args) { (args[0] as _$StatefulElement)._super$update(args[1] as StatefulWidget); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$activate#0', (args) { (args[0] as _$StatefulElement)._super$activate(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$deactivate#0', (args) { (args[0] as _$StatefulElement)._super$deactivate(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$unmount#0', (args) { (args[0] as _$StatefulElement)._super$unmount(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$dependOnInheritedElement#2', (args) => (args[0] as _$StatefulElement)._super$dependOnInheritedElement(args[1] as Element, aspect: identical(args[2], darticAbsent) ? null : args[2]));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$didChangeDependencies#0', (args) { (args[0] as _$StatefulElement)._super$didChangeDependencies(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$StatefulElement)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$debugFillProperties#1', (args) { (args[0] as _$StatefulElement)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$toString#1', (args) => (args[0] as _$StatefulElement)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$mount#2', (args) { (args[0] as _$StatefulElement)._super$mount(args[1] as Element?, args[2]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$visitChildren#1', (args) { (args[0] as _$StatefulElement)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$forgetChild#1', (args) { (args[0] as _$StatefulElement)._super$forgetChild(args[1] as Element); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$describeMissingAncestor#1', (args) => (args[0] as _$StatefulElement)._super$describeMissingAncestor(expectedAncestorType: args[1] as Type));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$describeElement#2', (args) => (args[0] as _$StatefulElement)._super$describeElement(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.errorProperty : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$describeWidget#2', (args) => (args[0] as _$StatefulElement)._super$describeWidget(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.errorProperty : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$describeOwnershipChain#1', (args) => (args[0] as _$StatefulElement)._super$describeOwnershipChain(args[1] as String));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$debugVisitOnstageChildren#1', (args) { (args[0] as _$StatefulElement)._super$debugVisitOnstageChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$visitChildElements#1', (args) { (args[0] as _$StatefulElement)._super$visitChildElements((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$updateChild#3', (args) => (args[0] as _$StatefulElement)._super$updateChild(args[1] as Element?, args[2] as Widget?, args[3]));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$updateChildren#4', (args) => (args[0] as _$StatefulElement)._super$updateChildren((args[1] as List).cast<Element>(), (args[2] as List).cast<Widget>(), forgottenChildren: identical(args[3], darticAbsent) ? null : args[3] == null ? null : (args[3] as Set).cast<Element>(), slots: identical(args[4], darticAbsent) ? null : args[4] as List<Object?>?));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$updateSlotForChild#2', (args) { (args[0] as _$StatefulElement)._super$updateSlotForChild(args[1] as Element, args[2]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$updateSlot#1', (args) { (args[0] as _$StatefulElement)._super$updateSlot(args[1]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$detachRenderObject#0', (args) { (args[0] as _$StatefulElement)._super$detachRenderObject(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$attachRenderObject#1', (args) { (args[0] as _$StatefulElement)._super$attachRenderObject(args[1]); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$inflateWidget#2', (args) => (args[0] as _$StatefulElement)._super$inflateWidget(args[1] as Widget, args[2]));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$deactivateChild#1', (args) { (args[0] as _$StatefulElement)._super$deactivateChild(args[1] as Element); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$debugDeactivated#0', (args) { (args[0] as _$StatefulElement)._super$debugDeactivated(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$debugExpectsRenderObjectForSlot#1', (args) => (args[0] as _$StatefulElement)._super$debugExpectsRenderObjectForSlot(args[1]));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$findRenderObject#0', (args) => (args[0] as _$StatefulElement)._super$findRenderObject());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$doesDependOnInheritedElement#1', (args) => (args[0] as _$StatefulElement)._super$doesDependOnInheritedElement(args[1] as InheritedElement));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$attachNotificationTree#0', (args) { (args[0] as _$StatefulElement)._super$attachNotificationTree(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$visitAncestorElements#1', (args) { (args[0] as _$StatefulElement)._super$visitAncestorElements((a) => (args[1] as Function)(a) as bool); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$debugGetCreatorChain#1', (args) => (args[0] as _$StatefulElement)._super$debugGetCreatorChain(args[1] as int));
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$debugGetDiagnosticChain#0', (args) => (args[0] as _$StatefulElement)._super$debugGetDiagnosticChain());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$dispatchNotification#1', (args) { (args[0] as _$StatefulElement)._super$dispatchNotification(args[1] as Notification); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$toStringShort#0', (args) => (args[0] as _$StatefulElement)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$StatefulElement)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$markNeedsBuild#0', (args) { (args[0] as _$StatefulElement)._super$markNeedsBuild(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$rebuild#1', (args) { (args[0] as _$StatefulElement)._super$rebuild(force: identical(args[1], darticAbsent) ? false : args[1] as bool); return null; });
    ...
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$depth#0', (args) => (args[0] as _$StatefulElement)._super$depth);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$widget#0', (args) => (args[0] as _$StatefulElement)._super$widget);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$mounted#0', (args) => (args[0] as _$StatefulElement)._super$mounted);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$debugIsDefunct#0', (args) => (args[0] as _$StatefulElement)._super$debugIsDefunct);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$debugIsActive#0', (args) => (args[0] as _$StatefulElement)._super$debugIsActive);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$owner#0', (args) => (args[0] as _$StatefulElement)._super$owner);
    ctx.registerBinding('package:flutter/src/widgets/framework.dart::StatefulElement::\$super\$buildScope#0', (args) => (args[0] as _$StatefulElement)._super$buildScope);
