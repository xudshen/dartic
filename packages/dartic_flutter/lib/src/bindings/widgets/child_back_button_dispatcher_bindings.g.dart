...
class _$ChildBackButtonDispatcher extends ChildBackButtonDispatcher implements DarticObjectHolder {
  ...
  Future<bool> notifiedByParent(Future<bool> defaultValue) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'notifiedByParent', [defaultValue]);
    if (identical(_$r, notOverridden)) return super.notifiedByParent(defaultValue);
