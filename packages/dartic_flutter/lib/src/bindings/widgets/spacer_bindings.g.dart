...
class _$Spacer extends Spacer implements DarticObjectHolder {
  _$Spacer(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, flex: superArgs[1] as int);
...
/// private class.
Object createSpacerBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$Spacer(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$Spacer(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/spacer.dart::Spacer::\$super\$build#1', (args) => (args[0] as _$Spacer)._super$build(args[1] as BuildContext));
    ctx.registerBinding('package:flutter/src/widgets/spacer.dart::Spacer::\$super\$toString#1', (args) => (args[0] as _$Spacer)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/spacer.dart::Spacer::\$super\$createElement#0', (args) => (args[0] as _$Spacer)._super$createElement());
    ctx.registerBinding('package:flutter/src/widgets/spacer.dart::Spacer::\$super\$toStringShort#0', (args) => (args[0] as _$Spacer)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/spacer.dart::Spacer::\$super\$debugFillProperties#1', (args) { (args[0] as _$Spacer)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/spacer.dart::Spacer::\$super\$toStringShallow#2', (args) => (args[0] as _$Spacer)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/spacer.dart::Spacer::\$super\$toStringDeep#4', (args) => (args[0] as _$Spacer)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
