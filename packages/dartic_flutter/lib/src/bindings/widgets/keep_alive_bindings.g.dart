...
class _$KeepAlive extends KeepAlive implements DarticObjectHolder {
  _$KeepAlive(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, keepAlive: superArgs[1] as bool, child: superArgs[2] as Widget);
  ...
  @override
  ParentDataElement<KeepAliveParentDataMixin> createElement() {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'createElement', const []);
    if (identical(_$r, notOverridden)) return super.createElement();
    return _$r as ParentDataElement<KeepAliveParentDataMixin>;
  }
  ...
  ParentDataElement<KeepAliveParentDataMixin> _super$createElement() => super.createElement();
...
/// private class.
Object createKeepAliveBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$KeepAlive(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$KeepAlive(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/sliver.dart::KeepAlive::\$super\$applyParentData#1', (args) { (args[0] as _$KeepAlive)._super$applyParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/widgets/sliver.dart::KeepAlive::\$super\$debugCanApplyOutOfTurn#0', (args) => (args[0] as _$KeepAlive)._super$debugCanApplyOutOfTurn());
    ctx.registerBinding('package:flutter/src/widgets/sliver.dart::KeepAlive::\$super\$debugFillProperties#1', (args) { (args[0] as _$KeepAlive)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/sliver.dart::KeepAlive::\$super\$toString#1', (args) => (args[0] as _$KeepAlive)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/sliver.dart::KeepAlive::\$super\$createElement#0', (args) => (args[0] as _$KeepAlive)._super$createElement());
    ctx.registerBinding('package:flutter/src/widgets/sliver.dart::KeepAlive::\$super\$debugIsValidRenderObject#1', (args) => (args[0] as _$KeepAlive)._super$debugIsValidRenderObject(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/widgets/sliver.dart::KeepAlive::\$super\$toStringShort#0', (args) => (args[0] as _$KeepAlive)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/sliver.dart::KeepAlive::\$super\$toStringShallow#2', (args) => (args[0] as _$KeepAlive)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/sliver.dart::KeepAlive::\$super\$toStringDeep#4', (args) => (args[0] as _$KeepAlive)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/widgets/sliver.dart::KeepAlive::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$KeepAlive)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/widgets/sliver.dart::KeepAlive::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$KeepAlive)._super$debugDescribeChildren());
