...
class _$RenderSliverOverlapAbsorber extends RenderSliverOverlapAbsorber implements DarticObjectHolder {
  _$RenderSliverOverlapAbsorber(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(handle: superArgs[0] as SliverOverlapAbsorberHandle, sliver: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as RenderSliver?);
...
/// private class.
Object createRenderSliverOverlapAbsorberBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderSliverOverlapAbsorber(dispatch, obj, superArgs);
...
abstract final class RenderSliverOverlapAbsorberBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderSliverOverlapAbsorber(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$attach#1', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$detach#0', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$performLayout#0', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$hitTestChildren#3', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$hitTestChildren(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$paint#2', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$paint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$toString#1', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$performResize#0', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$hitTest#3', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$hitTest(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$hitTestSelf#2', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$hitTestSelf(mainAxisPosition: args[1] as double, crossAxisPosition: args[2] as double));
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$calculatePaintOffset#3', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$calculatePaintOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$calculateCacheOffset#3', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$calculateCacheOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$childMainAxisPosition#1', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$childMainAxisPosition(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$childCrossAxisPosition#1', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$childCrossAxisPosition(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$childScrollOffset#1', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$childScrollOffset(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$getAbsoluteSizeRelativeToOrigin#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$getAbsoluteSizeRelativeToOrigin());
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$getAbsoluteSize#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$getAbsoluteSize());
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$debugPaint#2', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$debugPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$handleEvent#2', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$reassemble#0', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$dispose#0', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$setupParentData#1', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$redepthChild#1', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$adoptChild#1', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$dropChild#1', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$visitChildren#1', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$layout#2', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$paintsChild#1', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$toStringShort#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$describeForError#2', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ...
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$paintBounds#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$centerOffsetAdjustment#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$centerOffsetAdjustment);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$parentData#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$parentData);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$depth#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$depth);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$parent#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$parent);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$debugCreator#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$owner#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$owner);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$attached#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$attached);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$layer#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$layer);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$debugLayer#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$child#0', (args) => (args[0] as _$RenderSliverOverlapAbsorber)._super$child);
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$handle=#1', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$handle = args[1] as SliverOverlapAbsorberHandle; return args[1]; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$geometry=#1', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$geometry = args[1] as SliverGeometry?; return args[1]; });
    ctx.registerBinding('package:flutter/src/widgets/nested_scroll_view.dart::RenderSliverOverlapAbsorber::\$super\$parentData=#1', (args) { (args[0] as _$RenderSliverOverlapAbsorber)._super$parentData = args[1] as ParentData?; return args[1]; });
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderSliverOverlapAbsorber).handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; },
