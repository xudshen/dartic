...
class _$AnimatedScale extends AnimatedScale implements DarticObjectHolder {
  _$AnimatedScale(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, child: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as Widget?, scale: superArgs[2] as double, alignment: superArgs[3] as Alignment, filterQuality: identical(superArgs[4], darticAbsent) ? null : superArgs[4] as ui.FilterQuality?, curve: superArgs[5] as Curve, duration: superArgs[6] as Duration, onEnd: identical(superArgs[7], darticAbsent) ? null : superArgs[7] as ui.VoidCallback?);
  ...
  ImplicitlyAnimatedWidgetState<AnimatedScale> createState() {
    ...
    return _$r as ImplicitlyAnimatedWidgetState<AnimatedScale>;
  }
  ...
  // ── Super trampolines ──
  ImplicitlyAnimatedWidgetState<AnimatedScale> _super$createState() => super.createState();
...
/// private class.
Object createAnimatedScaleBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$AnimatedScale(dispatch, obj, superArgs);
...
abstract final class AnimatedScaleBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$AnimatedScale(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/implicit_animations.dart::AnimatedScale::\$super\$createState#0', (args) => (args[0] as _$AnimatedScale)._super$createState());
    ctx.registerBinding('package:flutter/src/widgets/implicit_animations.dart::AnimatedScale::\$super\$debugFillProperties#1', (args) { (args[0] as _$AnimatedScale)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/implicit_animations.dart::AnimatedScale::\$super\$toString#1', (args) => (args[0] as _$AnimatedScale)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/implicit_animations.dart::AnimatedScale::\$super\$createElement#0', (args) => (args[0] as _$AnimatedScale)._super$createElement());
    ctx.registerBinding('package:flutter/src/widgets/implicit_animations.dart::AnimatedScale::\$super\$toStringShort#0', (args) => (args[0] as _$AnimatedScale)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/implicit_animations.dart::AnimatedScale::\$super\$toStringShallow#2', (args) => (args[0] as _$AnimatedScale)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/implicit_animations.dart::AnimatedScale::\$super\$toStringDeep#4', (args) => (args[0] as _$AnimatedScale)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/widgets/implicit_animations.dart::AnimatedScale::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$AnimatedScale)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/widgets/implicit_animations.dart::AnimatedScale::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$AnimatedScale)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/widgets/implicit_animations.dart::AnimatedScale::\$super\$child#0', (args) => (args[0] as _$AnimatedScale)._super$child);
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#1': (args) => (args[0] as AnimatedScale).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
