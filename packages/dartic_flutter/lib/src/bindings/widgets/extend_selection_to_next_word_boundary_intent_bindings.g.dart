...
class _$ExtendSelectionToNextWordBoundaryIntent extends ExtendSelectionToNextWordBoundaryIntent implements DarticObjectHolder {
  _$ExtendSelectionToNextWordBoundaryIntent(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(forward: superArgs[0] as bool, collapseSelection: superArgs[1] as bool);
...
/// private class.
Object createExtendSelectionToNextWordBoundaryIntentBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$ExtendSelectionToNextWordBoundaryIntent(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$ExtendSelectionToNextWordBoundaryIntent(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/text_editing_intents.dart::ExtendSelectionToNextWordBoundaryIntent::\$super\$toString#1', (args) => (args[0] as _$ExtendSelectionToNextWordBoundaryIntent)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/text_editing_intents.dart::ExtendSelectionToNextWordBoundaryIntent::\$super\$toStringShort#0', (args) => (args[0] as _$ExtendSelectionToNextWordBoundaryIntent)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/text_editing_intents.dart::ExtendSelectionToNextWordBoundaryIntent::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$ExtendSelectionToNextWordBoundaryIntent)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/widgets/text_editing_intents.dart::ExtendSelectionToNextWordBoundaryIntent::\$super\$debugFillProperties#1', (args) { (args[0] as _$ExtendSelectionToNextWordBoundaryIntent)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/text_editing_intents.dart::ExtendSelectionToNextWordBoundaryIntent::\$super\$hashCode#0', (args) => (args[0] as _$ExtendSelectionToNextWordBoundaryIntent)._super$hashCode);
    ctx.registerBinding('package:flutter/src/widgets/text_editing_intents.dart::ExtendSelectionToNextWordBoundaryIntent::\$super\$collapseSelection#0', (args) => (args[0] as _$ExtendSelectionToNextWordBoundaryIntent)._super$collapseSelection);
    ctx.registerBinding('package:flutter/src/widgets/text_editing_intents.dart::ExtendSelectionToNextWordBoundaryIntent::\$super\$collapseAtReversal#0', (args) => (args[0] as _$ExtendSelectionToNextWordBoundaryIntent)._super$collapseAtReversal);
    ctx.registerBinding('package:flutter/src/widgets/text_editing_intents.dart::ExtendSelectionToNextWordBoundaryIntent::\$super\$continuesAtWrap#0', (args) => (args[0] as _$ExtendSelectionToNextWordBoundaryIntent)._super$continuesAtWrap);
    ctx.registerBinding('package:flutter/src/widgets/text_editing_intents.dart::ExtendSelectionToNextWordBoundaryIntent::\$super\$forward#0', (args) => (args[0] as _$ExtendSelectionToNextWordBoundaryIntent)._super$forward);
  }
