...
class _$ReorderableDragStartListener extends ReorderableDragStartListener implements DarticObjectHolder {
  _$ReorderableDragStartListener(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, child: superArgs[1] as Widget, index: superArgs[2] as int, enabled: superArgs[3] as bool);
  ...
  MultiDragGestureRecognizer createRecognizer() {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'createRecognizer', const []);
    if (identical(_$r, notOverridden)) return super.createRecognizer();
    return _$r as MultiDragGestureRecognizer;
  }
...
/// private class.
Object createReorderableDragStartListenerBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$ReorderableDragStartListener(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$ReorderableDragStartListener(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/reorderable_list.dart::ReorderableDragStartListener::\$super\$build#1', (args) => (args[0] as _$ReorderableDragStartListener)._super$build(args[1] as BuildContext));
    ctx.registerBinding('package:flutter/src/widgets/reorderable_list.dart::ReorderableDragStartListener::\$super\$createRecognizer#0', (args) => (args[0] as _$ReorderableDragStartListener)._super$createRecognizer());
    ctx.registerBinding('package:flutter/src/widgets/reorderable_list.dart::ReorderableDragStartListener::\$super\$toString#1', (args) => (args[0] as _$ReorderableDragStartListener)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/reorderable_list.dart::ReorderableDragStartListener::\$super\$createElement#0', (args) => (args[0] as _$ReorderableDragStartListener)._super$createElement());
    ctx.registerBinding('package:flutter/src/widgets/reorderable_list.dart::ReorderableDragStartListener::\$super\$toStringShort#0', (args) => (args[0] as _$ReorderableDragStartListener)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/widgets/reorderable_list.dart::ReorderableDragStartListener::\$super\$debugFillProperties#1', (args) { (args[0] as _$ReorderableDragStartListener)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/widgets/reorderable_list.dart::ReorderableDragStartListener::\$super\$toStringShallow#2', (args) => (args[0] as _$ReorderableDragStartListener)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/widgets/reorderable_list.dart::ReorderableDragStartListener::\$super\$toStringDeep#4', (args) => (args[0] as _$ReorderableDragStartListener)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/widgets/reorderable_list.dart::ReorderableDragStartListener::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$ReorderableDragStartListener)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/widgets/reorderable_list.dart::ReorderableDragStartListener::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$ReorderableDragStartListener)._super$debugDescribeChildren());
