...
class _$NeverScrollableScrollPhysics extends NeverScrollableScrollPhysics implements DarticObjectHolder {
  _$NeverScrollableScrollPhysics(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(parent: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as ScrollPhysics?);
  ...
  // ── Super trampolines ──
  NeverScrollableScrollPhysics _super$applyTo(ScrollPhysics? ancestor) => super.applyTo(ancestor);
...
/// private class.
Object createNeverScrollableScrollPhysicsBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$NeverScrollableScrollPhysics(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$NeverScrollableScrollPhysics(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/widgets/scroll_physics.dart::NeverScrollableScrollPhysics::\$super\$applyTo#1', (args) => (args[0] as _$NeverScrollableScrollPhysics)._super$applyTo(args[1] as ScrollPhysics?));
    ctx.registerBinding('package:flutter/src/widgets/scroll_physics.dart::NeverScrollableScrollPhysics::\$super\$toString#0', (args) => (args[0] as _$NeverScrollableScrollPhysics)._super$toString());
    ctx.registerBinding('package:flutter/src/widgets/scroll_physics.dart::NeverScrollableScrollPhysics::\$super\$buildParent#1', (args) => (args[0] as _$NeverScrollableScrollPhysics)._super$buildParent(args[1] as ScrollPhysics?));
    ctx.registerBinding('package:flutter/src/widgets/scroll_physics.dart::NeverScrollableScrollPhysics::\$super\$applyPhysicsToUserOffset#2', (args) => (args[0] as _$NeverScrollableScrollPhysics)._super$applyPhysicsToUserOffset(args[1] as ScrollMetrics, args[2] as double));
    ctx.registerBinding('package:flutter/src/widgets/scroll_physics.dart::NeverScrollableScrollPhysics::\$super\$shouldAcceptUserOffset#1', (args) => (args[0] as _$NeverScrollableScrollPhysics)._super$shouldAcceptUserOffset(args[1] as ScrollMetrics));
    ctx.registerBinding('package:flutter/src/widgets/scroll_physics.dart::NeverScrollableScrollPhysics::\$super\$recommendDeferredLoading#3', (args) => (args[0] as _$NeverScrollableScrollPhysics)._super$recommendDeferredLoading(args[1] as double, args[2] as ScrollMetrics, args[3] as BuildContext));
    ctx.registerBinding('package:flutter/src/widgets/scroll_physics.dart::NeverScrollableScrollPhysics::\$super\$applyBoundaryConditions#2', (args) => (args[0] as _$NeverScrollableScrollPhysics)._super$applyBoundaryConditions(args[1] as ScrollMetrics, args[2] as double));
    ctx.registerBinding('package:flutter/src/widgets/scroll_physics.dart::NeverScrollableScrollPhysics::\$super\$adjustPositionForNewDimensions#4', (args) => (args[0] as _$NeverScrollableScrollPhysics)._super$adjustPositionForNewDimensions(oldPosition: args[1] as ScrollMetrics, newPosition: args[2] as ScrollMetrics, isScrolling: args[3] as bool, velocity: args[4] as double));
    ctx.registerBinding('package:flutter/src/widgets/scroll_physics.dart::NeverScrollableScrollPhysics::\$super\$createBallisticSimulation#2', (args) => (args[0] as _$NeverScrollableScrollPhysics)._super$createBallisticSimulation(args[1] as ScrollMetrics, args[2] as double));
    ctx.registerBinding('package:flutter/src/widgets/scroll_physics.dart::NeverScrollableScrollPhysics::\$super\$toleranceFor#1', (args) => (args[0] as _$NeverScrollableScrollPhysics)._super$toleranceFor(args[1] as ScrollMetrics));
    ...
    ctx.registerBinding('package:flutter/src/widgets/scroll_physics.dart::NeverScrollableScrollPhysics::\$super\$minFlingDistance#0', (args) => (args[0] as _$NeverScrollableScrollPhysics)._super$minFlingDistance);
