...
abstract final class BuildContextBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'getInheritedWidgetOfExactType#0': (args) => (args[0] as BuildContext).getInheritedWidgetOfExactType(),
        'getElementForInheritedWidgetOfExactType#0': (args) => (args[0] as BuildContext).getElementForInheritedWidgetOfExactType(),
        'findAncestorWidgetOfExactType#0': (args) => (args[0] as BuildContext).findAncestorWidgetOfExactType(),
        'findAncestorStateOfType#0': (args) => (args[0] as BuildContext).findAncestorStateOfType(),
        'findRootAncestorStateOfType#0': (args) => (args[0] as BuildContext).findRootAncestorStateOfType(),
        'findAncestorRenderObjectOfType#0': (args) => (args[0] as BuildContext).findAncestorRenderObjectOfType(),
