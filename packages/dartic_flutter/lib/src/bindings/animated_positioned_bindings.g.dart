...
abstract final class AnimatedPositionedBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        '_#fromFields#7': (args) => AnimatedPositioned(bottom: args[0] as double?, child: args[1] as Widget, height: args[2] as double?, left: args[3] as double?, right: args[4] as double?, top: args[5] as double?, width: args[6] as double?),
      };
}
