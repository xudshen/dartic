...
abstract final class IOSSystemContextMenuItemDataCustomBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#1': (args) => (args[0] as IOSSystemContextMenuItemDataCustom).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
        ...
        '==#1': (args) => (args[0] as IOSSystemContextMenuItemDataCustom) == (args[1] as Object),
