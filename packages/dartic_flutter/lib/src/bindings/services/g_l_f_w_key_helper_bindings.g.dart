...
class _$GLFWKeyHelper extends GLFWKeyHelper implements DarticObjectHolder {
  _$GLFWKeyHelper(this._dispatch, this.$darticObject, List<Object?> superArgs);
...
/// private class.
Object createGLFWKeyHelperBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$GLFWKeyHelper(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$GLFWKeyHelper(dispatch, darticObject, superArgs),
    );
    ...
    ctx.registerBinding('package:flutter/src/services/raw_keyboard_linux.dart::GLFWKeyHelper::\$super\$isModifierPressed#5', (args) => (args[0] as _$GLFWKeyHelper)._super$isModifierPressed(args[1] as ModifierKey, args[2] as int, side: identical(args[3], darticAbsent) ? KeyboardSide.any : args[3] as KeyboardSide, keyCode: args[4] as int, isDown: args[5] as bool));
    ctx.registerBinding('package:flutter/src/services/raw_keyboard_linux.dart::GLFWKeyHelper::\$super\$getModifierSide#1', (args) => (args[0] as _$GLFWKeyHelper)._super$getModifierSide(args[1] as ModifierKey));
    ctx.registerBinding('package:flutter/src/services/raw_keyboard_linux.dart::GLFWKeyHelper::\$super\$numpadKey#1', (args) => (args[0] as _$GLFWKeyHelper)._super$numpadKey(args[1] as int));
    ctx.registerBinding('package:flutter/src/services/raw_keyboard_linux.dart::GLFWKeyHelper::\$super\$logicalKey#1', (args) => (args[0] as _$GLFWKeyHelper)._super$logicalKey(args[1] as int));
    ctx.registerBinding('package:flutter/src/services/raw_keyboard_linux.dart::GLFWKeyHelper::\$super\$toString#0', (args) => (args[0] as _$GLFWKeyHelper)._super$toString());
    ctx.registerBinding('package:flutter/src/services/raw_keyboard_linux.dart::GLFWKeyHelper::\$super\$debugToolkit#0', (args) => (args[0] as _$GLFWKeyHelper)._super$debugToolkit);
    ctx.registerBinding('package:flutter/src/services/raw_keyboard_linux.dart::GLFWKeyHelper::\$super\$platformPlane#0', (args) => (args[0] as _$GLFWKeyHelper)._super$platformPlane);
    ctx.registerBinding('package:flutter/src/services/raw_keyboard_linux.dart::GLFWKeyHelper::\$super\$hashCode#0', (args) => (args[0] as _$GLFWKeyHelper)._super$hashCode);
  }
