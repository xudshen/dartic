...
abstract final class IOSSystemContextMenuItemDataSelectAllBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        'toString#0': (args) => (args[0] as IOSSystemContextMenuItemDataSelectAll).toString(),
        'hashCode#0': (args) => (args[0] as IOSSystemContextMenuItemDataSelectAll).hashCode,
        'title#0': (args) => (args[0] as IOSSystemContextMenuItemDataSelectAll).title,
        '==#1': (args) => (args[0] as IOSSystemContextMenuItemDataSelectAll) == (args[1] as Object),
