...
class _$RawKeyDownEvent extends RawKeyDownEvent implements DarticObjectHolder {
  _$RawKeyDownEvent(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(data: superArgs[0] as RawKeyEventData, character: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as String?, repeat: superArgs[2] as bool);
...
/// private class.
Object createRawKeyDownEventBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RawKeyDownEvent(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RawKeyDownEvent(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/services/raw_keyboard.dart::RawKeyDownEvent::\$super\$toString#1', (args) => (args[0] as _$RawKeyDownEvent)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/services/raw_keyboard.dart::RawKeyDownEvent::\$super\$isKeyPressed#1', (args) => (args[0] as _$RawKeyDownEvent)._super$isKeyPressed(args[1] as LogicalKeyboardKey));
    ...
    ctx.registerBinding('package:flutter/src/services/raw_keyboard.dart::RawKeyDownEvent::\$super\$isMetaPressed#0', (args) => (args[0] as _$RawKeyDownEvent)._super$isMetaPressed);
    ctx.registerBinding('package:flutter/src/services/raw_keyboard.dart::RawKeyDownEvent::\$super\$physicalKey#0', (args) => (args[0] as _$RawKeyDownEvent)._super$physicalKey);
    ctx.registerBinding('package:flutter/src/services/raw_keyboard.dart::RawKeyDownEvent::\$super\$logicalKey#0', (args) => (args[0] as _$RawKeyDownEvent)._super$logicalKey);
