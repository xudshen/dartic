...
abstract final class IOSSystemContextMenuItemDataPasteBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      name: 'package:flutter/src/services/text_input.dart::IOSSystemContextMenuItemDataPaste',
      type: IOSSystemContextMenuItemDataPaste,
      test: (o) => o is IOSSystemContextMenuItemDataPaste,
      methods: methodMap(),
