...
abstract final class IOSSystemContextMenuItemDataBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      name: 'package:flutter/src/services/text_input.dart::IOSSystemContextMenuItemData',
      type: IOSSystemContextMenuItemData,
      test: (o) => o is IOSSystemContextMenuItemData,
      methods: methodMap(),
    );
  }
