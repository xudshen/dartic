...
abstract final class IOSSystemContextMenuItemDataCopyBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      name: 'package:flutter/src/services/text_input.dart::IOSSystemContextMenuItemDataCopy',
      type: IOSSystemContextMenuItemDataCopy,
      test: (o) => o is IOSSystemContextMenuItemDataCopy,
      methods: methodMap(),
