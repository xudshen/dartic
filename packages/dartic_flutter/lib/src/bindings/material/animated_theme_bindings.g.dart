...
class _$AnimatedTheme extends AnimatedTheme implements DarticObjectHolder {
  _$AnimatedTheme(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, data: superArgs[1] as ThemeData, curve: superArgs[2] as Curve, duration: superArgs[3] as Duration, onEnd: identical(superArgs[4], darticAbsent) ? null : superArgs[4] as VoidCallback?, child: superArgs[5] as Widget);
  ...
  AnimatedWidgetBaseState<AnimatedTheme> createState() {
    ...
    return _$r as AnimatedWidgetBaseState<AnimatedTheme>;
  }
  ...
  // ── Super trampolines ──
  AnimatedWidgetBaseState<AnimatedTheme> _super$createState() => super.createState();
...
/// private class.
Object createAnimatedThemeBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$AnimatedTheme(dispatch, obj, superArgs);
...
abstract final class AnimatedThemeBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$AnimatedTheme(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/material/theme.dart::AnimatedTheme::\$super\$createState#0', (args) => (args[0] as _$AnimatedTheme)._super$createState());
    ctx.registerBinding('package:flutter/src/material/theme.dart::AnimatedTheme::\$super\$toString#1', (args) => (args[0] as _$AnimatedTheme)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/material/theme.dart::AnimatedTheme::\$super\$debugFillProperties#1', (args) { (args[0] as _$AnimatedTheme)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/material/theme.dart::AnimatedTheme::\$super\$createElement#0', (args) => (args[0] as _$AnimatedTheme)._super$createElement());
    ctx.registerBinding('package:flutter/src/material/theme.dart::AnimatedTheme::\$super\$toStringShort#0', (args) => (args[0] as _$AnimatedTheme)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/material/theme.dart::AnimatedTheme::\$super\$toStringShallow#2', (args) => (args[0] as _$AnimatedTheme)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/material/theme.dart::AnimatedTheme::\$super\$toStringDeep#4', (args) => (args[0] as _$AnimatedTheme)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/material/theme.dart::AnimatedTheme::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$AnimatedTheme)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#1': (args) => (args[0] as AnimatedTheme).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
