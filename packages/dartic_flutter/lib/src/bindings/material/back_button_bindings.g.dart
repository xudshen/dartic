...
class _$BackButton extends BackButton implements DarticObjectHolder {
  _$BackButton(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, color: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as Color?, style: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as ButtonStyle?, onPressed: identical(superArgs[3], darticAbsent) ? null : superArgs[3] as VoidCallback?);
...
/// private class.
Object createBackButtonBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$BackButton(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$BackButton(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$toString#1', (args) => (args[0] as _$BackButton)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$build#1', (args) => (args[0] as _$BackButton)._super$build(args[1] as BuildContext));
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$debugFillProperties#1', (args) { (args[0] as _$BackButton)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$createElement#0', (args) => (args[0] as _$BackButton)._super$createElement());
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$toStringShort#0', (args) => (args[0] as _$BackButton)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$toStringShallow#2', (args) => (args[0] as _$BackButton)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$toStringDeep#4', (args) => (args[0] as _$BackButton)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$BackButton)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$BackButton)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$standardComponent#0', (args) => (args[0] as _$BackButton)._super$standardComponent);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$iconSize#0', (args) => (args[0] as _$BackButton)._super$iconSize);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$visualDensity#0', (args) => (args[0] as _$BackButton)._super$visualDensity);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$padding#0', (args) => (args[0] as _$BackButton)._super$padding);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$alignment#0', (args) => (args[0] as _$BackButton)._super$alignment);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$splashRadius#0', (args) => (args[0] as _$BackButton)._super$splashRadius);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$icon#0', (args) => (args[0] as _$BackButton)._super$icon);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$focusColor#0', (args) => (args[0] as _$BackButton)._super$focusColor);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$hoverColor#0', (args) => (args[0] as _$BackButton)._super$hoverColor);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$color#0', (args) => (args[0] as _$BackButton)._super$color);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$splashColor#0', (args) => (args[0] as _$BackButton)._super$splashColor);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$highlightColor#0', (args) => (args[0] as _$BackButton)._super$highlightColor);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$disabledColor#0', (args) => (args[0] as _$BackButton)._super$disabledColor);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$onPressed#0', (args) => (args[0] as _$BackButton)._super$onPressed);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$onHover#0', (args) => (args[0] as _$BackButton)._super$onHover);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$onLongPress#0', (args) => (args[0] as _$BackButton)._super$onLongPress);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$mouseCursor#0', (args) => (args[0] as _$BackButton)._super$mouseCursor);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$focusNode#0', (args) => (args[0] as _$BackButton)._super$focusNode);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$autofocus#0', (args) => (args[0] as _$BackButton)._super$autofocus);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$tooltip#0', (args) => (args[0] as _$BackButton)._super$tooltip);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$enableFeedback#0', (args) => (args[0] as _$BackButton)._super$enableFeedback);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$constraints#0', (args) => (args[0] as _$BackButton)._super$constraints);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$style#0', (args) => (args[0] as _$BackButton)._super$style);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$isSelected#0', (args) => (args[0] as _$BackButton)._super$isSelected);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$selectedIcon#0', (args) => (args[0] as _$BackButton)._super$selectedIcon);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$statesController#0', (args) => (args[0] as _$BackButton)._super$statesController);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$key#0', (args) => (args[0] as _$BackButton)._super$key);
    ctx.registerBinding('package:flutter/src/material/action_buttons.dart::BackButton::\$super\$hashCode#0', (args) => (args[0] as _$BackButton)._super$hashCode);
  }

  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        'toString#1': (args) => (args[0] as BackButton).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
        ...
        'hashCode#0': (args) => (args[0] as BackButton).hashCode,
        ...
        '==#1': (args) => (args[0] as BackButton) == (args[1] as Object),
