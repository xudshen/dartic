...
class _$CarouselController extends CarouselController implements DarticObjectHolder {
  ...
  Future<void> animateToItem(int index, {Duration duration = const Duration(milliseconds: 300), Curve curve = Curves.ease}) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'animateToItem', [index, duration, curve]);
    if (identical(_$r, notOverridden)) return super.animateToItem(index, duration: duration, curve: curve);
