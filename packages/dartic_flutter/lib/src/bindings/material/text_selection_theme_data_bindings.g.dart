...
class _$TextSelectionThemeData extends TextSelectionThemeData implements DarticObjectHolder {
  ...
  TextSelectionThemeData copyWith({Color? cursorColor, Color? selectionColor, Color? selectionHandleColor}) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'copyWith', [cursorColor, selectionColor, selectionHandleColor]);
    if (identical(r, notOverridden)) return super.copyWith(cursorColor: cursorColor, selectionColor: selectionColor, selectionHandleColor: selectionHandleColor);
