...
class _$DropdownMenuItem extends DropdownMenuItem<dynamic> implements DarticObjectHolder {
  _$DropdownMenuItem(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, onTap: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as VoidCallback?, value: superArgs[2], enabled: superArgs[3] as bool, alignment: superArgs[4] as AlignmentGeometry, child: superArgs[5] as Widget);
...
/// private class.
Object createDropdownMenuItemBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$DropdownMenuItem(dispatch, obj, superArgs);
...
abstract final class DropdownMenuItemBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$DropdownMenuItem(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/material/dropdown.dart::DropdownMenuItem::\$super\$toString#1', (args) => (args[0] as _$DropdownMenuItem)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/material/dropdown.dart::DropdownMenuItem::\$super\$build#1', (args) => (args[0] as _$DropdownMenuItem)._super$build(args[1] as BuildContext));
    ctx.registerBinding('package:flutter/src/material/dropdown.dart::DropdownMenuItem::\$super\$createElement#0', (args) => (args[0] as _$DropdownMenuItem)._super$createElement());
    ctx.registerBinding('package:flutter/src/material/dropdown.dart::DropdownMenuItem::\$super\$toStringShort#0', (args) => (args[0] as _$DropdownMenuItem)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/material/dropdown.dart::DropdownMenuItem::\$super\$debugFillProperties#1', (args) { (args[0] as _$DropdownMenuItem)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/material/dropdown.dart::DropdownMenuItem::\$super\$toStringShallow#2', (args) => (args[0] as _$DropdownMenuItem)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/material/dropdown.dart::DropdownMenuItem::\$super\$toStringDeep#4', (args) => (args[0] as _$DropdownMenuItem)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/material/dropdown.dart::DropdownMenuItem::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$DropdownMenuItem)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/material/dropdown.dart::DropdownMenuItem::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$DropdownMenuItem)._super$debugDescribeChildren());
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        'toString#1': (args) => (args[0] as DropdownMenuItem).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
