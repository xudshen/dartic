...
abstract final class ExpandIconBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        '#10': (args) => ExpandIcon(key: identical(args[0], darticAbsent) ? null : args[0] as Key?, isExpanded: identical(args[1], darticAbsent) ? false : args[1] as bool, size: identical(args[2], darticAbsent) ? 24.0 : args[2] as double, onPressed: args[3] as void Function(bool)?, padding: identical(args[4], darticAbsent) ? const EdgeInsets.all(8.0) : args[4] as EdgeInsetsGeometry, color: identical(args[5], darticAbsent) ? null : args[5] as Color?, disabledColor: identical(args[6], darticAbsent) ? null : args[6] as Color?, expandedColor: identical(args[7], darticAbsent) ? null : args[7] as Color?, splashColor: identical(args[8], darticAbsent) ? null : args[8] as Color?, highlightColor: identical(args[9], darticAbsent) ? null : args[9] as Color?),
