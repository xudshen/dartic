...
class _$MaterialColor extends MaterialColor implements DarticObjectHolder {
  _$MaterialColor(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(superArgs[0] as int, (superArgs[1] as Map).cast<int, Color>());
  ...
  @override
  Color get shade50 {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'shade50');
    if (identical(r, notOverridden)) return super.shade50;
    return r as Color;
  }

  @override
  Color get shade100 {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'shade100');
    if (identical(r, notOverridden)) return super.shade100;
    return r as Color;
  }

  @override
  Color get shade200 {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'shade200');
    if (identical(r, notOverridden)) return super.shade200;
    return r as Color;
  }

  @override
  Color get shade300 {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'shade300');
    if (identical(r, notOverridden)) return super.shade300;
    return r as Color;
  }

  @override
  Color get shade400 {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'shade400');
    if (identical(r, notOverridden)) return super.shade400;
    return r as Color;
  }

  @override
  Color get shade500 {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'shade500');
    if (identical(r, notOverridden)) return super.shade500;
    return r as Color;
  }

  @override
  Color get shade600 {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'shade600');
    if (identical(r, notOverridden)) return super.shade600;
    return r as Color;
  }

  @override
  Color get shade700 {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'shade700');
    if (identical(r, notOverridden)) return super.shade700;
    return r as Color;
  }

  @override
  Color get shade800 {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'shade800');
    if (identical(r, notOverridden)) return super.shade800;
    return r as Color;
  }

  @override
  Color get shade900 {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'shade900');
    if (identical(r, notOverridden)) return super.shade900;
    return r as Color;
  }
  ...
  Color get _super$shade50 => super.shade50;
  Color get _super$shade100 => super.shade100;
  Color get _super$shade200 => super.shade200;
  Color get _super$shade300 => super.shade300;
  Color get _super$shade400 => super.shade400;
  Color get _super$shade500 => super.shade500;
  Color get _super$shade600 => super.shade600;
...
/// private class.
Object createMaterialColorBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$MaterialColor(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$MaterialColor(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/material/colors.dart::MaterialColor::\$super\$toString#0', (args) => (args[0] as _$MaterialColor)._super$toString());
    ctx.registerBinding('package:flutter/src/material/colors.dart::MaterialColor::\$super\$toARGB32#0', (args) => (args[0] as _$MaterialColor)._super$toARGB32());
    ctx.registerBinding('package:flutter/src/material/colors.dart::MaterialColor::\$super\$withValues#5', (args) => (args[0] as _$MaterialColor)._super$withValues(alpha: identical(args[1], darticAbsent) ? null : args[1] as double?, red: identical(args[2], darticAbsent) ? null : args[2] as double?, green: identical(args[3], darticAbsent) ? null : args[3] as double?, blue: identical(args[4], darticAbsent) ? null : args[4] as double?, colorSpace: identical(args[5], darticAbsent) ? null : args[5] as ColorSpace?));
    ctx.registerBinding('package:flutter/src/material/colors.dart::MaterialColor::\$super\$withAlpha#1', (args) => (args[0] as _$MaterialColor)._super$withAlpha(args[1] as int));
    ctx.registerBinding('package:flutter/src/material/colors.dart::MaterialColor::\$super\$withOpacity#1', (args) => (args[0] as _$MaterialColor)._super$withOpacity(args[1] as double));
    ctx.registerBinding('package:flutter/src/material/colors.dart::MaterialColor::\$super\$withRed#1', (args) => (args[0] as _$MaterialColor)._super$withRed(args[1] as int));
    ctx.registerBinding('package:flutter/src/material/colors.dart::MaterialColor::\$super\$withGreen#1', (args) => (args[0] as _$MaterialColor)._super$withGreen(args[1] as int));
    ctx.registerBinding('package:flutter/src/material/colors.dart::MaterialColor::\$super\$withBlue#1', (args) => (args[0] as _$MaterialColor)._super$withBlue(args[1] as int));
    ctx.registerBinding('package:flutter/src/material/colors.dart::MaterialColor::\$super\$computeLuminance#0', (args) => (args[0] as _$MaterialColor)._super$computeLuminance());
    ctx.registerBinding('package:flutter/src/material/colors.dart::MaterialColor::\$super\$shade50#0', (args) => (args[0] as _$MaterialColor)._super$shade50);
    ctx.registerBinding('package:flutter/src/material/colors.dart::MaterialColor::\$super\$shade100#0', (args) => (args[0] as _$MaterialColor)._super$shade100);
    ctx.registerBinding('package:flutter/src/material/colors.dart::MaterialColor::\$super\$shade200#0', (args) => (args[0] as _$MaterialColor)._super$shade200);
    ctx.registerBinding('package:flutter/src/material/colors.dart::MaterialColor::\$super\$shade300#0', (args) => (args[0] as _$MaterialColor)._super$shade300);
    ctx.registerBinding('package:flutter/src/material/colors.dart::MaterialColor::\$super\$shade400#0', (args) => (args[0] as _$MaterialColor)._super$shade400);
    ctx.registerBinding('package:flutter/src/material/colors.dart::MaterialColor::\$super\$shade500#0', (args) => (args[0] as _$MaterialColor)._super$shade500);
    ctx.registerBinding('package:flutter/src/material/colors.dart::MaterialColor::\$super\$shade600#0', (args) => (args[0] as _$MaterialColor)._super$shade600);
    ...
    ctx.registerBinding('package:flutter/src/material/colors.dart::MaterialColor::\$super\$g#0', (args) => (args[0] as _$MaterialColor)._super$g);
    ctx.registerBinding('package:flutter/src/material/colors.dart::MaterialColor::\$super\$b#0', (args) => (args[0] as _$MaterialColor)._super$b);
    ctx.registerBinding('package:flutter/src/material/colors.dart::MaterialColor::\$super\$colorSpace#0', (args) => (args[0] as _$MaterialColor)._super$colorSpace);
    ctx.registerBinding('package:flutter/src/material/colors.dart::MaterialColor::\$super\$value#0', (args) => (args[0] as _$MaterialColor)._super$value);
    ctx.registerBinding('package:flutter/src/material/colors.dart::MaterialColor::\$super\$alpha#0', (args) => (args[0] as _$MaterialColor)._super$alpha);
    ctx.registerBinding('package:flutter/src/material/colors.dart::MaterialColor::\$super\$opacity#0', (args) => (args[0] as _$MaterialColor)._super$opacity);
