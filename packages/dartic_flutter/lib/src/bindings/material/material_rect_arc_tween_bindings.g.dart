...
abstract final class MaterialRectArcTweenBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      name: 'package:flutter/src/material/arc.dart::MaterialRectArcTween',
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        'lerp#1': (args) => (args[0] as MaterialRectArcTween).lerp(args[1] as double),
        'toString#0': (args) => (args[0] as MaterialRectArcTween).toString(),
        'transform#1': (args) => (args[0] as MaterialRectArcTween).transform(args[1] as double),
        'evaluate#1': (args) => (args[0] as MaterialRectArcTween).evaluate(args[1] as Animation<double>),
        'animate#1': (args) => (args[0] as MaterialRectArcTween).animate(args[1] as Animation<double>),
