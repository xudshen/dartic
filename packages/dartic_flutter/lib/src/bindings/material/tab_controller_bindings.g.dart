...
class _$TabController extends TabController implements DarticObjectHolder {
  ...
  void animateTo(int value, {Duration? duration, Curve curve = Curves.ease}) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'animateTo', [value, duration, curve]);
    if (identical(r, notOverridden)) { super.animateTo(value, duration: duration, curve: curve); return; }
  }
