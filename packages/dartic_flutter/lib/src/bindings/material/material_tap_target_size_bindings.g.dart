...
abstract final class MaterialTapTargetSizeBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      name: 'package:flutter/src/material/theme_data.dart::MaterialTapTargetSize',
      type: MaterialTapTargetSize,
      test: (o) => o is MaterialTapTargetSize,
      methods: methodMap(),
      superclasses: ['dart:core::Enum'],
    );
    ctx.registerBinding('package:flutter/src/material/theme_data.dart::MaterialTapTargetSize::padded#0', (args) => MaterialTapTargetSize.padded);
    ctx.registerBinding('package:flutter/src/material/theme_data.dart::MaterialTapTargetSize::shrinkWrap#0', (args) => MaterialTapTargetSize.shrinkWrap);
    ctx.registerBinding('package:flutter/src/material/theme_data.dart::MaterialTapTargetSize::values#0', (args) => MaterialTapTargetSize.values);
  }

  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        'toString#0': (args) => (args[0] as MaterialTapTargetSize).toString(),
        'hashCode#0': (args) => (args[0] as MaterialTapTargetSize).hashCode,
        'index#0': (args) => (args[0] as MaterialTapTargetSize).index,
        '==#1': (args) => (args[0] as MaterialTapTargetSize) == (args[1] as Object),
        '_#fromFields#2': (args) => MaterialTapTargetSize.values[args[1] as int],
      };
}
