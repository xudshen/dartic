...
abstract final class SwitchBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        '_#fromFields#30': (args) => Switch.adaptive(key: args[14] as Key?, value: args[29] as bool, onChanged: args[18] as ValueChanged<bool>?, activeColor: args[1] as Color?, activeThumbColor: args[2] as Color?, activeTrackColor: args[4] as Color?, inactiveThumbColor: args[11] as Color?, inactiveTrackColor: args[13] as Color?, activeThumbImage: args[3] as ImageProvider<Object>?, onActiveThumbImageError: args[17] as ImageErrorListener?, inactiveThumbImage: args[12] as ImageProvider<Object>?, onInactiveThumbImageError: args[20] as ImageErrorListener?, materialTapTargetSize: args[15] as MaterialTapTargetSize?, thumbColor: args[24] as WidgetStateProperty<Color?>?, trackColor: args[26] as WidgetStateProperty<Color?>?, trackOutlineColor: args[27] as WidgetStateProperty<Color?>?, trackOutlineWidth: args[28] as WidgetStateProperty<double?>?, thumbIcon: args[25] as WidgetStateProperty<Icon?>?, dragStartBehavior: args[7] as DragStartBehavior, mouseCursor: args[16] as MouseCursor?, focusColor: args[8] as Color?, hoverColor: args[10] as Color?, overlayColor: args[21] as WidgetStateProperty<Color?>?, splashRadius: args[23] as double?, focusNode: args[9] as FocusNode?, onFocusChange: args[19] as ValueChanged<bool>?, autofocus: args[6] as bool, padding: args[22] as EdgeInsetsGeometry?, applyCupertinoTheme: args[5] as bool?),
      };
}
