...
class _$ScaffoldMessenger extends ScaffoldMessenger implements DarticObjectHolder {
  _$ScaffoldMessenger(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, child: superArgs[1] as Widget);
  ...
  ScaffoldMessengerState createState() {
    ...
    return _$r as ScaffoldMessengerState;
  }
  ...
  // ── Super trampolines ──
  ScaffoldMessengerState _super$createState() => super.createState();
...
/// private class.
Object createScaffoldMessengerBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$ScaffoldMessenger(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$ScaffoldMessenger(dispatch, darticObject, superArgs),
    );
    ...
    ctx.registerBinding('package:flutter/src/material/scaffold.dart::ScaffoldMessenger::\$super\$createState#0', (args) => (args[0] as _$ScaffoldMessenger)._super$createState());
    ctx.registerBinding('package:flutter/src/material/scaffold.dart::ScaffoldMessenger::\$super\$toString#1', (args) => (args[0] as _$ScaffoldMessenger)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/material/scaffold.dart::ScaffoldMessenger::\$super\$createElement#0', (args) => (args[0] as _$ScaffoldMessenger)._super$createElement());
    ctx.registerBinding('package:flutter/src/material/scaffold.dart::ScaffoldMessenger::\$super\$toStringShort#0', (args) => (args[0] as _$ScaffoldMessenger)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/material/scaffold.dart::ScaffoldMessenger::\$super\$debugFillProperties#1', (args) { (args[0] as _$ScaffoldMessenger)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/material/scaffold.dart::ScaffoldMessenger::\$super\$toStringShallow#2', (args) => (args[0] as _$ScaffoldMessenger)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/material/scaffold.dart::ScaffoldMessenger::\$super\$toStringDeep#4', (args) => (args[0] as _$ScaffoldMessenger)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
