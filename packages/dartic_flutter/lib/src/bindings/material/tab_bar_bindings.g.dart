...
abstract final class TabBarBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        '_#fromFields#32': (args) => TabBar(key: args[14] as Key?, tabs: (args[28] as List).cast<Widget>(), controller: args[2] as TabController?, isScrollable: args[13] as bool, padding: args[23] as EdgeInsetsGeometry?, indicatorColor: args[9] as Color?, automaticIndicatorColorAdjustment: args[1] as bool, indicatorWeight: args[12] as double, indicatorPadding: args[10] as EdgeInsetsGeometry, indicator: args[7] as Decoration?, indicatorSize: args[11] as TabBarIndicatorSize?, dividerColor: args[3] as Color?, dividerHeight: args[4] as double?, labelColor: args[15] as Color?, labelStyle: args[17] as TextStyle?, labelPadding: args[16] as EdgeInsetsGeometry?, unselectedLabelColor: args[30] as Color?, unselectedLabelStyle: args[31] as TextStyle?, dragStartBehavior: args[5] as DragStartBehavior, overlayColor: args[22] as WidgetStateProperty<Color?>?, mouseCursor: args[18] as MouseCursor?, enableFeedback: args[6] as bool?, onTap: args[21] as ValueChanged<int>?, onHover: args[20] as TabValueChanged<bool>?, onFocusChange: args[19] as TabValueChanged<bool>?, physics: args[24] as ScrollPhysics?, splashFactory: args[26] as InteractiveInkFeatureFactory?, splashBorderRadius: args[25] as BorderRadius?, tabAlignment: args[27] as TabAlignment?, textScaler: args[29] as TextScaler?, indicatorAnimation: args[8] as TabIndicatorAnimation?),
      };
}
