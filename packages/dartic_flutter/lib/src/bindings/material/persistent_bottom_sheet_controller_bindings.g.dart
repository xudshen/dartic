...
abstract final class PersistentBottomSheetControllerBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      name: 'package:flutter/src/material/scaffold.dart::PersistentBottomSheetController',
      type: PersistentBottomSheetController,
      test: (o) => o is PersistentBottomSheetController,
      methods: methodMap(),
      superclasses: ['package:flutter/src/material/scaffold.dart::ScaffoldFeatureController'],
    );
  }
