...
abstract final class SliderBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        '#22': (args) => Slider(key: identical(args[0], darticAbsent) ? null : args[0] as Key?, value: args[1] as double, secondaryTrackValue: identical(args[2], darticAbsent) ? null : args[2] as double?, onChanged: args[3] as void Function(double)?, onChangeStart: identical(args[4], darticAbsent) ? null : args[4] as void Function(double)?, onChangeEnd: identical(args[5], darticAbsent) ? null : args[5] as void Function(double)?, min: identical(args[6], darticAbsent) ? 0.0 : args[6] as double, max: identical(args[7], darticAbsent) ? 1.0 : args[7] as double, divisions: identical(args[8], darticAbsent) ? null : args[8] as int?, label: identical(args[9], darticAbsent) ? null : args[9] as String?, activeColor: identical(args[10], darticAbsent) ? null : args[10] as Color?, inactiveColor: identical(args[11], darticAbsent) ? null : args[11] as Color?, secondaryActiveColor: identical(args[12], darticAbsent) ? null : args[12] as Color?, thumbColor: identical(args[13], darticAbsent) ? null : args[13] as Color?, overlayColor: identical(args[14], darticAbsent) ? null : args[14] as WidgetStateProperty<Color?>?, mouseCursor: identical(args[15], darticAbsent) ? null : args[15] as MouseCursor?, semanticFormatterCallback: identical(args[16], darticAbsent) ? null : args[16] as String Function(double)?, focusNode: identical(args[17], darticAbsent) ? null : args[17] as FocusNode?, autofocus: identical(args[18], darticAbsent) ? false : args[18] as bool, allowedInteraction: identical(args[19], darticAbsent) ? null : args[19] as SliderInteraction?, padding: identical(args[20], darticAbsent) ? null : args[20] as EdgeInsetsGeometry?, year2023: identical(args[21], darticAbsent) ? null : args[21] as bool?),
        'adaptive#21': (args) => Slider.adaptive(key: identical(args[0], darticAbsent) ? null : args[0] as Key?, value: args[1] as double, secondaryTrackValue: identical(args[2], darticAbsent) ? null : args[2] as double?, onChanged: args[3] as void Function(double)?, onChangeStart: identical(args[4], darticAbsent) ? null : args[4] as void Function(double)?, onChangeEnd: identical(args[5], darticAbsent) ? null : args[5] as void Function(double)?, min: identical(args[6], darticAbsent) ? 0.0 : args[6] as double, max: identical(args[7], darticAbsent) ? 1.0 : args[7] as double, divisions: identical(args[8], darticAbsent) ? null : args[8] as int?, label: identical(args[9], darticAbsent) ? null : args[9] as String?, mouseCursor: identical(args[10], darticAbsent) ? null : args[10] as MouseCursor?, activeColor: identical(args[11], darticAbsent) ? null : args[11] as Color?, inactiveColor: identical(args[12], darticAbsent) ? null : args[12] as Color?, secondaryActiveColor: identical(args[13], darticAbsent) ? null : args[13] as Color?, thumbColor: identical(args[14], darticAbsent) ? null : args[14] as Color?, overlayColor: identical(args[15], darticAbsent) ? null : args[15] as WidgetStateProperty<Color?>?, semanticFormatterCallback: identical(args[16], darticAbsent) ? null : args[16] as String Function(double)?, focusNode: identical(args[17], darticAbsent) ? null : args[17] as FocusNode?, autofocus: identical(args[18], darticAbsent) ? false : args[18] as bool, allowedInteraction: identical(args[19], darticAbsent) ? null : args[19] as SliderInteraction?, year2023: identical(args[20], darticAbsent) ? null : args[20] as bool?),
      };
}
