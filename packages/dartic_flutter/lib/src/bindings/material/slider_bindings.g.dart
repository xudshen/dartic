...
abstract final class SliderBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        '_#fromFields#23': (args) => Slider(key: args[7] as Key?, value: args[21] as double, secondaryTrackValue: args[18] as double?, onChanged: args[14] as ValueChanged<double>?, onChangeStart: args[13] as ValueChanged<double>?, onChangeEnd: args[12] as ValueChanged<double>?, min: args[10] as double, max: args[9] as double, divisions: args[4] as int?, label: args[8] as String?, activeColor: args[1] as Color?, inactiveColor: args[6] as Color?, secondaryActiveColor: args[17] as Color?, thumbColor: args[20] as Color?, overlayColor: args[15] as WidgetStateProperty<Color?>?, mouseCursor: args[11] as MouseCursor?, semanticFormatterCallback: args[19] as SemanticFormatterCallback?, focusNode: args[5] as FocusNode?, autofocus: args[3] as bool, allowedInteraction: args[2] as SliderInteraction?, padding: args[16] as EdgeInsetsGeometry?, year2023: args[22] as bool?),
      };
}
