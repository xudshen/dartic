...
class _$RoundedRectRangeSliderValueIndicatorShape extends RoundedRectRangeSliderValueIndicatorShape implements DarticObjectHolder {
  _$RoundedRectRangeSliderValueIndicatorShape(this._dispatch, this.$darticObject, List<Object?> superArgs);
...
/// private class.
Object createRoundedRectRangeSliderValueIndicatorShapeBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RoundedRectRangeSliderValueIndicatorShape(dispatch, obj, superArgs);
...
abstract final class RoundedRectRangeSliderValueIndicatorShapeBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RoundedRectRangeSliderValueIndicatorShape(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/material/range_slider_parts.dart::RoundedRectRangeSliderValueIndicatorShape::\$super\$getPreferredSize#4', (args) => (args[0] as _$RoundedRectRangeSliderValueIndicatorShape)._super$getPreferredSize(args[1] as bool, args[2] as bool, labelPainter: identical(args[3], darticAbsent) ? null : args[3] as TextPainter?, textScaleFactor: identical(args[4], darticAbsent) ? null : args[4] as double?));
    ctx.registerBinding('package:flutter/src/material/range_slider_parts.dart::RoundedRectRangeSliderValueIndicatorShape::\$super\$paint#14', (args) { (args[0] as _$RoundedRectRangeSliderValueIndicatorShape)._super$paint(args[1] as PaintingContext, args[2] as Offset, activationAnimation: args[3] as Animation<double>, enableAnimation: args[4] as Animation<double>, isDiscrete: identical(args[5], darticAbsent) ? null : args[5] as bool?, isOnTop: identical(args[6], darticAbsent) ? null : args[6] as bool?, labelPainter: args[7] as TextPainter, textScaleFactor: identical(args[8], darticAbsent) ? null : args[8] as double?, sizeWithOverflow: identical(args[9], darticAbsent) ? null : args[9] as Size?, parentBox: args[10] as RenderBox, sliderTheme: args[11] as SliderThemeData, textDirection: identical(args[12], darticAbsent) ? null : args[12] as TextDirection?, value: identical(args[13], darticAbsent) ? null : args[13] as double?, thumb: identical(args[14], darticAbsent) ? null : args[14] as Thumb?); return null; });
    ctx.registerBinding('package:flutter/src/material/range_slider_parts.dart::RoundedRectRangeSliderValueIndicatorShape::\$super\$toString#0', (args) => (args[0] as _$RoundedRectRangeSliderValueIndicatorShape)._super$toString());
    ctx.registerBinding('package:flutter/src/material/range_slider_parts.dart::RoundedRectRangeSliderValueIndicatorShape::\$super\$getHorizontalShift#6', (args) => (args[0] as _$RoundedRectRangeSliderValueIndicatorShape)._super$getHorizontalShift(parentBox: identical(args[1], darticAbsent) ? null : args[1] as RenderBox?, center: identical(args[2], darticAbsent) ? null : args[2] as Offset?, labelPainter: identical(args[3], darticAbsent) ? null : args[3] as TextPainter?, activationAnimation: identical(args[4], darticAbsent) ? null : args[4] as Animation<double>?, textScaleFactor: identical(args[5], darticAbsent) ? null : args[5] as double?, sizeWithOverflow: identical(args[6], darticAbsent) ? null : args[6] as Size?));
    ctx.registerBinding('package:flutter/src/material/range_slider_parts.dart::RoundedRectRangeSliderValueIndicatorShape::\$super\$hashCode#0', (args) => (args[0] as _$RoundedRectRangeSliderValueIndicatorShape)._super$hashCode);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#0': (args) => (args[0] as RoundedRectRangeSliderValueIndicatorShape).toString(),
        ...
        'hashCode#0': (args) => (args[0] as RoundedRectRangeSliderValueIndicatorShape).hashCode,
        '==#1': (args) => (args[0] as RoundedRectRangeSliderValueIndicatorShape) == (args[1] as Object),
