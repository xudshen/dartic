...
class _$TextSelectionTheme extends TextSelectionTheme implements DarticObjectHolder {
  _$TextSelectionTheme(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, data: superArgs[1] as TextSelectionThemeData, child: superArgs[2] as Widget);
  ...
  bool _super$updateShouldNotify(TextSelectionTheme oldWidget) => super.updateShouldNotify(oldWidget);
...
/// private class.
Object createTextSelectionThemeBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$TextSelectionTheme(dispatch, obj, superArgs);
...
abstract final class TextSelectionThemeBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$TextSelectionTheme(dispatch, darticObject, superArgs),
    );
    ...
    ctx.registerBinding('package:flutter/src/material/text_selection_theme.dart::TextSelectionTheme::\$super\$wrap#2', (args) => (args[0] as _$TextSelectionTheme)._super$wrap(args[1] as BuildContext, args[2] as Widget));
    ctx.registerBinding('package:flutter/src/material/text_selection_theme.dart::TextSelectionTheme::\$super\$updateShouldNotify#1', (args) => (args[0] as _$TextSelectionTheme)._super$updateShouldNotify(args[1] as TextSelectionTheme));
    ctx.registerBinding('package:flutter/src/material/text_selection_theme.dart::TextSelectionTheme::\$super\$toString#1', (args) => (args[0] as _$TextSelectionTheme)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/material/text_selection_theme.dart::TextSelectionTheme::\$super\$createElement#0', (args) => (args[0] as _$TextSelectionTheme)._super$createElement());
    ctx.registerBinding('package:flutter/src/material/text_selection_theme.dart::TextSelectionTheme::\$super\$toStringShort#0', (args) => (args[0] as _$TextSelectionTheme)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/material/text_selection_theme.dart::TextSelectionTheme::\$super\$debugFillProperties#1', (args) { (args[0] as _$TextSelectionTheme)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/material/text_selection_theme.dart::TextSelectionTheme::\$super\$toStringShallow#2', (args) => (args[0] as _$TextSelectionTheme)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/material/text_selection_theme.dart::TextSelectionTheme::\$super\$toStringDeep#4', (args) => (args[0] as _$TextSelectionTheme)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/material/text_selection_theme.dart::TextSelectionTheme::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$TextSelectionTheme)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#1': (args) => (args[0] as TextSelectionTheme).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
