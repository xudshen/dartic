...
class _$SegmentedButtonThemeData extends SegmentedButtonThemeData implements DarticObjectHolder {
  ...
  SegmentedButtonThemeData copyWith({ButtonStyle? style, Widget? selectedIcon}) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'copyWith', [style, selectedIcon]);
    if (identical(r, notOverridden)) return super.copyWith(style: style, selectedIcon: selectedIcon);
