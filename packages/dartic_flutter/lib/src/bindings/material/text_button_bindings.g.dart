...
class _$TextButton extends TextButton implements DarticObjectHolder {
  _$TextButton(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, onPressed: superArgs[1] as VoidCallback?, onLongPress: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as VoidCallback?, onHover: identical(superArgs[3], darticAbsent) ? null : superArgs[3] as ValueChanged<bool>?, onFocusChange: identical(superArgs[4], darticAbsent) ? null : superArgs[4] as ValueChanged<bool>?, style: identical(superArgs[5], darticAbsent) ? null : superArgs[5] as ButtonStyle?, focusNode: identical(superArgs[6], darticAbsent) ? null : superArgs[6] as FocusNode?, autofocus: superArgs[7] as bool, clipBehavior: identical(superArgs[8], darticAbsent) ? null : superArgs[8] as Clip?, statesController: identical(superArgs[9], darticAbsent) ? null : superArgs[9] as WidgetStatesController?, isSemanticButton: identical(superArgs[10], darticAbsent) ? null : superArgs[10] as bool?, child: superArgs[11] as Widget);
...
/// private class.
Object createTextButtonBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$TextButton(dispatch, obj, superArgs);
...
abstract final class TextButtonBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$TextButton(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::styleFrom#29', (args) => TextButton.styleFrom(foregroundColor: identical(args[0], darticAbsent) ? null : args[0] as Color?, backgroundColor: identical(args[1], darticAbsent) ? null : args[1] as Color?, disabledForegroundColor: identical(args[2], darticAbsent) ? null : args[2] as Color?, disabledBackgroundColor: identical(args[3], darticAbsent) ? null : args[3] as Color?, shadowColor: identical(args[4], darticAbsent) ? null : args[4] as Color?, surfaceTintColor: identical(args[5], darticAbsent) ? null : args[5] as Color?, iconColor: identical(args[6], darticAbsent) ? null : args[6] as Color?, iconSize: identical(args[7], darticAbsent) ? null : args[7] as double?, iconAlignment: identical(args[8], darticAbsent) ? null : args[8] as IconAlignment?, disabledIconColor: identical(args[9], darticAbsent) ? null : args[9] as Color?, overlayColor: identical(args[10], darticAbsent) ? null : args[10] as Color?, elevation: identical(args[11], darticAbsent) ? null : args[11] as double?, textStyle: identical(args[12], darticAbsent) ? null : args[12] as TextStyle?, padding: identical(args[13], darticAbsent) ? null : args[13] as EdgeInsetsGeometry?, minimumSize: identical(args[14], darticAbsent) ? null : args[14] as Size?, fixedSize: identical(args[15], darticAbsent) ? null : args[15] as Size?, maximumSize: identical(args[16], darticAbsent) ? null : args[16] as Size?, side: identical(args[17], darticAbsent) ? null : args[17] as BorderSide?, shape: identical(args[18], darticAbsent) ? null : args[18] as OutlinedBorder?, enabledMouseCursor: identical(args[19], darticAbsent) ? null : args[19] as MouseCursor?, disabledMouseCursor: identical(args[20], darticAbsent) ? null : args[20] as MouseCursor?, visualDensity: identical(args[21], darticAbsent) ? null : args[21] as VisualDensity?, tapTargetSize: identical(args[22], darticAbsent) ? null : args[22] as MaterialTapTargetSize?, animationDuration: identical(args[23], darticAbsent) ? null : args[23] as Duration?, enableFeedback: identical(args[24], darticAbsent) ? null : args[24] as bool?, alignment: identical(args[25], darticAbsent) ? null : args[25] as AlignmentGeometry?, splashFactory: identical(args[26], darticAbsent) ? null : args[26] as InteractiveInkFeatureFactory?, backgroundBuilder: identical(args[27], darticAbsent) ? null : (args[27] as Function?) == null ? null : (a, b, c) => (args[27] as Function?)!(a, b, c), foregroundBuilder: identical(args[28], darticAbsent) ? null : (args[28] as Function?) == null ? null : (a, b, c) => (args[28] as Function?)!(a, b, c)));
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$defaultStyleOf#1', (args) => (args[0] as _$TextButton)._super$defaultStyleOf(args[1] as BuildContext));
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$themeStyleOf#1', (args) => (args[0] as _$TextButton)._super$themeStyleOf(args[1] as BuildContext));
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$toString#1', (args) => (args[0] as _$TextButton)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$createState#0', (args) => (args[0] as _$TextButton)._super$createState());
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$debugFillProperties#1', (args) { (args[0] as _$TextButton)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$createElement#0', (args) => (args[0] as _$TextButton)._super$createElement());
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$toStringShort#0', (args) => (args[0] as _$TextButton)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$toStringShallow#2', (args) => (args[0] as _$TextButton)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$toStringDeep#4', (args) => (args[0] as _$TextButton)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$TextButton)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$TextButton)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$hashCode#0', (args) => (args[0] as _$TextButton)._super$hashCode);
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$onPressed#0', (args) => (args[0] as _$TextButton)._super$onPressed);
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$onLongPress#0', (args) => (args[0] as _$TextButton)._super$onLongPress);
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$onHover#0', (args) => (args[0] as _$TextButton)._super$onHover);
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$onFocusChange#0', (args) => (args[0] as _$TextButton)._super$onFocusChange);
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$style#0', (args) => (args[0] as _$TextButton)._super$style);
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$clipBehavior#0', (args) => (args[0] as _$TextButton)._super$clipBehavior);
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$focusNode#0', (args) => (args[0] as _$TextButton)._super$focusNode);
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$autofocus#0', (args) => (args[0] as _$TextButton)._super$autofocus);
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$statesController#0', (args) => (args[0] as _$TextButton)._super$statesController);
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$isSemanticButton#0', (args) => (args[0] as _$TextButton)._super$isSemanticButton);
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$iconAlignment#0', (args) => (args[0] as _$TextButton)._super$iconAlignment);
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$tooltip#0', (args) => (args[0] as _$TextButton)._super$tooltip);
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$child#0', (args) => (args[0] as _$TextButton)._super$child);
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$enabled#0', (args) => (args[0] as _$TextButton)._super$enabled);
    ctx.registerBinding('package:flutter/src/material/text_button.dart::TextButton::\$super\$key#0', (args) => (args[0] as _$TextButton)._super$key);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toStringShallow#2': (args) => (args[0] as TextButton).toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel),
        'toStringDeep#4': (args) => (args[0] as TextButton).toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int),
        'toDiagnosticsNode#2': (args) => (args[0] as TextButton).toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?),
        'debugDescribeChildren#0': (args) => (args[0] as TextButton).debugDescribeChildren(),
        'hashCode#0': (args) => (args[0] as TextButton).hashCode,
        ...
        '==#1': (args) => (args[0] as TextButton) == (args[1] as Object),
