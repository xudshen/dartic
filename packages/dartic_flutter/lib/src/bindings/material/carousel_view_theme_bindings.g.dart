...
class _$CarouselViewTheme extends CarouselViewTheme implements DarticObjectHolder {
  _$CarouselViewTheme(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, data: superArgs[1] as CarouselViewThemeData, child: superArgs[2] as Widget);
  ...
  bool _super$updateShouldNotify(CarouselViewTheme oldWidget) => super.updateShouldNotify(oldWidget);
...
/// private class.
Object createCarouselViewThemeBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$CarouselViewTheme(dispatch, obj, superArgs);
...
abstract final class CarouselViewThemeBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$CarouselViewTheme(dispatch, darticObject, superArgs),
    );
    ...
    ctx.registerBinding('package:flutter/src/material/carousel_theme.dart::CarouselViewTheme::\$super\$wrap#2', (args) => (args[0] as _$CarouselViewTheme)._super$wrap(args[1] as BuildContext, args[2] as Widget));
    ctx.registerBinding('package:flutter/src/material/carousel_theme.dart::CarouselViewTheme::\$super\$updateShouldNotify#1', (args) => (args[0] as _$CarouselViewTheme)._super$updateShouldNotify(args[1] as CarouselViewTheme));
    ctx.registerBinding('package:flutter/src/material/carousel_theme.dart::CarouselViewTheme::\$super\$toString#1', (args) => (args[0] as _$CarouselViewTheme)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/material/carousel_theme.dart::CarouselViewTheme::\$super\$createElement#0', (args) => (args[0] as _$CarouselViewTheme)._super$createElement());
    ctx.registerBinding('package:flutter/src/material/carousel_theme.dart::CarouselViewTheme::\$super\$toStringShort#0', (args) => (args[0] as _$CarouselViewTheme)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/material/carousel_theme.dart::CarouselViewTheme::\$super\$debugFillProperties#1', (args) { (args[0] as _$CarouselViewTheme)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/material/carousel_theme.dart::CarouselViewTheme::\$super\$toStringShallow#2', (args) => (args[0] as _$CarouselViewTheme)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/material/carousel_theme.dart::CarouselViewTheme::\$super\$toStringDeep#4', (args) => (args[0] as _$CarouselViewTheme)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'hashCode#0': (args) => (args[0] as CarouselViewTheme).hashCode,
        'child#0': (args) => (args[0] as CarouselViewTheme).child,
        'key#0': (args) => (args[0] as CarouselViewTheme).key,
        '==#1': (args) => (args[0] as CarouselViewTheme) == (args[1] as Object),
