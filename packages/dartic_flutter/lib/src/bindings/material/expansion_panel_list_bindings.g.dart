  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        '#9': (args) {
          if (identical(args[4], darticAbsent)) {
            return ExpansionPanelList(key: identical(args[0], darticAbsent) ? null : args[0] as Key?, children: identical(args[1], darticAbsent) ? const <ExpansionPanel>[] : (args[1] as List).cast<ExpansionPanel>(), expansionCallback: identical(args[2], darticAbsent) ? null : (args[2] as Function?) == null ? null : (a, b) => (args[2] as Function?)!(a, b), animationDuration: identical(args[3], darticAbsent) ? kThemeAnimationDuration : args[3] as Duration, dividerColor: identical(args[5], darticAbsent) ? null : args[5] as Color?, elevation: identical(args[6], darticAbsent) ? 2 : args[6] as double, expandIconColor: identical(args[7], darticAbsent) ? null : args[7] as Color?, materialGapSize: identical(args[8], darticAbsent) ? 16.0 : args[8] as double);
          } else {
            return ExpansionPanelList(key: identical(args[0], darticAbsent) ? null : args[0] as Key?, children: identical(args[1], darticAbsent) ? const <ExpansionPanel>[] : (args[1] as List).cast<ExpansionPanel>(), expansionCallback: identical(args[2], darticAbsent) ? null : (args[2] as Function?) == null ? null : (a, b) => (args[2] as Function?)!(a, b), animationDuration: identical(args[3], darticAbsent) ? kThemeAnimationDuration : args[3] as Duration, expandedHeaderPadding: args[4] as EdgeInsets, dividerColor: identical(args[5], darticAbsent) ? null : args[5] as Color?, elevation: identical(args[6], darticAbsent) ? 2 : args[6] as double, expandIconColor: identical(args[7], darticAbsent) ? null : args[7] as Color?, materialGapSize: identical(args[8], darticAbsent) ? 16.0 : args[8] as double);
          }
        },
        'radio#10': (args) {
          if (identical(args[5], darticAbsent)) {
            return ExpansionPanelList.radio(key: identical(args[0], darticAbsent) ? null : args[0] as Key?, children: identical(args[1], darticAbsent) ? const <ExpansionPanelRadio>[] : (args[1] as List).cast<ExpansionPanel>(), expansionCallback: identical(args[2], darticAbsent) ? null : (args[2] as Function?) == null ? null : (a, b) => (args[2] as Function?)!(a, b), animationDuration: identical(args[3], darticAbsent) ? kThemeAnimationDuration : args[3] as Duration, initialOpenPanelValue: identical(args[4], darticAbsent) ? null : args[4], dividerColor: identical(args[6], darticAbsent) ? null : args[6] as Color?, elevation: identical(args[7], darticAbsent) ? 2 : args[7] as double, expandIconColor: identical(args[8], darticAbsent) ? null : args[8] as Color?, materialGapSize: identical(args[9], darticAbsent) ? 16.0 : args[9] as double);
          } else {
            return ExpansionPanelList.radio(key: identical(args[0], darticAbsent) ? null : args[0] as Key?, children: identical(args[1], darticAbsent) ? const <ExpansionPanelRadio>[] : (args[1] as List).cast<ExpansionPanel>(), expansionCallback: identical(args[2], darticAbsent) ? null : (args[2] as Function?) == null ? null : (a, b) => (args[2] as Function?)!(a, b), animationDuration: identical(args[3], darticAbsent) ? kThemeAnimationDuration : args[3] as Duration, initialOpenPanelValue: identical(args[4], darticAbsent) ? null : args[4], expandedHeaderPadding: args[5] as EdgeInsets, dividerColor: identical(args[6], darticAbsent) ? null : args[6] as Color?, elevation: identical(args[7], darticAbsent) ? 2 : args[7] as double, expandIconColor: identical(args[8], darticAbsent) ? null : args[8] as Color?, materialGapSize: identical(args[9], darticAbsent) ? 16.0 : args[9] as double);
          }
        },
        '_#fromFields#11': (args) => ExpansionPanelList.radio(key: args[9] as Key?, children: (args[2] as List).cast<ExpansionPanel>(), expansionCallback: args[7] as ExpansionPanelCallback?, animationDuration: args[1] as Duration, initialOpenPanelValue: args[8], expandedHeaderPadding: args[6] as EdgeInsets, dividerColor: args[3] as Color?, elevation: args[4] as double, expandIconColor: args[5] as Color?, materialGapSize: args[10] as double),
      };
}
