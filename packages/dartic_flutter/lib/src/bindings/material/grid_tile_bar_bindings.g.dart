...
class _$GridTileBar extends GridTileBar implements DarticObjectHolder {
  _$GridTileBar(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, backgroundColor: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as Color?, leading: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as Widget?, title: identical(superArgs[3], darticAbsent) ? null : superArgs[3] as Widget?, subtitle: identical(superArgs[4], darticAbsent) ? null : superArgs[4] as Widget?, trailing: identical(superArgs[5], darticAbsent) ? null : superArgs[5] as Widget?);
...
/// private class.
Object createGridTileBarBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$GridTileBar(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$GridTileBar(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/material/grid_tile_bar.dart::GridTileBar::\$super\$build#1', (args) => (args[0] as _$GridTileBar)._super$build(args[1] as BuildContext));
    ctx.registerBinding('package:flutter/src/material/grid_tile_bar.dart::GridTileBar::\$super\$toString#1', (args) => (args[0] as _$GridTileBar)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/material/grid_tile_bar.dart::GridTileBar::\$super\$createElement#0', (args) => (args[0] as _$GridTileBar)._super$createElement());
    ctx.registerBinding('package:flutter/src/material/grid_tile_bar.dart::GridTileBar::\$super\$toStringShort#0', (args) => (args[0] as _$GridTileBar)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/material/grid_tile_bar.dart::GridTileBar::\$super\$debugFillProperties#1', (args) { (args[0] as _$GridTileBar)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/material/grid_tile_bar.dart::GridTileBar::\$super\$toStringShallow#2', (args) => (args[0] as _$GridTileBar)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/material/grid_tile_bar.dart::GridTileBar::\$super\$toStringDeep#4', (args) => (args[0] as _$GridTileBar)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/material/grid_tile_bar.dart::GridTileBar::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$GridTileBar)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/material/grid_tile_bar.dart::GridTileBar::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$GridTileBar)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/material/grid_tile_bar.dart::GridTileBar::\$super\$backgroundColor#0', (args) => (args[0] as _$GridTileBar)._super$backgroundColor);
    ctx.registerBinding('package:flutter/src/material/grid_tile_bar.dart::GridTileBar::\$super\$leading#0', (args) => (args[0] as _$GridTileBar)._super$leading);
