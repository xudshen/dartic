...
class _$TooltipState extends TooltipState implements DarticObjectHolder {
  ...
  bool ensureTooltipVisible() {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'ensureTooltipVisible', const []);
    if (identical(r, notOverridden)) return super.ensureTooltipVisible();
    return r as bool;
  }
