...
class _$SearchController extends SearchController implements DarticObjectHolder {
  ...
  @override
  void openView() {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'openView', const []);
    if (identical(_$r, notOverridden)) { super.openView(); return; }
  }

  @override
  void closeView(String? selectedText) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'closeView', [selectedText]);
    if (identical(_$r, notOverridden)) { super.closeView(selectedText); return; }
  }
