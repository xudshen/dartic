...
class _$OutlinedButton extends OutlinedButton implements DarticObjectHolder {
  _$OutlinedButton(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, onPressed: superArgs[1] as VoidCallback?, onLongPress: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as VoidCallback?, onHover: identical(superArgs[3], darticAbsent) ? null : superArgs[3] as ValueChanged<bool>?, onFocusChange: identical(superArgs[4], darticAbsent) ? null : superArgs[4] as ValueChanged<bool>?, style: identical(superArgs[5], darticAbsent) ? null : superArgs[5] as ButtonStyle?, focusNode: identical(superArgs[6], darticAbsent) ? null : superArgs[6] as FocusNode?, autofocus: superArgs[7] as bool, clipBehavior: identical(superArgs[8], darticAbsent) ? null : superArgs[8] as Clip?, statesController: identical(superArgs[9], darticAbsent) ? null : superArgs[9] as WidgetStatesController?, child: superArgs[10] as Widget?);
  ...
  State<ButtonStyleButton> createState() {
    ...
    return _$r as State<ButtonStyleButton>;
  }
...
/// private class.
Object createOutlinedButtonBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$OutlinedButton(dispatch, obj, superArgs);
...
abstract final class OutlinedButtonBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$OutlinedButton(dispatch, darticObject, superArgs),
    );
    ...
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$defaultStyleOf#1', (args) => (args[0] as _$OutlinedButton)._super$defaultStyleOf(args[1] as BuildContext));
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$themeStyleOf#1', (args) => (args[0] as _$OutlinedButton)._super$themeStyleOf(args[1] as BuildContext));
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$toString#1', (args) => (args[0] as _$OutlinedButton)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$createState#0', (args) => (args[0] as _$OutlinedButton)._super$createState());
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$debugFillProperties#1', (args) { (args[0] as _$OutlinedButton)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$createElement#0', (args) => (args[0] as _$OutlinedButton)._super$createElement());
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$toStringShort#0', (args) => (args[0] as _$OutlinedButton)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$toStringShallow#2', (args) => (args[0] as _$OutlinedButton)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$toStringDeep#4', (args) => (args[0] as _$OutlinedButton)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$OutlinedButton)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$OutlinedButton)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$hashCode#0', (args) => (args[0] as _$OutlinedButton)._super$hashCode);
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$onPressed#0', (args) => (args[0] as _$OutlinedButton)._super$onPressed);
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$onLongPress#0', (args) => (args[0] as _$OutlinedButton)._super$onLongPress);
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$onHover#0', (args) => (args[0] as _$OutlinedButton)._super$onHover);
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$onFocusChange#0', (args) => (args[0] as _$OutlinedButton)._super$onFocusChange);
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$style#0', (args) => (args[0] as _$OutlinedButton)._super$style);
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$clipBehavior#0', (args) => (args[0] as _$OutlinedButton)._super$clipBehavior);
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$focusNode#0', (args) => (args[0] as _$OutlinedButton)._super$focusNode);
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$autofocus#0', (args) => (args[0] as _$OutlinedButton)._super$autofocus);
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$statesController#0', (args) => (args[0] as _$OutlinedButton)._super$statesController);
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$isSemanticButton#0', (args) => (args[0] as _$OutlinedButton)._super$isSemanticButton);
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$iconAlignment#0', (args) => (args[0] as _$OutlinedButton)._super$iconAlignment);
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$tooltip#0', (args) => (args[0] as _$OutlinedButton)._super$tooltip);
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$child#0', (args) => (args[0] as _$OutlinedButton)._super$child);
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$enabled#0', (args) => (args[0] as _$OutlinedButton)._super$enabled);
    ctx.registerBinding('package:flutter/src/material/outlined_button.dart::OutlinedButton::\$super\$key#0', (args) => (args[0] as _$OutlinedButton)._super$key);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#1': (args) => (args[0] as OutlinedButton).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
        ...
        'hashCode#0': (args) => (args[0] as OutlinedButton).hashCode,
        ...
        '==#1': (args) => (args[0] as OutlinedButton) == (args[1] as Object),
        '#11': (args) => OutlinedButton(key: identical(args[0], darticAbsent) ? null : args[0] as Key?, onPressed: (args[1] as Function?) == null ? null : () => (args[1] as Function?)!(), onLongPress: identical(args[2], darticAbsent) ? null : (args[2] as Function?) == null ? null : () => (args[2] as Function?)!(), onHover: identical(args[3], darticAbsent) ? null : (args[3] as Function?) == null ? null : (a) => (args[3] as Function?)!(a), onFocusChange: identical(args[4], darticAbsent) ? null : (args[4] as Function?) == null ? null : (a) => (args[4] as Function?)!(a), style: identical(args[5], darticAbsent) ? null : args[5] as ButtonStyle?, focusNode: identical(args[6], darticAbsent) ? null : args[6] as FocusNode?, autofocus: identical(args[7], darticAbsent) ? false : args[7] as bool, clipBehavior: identical(args[8], darticAbsent) ? null : args[8] as Clip?, statesController: identical(args[9], darticAbsent) ? null : args[9] as WidgetStatesController?, child: args[10] as Widget?),
        'icon#13': (args) => OutlinedButton.icon(key: identical(args[0], darticAbsent) ? null : args[0] as Key?, onPressed: (args[1] as Function?) == null ? null : () => (args[1] as Function?)!(), onLongPress: identical(args[2], darticAbsent) ? null : (args[2] as Function?) == null ? null : () => (args[2] as Function?)!(), onHover: identical(args[3], darticAbsent) ? null : (args[3] as Function?) == null ? null : (a) => (args[3] as Function?)!(a), onFocusChange: identical(args[4], darticAbsent) ? null : (args[4] as Function?) == null ? null : (a) => (args[4] as Function?)!(a), style: identical(args[5], darticAbsent) ? null : args[5] as ButtonStyle?, focusNode: identical(args[6], darticAbsent) ? null : args[6] as FocusNode?, autofocus: identical(args[7], darticAbsent) ? false : args[7] as bool, clipBehavior: identical(args[8], darticAbsent) ? null : args[8] as Clip?, statesController: identical(args[9], darticAbsent) ? null : args[9] as WidgetStatesController?, icon: identical(args[10], darticAbsent) ? null : args[10] as Widget?, label: args[11] as Widget, iconAlignment: identical(args[12], darticAbsent) ? null : args[12] as IconAlignment?),
        '_#fromFields#15': (args) => OutlinedButton(key: args[7] as Key?, onPressed: args[11] as VoidCallback?, onLongPress: args[10] as VoidCallback?, onHover: args[9] as ValueChanged<bool>?, onFocusChange: args[8] as ValueChanged<bool>?, style: args[13] as ButtonStyle?, focusNode: args[4] as FocusNode?, autofocus: args[1] as bool, clipBehavior: args[3] as Clip?, statesController: args[12] as WidgetStatesController?, child: args[2] as Widget?),
      };
}
