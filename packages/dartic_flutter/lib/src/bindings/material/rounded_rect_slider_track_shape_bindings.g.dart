...
class _$RoundedRectSliderTrackShape extends RoundedRectSliderTrackShape implements DarticObjectHolder {
  _$RoundedRectSliderTrackShape(this._dispatch, this.$darticObject, List<Object?> superArgs);
  ...
  void paint(PaintingContext context, Offset offset, {required RenderBox parentBox, required SliderThemeData sliderTheme, required Animation<double> enableAnimation, required TextDirection textDirection, required Offset thumbCenter, Offset? secondaryOffset, bool isDiscrete = false, bool isEnabled = false, double additionalActiveTrackHeight = 2}) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'paint', [context, offset, parentBox, sliderTheme, enableAnimation, textDirection, thumbCenter, secondaryOffset, isDiscrete, isEnabled, additionalActiveTrackHeight]);
...
/// private class.
Object createRoundedRectSliderTrackShapeBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RoundedRectSliderTrackShape(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RoundedRectSliderTrackShape(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/material/slider_parts.dart::RoundedRectSliderTrackShape::\$super\$paint#11', (args) { (args[0] as _$RoundedRectSliderTrackShape)._super$paint(args[1] as PaintingContext, args[2] as Offset, parentBox: args[3] as RenderBox, sliderTheme: args[4] as SliderThemeData, enableAnimation: args[5] as Animation<double>, textDirection: args[6] as TextDirection, thumbCenter: args[7] as Offset, secondaryOffset: identical(args[8], darticAbsent) ? null : args[8] as Offset?, isDiscrete: identical(args[9], darticAbsent) ? false : args[9] as bool, isEnabled: identical(args[10], darticAbsent) ? false : args[10] as bool, additionalActiveTrackHeight: identical(args[11], darticAbsent) ? 2 : args[11] as double); return null; });
    ctx.registerBinding('package:flutter/src/material/slider_parts.dart::RoundedRectSliderTrackShape::\$super\$toString#0', (args) => (args[0] as _$RoundedRectSliderTrackShape)._super$toString());
    ctx.registerBinding('package:flutter/src/material/slider_parts.dart::RoundedRectSliderTrackShape::\$super\$getPreferredRect#5', (args) => (args[0] as _$RoundedRectSliderTrackShape)._super$getPreferredRect(parentBox: args[1] as RenderBox, offset: identical(args[2], darticAbsent) ? Offset.zero : args[2] as Offset, sliderTheme: args[3] as SliderThemeData, isEnabled: identical(args[4], darticAbsent) ? false : args[4] as bool, isDiscrete: identical(args[5], darticAbsent) ? false : args[5] as bool));
    ctx.registerBinding('package:flutter/src/material/slider_parts.dart::RoundedRectSliderTrackShape::\$super\$isRounded#0', (args) => (args[0] as _$RoundedRectSliderTrackShape)._super$isRounded);
    ctx.registerBinding('package:flutter/src/material/slider_parts.dart::RoundedRectSliderTrackShape::\$super\$hashCode#0', (args) => (args[0] as _$RoundedRectSliderTrackShape)._super$hashCode);
  }
