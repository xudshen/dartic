...
class _$Drawer extends Drawer implements DarticObjectHolder {
  _$Drawer(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(key: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Key?, backgroundColor: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as Color?, elevation: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as double?, shadowColor: identical(superArgs[3], darticAbsent) ? null : superArgs[3] as Color?, surfaceTintColor: identical(superArgs[4], darticAbsent) ? null : superArgs[4] as Color?, shape: identical(superArgs[5], darticAbsent) ? null : superArgs[5] as ShapeBorder?, width: identical(superArgs[6], darticAbsent) ? null : superArgs[6] as double?, child: identical(superArgs[7], darticAbsent) ? null : superArgs[7] as Widget?, semanticLabel: identical(superArgs[8], darticAbsent) ? null : superArgs[8] as String?, clipBehavior: identical(superArgs[9], darticAbsent) ? null : superArgs[9] as Clip?);
...
/// private class.
Object createDrawerBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$Drawer(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$Drawer(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/material/drawer.dart::Drawer::\$super\$build#1', (args) => (args[0] as _$Drawer)._super$build(args[1] as BuildContext));
    ctx.registerBinding('package:flutter/src/material/drawer.dart::Drawer::\$super\$toString#1', (args) => (args[0] as _$Drawer)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/material/drawer.dart::Drawer::\$super\$createElement#0', (args) => (args[0] as _$Drawer)._super$createElement());
    ctx.registerBinding('package:flutter/src/material/drawer.dart::Drawer::\$super\$toStringShort#0', (args) => (args[0] as _$Drawer)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/material/drawer.dart::Drawer::\$super\$debugFillProperties#1', (args) { (args[0] as _$Drawer)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/material/drawer.dart::Drawer::\$super\$toStringShallow#2', (args) => (args[0] as _$Drawer)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/material/drawer.dart::Drawer::\$super\$toStringDeep#4', (args) => (args[0] as _$Drawer)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/material/drawer.dart::Drawer::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$Drawer)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/material/drawer.dart::Drawer::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$Drawer)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/material/drawer.dart::Drawer::\$super\$backgroundColor#0', (args) => (args[0] as _$Drawer)._super$backgroundColor);
    ctx.registerBinding('package:flutter/src/material/drawer.dart::Drawer::\$super\$elevation#0', (args) => (args[0] as _$Drawer)._super$elevation);
    ctx.registerBinding('package:flutter/src/material/drawer.dart::Drawer::\$super\$shadowColor#0', (args) => (args[0] as _$Drawer)._super$shadowColor);
    ctx.registerBinding('package:flutter/src/material/drawer.dart::Drawer::\$super\$surfaceTintColor#0', (args) => (args[0] as _$Drawer)._super$surfaceTintColor);
    ctx.registerBinding('package:flutter/src/material/drawer.dart::Drawer::\$super\$shape#0', (args) => (args[0] as _$Drawer)._super$shape);
    ctx.registerBinding('package:flutter/src/material/drawer.dart::Drawer::\$super\$width#0', (args) => (args[0] as _$Drawer)._super$width);
