...
abstract final class RefreshIndicatorBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        '_#fromFields#15': (args) => RefreshIndicator(key: args[7] as Key?, child: args[2] as Widget, displacement: args[4] as double, edgeOffset: args[5] as double, onRefresh: args[9] as RefreshCallback, color: args[3] as Color?, backgroundColor: args[1] as Color?, notificationPredicate: args[8] as ScrollNotificationPredicate, semanticsLabel: args[11] as String?, semanticsValue: args[12] as String?, strokeWidth: args[13] as double, triggerMode: args[14] as RefreshIndicatorTriggerMode, elevation: args[6] as double),
      };
}
