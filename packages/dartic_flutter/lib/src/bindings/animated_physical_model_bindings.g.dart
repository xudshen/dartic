...
abstract final class AnimatedPhysicalModelBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        '_#fromFields#9': (args) => AnimatedPhysicalModel(animateColor: args[0] as bool, animateShadowColor: args[1] as bool, borderRadius: args[2] as BorderRadius?, child: args[3] as Widget, clipBehavior: args[4] as Clip, color: args[5] as Color, elevation: args[6] as double, shadowColor: args[7] as Color, shape: args[8] as BoxShape),
      };
}
