...
class _$AnimationStyle extends AnimationStyle implements DarticObjectHolder {
  ...
  AnimationStyle copyWith({Curve? curve, Duration? duration, Curve? reverseCurve, Duration? reverseDuration}) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'copyWith', [curve, duration, reverseCurve, reverseDuration]);
    if (identical(r, notOverridden)) return super.copyWith(curve: curve, duration: duration, reverseCurve: reverseCurve, reverseDuration: reverseDuration);
