...
class _$AnimationMin extends AnimationMin<num> implements DarticObjectHolder {
  _$AnimationMin(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(superArgs[0] as Animation<num>, superArgs[1] as Animation<num>);
...
/// private class.
Object createAnimationMinBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$AnimationMin(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$AnimationMin(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/animation/animations.dart::AnimationMin::\$super\$toString#0', (args) => (args[0] as _$AnimationMin)._super$toString());
    ctx.registerBinding('package:flutter/src/animation/animations.dart::AnimationMin::\$super\$didStartListening#0', (args) { (args[0] as _$AnimationMin)._super$didStartListening(); return null; });
    ctx.registerBinding('package:flutter/src/animation/animations.dart::AnimationMin::\$super\$didStopListening#0', (args) { (args[0] as _$AnimationMin)._super$didStopListening(); return null; });
    ctx.registerBinding('package:flutter/src/animation/animations.dart::AnimationMin::\$super\$addListener#1', (args) { (args[0] as _$AnimationMin)._super$addListener(() => (args[1] as Function)()); return null; });
    ctx.registerBinding('package:flutter/src/animation/animations.dart::AnimationMin::\$super\$removeListener#1', (args) { (args[0] as _$AnimationMin)._super$removeListener(() => (args[1] as Function)()); return null; });
    ctx.registerBinding('package:flutter/src/animation/animations.dart::AnimationMin::\$super\$addStatusListener#1', (args) { (args[0] as _$AnimationMin)._super$addStatusListener((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/animation/animations.dart::AnimationMin::\$super\$removeStatusListener#1', (args) { (args[0] as _$AnimationMin)._super$removeStatusListener((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/animation/animations.dart::AnimationMin::\$super\$toStringDetails#0', (args) => (args[0] as _$AnimationMin)._super$toStringDetails());
    ctx.registerBinding('package:flutter/src/animation/animations.dart::AnimationMin::\$super\$clearListeners#0', (args) { (args[0] as _$AnimationMin)._super$clearListeners(); return null; });
    ctx.registerBinding('package:flutter/src/animation/animations.dart::AnimationMin::\$super\$notifyListeners#0', (args) { (args[0] as _$AnimationMin)._super$notifyListeners(); return null; });
    ctx.registerBinding('package:flutter/src/animation/animations.dart::AnimationMin::\$super\$clearStatusListeners#0', (args) { (args[0] as _$AnimationMin)._super$clearStatusListeners(); return null; });
    ctx.registerBinding('package:flutter/src/animation/animations.dart::AnimationMin::\$super\$notifyStatusListeners#1', (args) { (args[0] as _$AnimationMin)._super$notifyStatusListeners(args[1] as AnimationStatus); return null; });
    ctx.registerBinding('package:flutter/src/animation/animations.dart::AnimationMin::\$super\$value#0', (args) => (args[0] as _$AnimationMin)._super$value);
    ctx.registerBinding('package:flutter/src/animation/animations.dart::AnimationMin::\$super\$hashCode#0', (args) => (args[0] as _$AnimationMin)._super$hashCode);
    ctx.registerBinding('package:flutter/src/animation/animations.dart::AnimationMin::\$super\$first#0', (args) => (args[0] as _$AnimationMin)._super$first);
    ctx.registerBinding('package:flutter/src/animation/animations.dart::AnimationMin::\$super\$next#0', (args) => (args[0] as _$AnimationMin)._super$next);
    ctx.registerBinding('package:flutter/src/animation/animations.dart::AnimationMin::\$super\$status#0', (args) => (args[0] as _$AnimationMin)._super$status);
    ctx.registerBinding('package:flutter/src/animation/animations.dart::AnimationMin::\$super\$isDismissed#0', (args) => (args[0] as _$AnimationMin)._super$isDismissed);
    ctx.registerBinding('package:flutter/src/animation/animations.dart::AnimationMin::\$super\$isCompleted#0', (args) => (args[0] as _$AnimationMin)._super$isCompleted);
    ctx.registerBinding('package:flutter/src/animation/animations.dart::AnimationMin::\$super\$isAnimating#0', (args) => (args[0] as _$AnimationMin)._super$isAnimating);
    ctx.registerBinding('package:flutter/src/animation/animations.dart::AnimationMin::\$super\$isForwardOrCompleted#0', (args) => (args[0] as _$AnimationMin)._super$isForwardOrCompleted);
    ctx.registerBinding('package:flutter/src/animation/animations.dart::AnimationMin::\$super\$isListening#0', (args) => (args[0] as _$AnimationMin)._super$isListening);
  }
