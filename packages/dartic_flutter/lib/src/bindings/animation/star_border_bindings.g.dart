...
abstract final class StarBorderBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'getInnerPath#2': (args) => (args[0] as StarBorder).getInnerPath(args[1] as Rect, textDirection: identical(args[2], darticAbsent) ? null : args[2] as TextDirection?),
        'getOuterPath#2': (args) => (args[0] as StarBorder).getOuterPath(args[1] as Rect, textDirection: identical(args[2], darticAbsent) ? null : args[2] as TextDirection?),
        'paint#3': (args) { (args[0] as StarBorder).paint(args[1] as Canvas, args[2] as Rect, textDirection: identical(args[3], darticAbsent) ? null : args[3] as TextDirection?); return null; },
        ...
        'paintInterior#4': (args) { (args[0] as StarBorder).paintInterior(args[1] as Canvas, args[2] as Rect, args[3] as Paint, textDirection: identical(args[4], darticAbsent) ? null : args[4] as TextDirection?); return null; },
