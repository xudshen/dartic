...
abstract final class RichTextBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        '#15': (args) => RichText(key: identical(args[0], darticAbsent) ? null : args[0] as Key?, text: args[1] as InlineSpan, textAlign: identical(args[2], darticAbsent) ? TextAlign.start : args[2] as TextAlign, textDirection: identical(args[3], darticAbsent) ? null : args[3] as TextDirection?, softWrap: identical(args[4], darticAbsent) ? true : args[4] as bool, overflow: identical(args[5], darticAbsent) ? TextOverflow.clip : args[5] as TextOverflow, textScaleFactor: identical(args[6], darticAbsent) ? 1.0 : args[6] as double, textScaler: identical(args[7], darticAbsent) ? TextScaler.noScaling : args[7] as TextScaler, maxLines: identical(args[8], darticAbsent) ? null : args[8] as int?, locale: identical(args[9], darticAbsent) ? null : args[9] as Locale?, strutStyle: identical(args[10], darticAbsent) ? null : args[10] as StrutStyle?, textWidthBasis: identical(args[11], darticAbsent) ? TextWidthBasis.parent : args[11] as TextWidthBasis, textHeightBehavior: identical(args[12], darticAbsent) ? null : args[12] as TextHeightBehavior?, selectionRegistrar: identical(args[13], darticAbsent) ? null : args[13] as SelectionRegistrar?, selectionColor: identical(args[14], darticAbsent) ? null : args[14] as Color?),
      };
}
