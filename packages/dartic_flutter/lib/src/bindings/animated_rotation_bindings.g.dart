...
abstract final class AnimatedRotationBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        '_#fromFields#4': (args) => AnimatedRotation(alignment: args[0] as Alignment, child: args[1] as Widget?, filterQuality: args[2] as FilterQuality?, turns: args[3] as double),
      };
}
