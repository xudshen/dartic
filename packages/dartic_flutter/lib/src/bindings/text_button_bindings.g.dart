...
abstract final class TextButtonBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        '#12': (args) => TextButton(key: identical(args[0], darticAbsent) ? null : args[0] as Key?, onPressed: args[1] as void Function()?, onLongPress: identical(args[2], darticAbsent) ? null : args[2] as void Function()?, onHover: identical(args[3], darticAbsent) ? null : args[3] as void Function(bool)?, onFocusChange: identical(args[4], darticAbsent) ? null : args[4] as void Function(bool)?, style: identical(args[5], darticAbsent) ? null : args[5] as ButtonStyle?, focusNode: identical(args[6], darticAbsent) ? null : args[6] as FocusNode?, autofocus: identical(args[7], darticAbsent) ? false : args[7] as bool, clipBehavior: identical(args[8], darticAbsent) ? null : args[8] as Clip?, statesController: identical(args[9], darticAbsent) ? null : args[9] as WidgetStatesController?, isSemanticButton: identical(args[10], darticAbsent) ? null : args[10] as bool?, child: args[11] as Widget),
        'icon#13': (args) => TextButton.icon(key: identical(args[0], darticAbsent) ? null : args[0] as Key?, onPressed: args[1] as void Function()?, onLongPress: identical(args[2], darticAbsent) ? null : args[2] as void Function()?, onHover: identical(args[3], darticAbsent) ? null : args[3] as void Function(bool)?, onFocusChange: identical(args[4], darticAbsent) ? null : args[4] as void Function(bool)?, style: identical(args[5], darticAbsent) ? null : args[5] as ButtonStyle?, focusNode: identical(args[6], darticAbsent) ? null : args[6] as FocusNode?, autofocus: identical(args[7], darticAbsent) ? null : args[7] as bool?, clipBehavior: identical(args[8], darticAbsent) ? null : args[8] as Clip?, statesController: identical(args[9], darticAbsent) ? null : args[9] as WidgetStatesController?, icon: identical(args[10], darticAbsent) ? null : args[10] as Widget?, label: args[11] as Widget, iconAlignment: identical(args[12], darticAbsent) ? null : args[12] as IconAlignment?),
        '_#fromFields#0': (args) => TextButton(),
      };
}
