...
class _$CircleBorder extends CircleBorder implements DarticObjectHolder {
  ...
  CircleBorder copyWith({BorderSide? side, double? eccentricity}) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'copyWith', [side, eccentricity]);
    if (identical(_$r, notOverridden)) return super.copyWith(side: side, eccentricity: eccentricity);
    return _$r as CircleBorder;
  }
