...
class _$StarBorder extends StarBorder implements DarticObjectHolder {
  ...
  StarBorder copyWith({BorderSide? side, double? points, double? innerRadiusRatio, double? pointRounding, double? valleyRounding, double? rotation, double? squash}) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'copyWith', [side, points, innerRadiusRatio, pointRounding, valleyRounding, rotation, squash]);
    if (identical(_$r, notOverridden)) return super.copyWith(side: side, points: points, innerRadiusRatio: innerRadiusRatio, pointRounding: pointRounding, valleyRounding: valleyRounding, rotation: rotation, squash: squash);
    return _$r as StarBorder;
  }
