...
abstract final class StarBorderBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        '_#fromFields#7': (args) => StarBorder(side: args[4] as BorderSide, points: args[3] as double, innerRadiusRatio: args[0] as double, pointRounding: args[2] as double, valleyRounding: args[6] as double, rotation: args[1] as double, squash: args[5] as double),
      };
}
