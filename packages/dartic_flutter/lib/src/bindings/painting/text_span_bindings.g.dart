...
class _$TextSpan extends TextSpan implements DarticObjectHolder {
  ...
  void build(ui.ParagraphBuilder builder, {TextScaler textScaler = TextScaler.noScaling, List<PlaceholderDimensions>? dimensions}) {
    ...
    if (identical(_$r, notOverridden)) { super.build(builder, textScaler: textScaler, dimensions: dimensions); return; }
  }

  @override
  bool visitChildren(InlineSpanVisitor visitor) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'visitChildren', [visitor]);
    if (identical(_$r, notOverridden)) return super.visitChildren((a) => visitor(a) as bool);
    return _$r as bool;
  }
  ...
  bool visitDirectChildren(InlineSpanVisitor visitor) {
    ...
    if (identical(_$r, notOverridden)) return super.visitDirectChildren((a) => visitor(a) as bool);
    return _$r as bool;
  }
  ...
  InlineSpan? getSpanForPositionVisitor(ui.TextPosition position, Accumulator offset) {
    ...
    if (identical(_$r, notOverridden)) return super.getSpanForPositionVisitor(position, offset);
  ...
  void computeSemanticsInformation(List<InlineSpanSemanticsInformation> collector, {ui.Locale? inheritedLocale, bool inheritedSpellOut = false}) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'computeSemanticsInformation', [collector, inheritedLocale, inheritedSpellOut]);
    if (identical(_$r, notOverridden)) { super.computeSemanticsInformation(collector, inheritedLocale: inheritedLocale, inheritedSpellOut: inheritedSpellOut); return; }
  }

  @override
  int? codeUnitAtVisitor(int index, Accumulator offset) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'codeUnitAtVisitor', [index, offset]);
    if (identical(_$r, notOverridden)) return super.codeUnitAtVisitor(index, offset);
    return _$r as int?;
  }
