...
abstract final class TextSpanBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'visitChildren#1': (args) => (args[0] as TextSpan).visitChildren(args[1] as bool Function(InlineSpan)),
        'visitDirectChildren#1': (args) => (args[0] as TextSpan).visitDirectChildren(args[1] as bool Function(InlineSpan)),
