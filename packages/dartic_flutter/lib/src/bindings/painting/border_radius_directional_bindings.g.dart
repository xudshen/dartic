...
abstract final class BorderRadiusDirectionalBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#0': (args) => (args[0] as BorderRadiusDirectional).toString(),
        ...
        'hashCode#0': (args) => (args[0] as BorderRadiusDirectional).hashCode,
        ...
        '~/#1': (args) => (args[0] as BorderRadiusDirectional) ~/ (args[1] as double),
        '%#1': (args) => (args[0] as BorderRadiusDirectional) % (args[1] as double),
        '==#1': (args) => (args[0] as BorderRadiusDirectional) == (args[1] as Object),
