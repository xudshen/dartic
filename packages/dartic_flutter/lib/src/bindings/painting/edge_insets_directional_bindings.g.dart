...
abstract final class EdgeInsetsDirectionalBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#0': (args) => (args[0] as EdgeInsetsDirectional).toString(),
        ...
        'hashCode#0': (args) => (args[0] as EdgeInsetsDirectional).hashCode,
        ...
        '~/#1': (args) => (args[0] as EdgeInsetsDirectional) ~/ (args[1] as double),
        '%#1': (args) => (args[0] as EdgeInsetsDirectional) % (args[1] as double),
        '==#1': (args) => (args[0] as EdgeInsetsDirectional) == (args[1] as Object),
