...
class _$LinearBorder extends LinearBorder implements DarticObjectHolder {
  ...
  LinearBorder copyWith({BorderSide? side, LinearBorderEdge? start, LinearBorderEdge? end, LinearBorderEdge? top, LinearBorderEdge? bottom}) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'copyWith', [side, start, end, top, bottom]);
    if (identical(_$r, notOverridden)) return super.copyWith(side: side, start: start, end: end, top: top, bottom: bottom);
    return _$r as LinearBorder;
  }
