...
abstract final class BorderRadiusBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#0': (args) => (args[0] as BorderRadius).toString(),
        ...
        'hashCode#0': (args) => (args[0] as BorderRadius).hashCode,
        ...
        '~/#1': (args) => (args[0] as BorderRadius) ~/ (args[1] as double),
        '%#1': (args) => (args[0] as BorderRadius) % (args[1] as double),
        '==#1': (args) => (args[0] as BorderRadius) == (args[1] as Object),
        ...
        '_#fromFields#4': (args) => BorderRadius.all(args[3] as Radius),
      };
}
