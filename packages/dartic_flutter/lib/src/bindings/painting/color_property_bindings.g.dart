...
class _$ColorProperty extends ColorProperty implements DarticObjectHolder {
  _$ColorProperty(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(superArgs[0] as String, superArgs[1] as Color?, showName: superArgs[2] as bool, defaultValue: identical(superArgs[3], darticAbsent) ? null : superArgs[3], style: superArgs[4] as DiagnosticsTreeStyle, level: superArgs[5] as DiagnosticLevel);
  ...
  Color? get _super$value => super.value;
...
/// private class.
Object createColorPropertyBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$ColorProperty(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$ColorProperty(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$toJsonMap#1', (args) => (args[0] as _$ColorProperty)._super$toJsonMap(args[1] as DiagnosticsSerializationDelegate));
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$toString#2', (args) => (args[0] as _$ColorProperty)._super$toString(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.info : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$valueToString#1', (args) => (args[0] as _$ColorProperty)._super$valueToString(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?));
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$toDescription#1', (args) => (args[0] as _$ColorProperty)._super$toDescription(parentConfiguration: identical(args[1], darticAbsent) ? null : args[1] as TextTreeConfiguration?));
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$getProperties#0', (args) => (args[0] as _$ColorProperty)._super$getProperties());
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$getChildren#0', (args) => (args[0] as _$ColorProperty)._super$getChildren());
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$isFiltered#1', (args) => (args[0] as _$ColorProperty)._super$isFiltered(args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$toTimelineArguments#0', (args) => (args[0] as _$ColorProperty)._super$toTimelineArguments());
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$toJsonMapIterative#1', (args) => (args[0] as _$ColorProperty)._super$toJsonMapIterative(args[1] as DiagnosticsSerializationDelegate));
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$toStringDeep#5', (args) => (args[0] as _$ColorProperty)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, parentConfiguration: identical(args[3], darticAbsent) ? null : args[3] as TextTreeConfiguration?, minLevel: identical(args[4], darticAbsent) ? DiagnosticLevel.debug : args[4] as DiagnosticLevel, wrapWidth: identical(args[5], darticAbsent) ? 65 : args[5] as int));
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$hashCode#0', (args) => (args[0] as _$ColorProperty)._super$hashCode);
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$expandableValue#0', (args) => (args[0] as _$ColorProperty)._super$expandableValue);
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$allowWrap#0', (args) => (args[0] as _$ColorProperty)._super$allowWrap);
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$allowNameWrap#0', (args) => (args[0] as _$ColorProperty)._super$allowNameWrap);
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$ifNull#0', (args) => (args[0] as _$ColorProperty)._super$ifNull);
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$ifEmpty#0', (args) => (args[0] as _$ColorProperty)._super$ifEmpty);
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$tooltip#0', (args) => (args[0] as _$ColorProperty)._super$tooltip);
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$missingIfNull#0', (args) => (args[0] as _$ColorProperty)._super$missingIfNull);
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$propertyType#0', (args) => (args[0] as _$ColorProperty)._super$propertyType);
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$value#0', (args) => (args[0] as _$ColorProperty)._super$value);
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$exception#0', (args) => (args[0] as _$ColorProperty)._super$exception);
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$defaultValue#0', (args) => (args[0] as _$ColorProperty)._super$defaultValue);
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$isInteresting#0', (args) => (args[0] as _$ColorProperty)._super$isInteresting);
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$level#0', (args) => (args[0] as _$ColorProperty)._super$level);
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$name#0', (args) => (args[0] as _$ColorProperty)._super$name);
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$showSeparator#0', (args) => (args[0] as _$ColorProperty)._super$showSeparator);
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$showName#0', (args) => (args[0] as _$ColorProperty)._super$showName);
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$linePrefix#0', (args) => (args[0] as _$ColorProperty)._super$linePrefix);
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$emptyBodyDescription#0', (args) => (args[0] as _$ColorProperty)._super$emptyBodyDescription);
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$style#0', (args) => (args[0] as _$ColorProperty)._super$style);
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$allowTruncate#0', (args) => (args[0] as _$ColorProperty)._super$allowTruncate);
    ctx.registerBinding('package:flutter/src/painting/colors.dart::ColorProperty::\$super\$textTreeConfiguration#0', (args) => (args[0] as _$ColorProperty)._super$textTreeConfiguration);
  }
