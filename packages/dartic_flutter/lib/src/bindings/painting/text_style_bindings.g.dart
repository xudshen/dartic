...
abstract final class TextStyleBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        '_#fromFields#26': (args) => TextStyle(inherit: args[18] as bool, color: args[4] as ui.Color?, backgroundColor: args[3] as ui.Color?, fontSize: args[12] as double?, fontWeight: args[15] as ui.FontWeight?, fontStyle: args[13] as ui.FontStyle?, letterSpacing: args[20] as double?, wordSpacing: args[25] as double?, textBaseline: args[24] as ui.TextBaseline?, height: args[17] as double?, leadingDistribution: args[19] as ui.TextLeadingDistribution?, locale: args[21] as ui.Locale?, foreground: args[16] as ui.Paint?, background: args[2] as ui.Paint?, shadows: args[23] == null ? null : (args[23] as List).cast<ui.Shadow>(), fontFeatures: args[11] == null ? null : (args[11] as List).cast<ui.FontFeature>(), fontVariations: args[14] == null ? null : (args[14] as List).cast<ui.FontVariation>(), decoration: args[6] as ui.TextDecoration?, decorationColor: args[7] as ui.Color?, decorationStyle: args[8] as ui.TextDecorationStyle?, decorationThickness: args[9] as double?, debugLabel: args[5] as String?, fontFamily: args[10] as String?, fontFamilyFallback: args[0] == null ? null : (args[0] as List).cast<String>(), package: args[1] as String?, overflow: args[22] as TextOverflow?),
      };
}
