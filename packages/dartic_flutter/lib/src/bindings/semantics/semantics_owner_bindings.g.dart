...
class _$SemanticsOwner extends SemanticsOwner implements DarticObjectHolder {
  ...
  void sendSemanticsUpdate() {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'sendSemanticsUpdate', const []);
    if (identical(r, notOverridden)) { super.sendSemanticsUpdate(); return; }
  }

  @override
  void performAction(int id, SemanticsAction action, [Object? args]) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'performAction', [id, action, args]);
    if (identical(r, notOverridden)) { super.performAction(id, action, args); return; }
  }

  @override
  void performActionAt(Offset position, SemanticsAction action, [Object? args]) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'performActionAt', [position, action, args]);
    if (identical(r, notOverridden)) { super.performActionAt(position, action, args); return; }
  }
