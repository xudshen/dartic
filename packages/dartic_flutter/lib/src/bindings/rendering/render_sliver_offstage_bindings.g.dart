...
class _$RenderSliverOffstage extends RenderSliverOffstage implements DarticObjectHolder {
  _$RenderSliverOffstage(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(offstage: superArgs[0] as bool, sliver: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as RenderSliver?);
...
/// private class.
Object createRenderSliverOffstageBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderSliverOffstage(dispatch, obj, superArgs);
...
abstract final class RenderSliverOffstageBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderSliverOffstage(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$performLayout#0', (args) { (args[0] as _$RenderSliverOffstage)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$hitTest#3', (args) => (args[0] as _$RenderSliverOffstage)._super$hitTest(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$hitTestChildren#3', (args) => (args[0] as _$RenderSliverOffstage)._super$hitTestChildren(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$paint#2', (args) { (args[0] as _$RenderSliverOffstage)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderSliverOffstage)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderSliverOffstage)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderSliverOffstage)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$toString#1', (args) => (args[0] as _$RenderSliverOffstage)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$setupParentData#1', (args) { (args[0] as _$RenderSliverOffstage)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$childMainAxisPosition#1', (args) => (args[0] as _$RenderSliverOffstage)._super$childMainAxisPosition(args[1] as RenderSliver));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderSliverOffstage)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderSliverOffstage)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderSliverOffstage)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$performResize#0', (args) { (args[0] as _$RenderSliverOffstage)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$hitTestSelf#2', (args) => (args[0] as _$RenderSliverOffstage)._super$hitTestSelf(mainAxisPosition: args[1] as double, crossAxisPosition: args[2] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$calculatePaintOffset#3', (args) => (args[0] as _$RenderSliverOffstage)._super$calculatePaintOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$calculateCacheOffset#3', (args) => (args[0] as _$RenderSliverOffstage)._super$calculateCacheOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$childCrossAxisPosition#1', (args) => (args[0] as _$RenderSliverOffstage)._super$childCrossAxisPosition(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$childScrollOffset#1', (args) => (args[0] as _$RenderSliverOffstage)._super$childScrollOffset(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$getAbsoluteSizeRelativeToOrigin#0', (args) => (args[0] as _$RenderSliverOffstage)._super$getAbsoluteSizeRelativeToOrigin());
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$getAbsoluteSize#0', (args) => (args[0] as _$RenderSliverOffstage)._super$getAbsoluteSize());
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$debugPaint#2', (args) { (args[0] as _$RenderSliverOffstage)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$handleEvent#2', (args) { (args[0] as _$RenderSliverOffstage)._super$handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$reassemble#0', (args) { (args[0] as _$RenderSliverOffstage)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$dispose#0', (args) { (args[0] as _$RenderSliverOffstage)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$redepthChild#1', (args) { (args[0] as _$RenderSliverOffstage)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderSliverOffstage)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$adoptChild#1', (args) { (args[0] as _$RenderSliverOffstage)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$dropChild#1', (args) { (args[0] as _$RenderSliverOffstage)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$visitChildren#1', (args) { (args[0] as _$RenderSliverOffstage)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$attach#1', (args) { (args[0] as _$RenderSliverOffstage)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$detach#0', (args) { (args[0] as _$RenderSliverOffstage)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderSliverOffstage)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderSliverOffstage)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderSliverOffstage)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderSliverOffstage)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$layout#2', (args) { (args[0] as _$RenderSliverOffstage)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderSliverOffstage)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderSliverOffstage)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderSliverOffstage)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderSliverOffstage)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderSliverOffstage)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderSliverOffstage)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderSliverOffstage)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$paintsChild#1', (args) => (args[0] as _$RenderSliverOffstage)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderSliverOffstage)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderSliverOffstage)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderSliverOffstage)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderSliverOffstage)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderSliverOffstage)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderSliverOffstage)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderSliverOffstage)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderSliverOffstage)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderSliverOffstage)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$toStringShort#0', (args) => (args[0] as _$RenderSliverOffstage)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderSliverOffstage)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderSliverOffstage)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderSliverOffstage)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$describeForError#2', (args) => (args[0] as _$RenderSliverOffstage)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ...
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$geometry#0', (args) => (args[0] as _$RenderSliverOffstage)._super$geometry);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$paintBounds#0', (args) => (args[0] as _$RenderSliverOffstage)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$centerOffsetAdjustment#0', (args) => (args[0] as _$RenderSliverOffstage)._super$centerOffsetAdjustment);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderSliverOffstage)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$parentData#0', (args) => (args[0] as _$RenderSliverOffstage)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$depth#0', (args) => (args[0] as _$RenderSliverOffstage)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$parent#0', (args) => (args[0] as _$RenderSliverOffstage)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderSliverOffstage)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$debugCreator#0', (args) => (args[0] as _$RenderSliverOffstage)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderSliverOffstage)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderSliverOffstage)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderSliverOffstage)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderSliverOffstage)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$owner#0', (args) => (args[0] as _$RenderSliverOffstage)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$attached#0', (args) => (args[0] as _$RenderSliverOffstage)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderSliverOffstage)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderSliverOffstage)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderSliverOffstage)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderSliverOffstage)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderSliverOffstage)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderSliverOffstage)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$layer#0', (args) => (args[0] as _$RenderSliverOffstage)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$debugLayer#0', (args) => (args[0] as _$RenderSliverOffstage)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderSliverOffstage)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderSliverOffstage)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderSliverOffstage)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderSliverOffstage)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderSliverOffstage)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$child#0', (args) => (args[0] as _$RenderSliverOffstage)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$offstage=#1', (args) { (args[0] as _$RenderSliverOffstage)._super$offstage = args[1] as bool; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$geometry=#1', (args) { (args[0] as _$RenderSliverOffstage)._super$geometry = args[1] as SliverGeometry?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOffstage::\$super\$parentData=#1', (args) { (args[0] as _$RenderSliverOffstage)._super$parentData = args[1] as ParentData?; return args[1]; });
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderSliverOffstage).handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; },
