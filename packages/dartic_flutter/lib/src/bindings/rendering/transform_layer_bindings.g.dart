...
class _$TransformLayer extends TransformLayer implements DarticObjectHolder {
  _$TransformLayer(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(transform: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as Matrix4?, offset: superArgs[1] as ui.Offset);
...
/// private class.
Object createTransformLayerBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$TransformLayer(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$TransformLayer(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$addToScene#1', (args) { (args[0] as _$TransformLayer)._super$addToScene(args[1] as ui.SceneBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$applyTransform#2', (args) { (args[0] as _$TransformLayer)._super$applyTransform(args[1] as Layer?, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$debugFillProperties#1', (args) { (args[0] as _$TransformLayer)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$toString#1', (args) => (args[0] as _$TransformLayer)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$toImage#2', (args) => (args[0] as _$TransformLayer)._super$toImage(args[1] as ui.Rect, pixelRatio: identical(args[2], darticAbsent) ? 1.0 : args[2] as double));
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$toImageSync#2', (args) => (args[0] as _$TransformLayer)._super$toImageSync(args[1] as ui.Rect, pixelRatio: identical(args[2], darticAbsent) ? 1.0 : args[2] as double));
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$supportsRasterization#0', (args) => (args[0] as _$TransformLayer)._super$supportsRasterization());
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$buildScene#1', (args) => (args[0] as _$TransformLayer)._super$buildScene(args[1] as ui.SceneBuilder));
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$dispose#0', (args) { (args[0] as _$TransformLayer)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$updateSubtreeNeedsAddToScene#0', (args) { (args[0] as _$TransformLayer)._super$updateSubtreeNeedsAddToScene(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$attach#1', (args) { (args[0] as _$TransformLayer)._super$attach(args[1] as Object); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$detach#0', (args) { (args[0] as _$TransformLayer)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$append#1', (args) { (args[0] as _$TransformLayer)._super$append(args[1] as Layer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$redepthChildren#0', (args) { (args[0] as _$TransformLayer)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$redepthChild#1', (args) { (args[0] as _$TransformLayer)._super$redepthChild(args[1] as Layer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$removeAllChildren#0', (args) { (args[0] as _$TransformLayer)._super$removeAllChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$addChildrenToScene#1', (args) { (args[0] as _$TransformLayer)._super$addChildrenToScene(args[1] as ui.SceneBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$depthFirstIterateChildren#0', (args) => (args[0] as _$TransformLayer)._super$depthFirstIterateChildren());
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$TransformLayer)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$describeClipBounds#0', (args) => (args[0] as _$TransformLayer)._super$describeClipBounds());
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$addCompositionCallback#1', (args) => (args[0] as _$TransformLayer)._super$addCompositionCallback((a) => (args[1] as Function)(a)));
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$markNeedsAddToScene#0', (args) { (args[0] as _$TransformLayer)._super$markNeedsAddToScene(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$debugMarkClean#0', (args) { (args[0] as _$TransformLayer)._super$debugMarkClean(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$remove#0', (args) { (args[0] as _$TransformLayer)._super$remove(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$toStringShort#0', (args) => (args[0] as _$TransformLayer)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$toStringShallow#2', (args) => (args[0] as _$TransformLayer)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ...
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$hasChildren#0', (args) => (args[0] as _$TransformLayer)._super$hasChildren);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$subtreeHasCompositionCallbacks#0', (args) => (args[0] as _$TransformLayer)._super$subtreeHasCompositionCallbacks);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$debugDisposed#0', (args) => (args[0] as _$TransformLayer)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$debugHandleCount#0', (args) => (args[0] as _$TransformLayer)._super$debugHandleCount);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$parent#0', (args) => (args[0] as _$TransformLayer)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$alwaysNeedsAddToScene#0', (args) => (args[0] as _$TransformLayer)._super$alwaysNeedsAddToScene);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$debugSubtreeNeedsAddToScene#0', (args) => (args[0] as _$TransformLayer)._super$debugSubtreeNeedsAddToScene);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$engineLayer#0', (args) => (args[0] as _$TransformLayer)._super$engineLayer);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$owner#0', (args) => (args[0] as _$TransformLayer)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$attached#0', (args) => (args[0] as _$TransformLayer)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$depth#0', (args) => (args[0] as _$TransformLayer)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$nextSibling#0', (args) => (args[0] as _$TransformLayer)._super$nextSibling);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$previousSibling#0', (args) => (args[0] as _$TransformLayer)._super$previousSibling);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$debugCreator#0', (args) => (args[0] as _$TransformLayer)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::TransformLayer::\$super\$transform=#1', (args) { (args[0] as _$TransformLayer)._super$transform = args[1] as Matrix4?; return args[1]; });
