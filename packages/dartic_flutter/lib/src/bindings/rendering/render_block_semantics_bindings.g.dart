...
class _$RenderBlockSemantics extends RenderBlockSemantics implements DarticObjectHolder {
  _$RenderBlockSemantics(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?, blocking: superArgs[1] as bool);
  ...
  @override
  bool get blocking {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'blocking');
    if (identical(r, notOverridden)) return super.blocking;
    return r as bool;
  }
  ...
  set blocking(bool value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'blocking', value)) {
  ...
  bool get _super$blocking => super.blocking;
  ...
  set _super$blocking(bool value) { super.blocking = value; }
...
/// private class.
Object createRenderBlockSemanticsBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderBlockSemantics(dispatch, obj, superArgs);
...
abstract final class RenderBlockSemanticsBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderBlockSemantics(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderBlockSemantics)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderBlockSemantics)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$toString#1', (args) => (args[0] as _$RenderBlockSemantics)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$setupParentData#1', (args) { (args[0] as _$RenderBlockSemantics)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderBlockSemantics)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderBlockSemantics)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderBlockSemantics)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderBlockSemantics)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderBlockSemantics)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderBlockSemantics)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderBlockSemantics)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderBlockSemantics)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderBlockSemantics)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderBlockSemantics)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderBlockSemantics)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderBlockSemantics)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderBlockSemantics)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderBlockSemantics)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderBlockSemantics)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderBlockSemantics)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderBlockSemantics)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderBlockSemantics)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderBlockSemantics)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderBlockSemantics)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$performResize#0', (args) { (args[0] as _$RenderBlockSemantics)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$performLayout#0', (args) { (args[0] as _$RenderBlockSemantics)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$hitTest#2', (args) => (args[0] as _$RenderBlockSemantics)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderBlockSemantics)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderBlockSemantics)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderBlockSemantics)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderBlockSemantics)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderBlockSemantics)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$handleEvent#2', (args) { (args[0] as _$RenderBlockSemantics)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderBlockSemantics)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugPaint#2', (args) { (args[0] as _$RenderBlockSemantics)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderBlockSemantics)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderBlockSemantics)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderBlockSemantics)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$reassemble#0', (args) { (args[0] as _$RenderBlockSemantics)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$dispose#0', (args) { (args[0] as _$RenderBlockSemantics)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$redepthChild#1', (args) { (args[0] as _$RenderBlockSemantics)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderBlockSemantics)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$adoptChild#1', (args) { (args[0] as _$RenderBlockSemantics)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$dropChild#1', (args) { (args[0] as _$RenderBlockSemantics)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$visitChildren#1', (args) { (args[0] as _$RenderBlockSemantics)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$attach#1', (args) { (args[0] as _$RenderBlockSemantics)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$detach#0', (args) { (args[0] as _$RenderBlockSemantics)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderBlockSemantics)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderBlockSemantics)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderBlockSemantics)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$layout#2', (args) { (args[0] as _$RenderBlockSemantics)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderBlockSemantics)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderBlockSemantics)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderBlockSemantics)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderBlockSemantics)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderBlockSemantics)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderBlockSemantics)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderBlockSemantics)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$paint#2', (args) { (args[0] as _$RenderBlockSemantics)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$paintsChild#1', (args) => (args[0] as _$RenderBlockSemantics)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderBlockSemantics)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderBlockSemantics)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderBlockSemantics)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderBlockSemantics)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderBlockSemantics)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderBlockSemantics)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderBlockSemantics)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderBlockSemantics)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderBlockSemantics)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$toStringShort#0', (args) => (args[0] as _$RenderBlockSemantics)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderBlockSemantics)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderBlockSemantics)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderBlockSemantics)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderBlockSemantics)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$describeForError#2', (args) => (args[0] as _$RenderBlockSemantics)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderBlockSemantics)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderBlockSemantics)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$computeSizeForNoChild#1', (args) => (args[0] as _$RenderBlockSemantics)._super$computeSizeForNoChild(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$blocking#0', (args) => (args[0] as _$RenderBlockSemantics)._super$blocking);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$hasSize#0', (args) => (args[0] as _$RenderBlockSemantics)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$size#0', (args) => (args[0] as _$RenderBlockSemantics)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderBlockSemantics)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$constraints#0', (args) => (args[0] as _$RenderBlockSemantics)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$paintBounds#0', (args) => (args[0] as _$RenderBlockSemantics)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderBlockSemantics)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$parentData#0', (args) => (args[0] as _$RenderBlockSemantics)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$depth#0', (args) => (args[0] as _$RenderBlockSemantics)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$parent#0', (args) => (args[0] as _$RenderBlockSemantics)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderBlockSemantics)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugCreator#0', (args) => (args[0] as _$RenderBlockSemantics)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderBlockSemantics)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderBlockSemantics)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderBlockSemantics)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderBlockSemantics)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$owner#0', (args) => (args[0] as _$RenderBlockSemantics)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$attached#0', (args) => (args[0] as _$RenderBlockSemantics)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderBlockSemantics)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderBlockSemantics)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderBlockSemantics)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderBlockSemantics)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderBlockSemantics)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderBlockSemantics)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$layer#0', (args) => (args[0] as _$RenderBlockSemantics)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugLayer#0', (args) => (args[0] as _$RenderBlockSemantics)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderBlockSemantics)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderBlockSemantics)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderBlockSemantics)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderBlockSemantics)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderBlockSemantics)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$child#0', (args) => (args[0] as _$RenderBlockSemantics)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$blocking=#1', (args) { (args[0] as _$RenderBlockSemantics)._super$blocking = args[1] as bool; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$size=#1', (args) { (args[0] as _$RenderBlockSemantics)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$parentData=#1', (args) { (args[0] as _$RenderBlockSemantics)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderBlockSemantics)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$layer=#1', (args) { (args[0] as _$RenderBlockSemantics)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$child=#1', (args) { (args[0] as _$RenderBlockSemantics)._super$child = args[1] as RenderBox?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBlockSemantics::\$super\$hashCode#0', (args) => (args[0] as _$RenderBlockSemantics)._super$hashCode);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderBlockSemantics).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
