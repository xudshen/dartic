...
class _$RenderStack extends RenderStack implements DarticObjectHolder {
  _$RenderStack(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(children: identical(superArgs[0], darticAbsent) ? null : superArgs[0] == null ? null : (superArgs[0] as List).cast<RenderBox>(), alignment: superArgs[1] as AlignmentGeometry, textDirection: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as TextDirection?, fit: superArgs[3] as StackFit, clipBehavior: superArgs[4] as Clip);
...
/// private class.
Object createRenderStackBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderStack(dispatch, obj, superArgs);
...
abstract final class RenderStackBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderStack(dispatch, darticObject, superArgs),
    );
    ...
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$setupParentData#1', (args) { (args[0] as _$RenderStack)._super$setupParentData(args[1] as RenderBox); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderStack)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderStack)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderStack)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderStack)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderStack)._super$computeDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderStack)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderStack)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$performLayout#0', (args) { (args[0] as _$RenderStack)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderStack)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$paintStack#2', (args) { (args[0] as _$RenderStack)._super$paintStack(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$paint#2', (args) { (args[0] as _$RenderStack)._super$paint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$dispose#0', (args) { (args[0] as _$RenderStack)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderStack)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderStack)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$toString#1', (args) => (args[0] as _$RenderStack)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderStack)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderStack)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderStack)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderStack)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderStack)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderStack)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderStack)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderStack)._super$debugAdoptSize(args[1] as Size));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderStack)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderStack)._super$getDistanceToBaseline(args[1] as TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderStack)._super$getDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderStack)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderStack)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$performResize#0', (args) { (args[0] as _$RenderStack)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$hitTest#2', (args) => (args[0] as _$RenderStack)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderStack)._super$hitTestSelf(args[1] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderStack)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderStack)._super$globalToLocal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderStack)._super$localToGlobal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$handleEvent#2', (args) { (args[0] as _$RenderStack)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderStack)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugPaint#2', (args) { (args[0] as _$RenderStack)._super$debugPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderStack)._super$debugPaintSize(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderStack)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderStack)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$reassemble#0', (args) { (args[0] as _$RenderStack)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$redepthChild#1', (args) { (args[0] as _$RenderStack)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderStack)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$adoptChild#1', (args) { (args[0] as _$RenderStack)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$dropChild#1', (args) { (args[0] as _$RenderStack)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$visitChildren#1', (args) { (args[0] as _$RenderStack)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$attach#1', (args) { (args[0] as _$RenderStack)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$detach#0', (args) { (args[0] as _$RenderStack)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderStack)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderStack)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderStack)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$layout#2', (args) { (args[0] as _$RenderStack)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderStack)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderStack)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderStack)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderStack)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderStack)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderStack)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderStack)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$paintsChild#1', (args) => (args[0] as _$RenderStack)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderStack)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderStack)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderStack)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderStack)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderStack)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderStack)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderStack)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderStack)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderStack)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$toStringShort#0', (args) => (args[0] as _$RenderStack)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderStack)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderStack)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderStack)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderStack)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$describeForError#2', (args) => (args[0] as _$RenderStack)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderStack)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderStack)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$insert#2', (args) { (args[0] as _$RenderStack)._super$insert(args[1] as RenderBox, after: identical(args[2], darticAbsent) ? null : args[2] as RenderBox?); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$add#1', (args) { (args[0] as _$RenderStack)._super$add(args[1] as RenderBox); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$addAll#1', (args) { (args[0] as _$RenderStack)._super$addAll(args[1] == null ? null : (args[1] as List).cast<RenderBox>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$remove#1', (args) { (args[0] as _$RenderStack)._super$remove(args[1] as RenderBox); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$removeAll#0', (args) { (args[0] as _$RenderStack)._super$removeAll(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$move#2', (args) { (args[0] as _$RenderStack)._super$move(args[1] as RenderBox, after: identical(args[2], darticAbsent) ? null : args[2] as RenderBox?); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$childBefore#1', (args) => (args[0] as _$RenderStack)._super$childBefore(args[1] as RenderBox));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$childAfter#1', (args) => (args[0] as _$RenderStack)._super$childAfter(args[1] as RenderBox));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$defaultComputeDistanceToFirstActualBaseline#1', (args) => (args[0] as _$RenderStack)._super$defaultComputeDistanceToFirstActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$defaultComputeDistanceToHighestActualBaseline#1', (args) => (args[0] as _$RenderStack)._super$defaultComputeDistanceToHighestActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$defaultHitTestChildren#2', (args) => (args[0] as _$RenderStack)._super$defaultHitTestChildren(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$defaultPaint#2', (args) { (args[0] as _$RenderStack)._super$defaultPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$getChildrenAsList#0', (args) => (args[0] as _$RenderStack)._super$getChildrenAsList());
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$alignment#0', (args) => (args[0] as _$RenderStack)._super$alignment);
    ...
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$constraints#0', (args) => (args[0] as _$RenderStack)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$paintBounds#0', (args) => (args[0] as _$RenderStack)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderStack)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$parentData#0', (args) => (args[0] as _$RenderStack)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$depth#0', (args) => (args[0] as _$RenderStack)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$parent#0', (args) => (args[0] as _$RenderStack)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderStack)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugCreator#0', (args) => (args[0] as _$RenderStack)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderStack)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderStack)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderStack)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderStack)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$owner#0', (args) => (args[0] as _$RenderStack)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$attached#0', (args) => (args[0] as _$RenderStack)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderStack)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderStack)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderStack)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderStack)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderStack)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderStack)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$layer#0', (args) => (args[0] as _$RenderStack)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugLayer#0', (args) => (args[0] as _$RenderStack)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderStack)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderStack)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderStack)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderStack)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderStack)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$childCount#0', (args) => (args[0] as _$RenderStack)._super$childCount);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$firstChild#0', (args) => (args[0] as _$RenderStack)._super$firstChild);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$lastChild#0', (args) => (args[0] as _$RenderStack)._super$lastChild);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$alignment=#1', (args) { (args[0] as _$RenderStack)._super$alignment = args[1] as AlignmentGeometry; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$textDirection=#1', (args) { (args[0] as _$RenderStack)._super$textDirection = args[1] as TextDirection?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$fit=#1', (args) { (args[0] as _$RenderStack)._super$fit = args[1] as StackFit; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$clipBehavior=#1', (args) { (args[0] as _$RenderStack)._super$clipBehavior = args[1] as Clip; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderStack::\$super\$size=#1', (args) { (args[0] as _$RenderStack)._super$size = args[1] as Size; return args[1]; });
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#1': (args) => (args[0] as RenderStack).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
        ...
        'handleEvent#2': (args) { (args[0] as RenderStack).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
