...
class _$RenderFractionalTranslation extends RenderFractionalTranslation implements DarticObjectHolder {
  _$RenderFractionalTranslation(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(translation: superArgs[0] as ui.Offset, transformHitTests: superArgs[1] as bool, child: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as RenderBox?);
  ...
  @override
  set translation(ui.Offset value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'translation', value)) {
  ...
  set _super$translation(ui.Offset value) { super.translation = value; }
...
/// private class.
Object createRenderFractionalTranslationBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderFractionalTranslation(dispatch, obj, superArgs);
...
abstract final class RenderFractionalTranslationBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderFractionalTranslation(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$hitTest#2', (args) => (args[0] as _$RenderFractionalTranslation)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderFractionalTranslation)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$paint#2', (args) { (args[0] as _$RenderFractionalTranslation)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderFractionalTranslation)._super$applyPaintTransform(args[1] as RenderBox, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderFractionalTranslation)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$toString#1', (args) => (args[0] as _$RenderFractionalTranslation)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$setupParentData#1', (args) { (args[0] as _$RenderFractionalTranslation)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderFractionalTranslation)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderFractionalTranslation)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderFractionalTranslation)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderFractionalTranslation)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderFractionalTranslation)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderFractionalTranslation)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderFractionalTranslation)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderFractionalTranslation)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderFractionalTranslation)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderFractionalTranslation)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderFractionalTranslation)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderFractionalTranslation)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderFractionalTranslation)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderFractionalTranslation)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderFractionalTranslation)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderFractionalTranslation)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderFractionalTranslation)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderFractionalTranslation)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderFractionalTranslation)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderFractionalTranslation)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$performResize#0', (args) { (args[0] as _$RenderFractionalTranslation)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$performLayout#0', (args) { (args[0] as _$RenderFractionalTranslation)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderFractionalTranslation)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderFractionalTranslation)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderFractionalTranslation)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$handleEvent#2', (args) { (args[0] as _$RenderFractionalTranslation)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderFractionalTranslation)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugPaint#2', (args) { (args[0] as _$RenderFractionalTranslation)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderFractionalTranslation)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderFractionalTranslation)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderFractionalTranslation)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$reassemble#0', (args) { (args[0] as _$RenderFractionalTranslation)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$dispose#0', (args) { (args[0] as _$RenderFractionalTranslation)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$redepthChild#1', (args) { (args[0] as _$RenderFractionalTranslation)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderFractionalTranslation)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$adoptChild#1', (args) { (args[0] as _$RenderFractionalTranslation)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$dropChild#1', (args) { (args[0] as _$RenderFractionalTranslation)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$visitChildren#1', (args) { (args[0] as _$RenderFractionalTranslation)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$attach#1', (args) { (args[0] as _$RenderFractionalTranslation)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$detach#0', (args) { (args[0] as _$RenderFractionalTranslation)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderFractionalTranslation)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderFractionalTranslation)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderFractionalTranslation)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$layout#2', (args) { (args[0] as _$RenderFractionalTranslation)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderFractionalTranslation)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderFractionalTranslation)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderFractionalTranslation)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderFractionalTranslation)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderFractionalTranslation)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderFractionalTranslation)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderFractionalTranslation)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$paintsChild#1', (args) => (args[0] as _$RenderFractionalTranslation)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderFractionalTranslation)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderFractionalTranslation)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderFractionalTranslation)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderFractionalTranslation)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderFractionalTranslation)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderFractionalTranslation)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderFractionalTranslation)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderFractionalTranslation)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderFractionalTranslation)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderFractionalTranslation)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$toStringShort#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderFractionalTranslation)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderFractionalTranslation)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderFractionalTranslation)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$describeForError#2', (args) => (args[0] as _$RenderFractionalTranslation)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderFractionalTranslation)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderFractionalTranslation)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$computeSizeForNoChild#1', (args) => (args[0] as _$RenderFractionalTranslation)._super$computeSizeForNoChild(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$translation#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$translation);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$transformHitTests#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$transformHitTests);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$hasSize#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$size#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$constraints#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$paintBounds#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$parentData#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$depth#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$parent#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugCreator#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$owner#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$attached#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$layer#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugLayer#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$child#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$translation=#1', (args) { (args[0] as _$RenderFractionalTranslation)._super$translation = args[1] as ui.Offset; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$transformHitTests=#1', (args) { (args[0] as _$RenderFractionalTranslation)._super$transformHitTests = args[1] as bool; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$size=#1', (args) { (args[0] as _$RenderFractionalTranslation)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$parentData=#1', (args) { (args[0] as _$RenderFractionalTranslation)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderFractionalTranslation)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$layer=#1', (args) { (args[0] as _$RenderFractionalTranslation)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$child=#1', (args) { (args[0] as _$RenderFractionalTranslation)._super$child = args[1] as RenderBox?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFractionalTranslation::\$super\$hashCode#0', (args) => (args[0] as _$RenderFractionalTranslation)._super$hashCode);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderFractionalTranslation).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
