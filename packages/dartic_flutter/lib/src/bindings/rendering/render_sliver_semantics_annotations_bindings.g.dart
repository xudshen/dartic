...
class _$RenderSliverSemanticsAnnotations extends RenderSliverSemanticsAnnotations implements DarticObjectHolder {
  _$RenderSliverSemanticsAnnotations(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderSliver?, properties: superArgs[1] as SemanticsProperties, container: superArgs[2] as bool, explicitChildNodes: superArgs[3] as bool, excludeSemantics: superArgs[4] as bool, blockUserActions: superArgs[5] as bool, localeForSubtree: identical(superArgs[6], darticAbsent) ? null : superArgs[6] as ui.Locale?, textDirection: identical(superArgs[7], darticAbsent) ? null : superArgs[7] as ui.TextDirection?);
  ...
  void initSemanticsAnnotations({required SemanticsProperties properties, required bool container, required bool explicitChildNodes, required bool excludeSemantics, required bool blockUserActions, required ui.Locale? localeForSubtree, required ui.TextDirection? textDirection}) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'initSemanticsAnnotations', [properties, container, explicitChildNodes, excludeSemantics, blockUserActions, localeForSubtree, textDirection]);
    if (identical(_$r, notOverridden)) { super.initSemanticsAnnotations(properties: properties, container: container, explicitChildNodes: explicitChildNodes, excludeSemantics: excludeSemantics, blockUserActions: blockUserActions, localeForSubtree: localeForSubtree, textDirection: textDirection); return; }
  }
...
/// private class.
Object createRenderSliverSemanticsAnnotationsBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderSliverSemanticsAnnotations(dispatch, obj, superArgs);
...
abstract final class RenderSliverSemanticsAnnotationsBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderSliverSemanticsAnnotations(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$toString#1', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$setupParentData#1', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$performLayout#0', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$paint#2', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$hitTestChildren#3', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$hitTestChildren(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$childMainAxisPosition#1', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$childMainAxisPosition(args[1] as RenderSliver));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$performResize#0', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$hitTest#3', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$hitTest(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$hitTestSelf#2', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$hitTestSelf(mainAxisPosition: args[1] as double, crossAxisPosition: args[2] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$calculatePaintOffset#3', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$calculatePaintOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$calculateCacheOffset#3', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$calculateCacheOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$childCrossAxisPosition#1', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$childCrossAxisPosition(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$childScrollOffset#1', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$childScrollOffset(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$getAbsoluteSizeRelativeToOrigin#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$getAbsoluteSizeRelativeToOrigin());
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$getAbsoluteSize#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$getAbsoluteSize());
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$debugPaint#2', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$handleEvent#2', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$reassemble#0', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$dispose#0', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$redepthChild#1', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$adoptChild#1', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$dropChild#1', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$visitChildren#1', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$attach#1', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$detach#0', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$layout#2', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$paintsChild#1', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$toStringShort#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$describeForError#2', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ...
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$geometry#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$geometry);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$paintBounds#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$centerOffsetAdjustment#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$centerOffsetAdjustment);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$parentData#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$depth#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$parent#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$debugCreator#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$owner#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$attached#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$layer#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$debugLayer#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$child#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$properties#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$properties);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$container#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$container);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$explicitChildNodes#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$explicitChildNodes);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$excludeSemantics#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$excludeSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$blockUserActions#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$blockUserActions);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$localeForSubtree#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$localeForSubtree);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$textDirection#0', (args) => (args[0] as _$RenderSliverSemanticsAnnotations)._super$textDirection);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$geometry=#1', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$geometry = args[1] as SliverGeometry?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$parentData=#1', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$layer=#1', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$child=#1', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$child = args[1] as RenderSliver?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$properties=#1', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$properties = args[1] as SemanticsProperties; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$container=#1', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$container = args[1] as bool; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$explicitChildNodes=#1', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$explicitChildNodes = args[1] as bool; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverSemanticsAnnotations::\$super\$excludeSemantics=#1', (args) { (args[0] as _$RenderSliverSemanticsAnnotations)._super$excludeSemantics = args[1] as bool; return args[1]; });
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderSliverSemanticsAnnotations).handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; },
