...
class _$RenderFractionallySizedOverflowBox extends RenderFractionallySizedOverflowBox implements DarticObjectHolder {
  _$RenderFractionallySizedOverflowBox(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?, widthFactor: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as double?, heightFactor: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as double?, alignment: superArgs[3] as AlignmentGeometry, textDirection: identical(superArgs[4], darticAbsent) ? null : superArgs[4] as TextDirection?);
  ...
  @override
  void alignChild() {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'alignChild', const []);
    if (identical(r, notOverridden)) { super.alignChild(); return; }
  }
...
/// private class.
Object createRenderFractionallySizedOverflowBoxBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderFractionallySizedOverflowBox(dispatch, obj, superArgs);
...
abstract final class RenderFractionallySizedOverflowBoxBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderFractionallySizedOverflowBox(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$performLayout#0', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$toString#1', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$alignChild#0', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$alignChild(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$computeDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$paint#2', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$paint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$setupParentData#1', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugAdoptSize(args[1] as Size));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$getDistanceToBaseline(args[1] as TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$getDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$performResize#0', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$hitTest#2', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$hitTestSelf(args[1] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$globalToLocal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$localToGlobal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$handleEvent#2', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugPaint#2', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugPaintSize(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$reassemble#0', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$dispose#0', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$redepthChild#1', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$adoptChild#1', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$dropChild#1', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$visitChildren#1', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$attach#1', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$detach#0', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$layout#2', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$paintsChild#1', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$toStringShort#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$describeForError#2', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$widthFactor#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$widthFactor);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$heightFactor#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$heightFactor);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$hashCode#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$hashCode);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$resolvedAlignment#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$resolvedAlignment);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$alignment#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$alignment);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$textDirection#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$textDirection);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$hasSize#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$size#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$constraints#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$paintBounds#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$parentData#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$depth#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$parent#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugCreator#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$owner#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$attached#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$layer#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugLayer#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$child#0', (args) => (args[0] as _$RenderFractionallySizedOverflowBox)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$widthFactor=#1', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$widthFactor = args[1] as double?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$heightFactor=#1', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$heightFactor = args[1] as double?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$alignment=#1', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$alignment = args[1] as AlignmentGeometry; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$textDirection=#1', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$textDirection = args[1] as TextDirection?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$size=#1', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$size = args[1] as Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$parentData=#1', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$layer=#1', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderFractionallySizedOverflowBox::\$super\$child=#1', (args) { (args[0] as _$RenderFractionallySizedOverflowBox)._super$child = args[1] as RenderBox?; return args[1]; });
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderFractionallySizedOverflowBox).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
