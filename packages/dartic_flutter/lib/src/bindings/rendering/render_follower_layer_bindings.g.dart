...
class _$RenderFollowerLayer extends RenderFollowerLayer implements DarticObjectHolder {
  ...
  Matrix4 getCurrentTransform() {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'getCurrentTransform', const []);
    if (identical(_$r, notOverridden)) return super.getCurrentTransform();
