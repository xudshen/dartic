...
class _$RenderMergeSemantics extends RenderMergeSemantics implements DarticObjectHolder {
  _$RenderMergeSemantics(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?);
...
/// private class.
Object createRenderMergeSemanticsBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderMergeSemantics(dispatch, obj, superArgs);
...
abstract final class RenderMergeSemanticsBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderMergeSemantics(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderMergeSemantics)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$toString#1', (args) => (args[0] as _$RenderMergeSemantics)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$setupParentData#1', (args) { (args[0] as _$RenderMergeSemantics)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderMergeSemantics)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderMergeSemantics)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderMergeSemantics)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderMergeSemantics)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderMergeSemantics)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderMergeSemantics)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderMergeSemantics)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderMergeSemantics)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderMergeSemantics)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderMergeSemantics)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderMergeSemantics)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderMergeSemantics)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderMergeSemantics)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderMergeSemantics)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderMergeSemantics)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderMergeSemantics)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderMergeSemantics)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderMergeSemantics)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderMergeSemantics)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderMergeSemantics)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$performResize#0', (args) { (args[0] as _$RenderMergeSemantics)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$performLayout#0', (args) { (args[0] as _$RenderMergeSemantics)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$hitTest#2', (args) => (args[0] as _$RenderMergeSemantics)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderMergeSemantics)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderMergeSemantics)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderMergeSemantics)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderMergeSemantics)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderMergeSemantics)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$handleEvent#2', (args) { (args[0] as _$RenderMergeSemantics)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderMergeSemantics)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugPaint#2', (args) { (args[0] as _$RenderMergeSemantics)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderMergeSemantics)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderMergeSemantics)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderMergeSemantics)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderMergeSemantics)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$reassemble#0', (args) { (args[0] as _$RenderMergeSemantics)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$dispose#0', (args) { (args[0] as _$RenderMergeSemantics)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$redepthChild#1', (args) { (args[0] as _$RenderMergeSemantics)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderMergeSemantics)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$adoptChild#1', (args) { (args[0] as _$RenderMergeSemantics)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$dropChild#1', (args) { (args[0] as _$RenderMergeSemantics)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$visitChildren#1', (args) { (args[0] as _$RenderMergeSemantics)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$attach#1', (args) { (args[0] as _$RenderMergeSemantics)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$detach#0', (args) { (args[0] as _$RenderMergeSemantics)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderMergeSemantics)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderMergeSemantics)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderMergeSemantics)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$layout#2', (args) { (args[0] as _$RenderMergeSemantics)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderMergeSemantics)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderMergeSemantics)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderMergeSemantics)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderMergeSemantics)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderMergeSemantics)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderMergeSemantics)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderMergeSemantics)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$paint#2', (args) { (args[0] as _$RenderMergeSemantics)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$paintsChild#1', (args) => (args[0] as _$RenderMergeSemantics)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderMergeSemantics)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderMergeSemantics)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderMergeSemantics)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderMergeSemantics)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderMergeSemantics)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderMergeSemantics)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderMergeSemantics)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderMergeSemantics)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderMergeSemantics)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$toStringShort#0', (args) => (args[0] as _$RenderMergeSemantics)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderMergeSemantics)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderMergeSemantics)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderMergeSemantics)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderMergeSemantics)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$describeForError#2', (args) => (args[0] as _$RenderMergeSemantics)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderMergeSemantics)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderMergeSemantics)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$computeSizeForNoChild#1', (args) => (args[0] as _$RenderMergeSemantics)._super$computeSizeForNoChild(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$hasSize#0', (args) => (args[0] as _$RenderMergeSemantics)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$size#0', (args) => (args[0] as _$RenderMergeSemantics)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderMergeSemantics)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$constraints#0', (args) => (args[0] as _$RenderMergeSemantics)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$paintBounds#0', (args) => (args[0] as _$RenderMergeSemantics)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderMergeSemantics)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$parentData#0', (args) => (args[0] as _$RenderMergeSemantics)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$depth#0', (args) => (args[0] as _$RenderMergeSemantics)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$parent#0', (args) => (args[0] as _$RenderMergeSemantics)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderMergeSemantics)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugCreator#0', (args) => (args[0] as _$RenderMergeSemantics)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderMergeSemantics)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderMergeSemantics)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderMergeSemantics)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderMergeSemantics)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$owner#0', (args) => (args[0] as _$RenderMergeSemantics)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$attached#0', (args) => (args[0] as _$RenderMergeSemantics)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderMergeSemantics)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderMergeSemantics)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderMergeSemantics)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderMergeSemantics)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderMergeSemantics)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderMergeSemantics)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$layer#0', (args) => (args[0] as _$RenderMergeSemantics)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugLayer#0', (args) => (args[0] as _$RenderMergeSemantics)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderMergeSemantics)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderMergeSemantics)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderMergeSemantics)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderMergeSemantics)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderMergeSemantics)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$child#0', (args) => (args[0] as _$RenderMergeSemantics)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$size=#1', (args) { (args[0] as _$RenderMergeSemantics)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$parentData=#1', (args) { (args[0] as _$RenderMergeSemantics)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderMergeSemantics)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$layer=#1', (args) { (args[0] as _$RenderMergeSemantics)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$child=#1', (args) { (args[0] as _$RenderMergeSemantics)._super$child = args[1] as RenderBox?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderMergeSemantics::\$super\$hashCode#0', (args) => (args[0] as _$RenderMergeSemantics)._super$hashCode);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderMergeSemantics).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
