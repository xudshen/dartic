...
class _$RenderExcludeSemantics extends RenderExcludeSemantics implements DarticObjectHolder {
  _$RenderExcludeSemantics(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?, excluding: superArgs[1] as bool);
  ...
  set excluding(bool value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'excluding', value)) {
  ...
  set _super$excluding(bool value) { super.excluding = value; }
...
/// private class.
Object createRenderExcludeSemanticsBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderExcludeSemantics(dispatch, obj, superArgs);
...
abstract final class RenderExcludeSemanticsBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderExcludeSemantics(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderExcludeSemantics)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderExcludeSemantics)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$toString#1', (args) => (args[0] as _$RenderExcludeSemantics)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$setupParentData#1', (args) { (args[0] as _$RenderExcludeSemantics)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderExcludeSemantics)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderExcludeSemantics)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderExcludeSemantics)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderExcludeSemantics)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderExcludeSemantics)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderExcludeSemantics)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderExcludeSemantics)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderExcludeSemantics)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderExcludeSemantics)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderExcludeSemantics)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderExcludeSemantics)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderExcludeSemantics)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderExcludeSemantics)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderExcludeSemantics)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderExcludeSemantics)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderExcludeSemantics)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderExcludeSemantics)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderExcludeSemantics)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderExcludeSemantics)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderExcludeSemantics)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$performResize#0', (args) { (args[0] as _$RenderExcludeSemantics)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$performLayout#0', (args) { (args[0] as _$RenderExcludeSemantics)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$hitTest#2', (args) => (args[0] as _$RenderExcludeSemantics)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderExcludeSemantics)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderExcludeSemantics)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderExcludeSemantics)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderExcludeSemantics)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderExcludeSemantics)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$handleEvent#2', (args) { (args[0] as _$RenderExcludeSemantics)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderExcludeSemantics)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugPaint#2', (args) { (args[0] as _$RenderExcludeSemantics)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderExcludeSemantics)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderExcludeSemantics)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderExcludeSemantics)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$reassemble#0', (args) { (args[0] as _$RenderExcludeSemantics)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$dispose#0', (args) { (args[0] as _$RenderExcludeSemantics)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$redepthChild#1', (args) { (args[0] as _$RenderExcludeSemantics)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderExcludeSemantics)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$adoptChild#1', (args) { (args[0] as _$RenderExcludeSemantics)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$dropChild#1', (args) { (args[0] as _$RenderExcludeSemantics)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$visitChildren#1', (args) { (args[0] as _$RenderExcludeSemantics)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$attach#1', (args) { (args[0] as _$RenderExcludeSemantics)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$detach#0', (args) { (args[0] as _$RenderExcludeSemantics)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderExcludeSemantics)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderExcludeSemantics)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderExcludeSemantics)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$layout#2', (args) { (args[0] as _$RenderExcludeSemantics)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderExcludeSemantics)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderExcludeSemantics)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderExcludeSemantics)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderExcludeSemantics)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderExcludeSemantics)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderExcludeSemantics)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderExcludeSemantics)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$paint#2', (args) { (args[0] as _$RenderExcludeSemantics)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$paintsChild#1', (args) => (args[0] as _$RenderExcludeSemantics)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderExcludeSemantics)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderExcludeSemantics)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderExcludeSemantics)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderExcludeSemantics)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderExcludeSemantics)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderExcludeSemantics)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderExcludeSemantics)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderExcludeSemantics)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderExcludeSemantics)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$toStringShort#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderExcludeSemantics)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderExcludeSemantics)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderExcludeSemantics)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$describeForError#2', (args) => (args[0] as _$RenderExcludeSemantics)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderExcludeSemantics)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderExcludeSemantics)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$computeSizeForNoChild#1', (args) => (args[0] as _$RenderExcludeSemantics)._super$computeSizeForNoChild(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$excluding#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$excluding);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$hashCode#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$hashCode);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$hasSize#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$size#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$constraints#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$paintBounds#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$parentData#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$depth#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$parent#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugCreator#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$owner#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$attached#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$layer#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugLayer#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$child#0', (args) => (args[0] as _$RenderExcludeSemantics)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$excluding=#1', (args) { (args[0] as _$RenderExcludeSemantics)._super$excluding = args[1] as bool; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$size=#1', (args) { (args[0] as _$RenderExcludeSemantics)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$parentData=#1', (args) { (args[0] as _$RenderExcludeSemantics)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderExcludeSemantics)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$layer=#1', (args) { (args[0] as _$RenderExcludeSemantics)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderExcludeSemantics::\$super\$child=#1', (args) { (args[0] as _$RenderExcludeSemantics)._super$child = args[1] as RenderBox?; return args[1]; });
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderExcludeSemantics).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
