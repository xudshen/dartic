...
class _$RenderAbsorbPointer extends RenderAbsorbPointer implements DarticObjectHolder {
  _$RenderAbsorbPointer(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?, absorbing: superArgs[1] as bool, ignoringSemantics: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as bool?);
  ...
  set absorbing(bool value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'absorbing', value)) {
  ...
  set _super$absorbing(bool value) { super.absorbing = value; }
...
/// private class.
Object createRenderAbsorbPointerBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderAbsorbPointer(dispatch, obj, superArgs);
...
abstract final class RenderAbsorbPointerBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderAbsorbPointer(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$hitTest#2', (args) => (args[0] as _$RenderAbsorbPointer)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderAbsorbPointer)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderAbsorbPointer)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderAbsorbPointer)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$toString#1', (args) => (args[0] as _$RenderAbsorbPointer)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$setupParentData#1', (args) { (args[0] as _$RenderAbsorbPointer)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderAbsorbPointer)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderAbsorbPointer)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderAbsorbPointer)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderAbsorbPointer)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderAbsorbPointer)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderAbsorbPointer)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderAbsorbPointer)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderAbsorbPointer)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderAbsorbPointer)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderAbsorbPointer)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderAbsorbPointer)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderAbsorbPointer)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderAbsorbPointer)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderAbsorbPointer)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderAbsorbPointer)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderAbsorbPointer)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderAbsorbPointer)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderAbsorbPointer)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderAbsorbPointer)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderAbsorbPointer)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$performResize#0', (args) { (args[0] as _$RenderAbsorbPointer)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$performLayout#0', (args) { (args[0] as _$RenderAbsorbPointer)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderAbsorbPointer)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderAbsorbPointer)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderAbsorbPointer)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderAbsorbPointer)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderAbsorbPointer)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$handleEvent#2', (args) { (args[0] as _$RenderAbsorbPointer)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderAbsorbPointer)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugPaint#2', (args) { (args[0] as _$RenderAbsorbPointer)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderAbsorbPointer)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderAbsorbPointer)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderAbsorbPointer)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$reassemble#0', (args) { (args[0] as _$RenderAbsorbPointer)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$dispose#0', (args) { (args[0] as _$RenderAbsorbPointer)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$redepthChild#1', (args) { (args[0] as _$RenderAbsorbPointer)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderAbsorbPointer)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$adoptChild#1', (args) { (args[0] as _$RenderAbsorbPointer)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$dropChild#1', (args) { (args[0] as _$RenderAbsorbPointer)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$visitChildren#1', (args) { (args[0] as _$RenderAbsorbPointer)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$attach#1', (args) { (args[0] as _$RenderAbsorbPointer)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$detach#0', (args) { (args[0] as _$RenderAbsorbPointer)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderAbsorbPointer)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderAbsorbPointer)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderAbsorbPointer)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$layout#2', (args) { (args[0] as _$RenderAbsorbPointer)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderAbsorbPointer)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderAbsorbPointer)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderAbsorbPointer)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderAbsorbPointer)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderAbsorbPointer)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderAbsorbPointer)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderAbsorbPointer)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$paint#2', (args) { (args[0] as _$RenderAbsorbPointer)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$paintsChild#1', (args) => (args[0] as _$RenderAbsorbPointer)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderAbsorbPointer)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderAbsorbPointer)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderAbsorbPointer)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderAbsorbPointer)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderAbsorbPointer)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderAbsorbPointer)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderAbsorbPointer)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderAbsorbPointer)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$toStringShort#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderAbsorbPointer)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderAbsorbPointer)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderAbsorbPointer)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$describeForError#2', (args) => (args[0] as _$RenderAbsorbPointer)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderAbsorbPointer)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderAbsorbPointer)._super$debugValidateChild(args[1] as RenderObject));
    ...
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$constraints#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$paintBounds#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$parentData#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$depth#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$parent#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugCreator#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$owner#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$attached#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$layer#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugLayer#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$child#0', (args) => (args[0] as _$RenderAbsorbPointer)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$absorbing=#1', (args) { (args[0] as _$RenderAbsorbPointer)._super$absorbing = args[1] as bool; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$ignoringSemantics=#1', (args) { (args[0] as _$RenderAbsorbPointer)._super$ignoringSemantics = args[1] as bool?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$size=#1', (args) { (args[0] as _$RenderAbsorbPointer)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAbsorbPointer::\$super\$parentData=#1', (args) { (args[0] as _$RenderAbsorbPointer)._super$parentData = args[1] as ParentData?; return args[1]; });
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderAbsorbPointer).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
