...
class _$RenderAnimatedSize extends RenderAnimatedSize implements DarticObjectHolder {
  _$RenderAnimatedSize(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(vsync: superArgs[0] as TickerProvider, duration: superArgs[1] as Duration, reverseDuration: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as Duration?, curve: superArgs[3] as Curve, alignment: superArgs[4] as AlignmentGeometry, textDirection: identical(superArgs[5], darticAbsent) ? null : superArgs[5] as TextDirection?, child: identical(superArgs[6], darticAbsent) ? null : superArgs[6] as RenderBox?, clipBehavior: superArgs[7] as Clip, onEnd: identical(superArgs[8], darticAbsent) ? null : superArgs[8] as VoidCallback?);
  ...
  AnimationController? get debugController {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'debugController');
    if (identical(r, notOverridden)) return super.debugController;
    return r as AnimationController?;
  }

  @override
  CurvedAnimation? get debugAnimation {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'debugAnimation');
    if (identical(r, notOverridden)) return super.debugAnimation;
    return r as CurvedAnimation?;
  }
  ...
  RenderAnimatedSizeState get state {
    ...
    return r as RenderAnimatedSizeState;
  }
  ...
  AnimationController? get _super$debugController => super.debugController;
  CurvedAnimation? get _super$debugAnimation => super.debugAnimation;
  RenderAnimatedSizeState get _super$state => super.state;
  ...
  set _super$onEnd(VoidCallback? value) { super.onEnd = value; }
...
/// private class.
Object createRenderAnimatedSizeBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderAnimatedSize(dispatch, obj, superArgs);
...
abstract final class RenderAnimatedSizeBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderAnimatedSize(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$attach#1', (args) { (args[0] as _$RenderAnimatedSize)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$detach#0', (args) { (args[0] as _$RenderAnimatedSize)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$performLayout#0', (args) { (args[0] as _$RenderAnimatedSize)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderAnimatedSize)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$paint#2', (args) { (args[0] as _$RenderAnimatedSize)._super$paint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$dispose#0', (args) { (args[0] as _$RenderAnimatedSize)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$toString#1', (args) => (args[0] as _$RenderAnimatedSize)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$alignChild#0', (args) { (args[0] as _$RenderAnimatedSize)._super$alignChild(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderAnimatedSize)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderAnimatedSize)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderAnimatedSize)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderAnimatedSize)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderAnimatedSize)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderAnimatedSize)._super$computeDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderAnimatedSize)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$setupParentData#1', (args) { (args[0] as _$RenderAnimatedSize)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderAnimatedSize)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderAnimatedSize)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderAnimatedSize)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderAnimatedSize)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderAnimatedSize)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderAnimatedSize)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderAnimatedSize)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderAnimatedSize)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderAnimatedSize)._super$debugAdoptSize(args[1] as Size));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderAnimatedSize)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderAnimatedSize)._super$getDistanceToBaseline(args[1] as TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderAnimatedSize)._super$getDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderAnimatedSize)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderAnimatedSize)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$performResize#0', (args) { (args[0] as _$RenderAnimatedSize)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$hitTest#2', (args) => (args[0] as _$RenderAnimatedSize)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderAnimatedSize)._super$hitTestSelf(args[1] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderAnimatedSize)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderAnimatedSize)._super$globalToLocal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderAnimatedSize)._super$localToGlobal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$handleEvent#2', (args) { (args[0] as _$RenderAnimatedSize)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderAnimatedSize)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugPaint#2', (args) { (args[0] as _$RenderAnimatedSize)._super$debugPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderAnimatedSize)._super$debugPaintSize(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderAnimatedSize)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderAnimatedSize)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$reassemble#0', (args) { (args[0] as _$RenderAnimatedSize)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$redepthChild#1', (args) { (args[0] as _$RenderAnimatedSize)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderAnimatedSize)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$adoptChild#1', (args) { (args[0] as _$RenderAnimatedSize)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$dropChild#1', (args) { (args[0] as _$RenderAnimatedSize)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$visitChildren#1', (args) { (args[0] as _$RenderAnimatedSize)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderAnimatedSize)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderAnimatedSize)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderAnimatedSize)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$layout#2', (args) { (args[0] as _$RenderAnimatedSize)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderAnimatedSize)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderAnimatedSize)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderAnimatedSize)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderAnimatedSize)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderAnimatedSize)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderAnimatedSize)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderAnimatedSize)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$paintsChild#1', (args) => (args[0] as _$RenderAnimatedSize)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderAnimatedSize)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderAnimatedSize)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderAnimatedSize)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderAnimatedSize)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderAnimatedSize)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderAnimatedSize)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderAnimatedSize)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderAnimatedSize)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderAnimatedSize)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderAnimatedSize)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$toStringShort#0', (args) => (args[0] as _$RenderAnimatedSize)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderAnimatedSize)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderAnimatedSize)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderAnimatedSize)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderAnimatedSize)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$describeForError#2', (args) => (args[0] as _$RenderAnimatedSize)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderAnimatedSize)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderAnimatedSize)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugController#0', (args) => (args[0] as _$RenderAnimatedSize)._super$debugController);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugAnimation#0', (args) => (args[0] as _$RenderAnimatedSize)._super$debugAnimation);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$state#0', (args) => (args[0] as _$RenderAnimatedSize)._super$state);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$duration#0', (args) => (args[0] as _$RenderAnimatedSize)._super$duration);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$reverseDuration#0', (args) => (args[0] as _$RenderAnimatedSize)._super$reverseDuration);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$curve#0', (args) => (args[0] as _$RenderAnimatedSize)._super$curve);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$clipBehavior#0', (args) => (args[0] as _$RenderAnimatedSize)._super$clipBehavior);
    ...
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$hasSize#0', (args) => (args[0] as _$RenderAnimatedSize)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$size#0', (args) => (args[0] as _$RenderAnimatedSize)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderAnimatedSize)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$constraints#0', (args) => (args[0] as _$RenderAnimatedSize)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$paintBounds#0', (args) => (args[0] as _$RenderAnimatedSize)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderAnimatedSize)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$parentData#0', (args) => (args[0] as _$RenderAnimatedSize)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$depth#0', (args) => (args[0] as _$RenderAnimatedSize)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$parent#0', (args) => (args[0] as _$RenderAnimatedSize)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderAnimatedSize)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugCreator#0', (args) => (args[0] as _$RenderAnimatedSize)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderAnimatedSize)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderAnimatedSize)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderAnimatedSize)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderAnimatedSize)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$owner#0', (args) => (args[0] as _$RenderAnimatedSize)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$attached#0', (args) => (args[0] as _$RenderAnimatedSize)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderAnimatedSize)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderAnimatedSize)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderAnimatedSize)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderAnimatedSize)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderAnimatedSize)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderAnimatedSize)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$layer#0', (args) => (args[0] as _$RenderAnimatedSize)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugLayer#0', (args) => (args[0] as _$RenderAnimatedSize)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderAnimatedSize)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderAnimatedSize)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderAnimatedSize)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderAnimatedSize)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderAnimatedSize)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$child#0', (args) => (args[0] as _$RenderAnimatedSize)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$duration=#1', (args) { (args[0] as _$RenderAnimatedSize)._super$duration = args[1] as Duration; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$reverseDuration=#1', (args) { (args[0] as _$RenderAnimatedSize)._super$reverseDuration = args[1] as Duration?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$curve=#1', (args) { (args[0] as _$RenderAnimatedSize)._super$curve = args[1] as Curve; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$clipBehavior=#1', (args) { (args[0] as _$RenderAnimatedSize)._super$clipBehavior = args[1] as Clip; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$vsync=#1', (args) { (args[0] as _$RenderAnimatedSize)._super$vsync = args[1] as TickerProvider; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$onEnd=#1', (args) { (args[0] as _$RenderAnimatedSize)._super$onEnd = args[1] as VoidCallback?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$alignment=#1', (args) { (args[0] as _$RenderAnimatedSize)._super$alignment = args[1] as AlignmentGeometry; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$textDirection=#1', (args) { (args[0] as _$RenderAnimatedSize)._super$textDirection = args[1] as TextDirection?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$size=#1', (args) { (args[0] as _$RenderAnimatedSize)._super$size = args[1] as Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/animated_size.dart::RenderAnimatedSize::\$super\$parentData=#1', (args) { (args[0] as _$RenderAnimatedSize)._super$parentData = args[1] as ParentData?; return args[1]; });
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderAnimatedSize).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
