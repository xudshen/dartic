...
class _$RenderSliverFillRemaining extends RenderSliverFillRemaining implements DarticObjectHolder {
  _$RenderSliverFillRemaining(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?);
...
/// private class.
Object createRenderSliverFillRemainingBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderSliverFillRemaining(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderSliverFillRemaining(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$performLayout#0', (args) { (args[0] as _$RenderSliverFillRemaining)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$toString#1', (args) => (args[0] as _$RenderSliverFillRemaining)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$setupParentData#1', (args) { (args[0] as _$RenderSliverFillRemaining)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$setChildParentData#3', (args) { (args[0] as _$RenderSliverFillRemaining)._super$setChildParentData(args[1] as RenderObject, args[2] as SliverConstraints, args[3] as SliverGeometry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$hitTestChildren#3', (args) => (args[0] as _$RenderSliverFillRemaining)._super$hitTestChildren(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$childMainAxisPosition#1', (args) => (args[0] as _$RenderSliverFillRemaining)._super$childMainAxisPosition(args[1] as RenderBox));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderSliverFillRemaining)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$paint#2', (args) { (args[0] as _$RenderSliverFillRemaining)._super$paint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderSliverFillRemaining)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderSliverFillRemaining)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$performResize#0', (args) { (args[0] as _$RenderSliverFillRemaining)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$hitTest#3', (args) => (args[0] as _$RenderSliverFillRemaining)._super$hitTest(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$hitTestSelf#2', (args) => (args[0] as _$RenderSliverFillRemaining)._super$hitTestSelf(mainAxisPosition: args[1] as double, crossAxisPosition: args[2] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$calculatePaintOffset#3', (args) => (args[0] as _$RenderSliverFillRemaining)._super$calculatePaintOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$calculateCacheOffset#3', (args) => (args[0] as _$RenderSliverFillRemaining)._super$calculateCacheOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$childCrossAxisPosition#1', (args) => (args[0] as _$RenderSliverFillRemaining)._super$childCrossAxisPosition(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$childScrollOffset#1', (args) => (args[0] as _$RenderSliverFillRemaining)._super$childScrollOffset(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$getAbsoluteSizeRelativeToOrigin#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$getAbsoluteSizeRelativeToOrigin());
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$getAbsoluteSize#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$getAbsoluteSize());
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$debugPaint#2', (args) { (args[0] as _$RenderSliverFillRemaining)._super$debugPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$handleEvent#2', (args) { (args[0] as _$RenderSliverFillRemaining)._super$handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderSliverFillRemaining)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$reassemble#0', (args) { (args[0] as _$RenderSliverFillRemaining)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$dispose#0', (args) { (args[0] as _$RenderSliverFillRemaining)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$redepthChild#1', (args) { (args[0] as _$RenderSliverFillRemaining)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderSliverFillRemaining)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$adoptChild#1', (args) { (args[0] as _$RenderSliverFillRemaining)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$dropChild#1', (args) { (args[0] as _$RenderSliverFillRemaining)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$visitChildren#1', (args) { (args[0] as _$RenderSliverFillRemaining)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$attach#1', (args) { (args[0] as _$RenderSliverFillRemaining)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$detach#0', (args) { (args[0] as _$RenderSliverFillRemaining)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderSliverFillRemaining)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderSliverFillRemaining)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderSliverFillRemaining)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderSliverFillRemaining)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$layout#2', (args) { (args[0] as _$RenderSliverFillRemaining)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderSliverFillRemaining)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderSliverFillRemaining)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderSliverFillRemaining)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderSliverFillRemaining)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderSliverFillRemaining)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderSliverFillRemaining)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderSliverFillRemaining)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$paintsChild#1', (args) => (args[0] as _$RenderSliverFillRemaining)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderSliverFillRemaining)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderSliverFillRemaining)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderSliverFillRemaining)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderSliverFillRemaining)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderSliverFillRemaining)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderSliverFillRemaining)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderSliverFillRemaining)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderSliverFillRemaining)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderSliverFillRemaining)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderSliverFillRemaining)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$toStringShort#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderSliverFillRemaining)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderSliverFillRemaining)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderSliverFillRemaining)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$describeForError#2', (args) => (args[0] as _$RenderSliverFillRemaining)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderSliverFillRemaining)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderSliverFillRemaining)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$hitTestBoxChild#4', (args) => (args[0] as _$RenderSliverFillRemaining)._super$hitTestBoxChild(args[1] as BoxHitTestResult, args[2] as RenderBox, mainAxisPosition: args[3] as double, crossAxisPosition: args[4] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$applyPaintTransformForBoxChild#2', (args) { (args[0] as _$RenderSliverFillRemaining)._super$applyPaintTransformForBoxChild(args[1] as RenderBox, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$hashCode#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$hashCode);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$ensureSemantics#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$ensureSemantics);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$constraints#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$geometry#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$geometry);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$paintBounds#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$centerOffsetAdjustment#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$centerOffsetAdjustment);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$parentData#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$depth#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$parent#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$debugCreator#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$owner#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$attached#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$layer#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$debugLayer#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$child#0', (args) => (args[0] as _$RenderSliverFillRemaining)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$geometry=#1', (args) { (args[0] as _$RenderSliverFillRemaining)._super$geometry = args[1] as SliverGeometry?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$parentData=#1', (args) { (args[0] as _$RenderSliverFillRemaining)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderSliverFillRemaining)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$layer=#1', (args) { (args[0] as _$RenderSliverFillRemaining)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemaining::\$super\$child=#1', (args) { (args[0] as _$RenderSliverFillRemaining)._super$child = args[1] as RenderBox?; return args[1]; });
  }

  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        'performLayout#0': (args) { (args[0] as RenderSliverFillRemaining).performLayout(); return null; },
        'toString#1': (args) => (args[0] as RenderSliverFillRemaining).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
        ...
        'handleEvent#2': (args) { (args[0] as RenderSliverFillRemaining).handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; },
