...
class _$RenderIgnorePointer extends RenderIgnorePointer implements DarticObjectHolder {
  _$RenderIgnorePointer(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?, ignoring: superArgs[1] as bool, ignoringSemantics: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as bool?);
...
/// private class.
Object createRenderIgnorePointerBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderIgnorePointer(dispatch, obj, superArgs);
...
abstract final class RenderIgnorePointerBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderIgnorePointer(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$hitTest#2', (args) => (args[0] as _$RenderIgnorePointer)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderIgnorePointer)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderIgnorePointer)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderIgnorePointer)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$toString#1', (args) => (args[0] as _$RenderIgnorePointer)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$setupParentData#1', (args) { (args[0] as _$RenderIgnorePointer)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderIgnorePointer)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderIgnorePointer)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderIgnorePointer)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderIgnorePointer)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderIgnorePointer)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderIgnorePointer)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderIgnorePointer)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderIgnorePointer)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderIgnorePointer)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderIgnorePointer)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderIgnorePointer)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderIgnorePointer)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderIgnorePointer)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderIgnorePointer)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderIgnorePointer)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderIgnorePointer)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderIgnorePointer)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderIgnorePointer)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderIgnorePointer)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderIgnorePointer)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$performResize#0', (args) { (args[0] as _$RenderIgnorePointer)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$performLayout#0', (args) { (args[0] as _$RenderIgnorePointer)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderIgnorePointer)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderIgnorePointer)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderIgnorePointer)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderIgnorePointer)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderIgnorePointer)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$handleEvent#2', (args) { (args[0] as _$RenderIgnorePointer)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderIgnorePointer)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugPaint#2', (args) { (args[0] as _$RenderIgnorePointer)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderIgnorePointer)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderIgnorePointer)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderIgnorePointer)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$reassemble#0', (args) { (args[0] as _$RenderIgnorePointer)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$dispose#0', (args) { (args[0] as _$RenderIgnorePointer)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$redepthChild#1', (args) { (args[0] as _$RenderIgnorePointer)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderIgnorePointer)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$adoptChild#1', (args) { (args[0] as _$RenderIgnorePointer)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$dropChild#1', (args) { (args[0] as _$RenderIgnorePointer)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$visitChildren#1', (args) { (args[0] as _$RenderIgnorePointer)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$attach#1', (args) { (args[0] as _$RenderIgnorePointer)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$detach#0', (args) { (args[0] as _$RenderIgnorePointer)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderIgnorePointer)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderIgnorePointer)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderIgnorePointer)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$layout#2', (args) { (args[0] as _$RenderIgnorePointer)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderIgnorePointer)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderIgnorePointer)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderIgnorePointer)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderIgnorePointer)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderIgnorePointer)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderIgnorePointer)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderIgnorePointer)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$paint#2', (args) { (args[0] as _$RenderIgnorePointer)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$paintsChild#1', (args) => (args[0] as _$RenderIgnorePointer)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderIgnorePointer)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderIgnorePointer)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderIgnorePointer)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderIgnorePointer)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderIgnorePointer)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderIgnorePointer)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderIgnorePointer)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderIgnorePointer)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$toStringShort#0', (args) => (args[0] as _$RenderIgnorePointer)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderIgnorePointer)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderIgnorePointer)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderIgnorePointer)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderIgnorePointer)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$describeForError#2', (args) => (args[0] as _$RenderIgnorePointer)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderIgnorePointer)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderIgnorePointer)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$computeSizeForNoChild#1', (args) => (args[0] as _$RenderIgnorePointer)._super$computeSizeForNoChild(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$ignoring#0', (args) => (args[0] as _$RenderIgnorePointer)._super$ignoring);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$ignoringSemantics#0', (args) => (args[0] as _$RenderIgnorePointer)._super$ignoringSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$hasSize#0', (args) => (args[0] as _$RenderIgnorePointer)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$size#0', (args) => (args[0] as _$RenderIgnorePointer)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderIgnorePointer)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$constraints#0', (args) => (args[0] as _$RenderIgnorePointer)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$paintBounds#0', (args) => (args[0] as _$RenderIgnorePointer)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderIgnorePointer)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$parentData#0', (args) => (args[0] as _$RenderIgnorePointer)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$depth#0', (args) => (args[0] as _$RenderIgnorePointer)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$parent#0', (args) => (args[0] as _$RenderIgnorePointer)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderIgnorePointer)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugCreator#0', (args) => (args[0] as _$RenderIgnorePointer)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderIgnorePointer)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderIgnorePointer)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderIgnorePointer)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderIgnorePointer)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$owner#0', (args) => (args[0] as _$RenderIgnorePointer)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$attached#0', (args) => (args[0] as _$RenderIgnorePointer)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderIgnorePointer)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderIgnorePointer)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderIgnorePointer)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderIgnorePointer)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderIgnorePointer)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderIgnorePointer)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$layer#0', (args) => (args[0] as _$RenderIgnorePointer)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugLayer#0', (args) => (args[0] as _$RenderIgnorePointer)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderIgnorePointer)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderIgnorePointer)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderIgnorePointer)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderIgnorePointer)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderIgnorePointer)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$child#0', (args) => (args[0] as _$RenderIgnorePointer)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$ignoring=#1', (args) { (args[0] as _$RenderIgnorePointer)._super$ignoring = args[1] as bool; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$ignoringSemantics=#1', (args) { (args[0] as _$RenderIgnorePointer)._super$ignoringSemantics = args[1] as bool?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$size=#1', (args) { (args[0] as _$RenderIgnorePointer)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$parentData=#1', (args) { (args[0] as _$RenderIgnorePointer)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderIgnorePointer)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$layer=#1', (args) { (args[0] as _$RenderIgnorePointer)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$child=#1', (args) { (args[0] as _$RenderIgnorePointer)._super$child = args[1] as RenderBox?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIgnorePointer::\$super\$hashCode#0', (args) => (args[0] as _$RenderIgnorePointer)._super$hashCode);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderIgnorePointer).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
