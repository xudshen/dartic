...
class _$RelayoutWhenSystemFontsChangeMixin implements RelayoutWhenSystemFontsChangeMixin, DarticObjectHolder {
  _$RelayoutWhenSystemFontsChangeMixin(this._dispatch, this.$darticObject, List<Object?> superArgs);
  ...
  void systemFontsDidChange() {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'systemFontsDidChange', const []);
    if (identical(_$r, notOverridden)) {
      throw UnsupportedError('Abstract method systemFontsDidChange must be overridden in dartic code');
    }
  }
...
/// private class.
Object createRelayoutWhenSystemFontsChangeMixinBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RelayoutWhenSystemFontsChangeMixin(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RelayoutWhenSystemFontsChangeMixin(dispatch, darticObject, superArgs),
    );
  }
