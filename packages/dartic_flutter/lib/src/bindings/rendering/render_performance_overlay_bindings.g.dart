...
class _$RenderPerformanceOverlay extends RenderPerformanceOverlay implements DarticObjectHolder {
  _$RenderPerformanceOverlay(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(optionsMask: superArgs[0] as int);
  ...
  set optionsMask(int value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'optionsMask', value)) {
  ...
  set _super$optionsMask(int value) { super.optionsMask = value; }
...
/// private class.
Object createRenderPerformanceOverlayBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderPerformanceOverlay(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderPerformanceOverlay(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderPerformanceOverlay)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderPerformanceOverlay)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderPerformanceOverlay)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderPerformanceOverlay)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderPerformanceOverlay)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$paint#2', (args) { (args[0] as _$RenderPerformanceOverlay)._super$paint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$toString#1', (args) => (args[0] as _$RenderPerformanceOverlay)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$setupParentData#1', (args) { (args[0] as _$RenderPerformanceOverlay)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderPerformanceOverlay)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderPerformanceOverlay)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderPerformanceOverlay)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderPerformanceOverlay)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderPerformanceOverlay)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderPerformanceOverlay)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderPerformanceOverlay)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderPerformanceOverlay)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderPerformanceOverlay)._super$debugAdoptSize(args[1] as Size));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderPerformanceOverlay)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderPerformanceOverlay)._super$getDistanceToBaseline(args[1] as TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderPerformanceOverlay)._super$getDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderPerformanceOverlay)._super$computeDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderPerformanceOverlay)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderPerformanceOverlay)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$performResize#0', (args) { (args[0] as _$RenderPerformanceOverlay)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$performLayout#0', (args) { (args[0] as _$RenderPerformanceOverlay)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$hitTest#2', (args) => (args[0] as _$RenderPerformanceOverlay)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderPerformanceOverlay)._super$hitTestSelf(args[1] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderPerformanceOverlay)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderPerformanceOverlay)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderPerformanceOverlay)._super$globalToLocal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderPerformanceOverlay)._super$localToGlobal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$handleEvent#2', (args) { (args[0] as _$RenderPerformanceOverlay)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderPerformanceOverlay)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugPaint#2', (args) { (args[0] as _$RenderPerformanceOverlay)._super$debugPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderPerformanceOverlay)._super$debugPaintSize(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderPerformanceOverlay)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderPerformanceOverlay)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderPerformanceOverlay)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$reassemble#0', (args) { (args[0] as _$RenderPerformanceOverlay)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$dispose#0', (args) { (args[0] as _$RenderPerformanceOverlay)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$redepthChild#1', (args) { (args[0] as _$RenderPerformanceOverlay)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderPerformanceOverlay)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$adoptChild#1', (args) { (args[0] as _$RenderPerformanceOverlay)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$dropChild#1', (args) { (args[0] as _$RenderPerformanceOverlay)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$visitChildren#1', (args) { (args[0] as _$RenderPerformanceOverlay)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$attach#1', (args) { (args[0] as _$RenderPerformanceOverlay)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$detach#0', (args) { (args[0] as _$RenderPerformanceOverlay)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderPerformanceOverlay)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderPerformanceOverlay)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderPerformanceOverlay)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$layout#2', (args) { (args[0] as _$RenderPerformanceOverlay)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderPerformanceOverlay)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderPerformanceOverlay)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderPerformanceOverlay)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderPerformanceOverlay)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderPerformanceOverlay)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderPerformanceOverlay)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderPerformanceOverlay)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$paintsChild#1', (args) => (args[0] as _$RenderPerformanceOverlay)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderPerformanceOverlay)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderPerformanceOverlay)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderPerformanceOverlay)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderPerformanceOverlay)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderPerformanceOverlay)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderPerformanceOverlay)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderPerformanceOverlay)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderPerformanceOverlay)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderPerformanceOverlay)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderPerformanceOverlay)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$toStringShort#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderPerformanceOverlay)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderPerformanceOverlay)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderPerformanceOverlay)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$describeForError#2', (args) => (args[0] as _$RenderPerformanceOverlay)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderPerformanceOverlay)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ...
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$constraints#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$paintBounds#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$parentData#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$depth#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$parent#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugCreator#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$owner#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$attached#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$layer#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugLayer#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderPerformanceOverlay)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$optionsMask=#1', (args) { (args[0] as _$RenderPerformanceOverlay)._super$optionsMask = args[1] as int; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/performance_overlay.dart::RenderPerformanceOverlay::\$super\$size=#1', (args) { (args[0] as _$RenderPerformanceOverlay)._super$size = args[1] as Size; return args[1]; });
