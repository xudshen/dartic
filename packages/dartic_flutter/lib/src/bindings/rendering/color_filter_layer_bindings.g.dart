...
class _$ColorFilterLayer extends ColorFilterLayer implements DarticObjectHolder {
  _$ColorFilterLayer(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(colorFilter: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as ui.ColorFilter?);
  ...
  set colorFilter(ui.ColorFilter? value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'colorFilter', value)) {
...
/// private class.
Object createColorFilterLayerBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$ColorFilterLayer(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$ColorFilterLayer(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$addToScene#1', (args) { (args[0] as _$ColorFilterLayer)._super$addToScene(args[1] as ui.SceneBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$debugFillProperties#1', (args) { (args[0] as _$ColorFilterLayer)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$toString#1', (args) => (args[0] as _$ColorFilterLayer)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$supportsRasterization#0', (args) => (args[0] as _$ColorFilterLayer)._super$supportsRasterization());
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$buildScene#1', (args) => (args[0] as _$ColorFilterLayer)._super$buildScene(args[1] as ui.SceneBuilder));
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$dispose#0', (args) { (args[0] as _$ColorFilterLayer)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$updateSubtreeNeedsAddToScene#0', (args) { (args[0] as _$ColorFilterLayer)._super$updateSubtreeNeedsAddToScene(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$attach#1', (args) { (args[0] as _$ColorFilterLayer)._super$attach(args[1] as Object); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$detach#0', (args) { (args[0] as _$ColorFilterLayer)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$append#1', (args) { (args[0] as _$ColorFilterLayer)._super$append(args[1] as Layer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$redepthChildren#0', (args) { (args[0] as _$ColorFilterLayer)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$redepthChild#1', (args) { (args[0] as _$ColorFilterLayer)._super$redepthChild(args[1] as Layer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$removeAllChildren#0', (args) { (args[0] as _$ColorFilterLayer)._super$removeAllChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$addChildrenToScene#1', (args) { (args[0] as _$ColorFilterLayer)._super$addChildrenToScene(args[1] as ui.SceneBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$applyTransform#2', (args) { (args[0] as _$ColorFilterLayer)._super$applyTransform(args[1] as Layer?, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$depthFirstIterateChildren#0', (args) => (args[0] as _$ColorFilterLayer)._super$depthFirstIterateChildren());
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$ColorFilterLayer)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$describeClipBounds#0', (args) => (args[0] as _$ColorFilterLayer)._super$describeClipBounds());
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$addCompositionCallback#1', (args) => (args[0] as _$ColorFilterLayer)._super$addCompositionCallback((a) => (args[1] as Function)(a)));
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$markNeedsAddToScene#0', (args) { (args[0] as _$ColorFilterLayer)._super$markNeedsAddToScene(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$debugMarkClean#0', (args) { (args[0] as _$ColorFilterLayer)._super$debugMarkClean(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$remove#0', (args) { (args[0] as _$ColorFilterLayer)._super$remove(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$toStringShort#0', (args) => (args[0] as _$ColorFilterLayer)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$toStringShallow#2', (args) => (args[0] as _$ColorFilterLayer)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ...
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$subtreeHasCompositionCallbacks#0', (args) => (args[0] as _$ColorFilterLayer)._super$subtreeHasCompositionCallbacks);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$debugDisposed#0', (args) => (args[0] as _$ColorFilterLayer)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$debugHandleCount#0', (args) => (args[0] as _$ColorFilterLayer)._super$debugHandleCount);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$parent#0', (args) => (args[0] as _$ColorFilterLayer)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$alwaysNeedsAddToScene#0', (args) => (args[0] as _$ColorFilterLayer)._super$alwaysNeedsAddToScene);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$debugSubtreeNeedsAddToScene#0', (args) => (args[0] as _$ColorFilterLayer)._super$debugSubtreeNeedsAddToScene);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$engineLayer#0', (args) => (args[0] as _$ColorFilterLayer)._super$engineLayer);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$owner#0', (args) => (args[0] as _$ColorFilterLayer)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$attached#0', (args) => (args[0] as _$ColorFilterLayer)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$depth#0', (args) => (args[0] as _$ColorFilterLayer)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$nextSibling#0', (args) => (args[0] as _$ColorFilterLayer)._super$nextSibling);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$previousSibling#0', (args) => (args[0] as _$ColorFilterLayer)._super$previousSibling);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::ColorFilterLayer::\$super\$debugCreator#0', (args) => (args[0] as _$ColorFilterLayer)._super$debugCreator);
