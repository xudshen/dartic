...
class _$TextureBox extends TextureBox implements DarticObjectHolder {
  _$TextureBox(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(textureId: superArgs[0] as int, freeze: superArgs[1] as bool, filterQuality: superArgs[2] as FilterQuality);
  ...
  set textureId(int value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'textureId', value)) {
  ...
  set freeze(bool value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'freeze', value)) {
      super.freeze = value;
    }
  }
  ...
  set _super$textureId(int value) { super.textureId = value; }
  set _super$freeze(bool value) { super.freeze = value; }
  set _super$filterQuality(FilterQuality value) { super.filterQuality = value; }
...
/// private class.
Object createTextureBoxBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$TextureBox(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$TextureBox(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$computeDryLayout#1', (args) => (args[0] as _$TextureBox)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$hitTestSelf#1', (args) => (args[0] as _$TextureBox)._super$hitTestSelf(args[1] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$paint#2', (args) { (args[0] as _$TextureBox)._super$paint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$toString#1', (args) => (args[0] as _$TextureBox)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$setupParentData#1', (args) { (args[0] as _$TextureBox)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$TextureBox)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$TextureBox)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$TextureBox)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$TextureBox)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$TextureBox)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$TextureBox)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$TextureBox)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$TextureBox)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$getDryLayout#1', (args) => (args[0] as _$TextureBox)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$getDryBaseline#2', (args) => (args[0] as _$TextureBox)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$computeDryBaseline#2', (args) => (args[0] as _$TextureBox)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$TextureBox)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugAdoptSize#1', (args) => (args[0] as _$TextureBox)._super$debugAdoptSize(args[1] as Size));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugResetSize#0', (args) { (args[0] as _$TextureBox)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$TextureBox)._super$getDistanceToBaseline(args[1] as TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$TextureBox)._super$getDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$TextureBox)._super$computeDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$TextureBox)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$markNeedsLayout#0', (args) { (args[0] as _$TextureBox)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$performResize#0', (args) { (args[0] as _$TextureBox)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$performLayout#0', (args) { (args[0] as _$TextureBox)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$hitTest#2', (args) => (args[0] as _$TextureBox)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$hitTestChildren#2', (args) => (args[0] as _$TextureBox)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$applyPaintTransform#2', (args) { (args[0] as _$TextureBox)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$globalToLocal#2', (args) => (args[0] as _$TextureBox)._super$globalToLocal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$localToGlobal#2', (args) => (args[0] as _$TextureBox)._super$localToGlobal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$handleEvent#2', (args) { (args[0] as _$TextureBox)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugHandleEvent#2', (args) => (args[0] as _$TextureBox)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugPaint#2', (args) { (args[0] as _$TextureBox)._super$debugPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugPaintSize#2', (args) { (args[0] as _$TextureBox)._super$debugPaintSize(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$TextureBox)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugPaintPointers#2', (args) { (args[0] as _$TextureBox)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugFillProperties#1', (args) { (args[0] as _$TextureBox)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$reassemble#0', (args) { (args[0] as _$TextureBox)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$dispose#0', (args) { (args[0] as _$TextureBox)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$redepthChild#1', (args) { (args[0] as _$TextureBox)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$redepthChildren#0', (args) { (args[0] as _$TextureBox)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$adoptChild#1', (args) { (args[0] as _$TextureBox)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$dropChild#1', (args) { (args[0] as _$TextureBox)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$visitChildren#1', (args) { (args[0] as _$TextureBox)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$attach#1', (args) { (args[0] as _$TextureBox)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$detach#0', (args) { (args[0] as _$TextureBox)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$TextureBox)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$TextureBox)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$TextureBox)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$layout#2', (args) { (args[0] as _$TextureBox)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$TextureBox)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$TextureBox)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$TextureBox)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$markNeedsPaint#0', (args) { (args[0] as _$TextureBox)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$TextureBox)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$TextureBox)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$replaceRootLayer#1', (args) { (args[0] as _$TextureBox)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$paintsChild#1', (args) => (args[0] as _$TextureBox)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$getTransformTo#1', (args) => (args[0] as _$TextureBox)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$TextureBox)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$TextureBox)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$TextureBox)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$TextureBox)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$TextureBox)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$clearSemantics#0', (args) { (args[0] as _$TextureBox)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$TextureBox)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$TextureBox)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$TextureBox)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$toStringShort#0', (args) => (args[0] as _$TextureBox)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$toStringDeep#4', (args) => (args[0] as _$TextureBox)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$toStringShallow#2', (args) => (args[0] as _$TextureBox)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$TextureBox)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$showOnScreen#4', (args) { (args[0] as _$TextureBox)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$describeForError#2', (args) => (args[0] as _$TextureBox)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$TextureBox)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$textureId#0', (args) => (args[0] as _$TextureBox)._super$textureId);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$freeze#0', (args) => (args[0] as _$TextureBox)._super$freeze);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$filterQuality#0', (args) => (args[0] as _$TextureBox)._super$filterQuality);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$sizedByParent#0', (args) => (args[0] as _$TextureBox)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$TextureBox)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$TextureBox)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$hasSize#0', (args) => (args[0] as _$TextureBox)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$size#0', (args) => (args[0] as _$TextureBox)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$semanticBounds#0', (args) => (args[0] as _$TextureBox)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$constraints#0', (args) => (args[0] as _$TextureBox)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$paintBounds#0', (args) => (args[0] as _$TextureBox)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugDisposed#0', (args) => (args[0] as _$TextureBox)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$parentData#0', (args) => (args[0] as _$TextureBox)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$depth#0', (args) => (args[0] as _$TextureBox)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$parent#0', (args) => (args[0] as _$TextureBox)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$semanticsParent#0', (args) => (args[0] as _$TextureBox)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugCreator#0', (args) => (args[0] as _$TextureBox)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$TextureBox)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$TextureBox)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$TextureBox)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugLayoutParent#0', (args) => (args[0] as _$TextureBox)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$owner#0', (args) => (args[0] as _$TextureBox)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$attached#0', (args) => (args[0] as _$TextureBox)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$TextureBox)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$TextureBox)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$TextureBox)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$layer#0', (args) => (args[0] as _$TextureBox)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugLayer#0', (args) => (args[0] as _$TextureBox)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$needsCompositing#0', (args) => (args[0] as _$TextureBox)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$TextureBox)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$TextureBox)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$TextureBox)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugSemantics#0', (args) => (args[0] as _$TextureBox)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$textureId=#1', (args) { (args[0] as _$TextureBox)._super$textureId = args[1] as int; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$freeze=#1', (args) { (args[0] as _$TextureBox)._super$freeze = args[1] as bool; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$filterQuality=#1', (args) { (args[0] as _$TextureBox)._super$filterQuality = args[1] as FilterQuality; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$size=#1', (args) { (args[0] as _$TextureBox)._super$size = args[1] as Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$parentData=#1', (args) { (args[0] as _$TextureBox)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$debugCreator=#1', (args) { (args[0] as _$TextureBox)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$layer=#1', (args) { (args[0] as _$TextureBox)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/texture.dart::TextureBox::\$super\$hashCode#0', (args) => (args[0] as _$TextureBox)._super$hashCode);
  }
