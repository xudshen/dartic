...
class _$RenderBackdropFilter extends RenderBackdropFilter implements DarticObjectHolder {
  _$RenderBackdropFilter(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?, filter: superArgs[1] as ui.ImageFilter, blendMode: superArgs[2] as ui.BlendMode, enabled: superArgs[3] as bool, backdropKey: identical(superArgs[4], darticAbsent) ? null : superArgs[4] as BackdropKey?);
  ...
  BackdropFilterLayer? get layer {
    ...
    return r as BackdropFilterLayer?;
  }
  ...
  BackdropFilterLayer? get _super$layer => super.layer;
...
/// private class.
Object createRenderBackdropFilterBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderBackdropFilter(dispatch, obj, superArgs);
...
abstract final class RenderBackdropFilterBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderBackdropFilter(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$paint#2', (args) { (args[0] as _$RenderBackdropFilter)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$toString#1', (args) => (args[0] as _$RenderBackdropFilter)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$setupParentData#1', (args) { (args[0] as _$RenderBackdropFilter)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderBackdropFilter)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderBackdropFilter)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderBackdropFilter)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderBackdropFilter)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderBackdropFilter)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderBackdropFilter)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderBackdropFilter)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderBackdropFilter)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderBackdropFilter)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderBackdropFilter)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderBackdropFilter)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderBackdropFilter)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderBackdropFilter)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderBackdropFilter)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderBackdropFilter)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderBackdropFilter)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderBackdropFilter)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderBackdropFilter)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderBackdropFilter)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderBackdropFilter)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$performResize#0', (args) { (args[0] as _$RenderBackdropFilter)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$performLayout#0', (args) { (args[0] as _$RenderBackdropFilter)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$hitTest#2', (args) => (args[0] as _$RenderBackdropFilter)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderBackdropFilter)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderBackdropFilter)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderBackdropFilter)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderBackdropFilter)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderBackdropFilter)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$handleEvent#2', (args) { (args[0] as _$RenderBackdropFilter)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderBackdropFilter)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugPaint#2', (args) { (args[0] as _$RenderBackdropFilter)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderBackdropFilter)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderBackdropFilter)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderBackdropFilter)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderBackdropFilter)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$reassemble#0', (args) { (args[0] as _$RenderBackdropFilter)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$dispose#0', (args) { (args[0] as _$RenderBackdropFilter)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$redepthChild#1', (args) { (args[0] as _$RenderBackdropFilter)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderBackdropFilter)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$adoptChild#1', (args) { (args[0] as _$RenderBackdropFilter)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$dropChild#1', (args) { (args[0] as _$RenderBackdropFilter)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$visitChildren#1', (args) { (args[0] as _$RenderBackdropFilter)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$attach#1', (args) { (args[0] as _$RenderBackdropFilter)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$detach#0', (args) { (args[0] as _$RenderBackdropFilter)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderBackdropFilter)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderBackdropFilter)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderBackdropFilter)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$layout#2', (args) { (args[0] as _$RenderBackdropFilter)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderBackdropFilter)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderBackdropFilter)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderBackdropFilter)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderBackdropFilter)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderBackdropFilter)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderBackdropFilter)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderBackdropFilter)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$paintsChild#1', (args) => (args[0] as _$RenderBackdropFilter)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderBackdropFilter)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderBackdropFilter)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderBackdropFilter)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderBackdropFilter)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderBackdropFilter)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderBackdropFilter)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderBackdropFilter)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderBackdropFilter)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderBackdropFilter)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderBackdropFilter)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$toStringShort#0', (args) => (args[0] as _$RenderBackdropFilter)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderBackdropFilter)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderBackdropFilter)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderBackdropFilter)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderBackdropFilter)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$describeForError#2', (args) => (args[0] as _$RenderBackdropFilter)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderBackdropFilter)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderBackdropFilter)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$computeSizeForNoChild#1', (args) => (args[0] as _$RenderBackdropFilter)._super$computeSizeForNoChild(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$layer#0', (args) => (args[0] as _$RenderBackdropFilter)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$enabled#0', (args) => (args[0] as _$RenderBackdropFilter)._super$enabled);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$filter#0', (args) => (args[0] as _$RenderBackdropFilter)._super$filter);
    ...
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$constraints#0', (args) => (args[0] as _$RenderBackdropFilter)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$paintBounds#0', (args) => (args[0] as _$RenderBackdropFilter)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderBackdropFilter)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$parentData#0', (args) => (args[0] as _$RenderBackdropFilter)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$depth#0', (args) => (args[0] as _$RenderBackdropFilter)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$parent#0', (args) => (args[0] as _$RenderBackdropFilter)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderBackdropFilter)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugCreator#0', (args) => (args[0] as _$RenderBackdropFilter)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderBackdropFilter)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderBackdropFilter)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderBackdropFilter)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderBackdropFilter)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$owner#0', (args) => (args[0] as _$RenderBackdropFilter)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$attached#0', (args) => (args[0] as _$RenderBackdropFilter)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderBackdropFilter)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderBackdropFilter)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderBackdropFilter)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderBackdropFilter)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderBackdropFilter)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugLayer#0', (args) => (args[0] as _$RenderBackdropFilter)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderBackdropFilter)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderBackdropFilter)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderBackdropFilter)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderBackdropFilter)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderBackdropFilter)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$child#0', (args) => (args[0] as _$RenderBackdropFilter)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$enabled=#1', (args) { (args[0] as _$RenderBackdropFilter)._super$enabled = args[1] as bool; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$filter=#1', (args) { (args[0] as _$RenderBackdropFilter)._super$filter = args[1] as ui.ImageFilter; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$blendMode=#1', (args) { (args[0] as _$RenderBackdropFilter)._super$blendMode = args[1] as ui.BlendMode; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$backdropKey=#1', (args) { (args[0] as _$RenderBackdropFilter)._super$backdropKey = args[1] as BackdropKey?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$size=#1', (args) { (args[0] as _$RenderBackdropFilter)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderBackdropFilter::\$super\$parentData=#1', (args) { (args[0] as _$RenderBackdropFilter)._super$parentData = args[1] as ParentData?; return args[1]; });
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#1': (args) => (args[0] as RenderBackdropFilter).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
        ...
        'handleEvent#2': (args) { (args[0] as RenderBackdropFilter).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
