...
class _$RenderAppKitView extends RenderAppKitView implements DarticObjectHolder {
  _$RenderAppKitView(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(viewController: superArgs[0] as AppKitViewController, hitTestBehavior: superArgs[1] as PlatformViewHitTestBehavior, gestureRecognizers: (superArgs[2] as Set).cast<Factory<OneSequenceGestureRecognizer>>());
  ...
  void updateGestureRecognizers(Set<Factory<OneSequenceGestureRecognizer>> gestureRecognizers) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'updateGestureRecognizers', [gestureRecognizers]);
    if (identical(_$r, notOverridden)) { super.updateGestureRecognizers(gestureRecognizers); return; }
  }
  ...
  @override
  AppKitViewController get viewController {
    ...
    return r as AppKitViewController;
  }
  ...
  @override
  set viewController(AppKitViewController value) {
  ...
  AppKitViewController get _super$viewController => super.viewController;
  ...
  set _super$viewController(AppKitViewController value) { super.viewController = value; }
...
/// private class.
Object createRenderAppKitViewBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderAppKitView(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderAppKitView(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$updateGestureRecognizers#1', (args) { (args[0] as _$RenderAppKitView)._super$updateGestureRecognizers((args[1] as Set).cast<Factory<OneSequenceGestureRecognizer>>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$toString#1', (args) => (args[0] as _$RenderAppKitView)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderAppKitView)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$paint#2', (args) { (args[0] as _$RenderAppKitView)._super$paint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$hitTest#2', (args) => (args[0] as _$RenderAppKitView)._super$hitTest(args[1] as BoxHitTestResult, position: identical(args[2], darticAbsent) ? null : args[2] as Offset?));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderAppKitView)._super$hitTestSelf(args[1] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderAppKitView)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$attach#1', (args) { (args[0] as _$RenderAppKitView)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$detach#0', (args) { (args[0] as _$RenderAppKitView)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$setupParentData#1', (args) { (args[0] as _$RenderAppKitView)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderAppKitView)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderAppKitView)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderAppKitView)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderAppKitView)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderAppKitView)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderAppKitView)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderAppKitView)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderAppKitView)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderAppKitView)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderAppKitView)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderAppKitView)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderAppKitView)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderAppKitView)._super$debugAdoptSize(args[1] as Size));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderAppKitView)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderAppKitView)._super$getDistanceToBaseline(args[1] as TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderAppKitView)._super$getDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderAppKitView)._super$computeDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderAppKitView)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderAppKitView)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$performResize#0', (args) { (args[0] as _$RenderAppKitView)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$performLayout#0', (args) { (args[0] as _$RenderAppKitView)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderAppKitView)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderAppKitView)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderAppKitView)._super$globalToLocal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderAppKitView)._super$localToGlobal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$handleEvent#2', (args) { (args[0] as _$RenderAppKitView)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderAppKitView)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugPaint#2', (args) { (args[0] as _$RenderAppKitView)._super$debugPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderAppKitView)._super$debugPaintSize(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderAppKitView)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderAppKitView)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderAppKitView)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$reassemble#0', (args) { (args[0] as _$RenderAppKitView)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$dispose#0', (args) { (args[0] as _$RenderAppKitView)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$redepthChild#1', (args) { (args[0] as _$RenderAppKitView)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderAppKitView)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$adoptChild#1', (args) { (args[0] as _$RenderAppKitView)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$dropChild#1', (args) { (args[0] as _$RenderAppKitView)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$visitChildren#1', (args) { (args[0] as _$RenderAppKitView)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderAppKitView)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderAppKitView)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderAppKitView)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$layout#2', (args) { (args[0] as _$RenderAppKitView)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderAppKitView)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderAppKitView)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderAppKitView)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderAppKitView)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderAppKitView)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderAppKitView)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderAppKitView)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$paintsChild#1', (args) => (args[0] as _$RenderAppKitView)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderAppKitView)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderAppKitView)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderAppKitView)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderAppKitView)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderAppKitView)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderAppKitView)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderAppKitView)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderAppKitView)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderAppKitView)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$toStringShort#0', (args) => (args[0] as _$RenderAppKitView)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderAppKitView)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderAppKitView)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderAppKitView)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderAppKitView)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$describeForError#2', (args) => (args[0] as _$RenderAppKitView)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderAppKitView)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$viewController#0', (args) => (args[0] as _$RenderAppKitView)._super$viewController);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$hitTestBehavior#0', (args) => (args[0] as _$RenderAppKitView)._super$hitTestBehavior);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderAppKitView)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderAppKitView)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderAppKitView)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$hasSize#0', (args) => (args[0] as _$RenderAppKitView)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$size#0', (args) => (args[0] as _$RenderAppKitView)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderAppKitView)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$constraints#0', (args) => (args[0] as _$RenderAppKitView)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$paintBounds#0', (args) => (args[0] as _$RenderAppKitView)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderAppKitView)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$parentData#0', (args) => (args[0] as _$RenderAppKitView)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$depth#0', (args) => (args[0] as _$RenderAppKitView)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$parent#0', (args) => (args[0] as _$RenderAppKitView)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderAppKitView)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugCreator#0', (args) => (args[0] as _$RenderAppKitView)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderAppKitView)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderAppKitView)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderAppKitView)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderAppKitView)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$owner#0', (args) => (args[0] as _$RenderAppKitView)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$attached#0', (args) => (args[0] as _$RenderAppKitView)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderAppKitView)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderAppKitView)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderAppKitView)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$layer#0', (args) => (args[0] as _$RenderAppKitView)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugLayer#0', (args) => (args[0] as _$RenderAppKitView)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderAppKitView)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderAppKitView)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderAppKitView)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderAppKitView)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderAppKitView)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$viewController=#1', (args) { (args[0] as _$RenderAppKitView)._super$viewController = args[1] as AppKitViewController; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$hitTestBehavior=#1', (args) { (args[0] as _$RenderAppKitView)._super$hitTestBehavior = args[1] as PlatformViewHitTestBehavior; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$size=#1', (args) { (args[0] as _$RenderAppKitView)._super$size = args[1] as Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$parentData=#1', (args) { (args[0] as _$RenderAppKitView)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderAppKitView)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$layer=#1', (args) { (args[0] as _$RenderAppKitView)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderAppKitView::\$super\$hashCode#0', (args) => (args[0] as _$RenderAppKitView)._super$hashCode);
  }
