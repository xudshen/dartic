...
class _$RenderSliverScrollingPersistentHeader extends RenderSliverScrollingPersistentHeader implements DarticObjectHolder {
  _$RenderSliverScrollingPersistentHeader(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?, stretchConfiguration: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as OverScrollHeaderStretchConfiguration?);
...
/// private class.
Object createRenderSliverScrollingPersistentHeaderBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderSliverScrollingPersistentHeader(dispatch, obj, superArgs);
...
abstract final class RenderSliverScrollingPersistentHeaderBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderSliverScrollingPersistentHeader(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$updateGeometry#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$updateGeometry());
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$performLayout#0', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$childMainAxisPosition#1', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$childMainAxisPosition(args[1] as RenderBox));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$toString#1', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$updateChild#2', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$updateChild(args[1] as double, args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$layoutChild#3', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$layoutChild(args[1] as double, args[2] as double, overlapsContent: identical(args[3], darticAbsent) ? false : args[3] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$hitTestChildren#3', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$hitTestChildren(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$paint#2', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$paint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$performResize#0', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$hitTest#3', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$hitTest(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$hitTestSelf#2', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$hitTestSelf(mainAxisPosition: args[1] as double, crossAxisPosition: args[2] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$calculatePaintOffset#3', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$calculatePaintOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$calculateCacheOffset#3', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$calculateCacheOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$childCrossAxisPosition#1', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$childCrossAxisPosition(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$childScrollOffset#1', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$childScrollOffset(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$getAbsoluteSizeRelativeToOrigin#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$getAbsoluteSizeRelativeToOrigin());
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$getAbsoluteSize#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$getAbsoluteSize());
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$debugPaint#2', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$debugPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$handleEvent#2', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$reassemble#0', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$dispose#0', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$setupParentData#1', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$redepthChild#1', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$adoptChild#1', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$dropChild#1', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$visitChildren#1', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$attach#1', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$detach#0', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$layout#2', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$paintsChild#1', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$toStringShort#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$describeForError#2', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$hitTestBoxChild#4', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$hitTestBoxChild(args[1] as BoxHitTestResult, args[2] as RenderBox, mainAxisPosition: args[3] as double, crossAxisPosition: args[4] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$applyPaintTransformForBoxChild#2', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$applyPaintTransformForBoxChild(args[1] as RenderBox, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$childExtent#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$childExtent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$lastShrinkOffset#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$lastShrinkOffset);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$lastOverlapsContent#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$lastOverlapsContent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$stretchConfiguration#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$stretchConfiguration);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$ensureSemantics#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$ensureSemantics);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$constraints#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$geometry#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$geometry);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$paintBounds#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$centerOffsetAdjustment#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$centerOffsetAdjustment);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$parentData#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$depth#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$parent#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$debugCreator#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$owner#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$attached#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$layer#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$debugLayer#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$child#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$stretchConfiguration=#1', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$stretchConfiguration = args[1] as OverScrollHeaderStretchConfiguration?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$geometry=#1', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$geometry = args[1] as SliverGeometry?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$parentData=#1', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$layer=#1', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$child=#1', (args) { (args[0] as _$RenderSliverScrollingPersistentHeader)._super$child = args[1] as RenderBox?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverScrollingPersistentHeader::\$super\$hashCode#0', (args) => (args[0] as _$RenderSliverScrollingPersistentHeader)._super$hashCode);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderSliverScrollingPersistentHeader).handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; },
