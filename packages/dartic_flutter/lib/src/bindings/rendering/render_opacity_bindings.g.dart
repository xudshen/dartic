...
class _$RenderOpacity extends RenderOpacity implements DarticObjectHolder {
  _$RenderOpacity(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(opacity: superArgs[0] as double, alwaysIncludeSemantics: superArgs[1] as bool, child: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as RenderBox?);
  ...
  set alwaysIncludeSemantics(bool value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'alwaysIncludeSemantics', value)) {
  ...
  OffsetLayer _super$updateCompositedLayer({required OpacityLayer? oldLayer}) => super.updateCompositedLayer(oldLayer: oldLayer);
  ...
  set _super$opacity(double value) { super.opacity = value; }
  set _super$alwaysIncludeSemantics(bool value) { super.alwaysIncludeSemantics = value; }
...
/// private class.
Object createRenderOpacityBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderOpacity(dispatch, obj, superArgs);
...
abstract final class RenderOpacityBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderOpacity(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$paintsChild#1', (args) => (args[0] as _$RenderOpacity)._super$paintsChild(args[1] as RenderBox));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderOpacity)._super$updateCompositedLayer(oldLayer: args[1] as OpacityLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$paint#2', (args) { (args[0] as _$RenderOpacity)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderOpacity)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderOpacity)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$toString#1', (args) => (args[0] as _$RenderOpacity)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$setupParentData#1', (args) { (args[0] as _$RenderOpacity)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderOpacity)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderOpacity)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderOpacity)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderOpacity)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderOpacity)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderOpacity)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderOpacity)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderOpacity)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderOpacity)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderOpacity)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderOpacity)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderOpacity)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderOpacity)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderOpacity)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderOpacity)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderOpacity)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderOpacity)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderOpacity)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderOpacity)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderOpacity)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$performResize#0', (args) { (args[0] as _$RenderOpacity)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$performLayout#0', (args) { (args[0] as _$RenderOpacity)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$hitTest#2', (args) => (args[0] as _$RenderOpacity)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderOpacity)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderOpacity)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderOpacity)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderOpacity)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderOpacity)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$handleEvent#2', (args) { (args[0] as _$RenderOpacity)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderOpacity)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugPaint#2', (args) { (args[0] as _$RenderOpacity)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderOpacity)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderOpacity)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderOpacity)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$reassemble#0', (args) { (args[0] as _$RenderOpacity)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$dispose#0', (args) { (args[0] as _$RenderOpacity)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$redepthChild#1', (args) { (args[0] as _$RenderOpacity)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderOpacity)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$adoptChild#1', (args) { (args[0] as _$RenderOpacity)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$dropChild#1', (args) { (args[0] as _$RenderOpacity)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$visitChildren#1', (args) { (args[0] as _$RenderOpacity)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$attach#1', (args) { (args[0] as _$RenderOpacity)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$detach#0', (args) { (args[0] as _$RenderOpacity)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderOpacity)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderOpacity)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderOpacity)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$layout#2', (args) { (args[0] as _$RenderOpacity)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderOpacity)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderOpacity)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderOpacity)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderOpacity)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderOpacity)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderOpacity)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderOpacity)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderOpacity)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderOpacity)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderOpacity)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderOpacity)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderOpacity)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderOpacity)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderOpacity)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderOpacity)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$toStringShort#0', (args) => (args[0] as _$RenderOpacity)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderOpacity)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderOpacity)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderOpacity)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderOpacity)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$describeForError#2', (args) => (args[0] as _$RenderOpacity)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderOpacity)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderOpacity)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$computeSizeForNoChild#1', (args) => (args[0] as _$RenderOpacity)._super$computeSizeForNoChild(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderOpacity)._super$alwaysNeedsCompositing);
    ...
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$constraints#0', (args) => (args[0] as _$RenderOpacity)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$paintBounds#0', (args) => (args[0] as _$RenderOpacity)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderOpacity)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$parentData#0', (args) => (args[0] as _$RenderOpacity)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$depth#0', (args) => (args[0] as _$RenderOpacity)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$parent#0', (args) => (args[0] as _$RenderOpacity)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderOpacity)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugCreator#0', (args) => (args[0] as _$RenderOpacity)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderOpacity)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderOpacity)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderOpacity)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderOpacity)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$owner#0', (args) => (args[0] as _$RenderOpacity)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$attached#0', (args) => (args[0] as _$RenderOpacity)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderOpacity)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderOpacity)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderOpacity)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderOpacity)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$layer#0', (args) => (args[0] as _$RenderOpacity)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugLayer#0', (args) => (args[0] as _$RenderOpacity)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderOpacity)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderOpacity)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderOpacity)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderOpacity)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderOpacity)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$child#0', (args) => (args[0] as _$RenderOpacity)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$opacity=#1', (args) { (args[0] as _$RenderOpacity)._super$opacity = args[1] as double; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$alwaysIncludeSemantics=#1', (args) { (args[0] as _$RenderOpacity)._super$alwaysIncludeSemantics = args[1] as bool; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$size=#1', (args) { (args[0] as _$RenderOpacity)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOpacity::\$super\$parentData=#1', (args) { (args[0] as _$RenderOpacity)._super$parentData = args[1] as ParentData?; return args[1]; });
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#1': (args) => (args[0] as RenderOpacity).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
        ...
        'handleEvent#2': (args) { (args[0] as RenderOpacity).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
