...
class _$RenderProxyBox extends RenderProxyBox implements DarticObjectHolder {
  _$RenderProxyBox(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?);
...
/// private class.
Object createRenderProxyBoxBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderProxyBox(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderProxyBox(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$toString#1', (args) => (args[0] as _$RenderProxyBox)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$setupParentData#1', (args) { (args[0] as _$RenderProxyBox)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderProxyBox)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderProxyBox)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderProxyBox)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderProxyBox)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderProxyBox)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderProxyBox)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderProxyBox)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderProxyBox)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderProxyBox)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderProxyBox)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderProxyBox)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderProxyBox)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderProxyBox)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderProxyBox)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderProxyBox)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderProxyBox)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderProxyBox)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderProxyBox)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderProxyBox)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderProxyBox)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$performResize#0', (args) { (args[0] as _$RenderProxyBox)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$performLayout#0', (args) { (args[0] as _$RenderProxyBox)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$hitTest#2', (args) => (args[0] as _$RenderProxyBox)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderProxyBox)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderProxyBox)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderProxyBox)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderProxyBox)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderProxyBox)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$handleEvent#2', (args) { (args[0] as _$RenderProxyBox)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderProxyBox)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugPaint#2', (args) { (args[0] as _$RenderProxyBox)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderProxyBox)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderProxyBox)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderProxyBox)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderProxyBox)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$reassemble#0', (args) { (args[0] as _$RenderProxyBox)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$dispose#0', (args) { (args[0] as _$RenderProxyBox)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$redepthChild#1', (args) { (args[0] as _$RenderProxyBox)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderProxyBox)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$adoptChild#1', (args) { (args[0] as _$RenderProxyBox)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$dropChild#1', (args) { (args[0] as _$RenderProxyBox)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$visitChildren#1', (args) { (args[0] as _$RenderProxyBox)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$attach#1', (args) { (args[0] as _$RenderProxyBox)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$detach#0', (args) { (args[0] as _$RenderProxyBox)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderProxyBox)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderProxyBox)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderProxyBox)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$layout#2', (args) { (args[0] as _$RenderProxyBox)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderProxyBox)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderProxyBox)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderProxyBox)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderProxyBox)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderProxyBox)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderProxyBox)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderProxyBox)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$paint#2', (args) { (args[0] as _$RenderProxyBox)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$paintsChild#1', (args) => (args[0] as _$RenderProxyBox)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderProxyBox)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderProxyBox)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderProxyBox)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderProxyBox)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderProxyBox)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderProxyBox)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderProxyBox)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderProxyBox)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderProxyBox)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderProxyBox)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$toStringShort#0', (args) => (args[0] as _$RenderProxyBox)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderProxyBox)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderProxyBox)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderProxyBox)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderProxyBox)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$describeForError#2', (args) => (args[0] as _$RenderProxyBox)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderProxyBox)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderProxyBox)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$computeSizeForNoChild#1', (args) => (args[0] as _$RenderProxyBox)._super$computeSizeForNoChild(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$hasSize#0', (args) => (args[0] as _$RenderProxyBox)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$size#0', (args) => (args[0] as _$RenderProxyBox)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderProxyBox)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$constraints#0', (args) => (args[0] as _$RenderProxyBox)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$paintBounds#0', (args) => (args[0] as _$RenderProxyBox)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderProxyBox)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$parentData#0', (args) => (args[0] as _$RenderProxyBox)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$depth#0', (args) => (args[0] as _$RenderProxyBox)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$parent#0', (args) => (args[0] as _$RenderProxyBox)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderProxyBox)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugCreator#0', (args) => (args[0] as _$RenderProxyBox)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderProxyBox)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderProxyBox)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderProxyBox)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderProxyBox)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$owner#0', (args) => (args[0] as _$RenderProxyBox)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$attached#0', (args) => (args[0] as _$RenderProxyBox)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderProxyBox)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderProxyBox)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderProxyBox)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderProxyBox)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderProxyBox)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderProxyBox)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$layer#0', (args) => (args[0] as _$RenderProxyBox)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugLayer#0', (args) => (args[0] as _$RenderProxyBox)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderProxyBox)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderProxyBox)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderProxyBox)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderProxyBox)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderProxyBox)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$child#0', (args) => (args[0] as _$RenderProxyBox)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$size=#1', (args) { (args[0] as _$RenderProxyBox)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$parentData=#1', (args) { (args[0] as _$RenderProxyBox)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderProxyBox)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$layer=#1', (args) { (args[0] as _$RenderProxyBox)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$child=#1', (args) { (args[0] as _$RenderProxyBox)._super$child = args[1] as RenderBox?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBox::\$super\$hashCode#0', (args) => (args[0] as _$RenderProxyBox)._super$hashCode);
  }

  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        'toString#1': (args) => (args[0] as RenderProxyBox).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
        ...
        'handleEvent#2': (args) { (args[0] as RenderProxyBox).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
