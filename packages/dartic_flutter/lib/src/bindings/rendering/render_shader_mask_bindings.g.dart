...
class _$RenderShaderMask extends RenderShaderMask implements DarticObjectHolder {
  _$RenderShaderMask(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?, shaderCallback: superArgs[1] as ShaderCallback, blendMode: superArgs[2] as ui.BlendMode);
  ...
  set shaderCallback(ShaderCallback value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'shaderCallback', value)) {
  ...
  ShaderMaskLayer? get _super$layer => super.layer;
  ...
  set _super$shaderCallback(ShaderCallback value) { super.shaderCallback = value; }
...
/// private class.
Object createRenderShaderMaskBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderShaderMask(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderShaderMask(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$paint#2', (args) { (args[0] as _$RenderShaderMask)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$toString#1', (args) => (args[0] as _$RenderShaderMask)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$setupParentData#1', (args) { (args[0] as _$RenderShaderMask)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderShaderMask)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderShaderMask)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderShaderMask)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderShaderMask)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderShaderMask)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderShaderMask)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderShaderMask)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderShaderMask)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderShaderMask)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderShaderMask)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderShaderMask)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderShaderMask)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderShaderMask)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderShaderMask)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderShaderMask)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderShaderMask)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderShaderMask)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderShaderMask)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderShaderMask)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderShaderMask)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$performResize#0', (args) { (args[0] as _$RenderShaderMask)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$performLayout#0', (args) { (args[0] as _$RenderShaderMask)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$hitTest#2', (args) => (args[0] as _$RenderShaderMask)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderShaderMask)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderShaderMask)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderShaderMask)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderShaderMask)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderShaderMask)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$handleEvent#2', (args) { (args[0] as _$RenderShaderMask)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderShaderMask)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugPaint#2', (args) { (args[0] as _$RenderShaderMask)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderShaderMask)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderShaderMask)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderShaderMask)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderShaderMask)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$reassemble#0', (args) { (args[0] as _$RenderShaderMask)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$dispose#0', (args) { (args[0] as _$RenderShaderMask)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$redepthChild#1', (args) { (args[0] as _$RenderShaderMask)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderShaderMask)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$adoptChild#1', (args) { (args[0] as _$RenderShaderMask)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$dropChild#1', (args) { (args[0] as _$RenderShaderMask)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$visitChildren#1', (args) { (args[0] as _$RenderShaderMask)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$attach#1', (args) { (args[0] as _$RenderShaderMask)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$detach#0', (args) { (args[0] as _$RenderShaderMask)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderShaderMask)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderShaderMask)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderShaderMask)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$layout#2', (args) { (args[0] as _$RenderShaderMask)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderShaderMask)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderShaderMask)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderShaderMask)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderShaderMask)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderShaderMask)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderShaderMask)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderShaderMask)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$paintsChild#1', (args) => (args[0] as _$RenderShaderMask)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderShaderMask)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderShaderMask)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderShaderMask)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderShaderMask)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderShaderMask)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderShaderMask)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderShaderMask)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderShaderMask)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderShaderMask)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderShaderMask)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$toStringShort#0', (args) => (args[0] as _$RenderShaderMask)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderShaderMask)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderShaderMask)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderShaderMask)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderShaderMask)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$describeForError#2', (args) => (args[0] as _$RenderShaderMask)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderShaderMask)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderShaderMask)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$computeSizeForNoChild#1', (args) => (args[0] as _$RenderShaderMask)._super$computeSizeForNoChild(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$layer#0', (args) => (args[0] as _$RenderShaderMask)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$shaderCallback#0', (args) => (args[0] as _$RenderShaderMask)._super$shaderCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$blendMode#0', (args) => (args[0] as _$RenderShaderMask)._super$blendMode);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderShaderMask)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$hasSize#0', (args) => (args[0] as _$RenderShaderMask)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$size#0', (args) => (args[0] as _$RenderShaderMask)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderShaderMask)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$constraints#0', (args) => (args[0] as _$RenderShaderMask)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$paintBounds#0', (args) => (args[0] as _$RenderShaderMask)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderShaderMask)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$parentData#0', (args) => (args[0] as _$RenderShaderMask)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$depth#0', (args) => (args[0] as _$RenderShaderMask)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$parent#0', (args) => (args[0] as _$RenderShaderMask)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderShaderMask)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugCreator#0', (args) => (args[0] as _$RenderShaderMask)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderShaderMask)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderShaderMask)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderShaderMask)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderShaderMask)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$owner#0', (args) => (args[0] as _$RenderShaderMask)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$attached#0', (args) => (args[0] as _$RenderShaderMask)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderShaderMask)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderShaderMask)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderShaderMask)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderShaderMask)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderShaderMask)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugLayer#0', (args) => (args[0] as _$RenderShaderMask)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderShaderMask)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderShaderMask)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderShaderMask)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderShaderMask)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderShaderMask)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$child#0', (args) => (args[0] as _$RenderShaderMask)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$shaderCallback=#1', (args) { (args[0] as _$RenderShaderMask)._super$shaderCallback = args[1] as ShaderCallback; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$blendMode=#1', (args) { (args[0] as _$RenderShaderMask)._super$blendMode = args[1] as ui.BlendMode; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$size=#1', (args) { (args[0] as _$RenderShaderMask)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$parentData=#1', (args) { (args[0] as _$RenderShaderMask)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderShaderMask)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$layer=#1', (args) { (args[0] as _$RenderShaderMask)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$child=#1', (args) { (args[0] as _$RenderShaderMask)._super$child = args[1] as RenderBox?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderShaderMask::\$super\$hashCode#0', (args) => (args[0] as _$RenderShaderMask)._super$hashCode);
  }

  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        'paint#2': (args) { (args[0] as RenderShaderMask).paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; },
        'toString#1': (args) => (args[0] as RenderShaderMask).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
        ...
        'handleEvent#2': (args) { (args[0] as RenderShaderMask).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
