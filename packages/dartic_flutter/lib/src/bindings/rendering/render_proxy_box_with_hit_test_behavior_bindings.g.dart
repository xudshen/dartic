...
class _$RenderProxyBoxWithHitTestBehavior extends RenderProxyBoxWithHitTestBehavior implements DarticObjectHolder {
  _$RenderProxyBoxWithHitTestBehavior(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(behavior: superArgs[0] as HitTestBehavior, child: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as RenderBox?);
...
/// private class.
Object createRenderProxyBoxWithHitTestBehaviorBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderProxyBoxWithHitTestBehavior(dispatch, obj, superArgs);
...
abstract final class RenderProxyBoxWithHitTestBehaviorBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderProxyBoxWithHitTestBehavior(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$hitTest#2', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$toString#1', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$setupParentData#1', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$performResize#0', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$performLayout#0', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$handleEvent#2', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugPaint#2', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$reassemble#0', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$dispose#0', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$redepthChild#1', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$adoptChild#1', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$dropChild#1', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$visitChildren#1', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$attach#1', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$detach#0', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$layout#2', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$paint#2', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$paintsChild#1', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$toStringShort#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$describeForError#2', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$computeSizeForNoChild#1', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$computeSizeForNoChild(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$behavior#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$behavior);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$hasSize#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$size#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$constraints#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$paintBounds#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$parentData#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$depth#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$parent#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugCreator#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$owner#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$attached#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$layer#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugLayer#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$child#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$behavior=#1', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$behavior = args[1] as HitTestBehavior; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$size=#1', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$parentData=#1', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$layer=#1', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$child=#1', (args) { (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$child = args[1] as RenderBox?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderProxyBoxWithHitTestBehavior::\$super\$hashCode#0', (args) => (args[0] as _$RenderProxyBoxWithHitTestBehavior)._super$hashCode);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderProxyBoxWithHitTestBehavior).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
