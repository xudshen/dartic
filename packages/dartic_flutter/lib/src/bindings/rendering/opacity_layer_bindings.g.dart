...
class _$OpacityLayer extends OpacityLayer implements DarticObjectHolder {
  _$OpacityLayer(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(alpha: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as int?, offset: superArgs[1] as ui.Offset);
  ...
  Future<ui.Image> toImage(ui.Rect bounds, {double pixelRatio = 1.0}) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'toImage', [bounds, pixelRatio]);
    if (identical(r, notOverridden)) return super.toImage(bounds, pixelRatio: pixelRatio);
    return r as Future<ui.Image>;
  }

  @override
  ui.Image toImageSync(ui.Rect bounds, {double pixelRatio = 1.0}) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'toImageSync', [bounds, pixelRatio]);
    if (identical(r, notOverridden)) return super.toImageSync(bounds, pixelRatio: pixelRatio);
  ...
  @override
  set alpha(int? value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'alpha', value)) {
      super.alpha = value;
    }
  }
  ...
  set _super$alpha(int? value) { super.alpha = value; }
...
/// private class.
Object createOpacityLayerBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$OpacityLayer(dispatch, obj, superArgs);
...
abstract final class OpacityLayerBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$OpacityLayer(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$addToScene#1', (args) { (args[0] as _$OpacityLayer)._super$addToScene(args[1] as ui.SceneBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$debugFillProperties#1', (args) { (args[0] as _$OpacityLayer)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$toString#1', (args) => (args[0] as _$OpacityLayer)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$applyTransform#2', (args) { (args[0] as _$OpacityLayer)._super$applyTransform(args[1] as Layer?, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$toImage#2', (args) => (args[0] as _$OpacityLayer)._super$toImage(args[1] as ui.Rect, pixelRatio: identical(args[2], darticAbsent) ? 1.0 : args[2] as double));
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$toImageSync#2', (args) => (args[0] as _$OpacityLayer)._super$toImageSync(args[1] as ui.Rect, pixelRatio: identical(args[2], darticAbsent) ? 1.0 : args[2] as double));
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$supportsRasterization#0', (args) => (args[0] as _$OpacityLayer)._super$supportsRasterization());
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$buildScene#1', (args) => (args[0] as _$OpacityLayer)._super$buildScene(args[1] as ui.SceneBuilder));
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$dispose#0', (args) { (args[0] as _$OpacityLayer)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$updateSubtreeNeedsAddToScene#0', (args) { (args[0] as _$OpacityLayer)._super$updateSubtreeNeedsAddToScene(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$attach#1', (args) { (args[0] as _$OpacityLayer)._super$attach(args[1] as Object); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$detach#0', (args) { (args[0] as _$OpacityLayer)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$append#1', (args) { (args[0] as _$OpacityLayer)._super$append(args[1] as Layer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$redepthChildren#0', (args) { (args[0] as _$OpacityLayer)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$redepthChild#1', (args) { (args[0] as _$OpacityLayer)._super$redepthChild(args[1] as Layer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$removeAllChildren#0', (args) { (args[0] as _$OpacityLayer)._super$removeAllChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$addChildrenToScene#1', (args) { (args[0] as _$OpacityLayer)._super$addChildrenToScene(args[1] as ui.SceneBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$depthFirstIterateChildren#0', (args) => (args[0] as _$OpacityLayer)._super$depthFirstIterateChildren());
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$OpacityLayer)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$describeClipBounds#0', (args) => (args[0] as _$OpacityLayer)._super$describeClipBounds());
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$addCompositionCallback#1', (args) => (args[0] as _$OpacityLayer)._super$addCompositionCallback((a) => (args[1] as Function)(a)));
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$markNeedsAddToScene#0', (args) { (args[0] as _$OpacityLayer)._super$markNeedsAddToScene(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$debugMarkClean#0', (args) { (args[0] as _$OpacityLayer)._super$debugMarkClean(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$remove#0', (args) { (args[0] as _$OpacityLayer)._super$remove(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$toStringShort#0', (args) => (args[0] as _$OpacityLayer)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$toStringShallow#2', (args) => (args[0] as _$OpacityLayer)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$toStringDeep#4', (args) => (args[0] as _$OpacityLayer)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$OpacityLayer)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$alpha#0', (args) => (args[0] as _$OpacityLayer)._super$alpha);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$hashCode#0', (args) => (args[0] as _$OpacityLayer)._super$hashCode);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$offset#0', (args) => (args[0] as _$OpacityLayer)._super$offset);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$firstChild#0', (args) => (args[0] as _$OpacityLayer)._super$firstChild);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$lastChild#0', (args) => (args[0] as _$OpacityLayer)._super$lastChild);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$hasChildren#0', (args) => (args[0] as _$OpacityLayer)._super$hasChildren);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$subtreeHasCompositionCallbacks#0', (args) => (args[0] as _$OpacityLayer)._super$subtreeHasCompositionCallbacks);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$debugDisposed#0', (args) => (args[0] as _$OpacityLayer)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$debugHandleCount#0', (args) => (args[0] as _$OpacityLayer)._super$debugHandleCount);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$parent#0', (args) => (args[0] as _$OpacityLayer)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$alwaysNeedsAddToScene#0', (args) => (args[0] as _$OpacityLayer)._super$alwaysNeedsAddToScene);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$debugSubtreeNeedsAddToScene#0', (args) => (args[0] as _$OpacityLayer)._super$debugSubtreeNeedsAddToScene);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$engineLayer#0', (args) => (args[0] as _$OpacityLayer)._super$engineLayer);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$owner#0', (args) => (args[0] as _$OpacityLayer)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$attached#0', (args) => (args[0] as _$OpacityLayer)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$depth#0', (args) => (args[0] as _$OpacityLayer)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$nextSibling#0', (args) => (args[0] as _$OpacityLayer)._super$nextSibling);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$previousSibling#0', (args) => (args[0] as _$OpacityLayer)._super$previousSibling);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$debugCreator#0', (args) => (args[0] as _$OpacityLayer)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$alpha=#1', (args) { (args[0] as _$OpacityLayer)._super$alpha = args[1] as int?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$offset=#1', (args) { (args[0] as _$OpacityLayer)._super$offset = args[1] as ui.Offset; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$engineLayer=#1', (args) { (args[0] as _$OpacityLayer)._super$engineLayer = args[1] as ui.EngineLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::OpacityLayer::\$super\$debugCreator=#1', (args) { (args[0] as _$OpacityLayer)._super$debugCreator = args[1]; return args[1]; });
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#1': (args) => (args[0] as OpacityLayer).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
