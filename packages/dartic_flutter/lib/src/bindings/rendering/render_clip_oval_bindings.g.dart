...
class _$RenderClipOval extends RenderClipOval implements DarticObjectHolder {
  _$RenderClipOval(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?, clipper: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as CustomClipper<ui.Rect>?, clipBehavior: superArgs[2] as ui.Clip);
...
/// private class.
Object createRenderClipOvalBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderClipOval(dispatch, obj, superArgs);
...
abstract final class RenderClipOvalBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderClipOval(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$hitTest#2', (args) => (args[0] as _$RenderClipOval)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$paint#2', (args) { (args[0] as _$RenderClipOval)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderClipOval)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$toString#1', (args) => (args[0] as _$RenderClipOval)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$attach#1', (args) { (args[0] as _$RenderClipOval)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$detach#0', (args) { (args[0] as _$RenderClipOval)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$performLayout#0', (args) { (args[0] as _$RenderClipOval)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderClipOval)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$dispose#0', (args) { (args[0] as _$RenderClipOval)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$setupParentData#1', (args) { (args[0] as _$RenderClipOval)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderClipOval)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderClipOval)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderClipOval)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderClipOval)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderClipOval)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderClipOval)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderClipOval)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderClipOval)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderClipOval)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderClipOval)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderClipOval)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderClipOval)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderClipOval)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderClipOval)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderClipOval)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderClipOval)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderClipOval)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderClipOval)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderClipOval)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderClipOval)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$performResize#0', (args) { (args[0] as _$RenderClipOval)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderClipOval)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderClipOval)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderClipOval)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderClipOval)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderClipOval)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$handleEvent#2', (args) { (args[0] as _$RenderClipOval)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderClipOval)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugPaint#2', (args) { (args[0] as _$RenderClipOval)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderClipOval)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderClipOval)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderClipOval)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$reassemble#0', (args) { (args[0] as _$RenderClipOval)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$redepthChild#1', (args) { (args[0] as _$RenderClipOval)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderClipOval)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$adoptChild#1', (args) { (args[0] as _$RenderClipOval)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$dropChild#1', (args) { (args[0] as _$RenderClipOval)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$visitChildren#1', (args) { (args[0] as _$RenderClipOval)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderClipOval)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderClipOval)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderClipOval)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$layout#2', (args) { (args[0] as _$RenderClipOval)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderClipOval)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderClipOval)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderClipOval)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderClipOval)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderClipOval)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderClipOval)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderClipOval)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$paintsChild#1', (args) => (args[0] as _$RenderClipOval)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderClipOval)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderClipOval)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderClipOval)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderClipOval)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderClipOval)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderClipOval)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderClipOval)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderClipOval)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderClipOval)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$toStringShort#0', (args) => (args[0] as _$RenderClipOval)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderClipOval)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderClipOval)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderClipOval)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderClipOval)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$describeForError#2', (args) => (args[0] as _$RenderClipOval)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ...
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$size#0', (args) => (args[0] as _$RenderClipOval)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderClipOval)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$constraints#0', (args) => (args[0] as _$RenderClipOval)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$paintBounds#0', (args) => (args[0] as _$RenderClipOval)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderClipOval)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$parentData#0', (args) => (args[0] as _$RenderClipOval)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$depth#0', (args) => (args[0] as _$RenderClipOval)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$parent#0', (args) => (args[0] as _$RenderClipOval)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderClipOval)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugCreator#0', (args) => (args[0] as _$RenderClipOval)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderClipOval)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderClipOval)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderClipOval)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderClipOval)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$owner#0', (args) => (args[0] as _$RenderClipOval)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$attached#0', (args) => (args[0] as _$RenderClipOval)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderClipOval)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderClipOval)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderClipOval)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderClipOval)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderClipOval)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderClipOval)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$layer#0', (args) => (args[0] as _$RenderClipOval)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugLayer#0', (args) => (args[0] as _$RenderClipOval)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderClipOval)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderClipOval)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderClipOval)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderClipOval)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderClipOval)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$child#0', (args) => (args[0] as _$RenderClipOval)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$clipper=#1', (args) { (args[0] as _$RenderClipOval)._super$clipper = args[1] as CustomClipper<ui.Rect>?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$clipBehavior=#1', (args) { (args[0] as _$RenderClipOval)._super$clipBehavior = args[1] as ui.Clip; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$size=#1', (args) { (args[0] as _$RenderClipOval)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipOval::\$super\$parentData=#1', (args) { (args[0] as _$RenderClipOval)._super$parentData = args[1] as ParentData?; return args[1]; });
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#1': (args) => (args[0] as RenderClipOval).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
        ...
        'handleEvent#2': (args) { (args[0] as RenderClipOval).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
        ...
        'hashCode#0': (args) => (args[0] as RenderClipOval).hashCode,
        ...
        '==#1': (args) => (args[0] as RenderClipOval) == (args[1] as Object),
