...
class _$RenderSliverFloatingPersistentHeader extends RenderSliverFloatingPersistentHeader implements DarticObjectHolder {
  _$RenderSliverFloatingPersistentHeader(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?, vsync: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as TickerProvider?, snapConfiguration: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as FloatingHeaderSnapConfiguration?, stretchConfiguration: identical(superArgs[3], darticAbsent) ? null : superArgs[3] as OverScrollHeaderStretchConfiguration?, showOnScreenConfiguration: superArgs[4] as PersistentHeaderShowOnScreenConfiguration?);
  ...
  double updateGeometry() {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'updateGeometry', const []);
    if (identical(_$r, notOverridden)) return super.updateGeometry();
    return _$r as double;
  }

  @override
  void updateScrollStartDirection(ScrollDirection direction) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'updateScrollStartDirection', [direction]);
    if (identical(_$r, notOverridden)) { super.updateScrollStartDirection(direction); return; }
  }

  @override
  void maybeStartSnapAnimation(ScrollDirection direction) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'maybeStartSnapAnimation', [direction]);
    if (identical(_$r, notOverridden)) { super.maybeStartSnapAnimation(direction); return; }
  }

  @override
  void maybeStopSnapAnimation(ScrollDirection direction) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'maybeStopSnapAnimation', [direction]);
    if (identical(_$r, notOverridden)) { super.maybeStopSnapAnimation(direction); return; }
  }
  ...
  void updateChild(double shrinkOffset, bool overlapsContent) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'updateChild', [shrinkOffset, overlapsContent]);
    if (identical(_$r, notOverridden)) { super.updateChild(shrinkOffset, overlapsContent); return; }
  }
  ...
  void layoutChild(double scrollOffset, double maxExtent, {bool overlapsContent = false}) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'layoutChild', [scrollOffset, maxExtent, overlapsContent]);
    if (identical(_$r, notOverridden)) { super.layoutChild(scrollOffset, maxExtent, overlapsContent: overlapsContent); return; }
  }
  ...
  set vsync(TickerProvider? value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'vsync', value)) {
      super.vsync = value;
    }
  }
  ...
  set snapConfiguration(FloatingHeaderSnapConfiguration? value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'snapConfiguration', value)) {
  ...
  double _super$updateGeometry() => super.updateGeometry();
  void _super$updateScrollStartDirection(ScrollDirection direction) { super.updateScrollStartDirection(direction); }
  void _super$maybeStartSnapAnimation(ScrollDirection direction) { super.maybeStartSnapAnimation(direction); }
  void _super$maybeStopSnapAnimation(ScrollDirection direction) { super.maybeStopSnapAnimation(direction); }
  ...
  set _super$vsync(TickerProvider? value) { super.vsync = value; }
  set _super$snapConfiguration(FloatingHeaderSnapConfiguration? value) { super.snapConfiguration = value; }
...
/// private class.
Object createRenderSliverFloatingPersistentHeaderBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderSliverFloatingPersistentHeader(dispatch, obj, superArgs);
...
abstract final class RenderSliverFloatingPersistentHeaderBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderSliverFloatingPersistentHeader(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$detach#0', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$updateGeometry#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$updateGeometry());
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$updateScrollStartDirection#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$updateScrollStartDirection(args[1] as ScrollDirection); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$maybeStartSnapAnimation#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$maybeStartSnapAnimation(args[1] as ScrollDirection); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$maybeStopSnapAnimation#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$maybeStopSnapAnimation(args[1] as ScrollDirection); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$performLayout#0', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$childMainAxisPosition#1', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$childMainAxisPosition(args[1] as RenderBox));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$toString#1', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$updateChild#2', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$updateChild(args[1] as double, args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$layoutChild#3', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$layoutChild(args[1] as double, args[2] as double, overlapsContent: identical(args[3], darticAbsent) ? false : args[3] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$hitTestChildren#3', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$hitTestChildren(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$paint#2', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$paint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$performResize#0', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$hitTest#3', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$hitTest(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$hitTestSelf#2', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$hitTestSelf(mainAxisPosition: args[1] as double, crossAxisPosition: args[2] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$calculatePaintOffset#3', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$calculatePaintOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$calculateCacheOffset#3', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$calculateCacheOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$childCrossAxisPosition#1', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$childCrossAxisPosition(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$childScrollOffset#1', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$childScrollOffset(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$getAbsoluteSizeRelativeToOrigin#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$getAbsoluteSizeRelativeToOrigin());
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$getAbsoluteSize#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$getAbsoluteSize());
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$debugPaint#2', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$debugPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$handleEvent#2', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$reassemble#0', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$dispose#0', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$setupParentData#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$redepthChild#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$adoptChild#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$dropChild#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$visitChildren#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$attach#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$layout#2', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$paintsChild#1', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$toStringShort#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$describeForError#2', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$hitTestBoxChild#4', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$hitTestBoxChild(args[1] as BoxHitTestResult, args[2] as RenderBox, mainAxisPosition: args[3] as double, crossAxisPosition: args[4] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$applyPaintTransformForBoxChild#2', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$applyPaintTransformForBoxChild(args[1] as RenderBox, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$vsync#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$vsync);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$snapConfiguration#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$snapConfiguration);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$showOnScreenConfiguration#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$showOnScreenConfiguration);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$childExtent#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$childExtent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$lastShrinkOffset#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$lastShrinkOffset);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$lastOverlapsContent#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$lastOverlapsContent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$stretchConfiguration#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$stretchConfiguration);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$ensureSemantics#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$ensureSemantics);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$constraints#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$geometry#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$geometry);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$paintBounds#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$centerOffsetAdjustment#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$centerOffsetAdjustment);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$parentData#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$depth#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$parent#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$debugCreator#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$owner#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$attached#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$layer#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$debugLayer#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$child#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$vsync=#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$vsync = args[1] as TickerProvider?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$snapConfiguration=#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$snapConfiguration = args[1] as FloatingHeaderSnapConfiguration?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$showOnScreenConfiguration=#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$showOnScreenConfiguration = args[1] as PersistentHeaderShowOnScreenConfiguration?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$stretchConfiguration=#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$stretchConfiguration = args[1] as OverScrollHeaderStretchConfiguration?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$geometry=#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$geometry = args[1] as SliverGeometry?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$parentData=#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$layer=#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$child=#1', (args) { (args[0] as _$RenderSliverFloatingPersistentHeader)._super$child = args[1] as RenderBox?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPersistentHeader::\$super\$hashCode#0', (args) => (args[0] as _$RenderSliverFloatingPersistentHeader)._super$hashCode);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#1': (args) => (args[0] as RenderSliverFloatingPersistentHeader).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
        ...
        'handleEvent#2': (args) { (args[0] as RenderSliverFloatingPersistentHeader).handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; },
