...
class _$RenderSliverFloatingPersistentHeader extends RenderSliverFloatingPersistentHeader implements DarticObjectHolder {
  ...
  double updateGeometry() {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'updateGeometry', const []);
    if (identical(r, notOverridden)) return super.updateGeometry();
    return r as double;
  }

  @override
  void updateScrollStartDirection(ScrollDirection direction) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'updateScrollStartDirection', [direction]);
    if (identical(r, notOverridden)) { super.updateScrollStartDirection(direction); return; }
  }

  @override
  void maybeStartSnapAnimation(ScrollDirection direction) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'maybeStartSnapAnimation', [direction]);
    if (identical(r, notOverridden)) { super.maybeStartSnapAnimation(direction); return; }
  }

  @override
  void maybeStopSnapAnimation(ScrollDirection direction) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'maybeStopSnapAnimation', [direction]);
    if (identical(r, notOverridden)) { super.maybeStopSnapAnimation(direction); return; }
  }
