...
class _$RenderSliverFloatingPinnedPersistentHeader extends RenderSliverFloatingPinnedPersistentHeader implements DarticObjectHolder {
  _$RenderSliverFloatingPinnedPersistentHeader(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?, vsync: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as TickerProvider?, snapConfiguration: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as FloatingHeaderSnapConfiguration?, stretchConfiguration: identical(superArgs[3], darticAbsent) ? null : superArgs[3] as OverScrollHeaderStretchConfiguration?, showOnScreenConfiguration: identical(superArgs[4], darticAbsent) ? null : superArgs[4] as PersistentHeaderShowOnScreenConfiguration?);
...
/// private class.
Object createRenderSliverFloatingPinnedPersistentHeaderBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderSliverFloatingPinnedPersistentHeader(dispatch, obj, superArgs);
...
abstract final class RenderSliverFloatingPinnedPersistentHeaderBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderSliverFloatingPinnedPersistentHeader(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$updateGeometry#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$updateGeometry());
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$toString#1', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$detach#0', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$updateScrollStartDirection#1', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$updateScrollStartDirection(args[1] as ScrollDirection); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$maybeStartSnapAnimation#1', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$maybeStartSnapAnimation(args[1] as ScrollDirection); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$maybeStopSnapAnimation#1', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$maybeStopSnapAnimation(args[1] as ScrollDirection); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$performLayout#0', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$childMainAxisPosition#1', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$childMainAxisPosition(args[1] as RenderBox));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$updateChild#2', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$updateChild(args[1] as double, args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$layoutChild#3', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$layoutChild(args[1] as double, args[2] as double, overlapsContent: identical(args[3], darticAbsent) ? false : args[3] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$hitTestChildren#3', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$hitTestChildren(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$paint#2', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$paint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$performResize#0', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$hitTest#3', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$hitTest(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$hitTestSelf#2', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$hitTestSelf(mainAxisPosition: args[1] as double, crossAxisPosition: args[2] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$calculatePaintOffset#3', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$calculatePaintOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$calculateCacheOffset#3', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$calculateCacheOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$childCrossAxisPosition#1', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$childCrossAxisPosition(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$childScrollOffset#1', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$childScrollOffset(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$getAbsoluteSizeRelativeToOrigin#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$getAbsoluteSizeRelativeToOrigin());
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$getAbsoluteSize#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$getAbsoluteSize());
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$debugPaint#2', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$debugPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$handleEvent#2', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$reassemble#0', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$dispose#0', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$setupParentData#1', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$redepthChild#1', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$adoptChild#1', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$dropChild#1', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$visitChildren#1', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$attach#1', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$layout#2', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$paintsChild#1', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$toStringShort#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$describeForError#2', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ...
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$childExtent#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$childExtent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$lastShrinkOffset#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$lastShrinkOffset);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$lastOverlapsContent#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$lastOverlapsContent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$stretchConfiguration#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$stretchConfiguration);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$ensureSemantics#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$ensureSemantics);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$constraints#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$geometry#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$geometry);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$paintBounds#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$centerOffsetAdjustment#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$centerOffsetAdjustment);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$parentData#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$depth#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$parent#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$debugCreator#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$owner#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$attached#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$layer#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$debugLayer#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$child#0', (args) => (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$vsync=#1', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$vsync = args[1] as TickerProvider?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$snapConfiguration=#1', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$snapConfiguration = args[1] as FloatingHeaderSnapConfiguration?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$showOnScreenConfiguration=#1', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$showOnScreenConfiguration = args[1] as PersistentHeaderShowOnScreenConfiguration?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$stretchConfiguration=#1', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$stretchConfiguration = args[1] as OverScrollHeaderStretchConfiguration?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$geometry=#1', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$geometry = args[1] as SliverGeometry?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverFloatingPinnedPersistentHeader::\$super\$parentData=#1', (args) { (args[0] as _$RenderSliverFloatingPinnedPersistentHeader)._super$parentData = args[1] as ParentData?; return args[1]; });
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderSliverFloatingPinnedPersistentHeader).handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; },
