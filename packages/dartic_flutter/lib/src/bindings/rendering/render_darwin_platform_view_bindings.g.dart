...
class _$RenderDarwinPlatformView extends RenderDarwinPlatformView<DarwinPlatformViewController> implements DarticObjectHolder {
  _$RenderDarwinPlatformView(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(viewController: superArgs[0] as DarwinPlatformViewController, hitTestBehavior: superArgs[1] as PlatformViewHitTestBehavior, gestureRecognizers: (superArgs[2] as Set).cast<Factory<OneSequenceGestureRecognizer>>());
  ...
  void updateGestureRecognizers(Set<Factory<OneSequenceGestureRecognizer>> gestureRecognizers) {
    ...
    if (identical(_$r, notOverridden)) {
      throw UnsupportedError('Abstract method updateGestureRecognizers must be overridden in dartic code');
    }
  }
  ...
  @override
  DarwinPlatformViewController get viewController {
    ...
    return r as DarwinPlatformViewController;
  }
  ...
  @override
  set viewController(DarwinPlatformViewController value) {
  ...
  DarwinPlatformViewController get _super$viewController => super.viewController;
  ...
  set _super$viewController(DarwinPlatformViewController value) { super.viewController = value; }
...
/// private class.
Object createRenderDarwinPlatformViewBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderDarwinPlatformView(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderDarwinPlatformView(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderDarwinPlatformView)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$paint#2', (args) { (args[0] as _$RenderDarwinPlatformView)._super$paint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$hitTest#2', (args) => (args[0] as _$RenderDarwinPlatformView)._super$hitTest(args[1] as BoxHitTestResult, position: identical(args[2], darticAbsent) ? null : args[2] as Offset?));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderDarwinPlatformView)._super$hitTestSelf(args[1] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderDarwinPlatformView)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$attach#1', (args) { (args[0] as _$RenderDarwinPlatformView)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$detach#0', (args) { (args[0] as _$RenderDarwinPlatformView)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$toString#1', (args) => (args[0] as _$RenderDarwinPlatformView)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$setupParentData#1', (args) { (args[0] as _$RenderDarwinPlatformView)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderDarwinPlatformView)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderDarwinPlatformView)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderDarwinPlatformView)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderDarwinPlatformView)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderDarwinPlatformView)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderDarwinPlatformView)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderDarwinPlatformView)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderDarwinPlatformView)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderDarwinPlatformView)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderDarwinPlatformView)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderDarwinPlatformView)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderDarwinPlatformView)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderDarwinPlatformView)._super$debugAdoptSize(args[1] as Size));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderDarwinPlatformView)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderDarwinPlatformView)._super$getDistanceToBaseline(args[1] as TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderDarwinPlatformView)._super$getDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderDarwinPlatformView)._super$computeDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderDarwinPlatformView)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderDarwinPlatformView)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$performResize#0', (args) { (args[0] as _$RenderDarwinPlatformView)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$performLayout#0', (args) { (args[0] as _$RenderDarwinPlatformView)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderDarwinPlatformView)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderDarwinPlatformView)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderDarwinPlatformView)._super$globalToLocal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderDarwinPlatformView)._super$localToGlobal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$handleEvent#2', (args) { (args[0] as _$RenderDarwinPlatformView)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderDarwinPlatformView)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugPaint#2', (args) { (args[0] as _$RenderDarwinPlatformView)._super$debugPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderDarwinPlatformView)._super$debugPaintSize(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderDarwinPlatformView)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderDarwinPlatformView)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderDarwinPlatformView)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$reassemble#0', (args) { (args[0] as _$RenderDarwinPlatformView)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$dispose#0', (args) { (args[0] as _$RenderDarwinPlatformView)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$redepthChild#1', (args) { (args[0] as _$RenderDarwinPlatformView)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderDarwinPlatformView)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$adoptChild#1', (args) { (args[0] as _$RenderDarwinPlatformView)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$dropChild#1', (args) { (args[0] as _$RenderDarwinPlatformView)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$visitChildren#1', (args) { (args[0] as _$RenderDarwinPlatformView)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderDarwinPlatformView)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderDarwinPlatformView)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderDarwinPlatformView)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$layout#2', (args) { (args[0] as _$RenderDarwinPlatformView)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderDarwinPlatformView)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderDarwinPlatformView)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderDarwinPlatformView)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderDarwinPlatformView)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderDarwinPlatformView)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderDarwinPlatformView)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderDarwinPlatformView)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$paintsChild#1', (args) => (args[0] as _$RenderDarwinPlatformView)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderDarwinPlatformView)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderDarwinPlatformView)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderDarwinPlatformView)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderDarwinPlatformView)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderDarwinPlatformView)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderDarwinPlatformView)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderDarwinPlatformView)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderDarwinPlatformView)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderDarwinPlatformView)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$toStringShort#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderDarwinPlatformView)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderDarwinPlatformView)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderDarwinPlatformView)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$describeForError#2', (args) => (args[0] as _$RenderDarwinPlatformView)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderDarwinPlatformView)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$viewController#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$viewController);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$hitTestBehavior#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$hitTestBehavior);
    ...
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$constraints#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$paintBounds#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$parentData#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$depth#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$parent#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugCreator#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$owner#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$attached#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$layer#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugLayer#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderDarwinPlatformView)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$viewController=#1', (args) { (args[0] as _$RenderDarwinPlatformView)._super$viewController = args[1] as DarwinPlatformViewController; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$hitTestBehavior=#1', (args) { (args[0] as _$RenderDarwinPlatformView)._super$hitTestBehavior = args[1] as PlatformViewHitTestBehavior; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/platform_view.dart::RenderDarwinPlatformView::\$super\$size=#1', (args) { (args[0] as _$RenderDarwinPlatformView)._super$size = args[1] as Size; return args[1]; });
