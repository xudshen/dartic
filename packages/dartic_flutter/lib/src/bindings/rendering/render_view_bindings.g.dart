...
class _$RenderView extends RenderView implements DarticObjectHolder {
  ...
  void prepareInitialFrame() {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'prepareInitialFrame', const []);
    if (identical(r, notOverridden)) { super.prepareInitialFrame(); return; }
  }
  ...
  @override
  void compositeFrame() {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'compositeFrame', const []);
    if (identical(r, notOverridden)) { super.compositeFrame(); return; }
  }

  @override
  void updateSemantics(ui.SemanticsUpdate update) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'updateSemantics', [update]);
    if (identical(r, notOverridden)) { super.updateSemantics(update); return; }
  }
