...
class _$RenderOffstage extends RenderOffstage implements DarticObjectHolder {
  _$RenderOffstage(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(offstage: superArgs[0] as bool, child: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as RenderBox?);
...
/// private class.
Object createRenderOffstageBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderOffstage(dispatch, obj, superArgs);
...
abstract final class RenderOffstageBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderOffstage(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderOffstage)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderOffstage)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderOffstage)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderOffstage)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderOffstage)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderOffstage)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderOffstage)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$performResize#0', (args) { (args[0] as _$RenderOffstage)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$performLayout#0', (args) { (args[0] as _$RenderOffstage)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$hitTest#2', (args) => (args[0] as _$RenderOffstage)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$paintsChild#1', (args) => (args[0] as _$RenderOffstage)._super$paintsChild(args[1] as RenderBox));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$paint#2', (args) { (args[0] as _$RenderOffstage)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderOffstage)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderOffstage)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderOffstage)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$toString#1', (args) => (args[0] as _$RenderOffstage)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$setupParentData#1', (args) { (args[0] as _$RenderOffstage)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderOffstage)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderOffstage)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderOffstage)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderOffstage)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderOffstage)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderOffstage)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderOffstage)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderOffstage)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderOffstage)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderOffstage)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderOffstage)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderOffstage)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderOffstage)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderOffstage)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderOffstage)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderOffstage)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderOffstage)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderOffstage)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$handleEvent#2', (args) { (args[0] as _$RenderOffstage)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderOffstage)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugPaint#2', (args) { (args[0] as _$RenderOffstage)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderOffstage)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderOffstage)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderOffstage)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$reassemble#0', (args) { (args[0] as _$RenderOffstage)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$dispose#0', (args) { (args[0] as _$RenderOffstage)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$redepthChild#1', (args) { (args[0] as _$RenderOffstage)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderOffstage)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$adoptChild#1', (args) { (args[0] as _$RenderOffstage)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$dropChild#1', (args) { (args[0] as _$RenderOffstage)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$visitChildren#1', (args) { (args[0] as _$RenderOffstage)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$attach#1', (args) { (args[0] as _$RenderOffstage)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$detach#0', (args) { (args[0] as _$RenderOffstage)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderOffstage)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderOffstage)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderOffstage)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$layout#2', (args) { (args[0] as _$RenderOffstage)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderOffstage)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderOffstage)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderOffstage)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderOffstage)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderOffstage)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderOffstage)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderOffstage)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderOffstage)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderOffstage)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderOffstage)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderOffstage)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderOffstage)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderOffstage)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderOffstage)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderOffstage)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderOffstage)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$toStringShort#0', (args) => (args[0] as _$RenderOffstage)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderOffstage)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderOffstage)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderOffstage)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$describeForError#2', (args) => (args[0] as _$RenderOffstage)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderOffstage)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderOffstage)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$computeSizeForNoChild#1', (args) => (args[0] as _$RenderOffstage)._super$computeSizeForNoChild(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$offstage#0', (args) => (args[0] as _$RenderOffstage)._super$offstage);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderOffstage)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$hasSize#0', (args) => (args[0] as _$RenderOffstage)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$size#0', (args) => (args[0] as _$RenderOffstage)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderOffstage)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$constraints#0', (args) => (args[0] as _$RenderOffstage)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$paintBounds#0', (args) => (args[0] as _$RenderOffstage)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderOffstage)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$parentData#0', (args) => (args[0] as _$RenderOffstage)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$depth#0', (args) => (args[0] as _$RenderOffstage)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$parent#0', (args) => (args[0] as _$RenderOffstage)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderOffstage)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugCreator#0', (args) => (args[0] as _$RenderOffstage)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderOffstage)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderOffstage)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderOffstage)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderOffstage)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$owner#0', (args) => (args[0] as _$RenderOffstage)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$attached#0', (args) => (args[0] as _$RenderOffstage)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderOffstage)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderOffstage)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderOffstage)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderOffstage)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderOffstage)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$layer#0', (args) => (args[0] as _$RenderOffstage)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugLayer#0', (args) => (args[0] as _$RenderOffstage)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderOffstage)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderOffstage)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderOffstage)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderOffstage)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderOffstage)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$child#0', (args) => (args[0] as _$RenderOffstage)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$offstage=#1', (args) { (args[0] as _$RenderOffstage)._super$offstage = args[1] as bool; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$size=#1', (args) { (args[0] as _$RenderOffstage)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$parentData=#1', (args) { (args[0] as _$RenderOffstage)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderOffstage)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$layer=#1', (args) { (args[0] as _$RenderOffstage)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$child=#1', (args) { (args[0] as _$RenderOffstage)._super$child = args[1] as RenderBox?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderOffstage::\$super\$hashCode#0', (args) => (args[0] as _$RenderOffstage)._super$hashCode);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderOffstage).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
