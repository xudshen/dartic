...
class _$RenderLeaderLayer extends RenderLeaderLayer implements DarticObjectHolder {
  _$RenderLeaderLayer(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(link: superArgs[0] as LayerLink, child: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as RenderBox?);
...
/// private class.
Object createRenderLeaderLayerBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderLeaderLayer(dispatch, obj, superArgs);
...
abstract final class RenderLeaderLayerBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderLeaderLayer(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$performLayout#0', (args) { (args[0] as _$RenderLeaderLayer)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$paint#2', (args) { (args[0] as _$RenderLeaderLayer)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderLeaderLayer)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$toString#1', (args) => (args[0] as _$RenderLeaderLayer)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$setupParentData#1', (args) { (args[0] as _$RenderLeaderLayer)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderLeaderLayer)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderLeaderLayer)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderLeaderLayer)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderLeaderLayer)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderLeaderLayer)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderLeaderLayer)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderLeaderLayer)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderLeaderLayer)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderLeaderLayer)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderLeaderLayer)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderLeaderLayer)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderLeaderLayer)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderLeaderLayer)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderLeaderLayer)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderLeaderLayer)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderLeaderLayer)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderLeaderLayer)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderLeaderLayer)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderLeaderLayer)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderLeaderLayer)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$performResize#0', (args) { (args[0] as _$RenderLeaderLayer)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$hitTest#2', (args) => (args[0] as _$RenderLeaderLayer)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderLeaderLayer)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderLeaderLayer)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderLeaderLayer)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderLeaderLayer)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderLeaderLayer)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$handleEvent#2', (args) { (args[0] as _$RenderLeaderLayer)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderLeaderLayer)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugPaint#2', (args) { (args[0] as _$RenderLeaderLayer)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderLeaderLayer)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderLeaderLayer)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderLeaderLayer)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$reassemble#0', (args) { (args[0] as _$RenderLeaderLayer)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$dispose#0', (args) { (args[0] as _$RenderLeaderLayer)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$redepthChild#1', (args) { (args[0] as _$RenderLeaderLayer)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderLeaderLayer)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$adoptChild#1', (args) { (args[0] as _$RenderLeaderLayer)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$dropChild#1', (args) { (args[0] as _$RenderLeaderLayer)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$visitChildren#1', (args) { (args[0] as _$RenderLeaderLayer)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$attach#1', (args) { (args[0] as _$RenderLeaderLayer)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$detach#0', (args) { (args[0] as _$RenderLeaderLayer)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderLeaderLayer)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderLeaderLayer)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderLeaderLayer)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$layout#2', (args) { (args[0] as _$RenderLeaderLayer)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderLeaderLayer)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderLeaderLayer)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderLeaderLayer)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderLeaderLayer)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderLeaderLayer)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderLeaderLayer)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderLeaderLayer)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$paintsChild#1', (args) => (args[0] as _$RenderLeaderLayer)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderLeaderLayer)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderLeaderLayer)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderLeaderLayer)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderLeaderLayer)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderLeaderLayer)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderLeaderLayer)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderLeaderLayer)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderLeaderLayer)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderLeaderLayer)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderLeaderLayer)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$toStringShort#0', (args) => (args[0] as _$RenderLeaderLayer)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderLeaderLayer)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderLeaderLayer)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderLeaderLayer)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderLeaderLayer)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$describeForError#2', (args) => (args[0] as _$RenderLeaderLayer)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderLeaderLayer)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderLeaderLayer)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$computeSizeForNoChild#1', (args) => (args[0] as _$RenderLeaderLayer)._super$computeSizeForNoChild(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$link#0', (args) => (args[0] as _$RenderLeaderLayer)._super$link);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderLeaderLayer)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$hashCode#0', (args) => (args[0] as _$RenderLeaderLayer)._super$hashCode);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$hasSize#0', (args) => (args[0] as _$RenderLeaderLayer)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$size#0', (args) => (args[0] as _$RenderLeaderLayer)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderLeaderLayer)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$constraints#0', (args) => (args[0] as _$RenderLeaderLayer)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$paintBounds#0', (args) => (args[0] as _$RenderLeaderLayer)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderLeaderLayer)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$parentData#0', (args) => (args[0] as _$RenderLeaderLayer)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$depth#0', (args) => (args[0] as _$RenderLeaderLayer)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$parent#0', (args) => (args[0] as _$RenderLeaderLayer)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderLeaderLayer)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugCreator#0', (args) => (args[0] as _$RenderLeaderLayer)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderLeaderLayer)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderLeaderLayer)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderLeaderLayer)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderLeaderLayer)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$owner#0', (args) => (args[0] as _$RenderLeaderLayer)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$attached#0', (args) => (args[0] as _$RenderLeaderLayer)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderLeaderLayer)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderLeaderLayer)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderLeaderLayer)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderLeaderLayer)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderLeaderLayer)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$layer#0', (args) => (args[0] as _$RenderLeaderLayer)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugLayer#0', (args) => (args[0] as _$RenderLeaderLayer)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderLeaderLayer)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderLeaderLayer)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderLeaderLayer)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderLeaderLayer)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderLeaderLayer)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$child#0', (args) => (args[0] as _$RenderLeaderLayer)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$link=#1', (args) { (args[0] as _$RenderLeaderLayer)._super$link = args[1] as LayerLink; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$size=#1', (args) { (args[0] as _$RenderLeaderLayer)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$parentData=#1', (args) { (args[0] as _$RenderLeaderLayer)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderLeaderLayer)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$layer=#1', (args) { (args[0] as _$RenderLeaderLayer)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderLeaderLayer::\$super\$child=#1', (args) { (args[0] as _$RenderLeaderLayer)._super$child = args[1] as RenderBox?; return args[1]; });
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderLeaderLayer).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
