...
class _$RenderIntrinsicWidth extends RenderIntrinsicWidth implements DarticObjectHolder {
  _$RenderIntrinsicWidth(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(stepWidth: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as double?, stepHeight: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as double?, child: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as RenderBox?);
  ...
  set stepWidth(double? value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'stepWidth', value)) {
  ...
  set stepHeight(double? value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'stepHeight', value)) {
  ...
  set _super$stepWidth(double? value) { super.stepWidth = value; }
  set _super$stepHeight(double? value) { super.stepHeight = value; }
...
/// private class.
Object createRenderIntrinsicWidthBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderIntrinsicWidth(dispatch, obj, superArgs);
...
abstract final class RenderIntrinsicWidthBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderIntrinsicWidth(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderIntrinsicWidth)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderIntrinsicWidth)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderIntrinsicWidth)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderIntrinsicWidth)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderIntrinsicWidth)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderIntrinsicWidth)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$performLayout#0', (args) { (args[0] as _$RenderIntrinsicWidth)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderIntrinsicWidth)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$toString#1', (args) => (args[0] as _$RenderIntrinsicWidth)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$setupParentData#1', (args) { (args[0] as _$RenderIntrinsicWidth)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderIntrinsicWidth)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderIntrinsicWidth)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderIntrinsicWidth)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderIntrinsicWidth)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderIntrinsicWidth)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderIntrinsicWidth)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderIntrinsicWidth)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderIntrinsicWidth)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderIntrinsicWidth)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderIntrinsicWidth)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderIntrinsicWidth)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderIntrinsicWidth)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderIntrinsicWidth)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderIntrinsicWidth)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$performResize#0', (args) { (args[0] as _$RenderIntrinsicWidth)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$hitTest#2', (args) => (args[0] as _$RenderIntrinsicWidth)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderIntrinsicWidth)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderIntrinsicWidth)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderIntrinsicWidth)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderIntrinsicWidth)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderIntrinsicWidth)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$handleEvent#2', (args) { (args[0] as _$RenderIntrinsicWidth)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderIntrinsicWidth)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugPaint#2', (args) { (args[0] as _$RenderIntrinsicWidth)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderIntrinsicWidth)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderIntrinsicWidth)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderIntrinsicWidth)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$reassemble#0', (args) { (args[0] as _$RenderIntrinsicWidth)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$dispose#0', (args) { (args[0] as _$RenderIntrinsicWidth)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$redepthChild#1', (args) { (args[0] as _$RenderIntrinsicWidth)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderIntrinsicWidth)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$adoptChild#1', (args) { (args[0] as _$RenderIntrinsicWidth)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$dropChild#1', (args) { (args[0] as _$RenderIntrinsicWidth)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$visitChildren#1', (args) { (args[0] as _$RenderIntrinsicWidth)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$attach#1', (args) { (args[0] as _$RenderIntrinsicWidth)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$detach#0', (args) { (args[0] as _$RenderIntrinsicWidth)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderIntrinsicWidth)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderIntrinsicWidth)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderIntrinsicWidth)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$layout#2', (args) { (args[0] as _$RenderIntrinsicWidth)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderIntrinsicWidth)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderIntrinsicWidth)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderIntrinsicWidth)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderIntrinsicWidth)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderIntrinsicWidth)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderIntrinsicWidth)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderIntrinsicWidth)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$paint#2', (args) { (args[0] as _$RenderIntrinsicWidth)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$paintsChild#1', (args) => (args[0] as _$RenderIntrinsicWidth)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderIntrinsicWidth)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderIntrinsicWidth)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderIntrinsicWidth)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderIntrinsicWidth)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderIntrinsicWidth)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderIntrinsicWidth)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderIntrinsicWidth)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderIntrinsicWidth)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderIntrinsicWidth)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderIntrinsicWidth)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$toStringShort#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderIntrinsicWidth)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderIntrinsicWidth)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderIntrinsicWidth)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$describeForError#2', (args) => (args[0] as _$RenderIntrinsicWidth)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderIntrinsicWidth)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderIntrinsicWidth)._super$debugValidateChild(args[1] as RenderObject));
    ...
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$constraints#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$paintBounds#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$parentData#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$depth#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$parent#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugCreator#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$owner#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$attached#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$layer#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugLayer#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$child#0', (args) => (args[0] as _$RenderIntrinsicWidth)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$stepWidth=#1', (args) { (args[0] as _$RenderIntrinsicWidth)._super$stepWidth = args[1] as double?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$stepHeight=#1', (args) { (args[0] as _$RenderIntrinsicWidth)._super$stepHeight = args[1] as double?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$size=#1', (args) { (args[0] as _$RenderIntrinsicWidth)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicWidth::\$super\$parentData=#1', (args) { (args[0] as _$RenderIntrinsicWidth)._super$parentData = args[1] as ParentData?; return args[1]; });
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderIntrinsicWidth).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
