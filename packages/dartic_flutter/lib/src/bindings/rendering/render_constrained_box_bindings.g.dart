...
class _$RenderConstrainedBox extends RenderConstrainedBox implements DarticObjectHolder {
  _$RenderConstrainedBox(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?, additionalConstraints: superArgs[1] as BoxConstraints);
  ...
  BoxConstraints get additionalConstraints {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'additionalConstraints');
    if (identical(r, notOverridden)) return super.additionalConstraints;
  ...
  set additionalConstraints(BoxConstraints value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'additionalConstraints', value)) {
  ...
  BoxConstraints get _super$additionalConstraints => super.additionalConstraints;
  ...
  set _super$additionalConstraints(BoxConstraints value) { super.additionalConstraints = value; }
...
/// private class.
Object createRenderConstrainedBoxBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderConstrainedBox(dispatch, obj, superArgs);
...
abstract final class RenderConstrainedBoxBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderConstrainedBox(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderConstrainedBox)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderConstrainedBox)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderConstrainedBox)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderConstrainedBox)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderConstrainedBox)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$performLayout#0', (args) { (args[0] as _$RenderConstrainedBox)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderConstrainedBox)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderConstrainedBox)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderConstrainedBox)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$toString#1', (args) => (args[0] as _$RenderConstrainedBox)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$setupParentData#1', (args) { (args[0] as _$RenderConstrainedBox)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderConstrainedBox)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderConstrainedBox)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderConstrainedBox)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderConstrainedBox)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderConstrainedBox)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderConstrainedBox)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderConstrainedBox)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderConstrainedBox)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderConstrainedBox)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderConstrainedBox)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderConstrainedBox)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderConstrainedBox)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderConstrainedBox)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderConstrainedBox)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$performResize#0', (args) { (args[0] as _$RenderConstrainedBox)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$hitTest#2', (args) => (args[0] as _$RenderConstrainedBox)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderConstrainedBox)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderConstrainedBox)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderConstrainedBox)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderConstrainedBox)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderConstrainedBox)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$handleEvent#2', (args) { (args[0] as _$RenderConstrainedBox)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderConstrainedBox)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugPaint#2', (args) { (args[0] as _$RenderConstrainedBox)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderConstrainedBox)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderConstrainedBox)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$reassemble#0', (args) { (args[0] as _$RenderConstrainedBox)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$dispose#0', (args) { (args[0] as _$RenderConstrainedBox)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$redepthChild#1', (args) { (args[0] as _$RenderConstrainedBox)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderConstrainedBox)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$adoptChild#1', (args) { (args[0] as _$RenderConstrainedBox)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$dropChild#1', (args) { (args[0] as _$RenderConstrainedBox)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$visitChildren#1', (args) { (args[0] as _$RenderConstrainedBox)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$attach#1', (args) { (args[0] as _$RenderConstrainedBox)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$detach#0', (args) { (args[0] as _$RenderConstrainedBox)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderConstrainedBox)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderConstrainedBox)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderConstrainedBox)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$layout#2', (args) { (args[0] as _$RenderConstrainedBox)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderConstrainedBox)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderConstrainedBox)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderConstrainedBox)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderConstrainedBox)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderConstrainedBox)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderConstrainedBox)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderConstrainedBox)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$paint#2', (args) { (args[0] as _$RenderConstrainedBox)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$paintsChild#1', (args) => (args[0] as _$RenderConstrainedBox)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderConstrainedBox)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderConstrainedBox)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderConstrainedBox)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderConstrainedBox)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderConstrainedBox)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderConstrainedBox)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderConstrainedBox)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderConstrainedBox)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderConstrainedBox)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderConstrainedBox)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$toStringShort#0', (args) => (args[0] as _$RenderConstrainedBox)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderConstrainedBox)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderConstrainedBox)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderConstrainedBox)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderConstrainedBox)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$describeForError#2', (args) => (args[0] as _$RenderConstrainedBox)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderConstrainedBox)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderConstrainedBox)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$computeSizeForNoChild#1', (args) => (args[0] as _$RenderConstrainedBox)._super$computeSizeForNoChild(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$additionalConstraints#0', (args) => (args[0] as _$RenderConstrainedBox)._super$additionalConstraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$hashCode#0', (args) => (args[0] as _$RenderConstrainedBox)._super$hashCode);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$hasSize#0', (args) => (args[0] as _$RenderConstrainedBox)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$size#0', (args) => (args[0] as _$RenderConstrainedBox)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderConstrainedBox)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$constraints#0', (args) => (args[0] as _$RenderConstrainedBox)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$paintBounds#0', (args) => (args[0] as _$RenderConstrainedBox)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderConstrainedBox)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$parentData#0', (args) => (args[0] as _$RenderConstrainedBox)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$depth#0', (args) => (args[0] as _$RenderConstrainedBox)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$parent#0', (args) => (args[0] as _$RenderConstrainedBox)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderConstrainedBox)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugCreator#0', (args) => (args[0] as _$RenderConstrainedBox)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderConstrainedBox)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderConstrainedBox)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderConstrainedBox)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderConstrainedBox)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$owner#0', (args) => (args[0] as _$RenderConstrainedBox)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$attached#0', (args) => (args[0] as _$RenderConstrainedBox)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderConstrainedBox)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderConstrainedBox)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderConstrainedBox)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderConstrainedBox)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderConstrainedBox)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderConstrainedBox)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$layer#0', (args) => (args[0] as _$RenderConstrainedBox)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugLayer#0', (args) => (args[0] as _$RenderConstrainedBox)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderConstrainedBox)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderConstrainedBox)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderConstrainedBox)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderConstrainedBox)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderConstrainedBox)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$child#0', (args) => (args[0] as _$RenderConstrainedBox)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$additionalConstraints=#1', (args) { (args[0] as _$RenderConstrainedBox)._super$additionalConstraints = args[1] as BoxConstraints; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$size=#1', (args) { (args[0] as _$RenderConstrainedBox)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$parentData=#1', (args) { (args[0] as _$RenderConstrainedBox)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderConstrainedBox)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$layer=#1', (args) { (args[0] as _$RenderConstrainedBox)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderConstrainedBox::\$super\$child=#1', (args) { (args[0] as _$RenderConstrainedBox)._super$child = args[1] as RenderBox?; return args[1]; });
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderConstrainedBox).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
