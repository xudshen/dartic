...
class _$RenderCustomSingleChildLayoutBox extends RenderCustomSingleChildLayoutBox implements DarticObjectHolder {
  _$RenderCustomSingleChildLayoutBox(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?, delegate: superArgs[1] as SingleChildLayoutDelegate);
  ...
  @override
  set delegate(SingleChildLayoutDelegate value) {
  ...
  set _super$delegate(SingleChildLayoutDelegate value) { super.delegate = value; }
...
/// private class.
Object createRenderCustomSingleChildLayoutBoxBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderCustomSingleChildLayoutBox(dispatch, obj, superArgs);
...
abstract final class RenderCustomSingleChildLayoutBoxBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderCustomSingleChildLayoutBox(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$attach#1', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$detach#0', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$performLayout#0', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$toString#1', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$computeDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$paint#2', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$paint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$setupParentData#1', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugAdoptSize(args[1] as Size));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$getDistanceToBaseline(args[1] as TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$getDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$performResize#0', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$hitTest#2', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$hitTestSelf(args[1] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$globalToLocal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$localToGlobal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$handleEvent#2', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugPaint#2', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugPaintSize(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$reassemble#0', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$dispose#0', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$redepthChild#1', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$adoptChild#1', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$dropChild#1', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$visitChildren#1', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$layout#2', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$paintsChild#1', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$toStringShort#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$describeForError#2', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ...
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$constraints#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$paintBounds#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$parentData#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$depth#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$parent#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugCreator#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$owner#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$attached#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$layer#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugLayer#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$child#0', (args) => (args[0] as _$RenderCustomSingleChildLayoutBox)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$delegate=#1', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$delegate = args[1] as SingleChildLayoutDelegate; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$size=#1', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$size = args[1] as Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderCustomSingleChildLayoutBox::\$super\$parentData=#1', (args) { (args[0] as _$RenderCustomSingleChildLayoutBox)._super$parentData = args[1] as ParentData?; return args[1]; });
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderCustomSingleChildLayoutBox).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
