...
class _$RenderSliverFillRemainingWithScrollable extends RenderSliverFillRemainingWithScrollable implements DarticObjectHolder {
  _$RenderSliverFillRemainingWithScrollable(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?);
...
/// private class.
Object createRenderSliverFillRemainingWithScrollableBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderSliverFillRemainingWithScrollable(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderSliverFillRemainingWithScrollable(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$performLayout#0', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$toString#1', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$setupParentData#1', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$setChildParentData#3', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$setChildParentData(args[1] as RenderObject, args[2] as SliverConstraints, args[3] as SliverGeometry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$hitTestChildren#3', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$hitTestChildren(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$childMainAxisPosition#1', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$childMainAxisPosition(args[1] as RenderBox));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$paint#2', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$paint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$performResize#0', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$hitTest#3', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$hitTest(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$hitTestSelf#2', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$hitTestSelf(mainAxisPosition: args[1] as double, crossAxisPosition: args[2] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$calculatePaintOffset#3', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$calculatePaintOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$calculateCacheOffset#3', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$calculateCacheOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$childCrossAxisPosition#1', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$childCrossAxisPosition(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$childScrollOffset#1', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$childScrollOffset(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$getAbsoluteSizeRelativeToOrigin#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$getAbsoluteSizeRelativeToOrigin());
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$getAbsoluteSize#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$getAbsoluteSize());
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$debugPaint#2', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$debugPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$handleEvent#2', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$reassemble#0', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$dispose#0', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$redepthChild#1', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$adoptChild#1', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$dropChild#1', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$visitChildren#1', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$attach#1', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$detach#0', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$layout#2', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$paintsChild#1', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$toStringShort#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$describeForError#2', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$hitTestBoxChild#4', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$hitTestBoxChild(args[1] as BoxHitTestResult, args[2] as RenderBox, mainAxisPosition: args[3] as double, crossAxisPosition: args[4] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$applyPaintTransformForBoxChild#2', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$applyPaintTransformForBoxChild(args[1] as RenderBox, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$hashCode#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$hashCode);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$ensureSemantics#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$ensureSemantics);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$constraints#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$geometry#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$geometry);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$paintBounds#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$centerOffsetAdjustment#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$centerOffsetAdjustment);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$parentData#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$depth#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$parent#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$debugCreator#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$owner#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$attached#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$layer#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$debugLayer#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$child#0', (args) => (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$geometry=#1', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$geometry = args[1] as SliverGeometry?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$parentData=#1', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$layer=#1', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_fill.dart::RenderSliverFillRemainingWithScrollable::\$super\$child=#1', (args) { (args[0] as _$RenderSliverFillRemainingWithScrollable)._super$child = args[1] as RenderBox?; return args[1]; });
  }

  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        'performLayout#0': (args) { (args[0] as RenderSliverFillRemainingWithScrollable).performLayout(); return null; },
        'toString#1': (args) => (args[0] as RenderSliverFillRemainingWithScrollable).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
        ...
        'handleEvent#2': (args) { (args[0] as RenderSliverFillRemainingWithScrollable).handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; },
