...
class _$RenderSliverConstrainedCrossAxis extends RenderSliverConstrainedCrossAxis implements DarticObjectHolder {
  _$RenderSliverConstrainedCrossAxis(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(maxExtent: superArgs[0] as double);
  ...
  set maxExtent(double value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'maxExtent', value)) {
  ...
  set _super$maxExtent(double value) { super.maxExtent = value; }
...
/// private class.
Object createRenderSliverConstrainedCrossAxisBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderSliverConstrainedCrossAxis(dispatch, obj, superArgs);
...
abstract final class RenderSliverConstrainedCrossAxisBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderSliverConstrainedCrossAxis(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$performLayout#0', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$toString#1', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$setupParentData#1', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$paint#2', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$hitTestChildren#3', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$hitTestChildren(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$childMainAxisPosition#1', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$childMainAxisPosition(args[1] as RenderSliver));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$performResize#0', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$hitTest#3', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$hitTest(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$hitTestSelf#2', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$hitTestSelf(mainAxisPosition: args[1] as double, crossAxisPosition: args[2] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$calculatePaintOffset#3', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$calculatePaintOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$calculateCacheOffset#3', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$calculateCacheOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$childCrossAxisPosition#1', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$childCrossAxisPosition(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$childScrollOffset#1', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$childScrollOffset(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$getAbsoluteSizeRelativeToOrigin#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$getAbsoluteSizeRelativeToOrigin());
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$getAbsoluteSize#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$getAbsoluteSize());
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$debugPaint#2', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$handleEvent#2', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$reassemble#0', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$dispose#0', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$redepthChild#1', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$adoptChild#1', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$dropChild#1', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$visitChildren#1', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$attach#1', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$detach#0', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$layout#2', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$paintsChild#1', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$toStringShort#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$describeForError#2', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$maxExtent#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$maxExtent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$hashCode#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$hashCode);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$ensureSemantics#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$ensureSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$constraints#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$geometry#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$geometry);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$paintBounds#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$centerOffsetAdjustment#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$centerOffsetAdjustment);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$parentData#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$depth#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$parent#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$debugCreator#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$owner#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$attached#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$layer#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$debugLayer#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$child#0', (args) => (args[0] as _$RenderSliverConstrainedCrossAxis)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$maxExtent=#1', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$maxExtent = args[1] as double; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$geometry=#1', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$geometry = args[1] as SliverGeometry?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$parentData=#1', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$layer=#1', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverConstrainedCrossAxis::\$super\$child=#1', (args) { (args[0] as _$RenderSliverConstrainedCrossAxis)._super$child = args[1] as RenderSliver?; return args[1]; });
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderSliverConstrainedCrossAxis).handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; },
