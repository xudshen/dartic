...
class _$MouseTracker extends MouseTracker implements DarticObjectHolder {
  ...
  void updateWithEvent(PointerEvent event, HitTestResult? hitTestResult) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'updateWithEvent', [event, hitTestResult]);
    if (identical(_$r, notOverridden)) { super.updateWithEvent(event, hitTestResult); return; }
  }

  @override
  void updateAllDevices() {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'updateAllDevices', const []);
    if (identical(_$r, notOverridden)) { super.updateAllDevices(); return; }
  }
