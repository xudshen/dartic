...
class _$RenderSliverList extends RenderSliverList implements DarticObjectHolder {
  _$RenderSliverList(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(childManager: superArgs[0] as RenderSliverBoxChildManager);
...
/// private class.
Object createRenderSliverListBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderSliverList(dispatch, obj, superArgs);
...
abstract final class RenderSliverListBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderSliverList(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$performLayout#0', (args) { (args[0] as _$RenderSliverList)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$toString#1', (args) => (args[0] as _$RenderSliverList)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$setupParentData#1', (args) { (args[0] as _$RenderSliverList)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$adoptChild#1', (args) { (args[0] as _$RenderSliverList)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$insert#2', (args) { (args[0] as _$RenderSliverList)._super$insert(args[1] as RenderBox, after: identical(args[2], darticAbsent) ? null : args[2] as RenderBox?); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$move#2', (args) { (args[0] as _$RenderSliverList)._super$move(args[1] as RenderBox, after: identical(args[2], darticAbsent) ? null : args[2] as RenderBox?); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$remove#1', (args) { (args[0] as _$RenderSliverList)._super$remove(args[1] as RenderBox); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$removeAll#0', (args) { (args[0] as _$RenderSliverList)._super$removeAll(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$attach#1', (args) { (args[0] as _$RenderSliverList)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$detach#0', (args) { (args[0] as _$RenderSliverList)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderSliverList)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$visitChildren#1', (args) { (args[0] as _$RenderSliverList)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderSliverList)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$addInitialChild#2', (args) => (args[0] as _$RenderSliverList)._super$addInitialChild(index: identical(args[1], darticAbsent) ? 0 : args[1] as int, layoutOffset: identical(args[2], darticAbsent) ? 0.0 : args[2] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$insertAndLayoutLeadingChild#2', (args) => (args[0] as _$RenderSliverList)._super$insertAndLayoutLeadingChild(args[1] as BoxConstraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$insertAndLayoutChild#3', (args) => (args[0] as _$RenderSliverList)._super$insertAndLayoutChild(args[1] as BoxConstraints, after: args[2] as RenderBox?, parentUsesSize: identical(args[3], darticAbsent) ? false : args[3] as bool));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$calculateLeadingGarbage#1', (args) => (args[0] as _$RenderSliverList)._super$calculateLeadingGarbage(firstIndex: args[1] as int));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$calculateTrailingGarbage#1', (args) => (args[0] as _$RenderSliverList)._super$calculateTrailingGarbage(lastIndex: args[1] as int));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$collectGarbage#2', (args) { (args[0] as _$RenderSliverList)._super$collectGarbage(args[1] as int, args[2] as int); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$indexOf#1', (args) => (args[0] as _$RenderSliverList)._super$indexOf(args[1] as RenderBox));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$paintExtentOf#1', (args) => (args[0] as _$RenderSliverList)._super$paintExtentOf(args[1] as RenderBox));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$hitTestChildren#3', (args) => (args[0] as _$RenderSliverList)._super$hitTestChildren(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$childMainAxisPosition#1', (args) => (args[0] as _$RenderSliverList)._super$childMainAxisPosition(args[1] as RenderBox));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$childScrollOffset#1', (args) => (args[0] as _$RenderSliverList)._super$childScrollOffset(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$paintsChild#1', (args) => (args[0] as _$RenderSliverList)._super$paintsChild(args[1] as RenderBox));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderSliverList)._super$applyPaintTransform(args[1] as RenderBox, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$paint#2', (args) { (args[0] as _$RenderSliverList)._super$paint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderSliverList)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugAssertChildListIsNonEmptyAndContiguous#0', (args) => (args[0] as _$RenderSliverList)._super$debugAssertChildListIsNonEmptyAndContiguous());
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderSliverList)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderSliverList)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderSliverList)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$performResize#0', (args) { (args[0] as _$RenderSliverList)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$hitTest#3', (args) => (args[0] as _$RenderSliverList)._super$hitTest(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$hitTestSelf#2', (args) => (args[0] as _$RenderSliverList)._super$hitTestSelf(mainAxisPosition: args[1] as double, crossAxisPosition: args[2] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$calculatePaintOffset#3', (args) => (args[0] as _$RenderSliverList)._super$calculatePaintOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$calculateCacheOffset#3', (args) => (args[0] as _$RenderSliverList)._super$calculateCacheOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$childCrossAxisPosition#1', (args) => (args[0] as _$RenderSliverList)._super$childCrossAxisPosition(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$getAbsoluteSizeRelativeToOrigin#0', (args) => (args[0] as _$RenderSliverList)._super$getAbsoluteSizeRelativeToOrigin());
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$getAbsoluteSize#0', (args) => (args[0] as _$RenderSliverList)._super$getAbsoluteSize());
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugPaint#2', (args) { (args[0] as _$RenderSliverList)._super$debugPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$handleEvent#2', (args) { (args[0] as _$RenderSliverList)._super$handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$reassemble#0', (args) { (args[0] as _$RenderSliverList)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$dispose#0', (args) { (args[0] as _$RenderSliverList)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$redepthChild#1', (args) { (args[0] as _$RenderSliverList)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$dropChild#1', (args) { (args[0] as _$RenderSliverList)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderSliverList)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderSliverList)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderSliverList)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderSliverList)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$layout#2', (args) { (args[0] as _$RenderSliverList)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderSliverList)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderSliverList)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderSliverList)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderSliverList)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderSliverList)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderSliverList)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderSliverList)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderSliverList)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderSliverList)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderSliverList)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderSliverList)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderSliverList)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderSliverList)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderSliverList)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderSliverList)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderSliverList)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$toStringShort#0', (args) => (args[0] as _$RenderSliverList)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderSliverList)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderSliverList)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderSliverList)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$describeForError#2', (args) => (args[0] as _$RenderSliverList)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderSliverList)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderSliverList)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$add#1', (args) { (args[0] as _$RenderSliverList)._super$add(args[1] as RenderBox); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$addAll#1', (args) { (args[0] as _$RenderSliverList)._super$addAll(args[1] == null ? null : (args[1] as List).cast<RenderBox>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$childBefore#1', (args) => (args[0] as _$RenderSliverList)._super$childBefore(args[1] as RenderBox));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$childAfter#1', (args) => (args[0] as _$RenderSliverList)._super$childAfter(args[1] as RenderBox));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$hitTestBoxChild#4', (args) => (args[0] as _$RenderSliverList)._super$hitTestBoxChild(args[1] as BoxHitTestResult, args[2] as RenderBox, mainAxisPosition: args[3] as double, crossAxisPosition: args[4] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$applyPaintTransformForBoxChild#2', (args) { (args[0] as _$RenderSliverList)._super$applyPaintTransformForBoxChild(args[1] as RenderBox, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$childManager#0', (args) => (args[0] as _$RenderSliverList)._super$childManager);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugChildIntegrityEnabled#0', (args) => (args[0] as _$RenderSliverList)._super$debugChildIntegrityEnabled);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderSliverList)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$ensureSemantics#0', (args) => (args[0] as _$RenderSliverList)._super$ensureSemantics);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$constraints#0', (args) => (args[0] as _$RenderSliverList)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$geometry#0', (args) => (args[0] as _$RenderSliverList)._super$geometry);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$paintBounds#0', (args) => (args[0] as _$RenderSliverList)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$centerOffsetAdjustment#0', (args) => (args[0] as _$RenderSliverList)._super$centerOffsetAdjustment);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderSliverList)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$parentData#0', (args) => (args[0] as _$RenderSliverList)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$depth#0', (args) => (args[0] as _$RenderSliverList)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$parent#0', (args) => (args[0] as _$RenderSliverList)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderSliverList)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugCreator#0', (args) => (args[0] as _$RenderSliverList)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderSliverList)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderSliverList)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderSliverList)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderSliverList)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$owner#0', (args) => (args[0] as _$RenderSliverList)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$attached#0', (args) => (args[0] as _$RenderSliverList)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderSliverList)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderSliverList)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderSliverList)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderSliverList)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderSliverList)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderSliverList)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$layer#0', (args) => (args[0] as _$RenderSliverList)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugLayer#0', (args) => (args[0] as _$RenderSliverList)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderSliverList)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderSliverList)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderSliverList)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderSliverList)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderSliverList)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$childCount#0', (args) => (args[0] as _$RenderSliverList)._super$childCount);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$firstChild#0', (args) => (args[0] as _$RenderSliverList)._super$firstChild);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$lastChild#0', (args) => (args[0] as _$RenderSliverList)._super$lastChild);
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugChildIntegrityEnabled=#1', (args) { (args[0] as _$RenderSliverList)._super$debugChildIntegrityEnabled = args[1] as bool; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$geometry=#1', (args) { (args[0] as _$RenderSliverList)._super$geometry = args[1] as SliverGeometry?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$parentData=#1', (args) { (args[0] as _$RenderSliverList)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderSliverList)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$layer=#1', (args) { (args[0] as _$RenderSliverList)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_list.dart::RenderSliverList::\$super\$hashCode#0', (args) => (args[0] as _$RenderSliverList)._super$hashCode);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderSliverList).handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; },
