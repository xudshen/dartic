...
class _$RenderIndexedStack extends RenderIndexedStack implements DarticObjectHolder {
  ...
  void paintStack(PaintingContext context, Offset offset) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'paintStack', [context, offset]);
    if (identical(r, notOverridden)) { super.paintStack(context, offset); return; }
  }
