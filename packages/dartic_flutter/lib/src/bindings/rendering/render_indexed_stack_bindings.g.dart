...
class _$RenderIndexedStack extends RenderIndexedStack implements DarticObjectHolder {
  _$RenderIndexedStack(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(children: identical(superArgs[0], darticAbsent) ? null : superArgs[0] == null ? null : (superArgs[0] as List).cast<RenderBox>(), alignment: superArgs[1] as AlignmentGeometry, textDirection: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as TextDirection?, fit: superArgs[3] as StackFit, clipBehavior: superArgs[4] as Clip, index: identical(superArgs[5], darticAbsent) ? null : superArgs[5] as int?);
  ...
  void paintStack(PaintingContext context, Offset offset) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'paintStack', [context, offset]);
    if (identical(_$r, notOverridden)) { super.paintStack(context, offset); return; }
  }
  ...
  void _super$paintStack(PaintingContext context, Offset offset) { super.paintStack(context, offset); }
  ...
  set _super$fit(StackFit value) { super.fit = value; }
...
/// private class.
Object createRenderIndexedStackBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderIndexedStack(dispatch, obj, superArgs);
...
abstract final class RenderIndexedStackBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderIndexedStack(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderIndexedStack)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderIndexedStack)._super$computeDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderIndexedStack)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderIndexedStack)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$paintStack#2', (args) { (args[0] as _$RenderIndexedStack)._super$paintStack(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderIndexedStack)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderIndexedStack)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$toString#1', (args) => (args[0] as _$RenderIndexedStack)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$setupParentData#1', (args) { (args[0] as _$RenderIndexedStack)._super$setupParentData(args[1] as RenderBox); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderIndexedStack)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderIndexedStack)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderIndexedStack)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderIndexedStack)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderIndexedStack)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$performLayout#0', (args) { (args[0] as _$RenderIndexedStack)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$paint#2', (args) { (args[0] as _$RenderIndexedStack)._super$paint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$dispose#0', (args) { (args[0] as _$RenderIndexedStack)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderIndexedStack)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderIndexedStack)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderIndexedStack)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderIndexedStack)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderIndexedStack)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderIndexedStack)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderIndexedStack)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderIndexedStack)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderIndexedStack)._super$debugAdoptSize(args[1] as Size));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderIndexedStack)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderIndexedStack)._super$getDistanceToBaseline(args[1] as TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderIndexedStack)._super$getDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderIndexedStack)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderIndexedStack)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$performResize#0', (args) { (args[0] as _$RenderIndexedStack)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$hitTest#2', (args) => (args[0] as _$RenderIndexedStack)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderIndexedStack)._super$hitTestSelf(args[1] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderIndexedStack)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderIndexedStack)._super$globalToLocal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderIndexedStack)._super$localToGlobal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$handleEvent#2', (args) { (args[0] as _$RenderIndexedStack)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderIndexedStack)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugPaint#2', (args) { (args[0] as _$RenderIndexedStack)._super$debugPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderIndexedStack)._super$debugPaintSize(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderIndexedStack)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderIndexedStack)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$reassemble#0', (args) { (args[0] as _$RenderIndexedStack)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$redepthChild#1', (args) { (args[0] as _$RenderIndexedStack)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderIndexedStack)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$adoptChild#1', (args) { (args[0] as _$RenderIndexedStack)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$dropChild#1', (args) { (args[0] as _$RenderIndexedStack)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$visitChildren#1', (args) { (args[0] as _$RenderIndexedStack)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$attach#1', (args) { (args[0] as _$RenderIndexedStack)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$detach#0', (args) { (args[0] as _$RenderIndexedStack)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderIndexedStack)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderIndexedStack)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderIndexedStack)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$layout#2', (args) { (args[0] as _$RenderIndexedStack)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderIndexedStack)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderIndexedStack)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderIndexedStack)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderIndexedStack)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderIndexedStack)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderIndexedStack)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderIndexedStack)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$paintsChild#1', (args) => (args[0] as _$RenderIndexedStack)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderIndexedStack)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderIndexedStack)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderIndexedStack)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderIndexedStack)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderIndexedStack)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderIndexedStack)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderIndexedStack)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderIndexedStack)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$toStringShort#0', (args) => (args[0] as _$RenderIndexedStack)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderIndexedStack)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderIndexedStack)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderIndexedStack)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$describeForError#2', (args) => (args[0] as _$RenderIndexedStack)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderIndexedStack)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderIndexedStack)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$insert#2', (args) { (args[0] as _$RenderIndexedStack)._super$insert(args[1] as RenderBox, after: identical(args[2], darticAbsent) ? null : args[2] as RenderBox?); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$add#1', (args) { (args[0] as _$RenderIndexedStack)._super$add(args[1] as RenderBox); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$addAll#1', (args) { (args[0] as _$RenderIndexedStack)._super$addAll(args[1] == null ? null : (args[1] as List).cast<RenderBox>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$remove#1', (args) { (args[0] as _$RenderIndexedStack)._super$remove(args[1] as RenderBox); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$removeAll#0', (args) { (args[0] as _$RenderIndexedStack)._super$removeAll(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$move#2', (args) { (args[0] as _$RenderIndexedStack)._super$move(args[1] as RenderBox, after: identical(args[2], darticAbsent) ? null : args[2] as RenderBox?); return null; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$childBefore#1', (args) => (args[0] as _$RenderIndexedStack)._super$childBefore(args[1] as RenderBox));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$childAfter#1', (args) => (args[0] as _$RenderIndexedStack)._super$childAfter(args[1] as RenderBox));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$defaultComputeDistanceToFirstActualBaseline#1', (args) => (args[0] as _$RenderIndexedStack)._super$defaultComputeDistanceToFirstActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$defaultComputeDistanceToHighestActualBaseline#1', (args) => (args[0] as _$RenderIndexedStack)._super$defaultComputeDistanceToHighestActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$defaultHitTestChildren#2', (args) => (args[0] as _$RenderIndexedStack)._super$defaultHitTestChildren(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ...
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$clipBehavior#0', (args) => (args[0] as _$RenderIndexedStack)._super$clipBehavior);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$hasSize#0', (args) => (args[0] as _$RenderIndexedStack)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$size#0', (args) => (args[0] as _$RenderIndexedStack)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderIndexedStack)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$constraints#0', (args) => (args[0] as _$RenderIndexedStack)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$paintBounds#0', (args) => (args[0] as _$RenderIndexedStack)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderIndexedStack)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$parentData#0', (args) => (args[0] as _$RenderIndexedStack)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$depth#0', (args) => (args[0] as _$RenderIndexedStack)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$parent#0', (args) => (args[0] as _$RenderIndexedStack)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderIndexedStack)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugCreator#0', (args) => (args[0] as _$RenderIndexedStack)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderIndexedStack)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderIndexedStack)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderIndexedStack)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderIndexedStack)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$owner#0', (args) => (args[0] as _$RenderIndexedStack)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$attached#0', (args) => (args[0] as _$RenderIndexedStack)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderIndexedStack)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderIndexedStack)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderIndexedStack)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderIndexedStack)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderIndexedStack)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderIndexedStack)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$layer#0', (args) => (args[0] as _$RenderIndexedStack)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugLayer#0', (args) => (args[0] as _$RenderIndexedStack)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderIndexedStack)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderIndexedStack)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderIndexedStack)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderIndexedStack)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderIndexedStack)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$childCount#0', (args) => (args[0] as _$RenderIndexedStack)._super$childCount);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$firstChild#0', (args) => (args[0] as _$RenderIndexedStack)._super$firstChild);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$lastChild#0', (args) => (args[0] as _$RenderIndexedStack)._super$lastChild);
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$index=#1', (args) { (args[0] as _$RenderIndexedStack)._super$index = args[1] as int?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$alignment=#1', (args) { (args[0] as _$RenderIndexedStack)._super$alignment = args[1] as AlignmentGeometry; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$textDirection=#1', (args) { (args[0] as _$RenderIndexedStack)._super$textDirection = args[1] as TextDirection?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$fit=#1', (args) { (args[0] as _$RenderIndexedStack)._super$fit = args[1] as StackFit; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$clipBehavior=#1', (args) { (args[0] as _$RenderIndexedStack)._super$clipBehavior = args[1] as Clip; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/stack.dart::RenderIndexedStack::\$super\$size=#1', (args) { (args[0] as _$RenderIndexedStack)._super$size = args[1] as Size; return args[1]; });
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderIndexedStack).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
