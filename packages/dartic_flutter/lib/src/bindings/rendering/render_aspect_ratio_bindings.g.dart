...
class _$RenderAspectRatio extends RenderAspectRatio implements DarticObjectHolder {
  _$RenderAspectRatio(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?, aspectRatio: superArgs[1] as double);
  ...
  set aspectRatio(double value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'aspectRatio', value)) {
  ...
  set _super$aspectRatio(double value) { super.aspectRatio = value; }
...
/// private class.
Object createRenderAspectRatioBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderAspectRatio(dispatch, obj, superArgs);
...
abstract final class RenderAspectRatioBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderAspectRatio(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderAspectRatio)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderAspectRatio)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderAspectRatio)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderAspectRatio)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderAspectRatio)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderAspectRatio)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$performLayout#0', (args) { (args[0] as _$RenderAspectRatio)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderAspectRatio)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$toString#1', (args) => (args[0] as _$RenderAspectRatio)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$setupParentData#1', (args) { (args[0] as _$RenderAspectRatio)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderAspectRatio)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderAspectRatio)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderAspectRatio)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderAspectRatio)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderAspectRatio)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderAspectRatio)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderAspectRatio)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderAspectRatio)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderAspectRatio)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderAspectRatio)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderAspectRatio)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderAspectRatio)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderAspectRatio)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderAspectRatio)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$performResize#0', (args) { (args[0] as _$RenderAspectRatio)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$hitTest#2', (args) => (args[0] as _$RenderAspectRatio)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderAspectRatio)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderAspectRatio)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderAspectRatio)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderAspectRatio)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderAspectRatio)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$handleEvent#2', (args) { (args[0] as _$RenderAspectRatio)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderAspectRatio)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugPaint#2', (args) { (args[0] as _$RenderAspectRatio)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderAspectRatio)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderAspectRatio)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderAspectRatio)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$reassemble#0', (args) { (args[0] as _$RenderAspectRatio)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$dispose#0', (args) { (args[0] as _$RenderAspectRatio)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$redepthChild#1', (args) { (args[0] as _$RenderAspectRatio)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderAspectRatio)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$adoptChild#1', (args) { (args[0] as _$RenderAspectRatio)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$dropChild#1', (args) { (args[0] as _$RenderAspectRatio)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$visitChildren#1', (args) { (args[0] as _$RenderAspectRatio)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$attach#1', (args) { (args[0] as _$RenderAspectRatio)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$detach#0', (args) { (args[0] as _$RenderAspectRatio)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderAspectRatio)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderAspectRatio)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderAspectRatio)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$layout#2', (args) { (args[0] as _$RenderAspectRatio)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderAspectRatio)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderAspectRatio)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderAspectRatio)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderAspectRatio)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderAspectRatio)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderAspectRatio)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderAspectRatio)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$paint#2', (args) { (args[0] as _$RenderAspectRatio)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$paintsChild#1', (args) => (args[0] as _$RenderAspectRatio)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderAspectRatio)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderAspectRatio)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderAspectRatio)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderAspectRatio)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderAspectRatio)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderAspectRatio)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderAspectRatio)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderAspectRatio)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderAspectRatio)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderAspectRatio)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$toStringShort#0', (args) => (args[0] as _$RenderAspectRatio)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderAspectRatio)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderAspectRatio)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderAspectRatio)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderAspectRatio)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$describeForError#2', (args) => (args[0] as _$RenderAspectRatio)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderAspectRatio)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ...
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$constraints#0', (args) => (args[0] as _$RenderAspectRatio)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$paintBounds#0', (args) => (args[0] as _$RenderAspectRatio)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderAspectRatio)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$parentData#0', (args) => (args[0] as _$RenderAspectRatio)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$depth#0', (args) => (args[0] as _$RenderAspectRatio)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$parent#0', (args) => (args[0] as _$RenderAspectRatio)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderAspectRatio)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugCreator#0', (args) => (args[0] as _$RenderAspectRatio)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderAspectRatio)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderAspectRatio)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderAspectRatio)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderAspectRatio)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$owner#0', (args) => (args[0] as _$RenderAspectRatio)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$attached#0', (args) => (args[0] as _$RenderAspectRatio)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderAspectRatio)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderAspectRatio)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderAspectRatio)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderAspectRatio)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderAspectRatio)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderAspectRatio)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$layer#0', (args) => (args[0] as _$RenderAspectRatio)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugLayer#0', (args) => (args[0] as _$RenderAspectRatio)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderAspectRatio)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderAspectRatio)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderAspectRatio)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderAspectRatio)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderAspectRatio)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$child#0', (args) => (args[0] as _$RenderAspectRatio)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$aspectRatio=#1', (args) { (args[0] as _$RenderAspectRatio)._super$aspectRatio = args[1] as double; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$size=#1', (args) { (args[0] as _$RenderAspectRatio)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAspectRatio::\$super\$parentData=#1', (args) { (args[0] as _$RenderAspectRatio)._super$parentData = args[1] as ParentData?; return args[1]; });
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderAspectRatio).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
