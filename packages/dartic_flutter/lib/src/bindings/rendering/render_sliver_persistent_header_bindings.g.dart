...
class _$RenderSliverPersistentHeader extends RenderSliverPersistentHeader implements DarticObjectHolder {
  _$RenderSliverPersistentHeader(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?, stretchConfiguration: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as OverScrollHeaderStretchConfiguration?);
...
/// private class.
Object createRenderSliverPersistentHeaderBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderSliverPersistentHeader(dispatch, obj, superArgs);
...
abstract final class RenderSliverPersistentHeaderBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderSliverPersistentHeader(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$updateChild#2', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$updateChild(args[1] as double, args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$layoutChild#3', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$layoutChild(args[1] as double, args[2] as double, overlapsContent: identical(args[3], darticAbsent) ? false : args[3] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$childMainAxisPosition#1', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$childMainAxisPosition(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$hitTestChildren#3', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$hitTestChildren(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$paint#2', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$paint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$toString#1', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$performResize#0', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$hitTest#3', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$hitTest(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$hitTestSelf#2', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$hitTestSelf(mainAxisPosition: args[1] as double, crossAxisPosition: args[2] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$calculatePaintOffset#3', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$calculatePaintOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$calculateCacheOffset#3', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$calculateCacheOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$childCrossAxisPosition#1', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$childCrossAxisPosition(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$childScrollOffset#1', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$childScrollOffset(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$getAbsoluteSizeRelativeToOrigin#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$getAbsoluteSizeRelativeToOrigin());
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$getAbsoluteSize#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$getAbsoluteSize());
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$debugPaint#2', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$debugPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$handleEvent#2', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$reassemble#0', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$dispose#0', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$setupParentData#1', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$redepthChild#1', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$adoptChild#1', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$dropChild#1', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$visitChildren#1', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$attach#1', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$detach#0', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$layout#2', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$paintsChild#1', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$toStringShort#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$describeForError#2', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$hitTestBoxChild#4', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$hitTestBoxChild(args[1] as BoxHitTestResult, args[2] as RenderBox, mainAxisPosition: args[3] as double, crossAxisPosition: args[4] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$applyPaintTransformForBoxChild#2', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$applyPaintTransformForBoxChild(args[1] as RenderBox, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$childExtent#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$childExtent);
    ...
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$paintBounds#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$centerOffsetAdjustment#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$centerOffsetAdjustment);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$parentData#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$depth#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$parent#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$debugCreator#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$owner#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$attached#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$layer#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$debugLayer#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$child#0', (args) => (args[0] as _$RenderSliverPersistentHeader)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$stretchConfiguration=#1', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$stretchConfiguration = args[1] as OverScrollHeaderStretchConfiguration?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$geometry=#1', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$geometry = args[1] as SliverGeometry?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_persistent_header.dart::RenderSliverPersistentHeader::\$super\$parentData=#1', (args) { (args[0] as _$RenderSliverPersistentHeader)._super$parentData = args[1] as ParentData?; return args[1]; });
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderSliverPersistentHeader).handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; },
