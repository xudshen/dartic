...
class _$RenderTable extends RenderTable implements DarticObjectHolder {
  ...
  void setColumnWidth(int column, TableColumnWidth value) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'setColumnWidth', [column, value]);
    if (identical(r, notOverridden)) { super.setColumnWidth(column, value); return; }
  }
  ...
  void setFlatChildren(int columns, List<RenderBox?> cells) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'setFlatChildren', [columns, cells]);
    if (identical(r, notOverridden)) { super.setFlatChildren(columns, cells); return; }
  }

  @override
  void setChildren(List<List<RenderBox>>? cells) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'setChildren', [cells]);
    if (identical(r, notOverridden)) { super.setChildren(cells); return; }
  }

  @override
  void addRow(List<RenderBox?> cells) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'addRow', [cells]);
    if (identical(r, notOverridden)) { super.addRow(cells); return; }
  }

  @override
  void setChild(int x, int y, RenderBox? value) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'setChild', [x, y, value]);
    if (identical(r, notOverridden)) { super.setChild(x, y, value); return; }
  }
  ...
  Iterable<RenderBox> column(int x) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'column', [x]);
    if (identical(r, notOverridden)) return super.column(x);
    return r as Iterable<RenderBox>;
  }

  @override
  Iterable<RenderBox> row(int y) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'row', [y]);
    if (identical(r, notOverridden)) return super.row(y);
    return r as Iterable<RenderBox>;
  }

  @override
  Rect getRowBox(int row) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'getRowBox', [row]);
    if (identical(r, notOverridden)) return super.getRowBox(row);
    return r as Rect;
  }
