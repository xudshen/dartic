...
class _$RenderFittedBox extends RenderFittedBox implements DarticObjectHolder {
  _$RenderFittedBox(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(fit: superArgs[0] as BoxFit, alignment: superArgs[1] as AlignmentGeometry, textDirection: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as ui.TextDirection?, child: identical(superArgs[3], darticAbsent) ? null : superArgs[3] as RenderBox?, clipBehavior: superArgs[4] as ui.Clip);
...
/// private class.
Object createRenderFittedBoxBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderFittedBox(dispatch, obj, superArgs);
...
abstract final class RenderFittedBoxBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderFittedBox(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderFittedBox)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$performLayout#0', (args) { (args[0] as _$RenderFittedBox)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$paint#2', (args) { (args[0] as _$RenderFittedBox)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderFittedBox)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$paintsChild#1', (args) => (args[0] as _$RenderFittedBox)._super$paintsChild(args[1] as RenderBox));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderFittedBox)._super$applyPaintTransform(args[1] as RenderBox, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderFittedBox)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$toString#1', (args) => (args[0] as _$RenderFittedBox)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$setupParentData#1', (args) { (args[0] as _$RenderFittedBox)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderFittedBox)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderFittedBox)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderFittedBox)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderFittedBox)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderFittedBox)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderFittedBox)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderFittedBox)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderFittedBox)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderFittedBox)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderFittedBox)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderFittedBox)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderFittedBox)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderFittedBox)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderFittedBox)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderFittedBox)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderFittedBox)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderFittedBox)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderFittedBox)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderFittedBox)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$performResize#0', (args) { (args[0] as _$RenderFittedBox)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$hitTest#2', (args) => (args[0] as _$RenderFittedBox)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderFittedBox)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderFittedBox)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderFittedBox)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$handleEvent#2', (args) { (args[0] as _$RenderFittedBox)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderFittedBox)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugPaint#2', (args) { (args[0] as _$RenderFittedBox)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderFittedBox)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderFittedBox)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderFittedBox)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$reassemble#0', (args) { (args[0] as _$RenderFittedBox)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$dispose#0', (args) { (args[0] as _$RenderFittedBox)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$redepthChild#1', (args) { (args[0] as _$RenderFittedBox)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderFittedBox)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$adoptChild#1', (args) { (args[0] as _$RenderFittedBox)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$dropChild#1', (args) { (args[0] as _$RenderFittedBox)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$visitChildren#1', (args) { (args[0] as _$RenderFittedBox)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$attach#1', (args) { (args[0] as _$RenderFittedBox)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$detach#0', (args) { (args[0] as _$RenderFittedBox)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderFittedBox)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderFittedBox)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderFittedBox)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$layout#2', (args) { (args[0] as _$RenderFittedBox)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderFittedBox)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderFittedBox)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderFittedBox)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderFittedBox)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderFittedBox)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderFittedBox)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderFittedBox)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderFittedBox)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderFittedBox)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderFittedBox)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderFittedBox)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderFittedBox)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderFittedBox)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderFittedBox)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderFittedBox)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderFittedBox)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderFittedBox)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$toStringShort#0', (args) => (args[0] as _$RenderFittedBox)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderFittedBox)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderFittedBox)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderFittedBox)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderFittedBox)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$describeForError#2', (args) => (args[0] as _$RenderFittedBox)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderFittedBox)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderFittedBox)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$computeSizeForNoChild#1', (args) => (args[0] as _$RenderFittedBox)._super$computeSizeForNoChild(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$fit#0', (args) => (args[0] as _$RenderFittedBox)._super$fit);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$alignment#0', (args) => (args[0] as _$RenderFittedBox)._super$alignment);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$textDirection#0', (args) => (args[0] as _$RenderFittedBox)._super$textDirection);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$clipBehavior#0', (args) => (args[0] as _$RenderFittedBox)._super$clipBehavior);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$hasSize#0', (args) => (args[0] as _$RenderFittedBox)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$size#0', (args) => (args[0] as _$RenderFittedBox)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderFittedBox)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$constraints#0', (args) => (args[0] as _$RenderFittedBox)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$paintBounds#0', (args) => (args[0] as _$RenderFittedBox)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderFittedBox)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$parentData#0', (args) => (args[0] as _$RenderFittedBox)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$depth#0', (args) => (args[0] as _$RenderFittedBox)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$parent#0', (args) => (args[0] as _$RenderFittedBox)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderFittedBox)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugCreator#0', (args) => (args[0] as _$RenderFittedBox)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderFittedBox)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderFittedBox)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderFittedBox)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderFittedBox)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$owner#0', (args) => (args[0] as _$RenderFittedBox)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$attached#0', (args) => (args[0] as _$RenderFittedBox)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderFittedBox)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderFittedBox)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderFittedBox)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderFittedBox)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderFittedBox)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderFittedBox)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$layer#0', (args) => (args[0] as _$RenderFittedBox)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugLayer#0', (args) => (args[0] as _$RenderFittedBox)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderFittedBox)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderFittedBox)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderFittedBox)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderFittedBox)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderFittedBox)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$child#0', (args) => (args[0] as _$RenderFittedBox)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$fit=#1', (args) { (args[0] as _$RenderFittedBox)._super$fit = args[1] as BoxFit; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$alignment=#1', (args) { (args[0] as _$RenderFittedBox)._super$alignment = args[1] as AlignmentGeometry; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$textDirection=#1', (args) { (args[0] as _$RenderFittedBox)._super$textDirection = args[1] as ui.TextDirection?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$clipBehavior=#1', (args) { (args[0] as _$RenderFittedBox)._super$clipBehavior = args[1] as ui.Clip; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$size=#1', (args) { (args[0] as _$RenderFittedBox)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$parentData=#1', (args) { (args[0] as _$RenderFittedBox)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderFittedBox)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$layer=#1', (args) { (args[0] as _$RenderFittedBox)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$child=#1', (args) { (args[0] as _$RenderFittedBox)._super$child = args[1] as RenderBox?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderFittedBox::\$super\$hashCode#0', (args) => (args[0] as _$RenderFittedBox)._super$hashCode);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderFittedBox).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
