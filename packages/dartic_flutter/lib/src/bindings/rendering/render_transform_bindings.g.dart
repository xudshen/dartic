...
class _$RenderTransform extends RenderTransform implements DarticObjectHolder {
  _$RenderTransform(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(transform: superArgs[0] as Matrix4, origin: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as ui.Offset?, alignment: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as AlignmentGeometry?, textDirection: identical(superArgs[3], darticAbsent) ? null : superArgs[3] as ui.TextDirection?, transformHitTests: superArgs[4] as bool, filterQuality: identical(superArgs[5], darticAbsent) ? null : superArgs[5] as ui.FilterQuality?, child: identical(superArgs[6], darticAbsent) ? null : superArgs[6] as RenderBox?);
  ...
  @override
  void setIdentity() {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'setIdentity', const []);
    if (identical(_$r, notOverridden)) { super.setIdentity(); return; }
  }

  @override
  void rotateX(double radians) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'rotateX', [radians]);
    if (identical(_$r, notOverridden)) { super.rotateX(radians); return; }
  }

  @override
  void rotateY(double radians) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'rotateY', [radians]);
    if (identical(_$r, notOverridden)) { super.rotateY(radians); return; }
  }

  @override
  void rotateZ(double radians) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'rotateZ', [radians]);
    if (identical(_$r, notOverridden)) { super.rotateZ(radians); return; }
  }

  @override
  void translate(double x, [double y = 0.0, double z = 0.0]) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'translate', [x, y, z]);
    if (identical(_$r, notOverridden)) { super.translate(x, y, z); return; }
  }

  @override
  void scale(double x, [double? y, double? z]) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'scale', [x, y, z]);
    if (identical(_$r, notOverridden)) { super.scale(x, y, z); return; }
  }
  ...
  @override
  set origin(ui.Offset? value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'origin', value)) {
      super.origin = value;
    }
  }
  ...
  @override
  set transformHitTests(bool value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'transformHitTests', value)) {
  ...
  // ── Super trampolines ──
  void _super$setIdentity() { super.setIdentity(); }
  void _super$rotateX(double radians) { super.rotateX(radians); }
  void _super$rotateY(double radians) { super.rotateY(radians); }
  void _super$rotateZ(double radians) { super.rotateZ(radians); }
  void _super$translate(double x, [double y = 0.0, double z = 0.0]) { super.translate(x, y, z); }
  void _super$scale(double x, [double? y, double? z]) { super.scale(x, y, z); }
  ...
  set _super$origin(ui.Offset? value) { super.origin = value; }
  ...
  set _super$transformHitTests(bool value) { super.transformHitTests = value; }
...
/// private class.
Object createRenderTransformBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderTransform(dispatch, obj, superArgs);
...
abstract final class RenderTransformBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderTransform(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$setIdentity#0', (args) { (args[0] as _$RenderTransform)._super$setIdentity(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$rotateX#1', (args) { (args[0] as _$RenderTransform)._super$rotateX(args[1] as double); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$rotateY#1', (args) { (args[0] as _$RenderTransform)._super$rotateY(args[1] as double); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$rotateZ#1', (args) { (args[0] as _$RenderTransform)._super$rotateZ(args[1] as double); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$translate#3', (args) { (args[0] as _$RenderTransform)._super$translate(args[1] as double, identical(args[2], darticAbsent) ? 0.0 : args[2] as double, identical(args[3], darticAbsent) ? 0.0 : args[3] as double); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$scale#3', (args) { (args[0] as _$RenderTransform)._super$scale(args[1] as double, identical(args[2], darticAbsent) ? null : args[2] as double?, identical(args[3], darticAbsent) ? null : args[3] as double?); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$hitTest#2', (args) => (args[0] as _$RenderTransform)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderTransform)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$paint#2', (args) { (args[0] as _$RenderTransform)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderTransform)._super$applyPaintTransform(args[1] as RenderBox, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderTransform)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$toString#1', (args) => (args[0] as _$RenderTransform)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$setupParentData#1', (args) { (args[0] as _$RenderTransform)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderTransform)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderTransform)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderTransform)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderTransform)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderTransform)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderTransform)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderTransform)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderTransform)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderTransform)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderTransform)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderTransform)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderTransform)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderTransform)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderTransform)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderTransform)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderTransform)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderTransform)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderTransform)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderTransform)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderTransform)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$performResize#0', (args) { (args[0] as _$RenderTransform)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$performLayout#0', (args) { (args[0] as _$RenderTransform)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderTransform)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderTransform)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderTransform)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$handleEvent#2', (args) { (args[0] as _$RenderTransform)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderTransform)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugPaint#2', (args) { (args[0] as _$RenderTransform)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderTransform)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderTransform)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderTransform)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$reassemble#0', (args) { (args[0] as _$RenderTransform)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$dispose#0', (args) { (args[0] as _$RenderTransform)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$redepthChild#1', (args) { (args[0] as _$RenderTransform)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderTransform)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$adoptChild#1', (args) { (args[0] as _$RenderTransform)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$dropChild#1', (args) { (args[0] as _$RenderTransform)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$visitChildren#1', (args) { (args[0] as _$RenderTransform)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$attach#1', (args) { (args[0] as _$RenderTransform)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$detach#0', (args) { (args[0] as _$RenderTransform)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderTransform)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderTransform)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderTransform)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$layout#2', (args) { (args[0] as _$RenderTransform)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderTransform)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderTransform)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderTransform)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderTransform)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderTransform)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderTransform)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderTransform)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$paintsChild#1', (args) => (args[0] as _$RenderTransform)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderTransform)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderTransform)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderTransform)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderTransform)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderTransform)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderTransform)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderTransform)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderTransform)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderTransform)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderTransform)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$toStringShort#0', (args) => (args[0] as _$RenderTransform)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderTransform)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderTransform)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderTransform)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderTransform)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$describeForError#2', (args) => (args[0] as _$RenderTransform)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderTransform)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderTransform)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$computeSizeForNoChild#1', (args) => (args[0] as _$RenderTransform)._super$computeSizeForNoChild(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$origin#0', (args) => (args[0] as _$RenderTransform)._super$origin);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$alignment#0', (args) => (args[0] as _$RenderTransform)._super$alignment);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$textDirection#0', (args) => (args[0] as _$RenderTransform)._super$textDirection);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderTransform)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$transformHitTests#0', (args) => (args[0] as _$RenderTransform)._super$transformHitTests);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$filterQuality#0', (args) => (args[0] as _$RenderTransform)._super$filterQuality);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$hasSize#0', (args) => (args[0] as _$RenderTransform)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$size#0', (args) => (args[0] as _$RenderTransform)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderTransform)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$constraints#0', (args) => (args[0] as _$RenderTransform)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$paintBounds#0', (args) => (args[0] as _$RenderTransform)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderTransform)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$parentData#0', (args) => (args[0] as _$RenderTransform)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$depth#0', (args) => (args[0] as _$RenderTransform)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$parent#0', (args) => (args[0] as _$RenderTransform)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderTransform)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugCreator#0', (args) => (args[0] as _$RenderTransform)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderTransform)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderTransform)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderTransform)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderTransform)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$owner#0', (args) => (args[0] as _$RenderTransform)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$attached#0', (args) => (args[0] as _$RenderTransform)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderTransform)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderTransform)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderTransform)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderTransform)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderTransform)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$layer#0', (args) => (args[0] as _$RenderTransform)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugLayer#0', (args) => (args[0] as _$RenderTransform)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderTransform)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderTransform)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderTransform)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderTransform)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderTransform)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$child#0', (args) => (args[0] as _$RenderTransform)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$origin=#1', (args) { (args[0] as _$RenderTransform)._super$origin = args[1] as ui.Offset?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$alignment=#1', (args) { (args[0] as _$RenderTransform)._super$alignment = args[1] as AlignmentGeometry?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$textDirection=#1', (args) { (args[0] as _$RenderTransform)._super$textDirection = args[1] as ui.TextDirection?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$transformHitTests=#1', (args) { (args[0] as _$RenderTransform)._super$transformHitTests = args[1] as bool; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$transform=#1', (args) { (args[0] as _$RenderTransform)._super$transform = args[1] as Matrix4; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$filterQuality=#1', (args) { (args[0] as _$RenderTransform)._super$filterQuality = args[1] as ui.FilterQuality?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$size=#1', (args) { (args[0] as _$RenderTransform)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$parentData=#1', (args) { (args[0] as _$RenderTransform)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderTransform)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$layer=#1', (args) { (args[0] as _$RenderTransform)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$child=#1', (args) { (args[0] as _$RenderTransform)._super$child = args[1] as RenderBox?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderTransform::\$super\$hashCode#0', (args) => (args[0] as _$RenderTransform)._super$hashCode);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#1': (args) => (args[0] as RenderTransform).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
        ...
        'handleEvent#2': (args) { (args[0] as RenderTransform).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
