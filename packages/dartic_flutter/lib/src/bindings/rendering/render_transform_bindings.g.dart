...
class _$RenderTransform extends RenderTransform implements DarticObjectHolder {
  ...
  @override
  void setIdentity() {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'setIdentity', const []);
    if (identical(r, notOverridden)) { super.setIdentity(); return; }
  }

  @override
  void rotateX(double radians) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'rotateX', [radians]);
    if (identical(r, notOverridden)) { super.rotateX(radians); return; }
  }

  @override
  void rotateY(double radians) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'rotateY', [radians]);
    if (identical(r, notOverridden)) { super.rotateY(radians); return; }
  }

  @override
  void rotateZ(double radians) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'rotateZ', [radians]);
    if (identical(r, notOverridden)) { super.rotateZ(radians); return; }
  }

  @override
  void translate(double x, [double y = 0.0, double z = 0.0]) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'translate', [x, y, z]);
    if (identical(r, notOverridden)) { super.translate(x, y, z); return; }
  }

  @override
  void scale(double x, [double? y, double? z]) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'scale', [x, y, z]);
    if (identical(r, notOverridden)) { super.scale(x, y, z); return; }
  }
