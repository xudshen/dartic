...
class _$RenderRotatedBox extends RenderRotatedBox implements DarticObjectHolder {
  _$RenderRotatedBox(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(quarterTurns: superArgs[0] as int, child: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as RenderBox?);
  ...
  int get quarterTurns {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'quarterTurns');
    if (identical(r, notOverridden)) return super.quarterTurns;
    return r as int;
  }
  ...
  set quarterTurns(int value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'quarterTurns', value)) {
  ...
  set _super$quarterTurns(int value) { super.quarterTurns = value; }
...
/// private class.
Object createRenderRotatedBoxBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderRotatedBox(dispatch, obj, superArgs);
...
abstract final class RenderRotatedBoxBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderRotatedBox(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderRotatedBox)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderRotatedBox)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderRotatedBox)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderRotatedBox)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderRotatedBox)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$performLayout#0', (args) { (args[0] as _$RenderRotatedBox)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderRotatedBox)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$paint#2', (args) { (args[0] as _$RenderRotatedBox)._super$paint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$dispose#0', (args) { (args[0] as _$RenderRotatedBox)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderRotatedBox)._super$applyPaintTransform(args[1] as RenderBox, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$toString#1', (args) => (args[0] as _$RenderRotatedBox)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$setupParentData#1', (args) { (args[0] as _$RenderRotatedBox)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderRotatedBox)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderRotatedBox)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderRotatedBox)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderRotatedBox)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderRotatedBox)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderRotatedBox)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderRotatedBox)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderRotatedBox)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderRotatedBox)._super$debugAdoptSize(args[1] as Size));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderRotatedBox)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderRotatedBox)._super$getDistanceToBaseline(args[1] as TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderRotatedBox)._super$getDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderRotatedBox)._super$computeDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderRotatedBox)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderRotatedBox)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$performResize#0', (args) { (args[0] as _$RenderRotatedBox)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$hitTest#2', (args) => (args[0] as _$RenderRotatedBox)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderRotatedBox)._super$hitTestSelf(args[1] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderRotatedBox)._super$globalToLocal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderRotatedBox)._super$localToGlobal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$handleEvent#2', (args) { (args[0] as _$RenderRotatedBox)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderRotatedBox)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugPaint#2', (args) { (args[0] as _$RenderRotatedBox)._super$debugPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderRotatedBox)._super$debugPaintSize(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderRotatedBox)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderRotatedBox)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderRotatedBox)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$reassemble#0', (args) { (args[0] as _$RenderRotatedBox)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$redepthChild#1', (args) { (args[0] as _$RenderRotatedBox)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderRotatedBox)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$adoptChild#1', (args) { (args[0] as _$RenderRotatedBox)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$dropChild#1', (args) { (args[0] as _$RenderRotatedBox)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$visitChildren#1', (args) { (args[0] as _$RenderRotatedBox)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$attach#1', (args) { (args[0] as _$RenderRotatedBox)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$detach#0', (args) { (args[0] as _$RenderRotatedBox)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderRotatedBox)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderRotatedBox)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderRotatedBox)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$layout#2', (args) { (args[0] as _$RenderRotatedBox)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderRotatedBox)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderRotatedBox)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderRotatedBox)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderRotatedBox)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderRotatedBox)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderRotatedBox)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderRotatedBox)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$paintsChild#1', (args) => (args[0] as _$RenderRotatedBox)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderRotatedBox)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderRotatedBox)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderRotatedBox)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderRotatedBox)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderRotatedBox)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderRotatedBox)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderRotatedBox)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderRotatedBox)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderRotatedBox)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderRotatedBox)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$toStringShort#0', (args) => (args[0] as _$RenderRotatedBox)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderRotatedBox)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderRotatedBox)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderRotatedBox)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderRotatedBox)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$describeForError#2', (args) => (args[0] as _$RenderRotatedBox)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ...
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$constraints#0', (args) => (args[0] as _$RenderRotatedBox)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$paintBounds#0', (args) => (args[0] as _$RenderRotatedBox)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderRotatedBox)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$parentData#0', (args) => (args[0] as _$RenderRotatedBox)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$depth#0', (args) => (args[0] as _$RenderRotatedBox)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$parent#0', (args) => (args[0] as _$RenderRotatedBox)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderRotatedBox)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugCreator#0', (args) => (args[0] as _$RenderRotatedBox)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderRotatedBox)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderRotatedBox)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderRotatedBox)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderRotatedBox)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$owner#0', (args) => (args[0] as _$RenderRotatedBox)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$attached#0', (args) => (args[0] as _$RenderRotatedBox)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderRotatedBox)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderRotatedBox)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderRotatedBox)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderRotatedBox)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderRotatedBox)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderRotatedBox)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$layer#0', (args) => (args[0] as _$RenderRotatedBox)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugLayer#0', (args) => (args[0] as _$RenderRotatedBox)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderRotatedBox)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderRotatedBox)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderRotatedBox)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderRotatedBox)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderRotatedBox)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$child#0', (args) => (args[0] as _$RenderRotatedBox)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$quarterTurns=#1', (args) { (args[0] as _$RenderRotatedBox)._super$quarterTurns = args[1] as int; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$size=#1', (args) { (args[0] as _$RenderRotatedBox)._super$size = args[1] as Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/rotated_box.dart::RenderRotatedBox::\$super\$parentData=#1', (args) { (args[0] as _$RenderRotatedBox)._super$parentData = args[1] as ParentData?; return args[1]; });
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderRotatedBox).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
