...
class _$RenderAnimatedOpacityMixin implements RenderAnimatedOpacityMixin<RenderObject>, DarticObjectHolder {
  _$RenderAnimatedOpacityMixin(this._dispatch, this.$darticObject, List<Object?> superArgs);
  ...
  Animation<double> get opacity {
    ...
    if (identical(r, notOverridden)) {
      throw UnsupportedError('Abstract getter opacity must be overridden in dartic code');
    }
  ...
  bool get alwaysIncludeSemantics {
    ...
    if (identical(r, notOverridden)) {
      throw UnsupportedError('Abstract getter alwaysIncludeSemantics must be overridden in dartic code');
    }
    return r as bool;
  }
  ...
  set opacity(Animation<double> value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'opacity', value)) {
      throw UnsupportedError('Abstract setter opacity must be overridden in dartic code');
    }
  }
  ...
  set alwaysIncludeSemantics(bool value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'alwaysIncludeSemantics', value)) {
      throw UnsupportedError('Abstract setter alwaysIncludeSemantics must be overridden in dartic code');
    }
  }
...
/// private class.
Object createRenderAnimatedOpacityMixinBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderAnimatedOpacityMixin(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderAnimatedOpacityMixin(dispatch, darticObject, superArgs),
    );
  }
