...
class _$FollowerLayer extends FollowerLayer implements DarticObjectHolder {
  ...
  Matrix4? getLastTransform() {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'getLastTransform', const []);
    if (identical(r, notOverridden)) return super.getLastTransform();
    return r as Matrix4?;
  }
