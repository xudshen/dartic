...
class _$FollowerLayer extends FollowerLayer implements DarticObjectHolder {
  _$FollowerLayer(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(link: superArgs[0] as LayerLink, showWhenUnlinked: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as bool?, unlinkedOffset: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as ui.Offset?, linkedOffset: identical(superArgs[3], darticAbsent) ? null : superArgs[3] as ui.Offset?);
  ...
  Matrix4? getLastTransform() {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'getLastTransform', const []);
    if (identical(_$r, notOverridden)) return super.getLastTransform();
  ...
  @override
  ui.Offset? get unlinkedOffset {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'unlinkedOffset');
    if (identical(r, notOverridden)) return super.unlinkedOffset;
    return r as ui.Offset?;
  }

  @override
  ui.Offset? get linkedOffset {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'linkedOffset');
    if (identical(r, notOverridden)) return super.linkedOffset;
    return r as ui.Offset?;
  }
  ...
  @override
  set unlinkedOffset(ui.Offset? value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'unlinkedOffset', value)) {
      super.unlinkedOffset = value;
    }
  }

  @override
  set linkedOffset(ui.Offset? value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'linkedOffset', value)) {
      super.linkedOffset = value;
    }
  }
  ...
  // ── Super trampolines ──
  Matrix4? _super$getLastTransform() => super.getLastTransform();
  ...
  set _super$unlinkedOffset(ui.Offset? value) { super.unlinkedOffset = value; }
...
/// private class.
Object createFollowerLayerBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$FollowerLayer(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$FollowerLayer(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$getLastTransform#0', (args) => (args[0] as _$FollowerLayer)._super$getLastTransform());
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$addToScene#1', (args) { (args[0] as _$FollowerLayer)._super$addToScene(args[1] as ui.SceneBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$applyTransform#2', (args) { (args[0] as _$FollowerLayer)._super$applyTransform(args[1] as Layer?, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$debugFillProperties#1', (args) { (args[0] as _$FollowerLayer)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$toString#1', (args) => (args[0] as _$FollowerLayer)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$supportsRasterization#0', (args) => (args[0] as _$FollowerLayer)._super$supportsRasterization());
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$buildScene#1', (args) => (args[0] as _$FollowerLayer)._super$buildScene(args[1] as ui.SceneBuilder));
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$dispose#0', (args) { (args[0] as _$FollowerLayer)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$updateSubtreeNeedsAddToScene#0', (args) { (args[0] as _$FollowerLayer)._super$updateSubtreeNeedsAddToScene(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$attach#1', (args) { (args[0] as _$FollowerLayer)._super$attach(args[1] as Object); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$detach#0', (args) { (args[0] as _$FollowerLayer)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$append#1', (args) { (args[0] as _$FollowerLayer)._super$append(args[1] as Layer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$redepthChildren#0', (args) { (args[0] as _$FollowerLayer)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$redepthChild#1', (args) { (args[0] as _$FollowerLayer)._super$redepthChild(args[1] as Layer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$removeAllChildren#0', (args) { (args[0] as _$FollowerLayer)._super$removeAllChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$addChildrenToScene#1', (args) { (args[0] as _$FollowerLayer)._super$addChildrenToScene(args[1] as ui.SceneBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$depthFirstIterateChildren#0', (args) => (args[0] as _$FollowerLayer)._super$depthFirstIterateChildren());
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$FollowerLayer)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$describeClipBounds#0', (args) => (args[0] as _$FollowerLayer)._super$describeClipBounds());
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$addCompositionCallback#1', (args) => (args[0] as _$FollowerLayer)._super$addCompositionCallback((a) => (args[1] as Function)(a)));
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$markNeedsAddToScene#0', (args) { (args[0] as _$FollowerLayer)._super$markNeedsAddToScene(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$debugMarkClean#0', (args) { (args[0] as _$FollowerLayer)._super$debugMarkClean(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$remove#0', (args) { (args[0] as _$FollowerLayer)._super$remove(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$toStringShort#0', (args) => (args[0] as _$FollowerLayer)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$toStringShallow#2', (args) => (args[0] as _$FollowerLayer)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$toStringDeep#4', (args) => (args[0] as _$FollowerLayer)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$FollowerLayer)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$link#0', (args) => (args[0] as _$FollowerLayer)._super$link);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$showWhenUnlinked#0', (args) => (args[0] as _$FollowerLayer)._super$showWhenUnlinked);
    ...
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$subtreeHasCompositionCallbacks#0', (args) => (args[0] as _$FollowerLayer)._super$subtreeHasCompositionCallbacks);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$debugDisposed#0', (args) => (args[0] as _$FollowerLayer)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$debugHandleCount#0', (args) => (args[0] as _$FollowerLayer)._super$debugHandleCount);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$parent#0', (args) => (args[0] as _$FollowerLayer)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$debugSubtreeNeedsAddToScene#0', (args) => (args[0] as _$FollowerLayer)._super$debugSubtreeNeedsAddToScene);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$engineLayer#0', (args) => (args[0] as _$FollowerLayer)._super$engineLayer);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$owner#0', (args) => (args[0] as _$FollowerLayer)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$attached#0', (args) => (args[0] as _$FollowerLayer)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$depth#0', (args) => (args[0] as _$FollowerLayer)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$nextSibling#0', (args) => (args[0] as _$FollowerLayer)._super$nextSibling);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$previousSibling#0', (args) => (args[0] as _$FollowerLayer)._super$previousSibling);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$debugCreator#0', (args) => (args[0] as _$FollowerLayer)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$link=#1', (args) { (args[0] as _$FollowerLayer)._super$link = args[1] as LayerLink; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$showWhenUnlinked=#1', (args) { (args[0] as _$FollowerLayer)._super$showWhenUnlinked = args[1] as bool?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/layer.dart::FollowerLayer::\$super\$unlinkedOffset=#1', (args) { (args[0] as _$FollowerLayer)._super$unlinkedOffset = args[1] as ui.Offset?; return args[1]; });
