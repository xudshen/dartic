...
class _$RenderRepaintBoundary extends RenderRepaintBoundary implements DarticObjectHolder {
  ...
  Future<ui.Image> toImage({double pixelRatio = 1.0}) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'toImage', [pixelRatio]);
    if (identical(_$r, notOverridden)) return super.toImage(pixelRatio: pixelRatio);
    return _$r as Future<ui.Image>;
  }

  @override
  ui.Image toImageSync({double pixelRatio = 1.0}) {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'toImageSync', [pixelRatio]);
    if (identical(_$r, notOverridden)) return super.toImageSync(pixelRatio: pixelRatio);
    return _$r as ui.Image;
  }

  @override
  void debugResetMetrics() {
    final _$r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'debugResetMetrics', const []);
    if (identical(_$r, notOverridden)) { super.debugResetMetrics(); return; }
  }
