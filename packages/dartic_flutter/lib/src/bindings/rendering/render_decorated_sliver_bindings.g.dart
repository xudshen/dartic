...
class _$RenderDecoratedSliver extends RenderDecoratedSliver implements DarticObjectHolder {
  _$RenderDecoratedSliver(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(decoration: superArgs[0] as Decoration, position: superArgs[1] as DecorationPosition, configuration: superArgs[2] as ImageConfiguration);
...
/// private class.
Object createRenderDecoratedSliverBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderDecoratedSliver(dispatch, obj, superArgs);
...
abstract final class RenderDecoratedSliverBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderDecoratedSliver(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$attach#1', (args) { (args[0] as _$RenderDecoratedSliver)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$detach#0', (args) { (args[0] as _$RenderDecoratedSliver)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$dispose#0', (args) { (args[0] as _$RenderDecoratedSliver)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$paint#2', (args) { (args[0] as _$RenderDecoratedSliver)._super$paint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$toString#1', (args) => (args[0] as _$RenderDecoratedSliver)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$setupParentData#1', (args) { (args[0] as _$RenderDecoratedSliver)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$performLayout#0', (args) { (args[0] as _$RenderDecoratedSliver)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$hitTestChildren#3', (args) => (args[0] as _$RenderDecoratedSliver)._super$hitTestChildren(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$childMainAxisPosition#1', (args) => (args[0] as _$RenderDecoratedSliver)._super$childMainAxisPosition(args[1] as RenderSliver));
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderDecoratedSliver)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderDecoratedSliver)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderDecoratedSliver)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$performResize#0', (args) { (args[0] as _$RenderDecoratedSliver)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$hitTest#3', (args) => (args[0] as _$RenderDecoratedSliver)._super$hitTest(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$hitTestSelf#2', (args) => (args[0] as _$RenderDecoratedSliver)._super$hitTestSelf(mainAxisPosition: args[1] as double, crossAxisPosition: args[2] as double));
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$calculatePaintOffset#3', (args) => (args[0] as _$RenderDecoratedSliver)._super$calculatePaintOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$calculateCacheOffset#3', (args) => (args[0] as _$RenderDecoratedSliver)._super$calculateCacheOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$childCrossAxisPosition#1', (args) => (args[0] as _$RenderDecoratedSliver)._super$childCrossAxisPosition(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$childScrollOffset#1', (args) => (args[0] as _$RenderDecoratedSliver)._super$childScrollOffset(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$getAbsoluteSizeRelativeToOrigin#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$getAbsoluteSizeRelativeToOrigin());
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$getAbsoluteSize#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$getAbsoluteSize());
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$debugPaint#2', (args) { (args[0] as _$RenderDecoratedSliver)._super$debugPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$handleEvent#2', (args) { (args[0] as _$RenderDecoratedSliver)._super$handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderDecoratedSliver)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$reassemble#0', (args) { (args[0] as _$RenderDecoratedSliver)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$redepthChild#1', (args) { (args[0] as _$RenderDecoratedSliver)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderDecoratedSliver)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$adoptChild#1', (args) { (args[0] as _$RenderDecoratedSliver)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$dropChild#1', (args) { (args[0] as _$RenderDecoratedSliver)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$visitChildren#1', (args) { (args[0] as _$RenderDecoratedSliver)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderDecoratedSliver)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderDecoratedSliver)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderDecoratedSliver)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderDecoratedSliver)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$layout#2', (args) { (args[0] as _$RenderDecoratedSliver)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderDecoratedSliver)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderDecoratedSliver)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderDecoratedSliver)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderDecoratedSliver)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderDecoratedSliver)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderDecoratedSliver)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderDecoratedSliver)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$paintsChild#1', (args) => (args[0] as _$RenderDecoratedSliver)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderDecoratedSliver)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderDecoratedSliver)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderDecoratedSliver)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderDecoratedSliver)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderDecoratedSliver)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderDecoratedSliver)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderDecoratedSliver)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderDecoratedSliver)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderDecoratedSliver)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderDecoratedSliver)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$toStringShort#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderDecoratedSliver)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderDecoratedSliver)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderDecoratedSliver)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$describeForError#2', (args) => (args[0] as _$RenderDecoratedSliver)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderDecoratedSliver)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderDecoratedSliver)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$decoration#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$decoration);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$position#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$position);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$configuration#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$configuration);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$ensureSemantics#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$ensureSemantics);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$constraints#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$geometry#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$geometry);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$paintBounds#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$centerOffsetAdjustment#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$centerOffsetAdjustment);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$parentData#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$depth#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$parent#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$debugCreator#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$owner#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$attached#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$layer#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$debugLayer#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$child#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$decoration=#1', (args) { (args[0] as _$RenderDecoratedSliver)._super$decoration = args[1] as Decoration; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$position=#1', (args) { (args[0] as _$RenderDecoratedSliver)._super$position = args[1] as DecorationPosition; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$configuration=#1', (args) { (args[0] as _$RenderDecoratedSliver)._super$configuration = args[1] as ImageConfiguration; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$geometry=#1', (args) { (args[0] as _$RenderDecoratedSliver)._super$geometry = args[1] as SliverGeometry?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$parentData=#1', (args) { (args[0] as _$RenderDecoratedSliver)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderDecoratedSliver)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$layer=#1', (args) { (args[0] as _$RenderDecoratedSliver)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$child=#1', (args) { (args[0] as _$RenderDecoratedSliver)._super$child = args[1] as RenderSliver?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/decorated_sliver.dart::RenderDecoratedSliver::\$super\$hashCode#0', (args) => (args[0] as _$RenderDecoratedSliver)._super$hashCode);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderDecoratedSliver).handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; },
