...
class _$RenderClipRect extends RenderClipRect implements DarticObjectHolder {
  _$RenderClipRect(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?, clipper: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as CustomClipper<ui.Rect>?, clipBehavior: superArgs[2] as ui.Clip);
  ...
  @override
  set clipper(CustomClipper<ui.Rect>? value) {
  ...
  set _super$clipper(CustomClipper<ui.Rect>? value) { super.clipper = value; }
...
/// private class.
Object createRenderClipRectBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderClipRect(dispatch, obj, superArgs);
...
abstract final class RenderClipRectBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderClipRect(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$hitTest#2', (args) => (args[0] as _$RenderClipRect)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$paint#2', (args) { (args[0] as _$RenderClipRect)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderClipRect)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$toString#1', (args) => (args[0] as _$RenderClipRect)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$attach#1', (args) { (args[0] as _$RenderClipRect)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$detach#0', (args) { (args[0] as _$RenderClipRect)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$performLayout#0', (args) { (args[0] as _$RenderClipRect)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderClipRect)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$dispose#0', (args) { (args[0] as _$RenderClipRect)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$setupParentData#1', (args) { (args[0] as _$RenderClipRect)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderClipRect)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderClipRect)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderClipRect)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderClipRect)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderClipRect)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderClipRect)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderClipRect)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderClipRect)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderClipRect)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderClipRect)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderClipRect)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderClipRect)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderClipRect)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderClipRect)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderClipRect)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderClipRect)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderClipRect)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderClipRect)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderClipRect)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderClipRect)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$performResize#0', (args) { (args[0] as _$RenderClipRect)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderClipRect)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderClipRect)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderClipRect)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderClipRect)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderClipRect)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$handleEvent#2', (args) { (args[0] as _$RenderClipRect)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderClipRect)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugPaint#2', (args) { (args[0] as _$RenderClipRect)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderClipRect)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderClipRect)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderClipRect)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$reassemble#0', (args) { (args[0] as _$RenderClipRect)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$redepthChild#1', (args) { (args[0] as _$RenderClipRect)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderClipRect)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$adoptChild#1', (args) { (args[0] as _$RenderClipRect)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$dropChild#1', (args) { (args[0] as _$RenderClipRect)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$visitChildren#1', (args) { (args[0] as _$RenderClipRect)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderClipRect)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderClipRect)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderClipRect)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$layout#2', (args) { (args[0] as _$RenderClipRect)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderClipRect)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderClipRect)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderClipRect)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderClipRect)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderClipRect)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderClipRect)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderClipRect)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$paintsChild#1', (args) => (args[0] as _$RenderClipRect)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderClipRect)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderClipRect)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderClipRect)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderClipRect)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderClipRect)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderClipRect)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderClipRect)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderClipRect)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderClipRect)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$toStringShort#0', (args) => (args[0] as _$RenderClipRect)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderClipRect)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderClipRect)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderClipRect)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderClipRect)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$describeForError#2', (args) => (args[0] as _$RenderClipRect)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderClipRect)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderClipRect)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$computeSizeForNoChild#1', (args) => (args[0] as _$RenderClipRect)._super$computeSizeForNoChild(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$clipper#0', (args) => (args[0] as _$RenderClipRect)._super$clipper);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$clipBehavior#0', (args) => (args[0] as _$RenderClipRect)._super$clipBehavior);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$hasSize#0', (args) => (args[0] as _$RenderClipRect)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$size#0', (args) => (args[0] as _$RenderClipRect)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderClipRect)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$constraints#0', (args) => (args[0] as _$RenderClipRect)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$paintBounds#0', (args) => (args[0] as _$RenderClipRect)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderClipRect)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$parentData#0', (args) => (args[0] as _$RenderClipRect)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$depth#0', (args) => (args[0] as _$RenderClipRect)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$parent#0', (args) => (args[0] as _$RenderClipRect)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderClipRect)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugCreator#0', (args) => (args[0] as _$RenderClipRect)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderClipRect)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderClipRect)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderClipRect)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderClipRect)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$owner#0', (args) => (args[0] as _$RenderClipRect)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$attached#0', (args) => (args[0] as _$RenderClipRect)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderClipRect)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderClipRect)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderClipRect)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderClipRect)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderClipRect)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderClipRect)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$layer#0', (args) => (args[0] as _$RenderClipRect)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugLayer#0', (args) => (args[0] as _$RenderClipRect)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderClipRect)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderClipRect)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderClipRect)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderClipRect)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderClipRect)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$child#0', (args) => (args[0] as _$RenderClipRect)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$clipper=#1', (args) { (args[0] as _$RenderClipRect)._super$clipper = args[1] as CustomClipper<ui.Rect>?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$clipBehavior=#1', (args) { (args[0] as _$RenderClipRect)._super$clipBehavior = args[1] as ui.Clip; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$size=#1', (args) { (args[0] as _$RenderClipRect)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$parentData=#1', (args) { (args[0] as _$RenderClipRect)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderClipRect)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$layer=#1', (args) { (args[0] as _$RenderClipRect)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$child=#1', (args) { (args[0] as _$RenderClipRect)._super$child = args[1] as RenderBox?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRect::\$super\$hashCode#0', (args) => (args[0] as _$RenderClipRect)._super$hashCode);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderClipRect).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
