...
class _$RenderConstrainedOverflowBox extends RenderConstrainedOverflowBox implements DarticObjectHolder {
  _$RenderConstrainedOverflowBox(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?, minWidth: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as double?, maxWidth: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as double?, minHeight: identical(superArgs[3], darticAbsent) ? null : superArgs[3] as double?, maxHeight: identical(superArgs[4], darticAbsent) ? null : superArgs[4] as double?, fit: superArgs[5] as OverflowBoxFit, alignment: superArgs[6] as AlignmentGeometry, textDirection: identical(superArgs[7], darticAbsent) ? null : superArgs[7] as TextDirection?);
  ...
  set minWidth(double? value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'minWidth', value)) {
  ...
  set minHeight(double? value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'minHeight', value)) {
  ...
  set _super$minWidth(double? value) { super.minWidth = value; }
  set _super$maxWidth(double? value) { super.maxWidth = value; }
  set _super$minHeight(double? value) { super.minHeight = value; }
  set _super$maxHeight(double? value) { super.maxHeight = value; }
  set _super$fit(OverflowBoxFit value) { super.fit = value; }
...
/// private class.
Object createRenderConstrainedOverflowBoxBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderConstrainedOverflowBox(dispatch, obj, superArgs);
...
abstract final class RenderConstrainedOverflowBoxBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderConstrainedOverflowBox(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$performLayout#0', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$toString#1', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$alignChild#0', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$alignChild(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$computeDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$paint#2', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$paint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$setupParentData#1', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$debugAdoptSize(args[1] as Size));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$getDistanceToBaseline(args[1] as TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$getDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$performResize#0', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$hitTest#2', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$hitTestSelf(args[1] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$globalToLocal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$localToGlobal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$handleEvent#2', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugPaint#2', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$debugPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$debugPaintSize(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$reassemble#0', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$dispose#0', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$redepthChild#1', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$adoptChild#1', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$dropChild#1', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$visitChildren#1', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$attach#1', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$detach#0', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$layout#2', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$paintsChild#1', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$toStringShort#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$describeForError#2', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$minWidth#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$minWidth);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$maxWidth#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$maxWidth);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$minHeight#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$minHeight);
    ...
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$hasSize#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$size#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$constraints#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$paintBounds#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$parentData#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$depth#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$parent#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugCreator#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$owner#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$attached#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$layer#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugLayer#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$child#0', (args) => (args[0] as _$RenderConstrainedOverflowBox)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$minWidth=#1', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$minWidth = args[1] as double?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$maxWidth=#1', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$maxWidth = args[1] as double?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$minHeight=#1', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$minHeight = args[1] as double?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$maxHeight=#1', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$maxHeight = args[1] as double?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$fit=#1', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$fit = args[1] as OverflowBoxFit; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$alignment=#1', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$alignment = args[1] as AlignmentGeometry; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$textDirection=#1', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$textDirection = args[1] as TextDirection?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$size=#1', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$size = args[1] as Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderConstrainedOverflowBox::\$super\$parentData=#1', (args) { (args[0] as _$RenderConstrainedOverflowBox)._super$parentData = args[1] as ParentData?; return args[1]; });
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderConstrainedOverflowBox).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
