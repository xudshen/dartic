...
class _$DebugOverflowIndicatorMixin implements DebugOverflowIndicatorMixin, DarticObjectHolder {
  _$DebugOverflowIndicatorMixin(this._dispatch, this.$darticObject, List<Object?> superArgs);
  ...
  @override
  void paintOverflowIndicator(PaintingContext context, ui.Offset offset, ui.Rect containerRect, ui.Rect childRect, {List<DiagnosticsNode>? overflowHints}) {
    final r = _dispatch.invoke($darticObject.bridge ?? $darticObject, $darticObject, 'paintOverflowIndicator', [context, offset, containerRect, childRect, overflowHints]);
    if (identical(r, notOverridden)) {
      throw UnsupportedError('Abstract method paintOverflowIndicator must be overridden in dartic code');
    }
  }
...
/// private class.
Object createDebugOverflowIndicatorMixinBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$DebugOverflowIndicatorMixin(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$DebugOverflowIndicatorMixin(dispatch, darticObject, superArgs),
    );
  }
