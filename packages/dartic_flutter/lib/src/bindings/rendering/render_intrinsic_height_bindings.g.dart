...
class _$RenderIntrinsicHeight extends RenderIntrinsicHeight implements DarticObjectHolder {
  _$RenderIntrinsicHeight(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?);
...
/// private class.
Object createRenderIntrinsicHeightBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderIntrinsicHeight(dispatch, obj, superArgs);
...
abstract final class RenderIntrinsicHeightBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderIntrinsicHeight(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderIntrinsicHeight)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderIntrinsicHeight)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderIntrinsicHeight)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderIntrinsicHeight)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderIntrinsicHeight)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$performLayout#0', (args) { (args[0] as _$RenderIntrinsicHeight)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$toString#1', (args) => (args[0] as _$RenderIntrinsicHeight)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$setupParentData#1', (args) { (args[0] as _$RenderIntrinsicHeight)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderIntrinsicHeight)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderIntrinsicHeight)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderIntrinsicHeight)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderIntrinsicHeight)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderIntrinsicHeight)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderIntrinsicHeight)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderIntrinsicHeight)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderIntrinsicHeight)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderIntrinsicHeight)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderIntrinsicHeight)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderIntrinsicHeight)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderIntrinsicHeight)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderIntrinsicHeight)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderIntrinsicHeight)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderIntrinsicHeight)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$performResize#0', (args) { (args[0] as _$RenderIntrinsicHeight)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$hitTest#2', (args) => (args[0] as _$RenderIntrinsicHeight)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderIntrinsicHeight)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderIntrinsicHeight)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderIntrinsicHeight)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderIntrinsicHeight)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderIntrinsicHeight)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$handleEvent#2', (args) { (args[0] as _$RenderIntrinsicHeight)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderIntrinsicHeight)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugPaint#2', (args) { (args[0] as _$RenderIntrinsicHeight)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderIntrinsicHeight)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderIntrinsicHeight)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderIntrinsicHeight)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderIntrinsicHeight)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$reassemble#0', (args) { (args[0] as _$RenderIntrinsicHeight)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$dispose#0', (args) { (args[0] as _$RenderIntrinsicHeight)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$redepthChild#1', (args) { (args[0] as _$RenderIntrinsicHeight)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderIntrinsicHeight)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$adoptChild#1', (args) { (args[0] as _$RenderIntrinsicHeight)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$dropChild#1', (args) { (args[0] as _$RenderIntrinsicHeight)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$visitChildren#1', (args) { (args[0] as _$RenderIntrinsicHeight)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$attach#1', (args) { (args[0] as _$RenderIntrinsicHeight)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$detach#0', (args) { (args[0] as _$RenderIntrinsicHeight)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderIntrinsicHeight)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderIntrinsicHeight)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderIntrinsicHeight)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$layout#2', (args) { (args[0] as _$RenderIntrinsicHeight)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderIntrinsicHeight)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderIntrinsicHeight)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderIntrinsicHeight)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderIntrinsicHeight)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderIntrinsicHeight)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderIntrinsicHeight)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderIntrinsicHeight)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$paint#2', (args) { (args[0] as _$RenderIntrinsicHeight)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$paintsChild#1', (args) => (args[0] as _$RenderIntrinsicHeight)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderIntrinsicHeight)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderIntrinsicHeight)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderIntrinsicHeight)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderIntrinsicHeight)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderIntrinsicHeight)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderIntrinsicHeight)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderIntrinsicHeight)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderIntrinsicHeight)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderIntrinsicHeight)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderIntrinsicHeight)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$toStringShort#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderIntrinsicHeight)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderIntrinsicHeight)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderIntrinsicHeight)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$describeForError#2', (args) => (args[0] as _$RenderIntrinsicHeight)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderIntrinsicHeight)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderIntrinsicHeight)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$computeSizeForNoChild#1', (args) => (args[0] as _$RenderIntrinsicHeight)._super$computeSizeForNoChild(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$hasSize#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$size#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$constraints#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$paintBounds#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$parentData#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$depth#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$parent#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugCreator#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$owner#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$attached#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$layer#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugLayer#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$child#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$size=#1', (args) { (args[0] as _$RenderIntrinsicHeight)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$parentData=#1', (args) { (args[0] as _$RenderIntrinsicHeight)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderIntrinsicHeight)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$layer=#1', (args) { (args[0] as _$RenderIntrinsicHeight)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$child=#1', (args) { (args[0] as _$RenderIntrinsicHeight)._super$child = args[1] as RenderBox?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIntrinsicHeight::\$super\$hashCode#0', (args) => (args[0] as _$RenderIntrinsicHeight)._super$hashCode);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderIntrinsicHeight).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
