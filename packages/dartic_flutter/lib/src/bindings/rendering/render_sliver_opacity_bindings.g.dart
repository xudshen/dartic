...
class _$RenderSliverOpacity extends RenderSliverOpacity implements DarticObjectHolder {
  _$RenderSliverOpacity(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(opacity: superArgs[0] as double, alwaysIncludeSemantics: superArgs[1] as bool, sliver: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as RenderSliver?);
...
/// private class.
Object createRenderSliverOpacityBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderSliverOpacity(dispatch, obj, superArgs);
...
abstract final class RenderSliverOpacityBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderSliverOpacity(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$paint#2', (args) { (args[0] as _$RenderSliverOpacity)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderSliverOpacity)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderSliverOpacity)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$toString#1', (args) => (args[0] as _$RenderSliverOpacity)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$setupParentData#1', (args) { (args[0] as _$RenderSliverOpacity)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$performLayout#0', (args) { (args[0] as _$RenderSliverOpacity)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$hitTestChildren#3', (args) => (args[0] as _$RenderSliverOpacity)._super$hitTestChildren(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$childMainAxisPosition#1', (args) => (args[0] as _$RenderSliverOpacity)._super$childMainAxisPosition(args[1] as RenderSliver));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderSliverOpacity)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderSliverOpacity)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderSliverOpacity)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$performResize#0', (args) { (args[0] as _$RenderSliverOpacity)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$hitTest#3', (args) => (args[0] as _$RenderSliverOpacity)._super$hitTest(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$hitTestSelf#2', (args) => (args[0] as _$RenderSliverOpacity)._super$hitTestSelf(mainAxisPosition: args[1] as double, crossAxisPosition: args[2] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$calculatePaintOffset#3', (args) => (args[0] as _$RenderSliverOpacity)._super$calculatePaintOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$calculateCacheOffset#3', (args) => (args[0] as _$RenderSliverOpacity)._super$calculateCacheOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$childCrossAxisPosition#1', (args) => (args[0] as _$RenderSliverOpacity)._super$childCrossAxisPosition(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$childScrollOffset#1', (args) => (args[0] as _$RenderSliverOpacity)._super$childScrollOffset(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$getAbsoluteSizeRelativeToOrigin#0', (args) => (args[0] as _$RenderSliverOpacity)._super$getAbsoluteSizeRelativeToOrigin());
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$getAbsoluteSize#0', (args) => (args[0] as _$RenderSliverOpacity)._super$getAbsoluteSize());
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$debugPaint#2', (args) { (args[0] as _$RenderSliverOpacity)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$handleEvent#2', (args) { (args[0] as _$RenderSliverOpacity)._super$handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$reassemble#0', (args) { (args[0] as _$RenderSliverOpacity)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$dispose#0', (args) { (args[0] as _$RenderSliverOpacity)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$redepthChild#1', (args) { (args[0] as _$RenderSliverOpacity)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderSliverOpacity)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$adoptChild#1', (args) { (args[0] as _$RenderSliverOpacity)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$dropChild#1', (args) { (args[0] as _$RenderSliverOpacity)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$visitChildren#1', (args) { (args[0] as _$RenderSliverOpacity)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$attach#1', (args) { (args[0] as _$RenderSliverOpacity)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$detach#0', (args) { (args[0] as _$RenderSliverOpacity)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderSliverOpacity)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderSliverOpacity)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderSliverOpacity)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderSliverOpacity)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$layout#2', (args) { (args[0] as _$RenderSliverOpacity)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderSliverOpacity)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderSliverOpacity)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderSliverOpacity)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderSliverOpacity)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderSliverOpacity)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderSliverOpacity)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderSliverOpacity)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$paintsChild#1', (args) => (args[0] as _$RenderSliverOpacity)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderSliverOpacity)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderSliverOpacity)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderSliverOpacity)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderSliverOpacity)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderSliverOpacity)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderSliverOpacity)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderSliverOpacity)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderSliverOpacity)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderSliverOpacity)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$toStringShort#0', (args) => (args[0] as _$RenderSliverOpacity)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderSliverOpacity)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderSliverOpacity)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderSliverOpacity)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderSliverOpacity)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$describeForError#2', (args) => (args[0] as _$RenderSliverOpacity)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderSliverOpacity)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderSliverOpacity)._super$debugValidateChild(args[1] as RenderObject));
    ...
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$geometry#0', (args) => (args[0] as _$RenderSliverOpacity)._super$geometry);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$paintBounds#0', (args) => (args[0] as _$RenderSliverOpacity)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$centerOffsetAdjustment#0', (args) => (args[0] as _$RenderSliverOpacity)._super$centerOffsetAdjustment);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderSliverOpacity)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$parentData#0', (args) => (args[0] as _$RenderSliverOpacity)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$depth#0', (args) => (args[0] as _$RenderSliverOpacity)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$parent#0', (args) => (args[0] as _$RenderSliverOpacity)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderSliverOpacity)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$debugCreator#0', (args) => (args[0] as _$RenderSliverOpacity)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderSliverOpacity)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderSliverOpacity)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderSliverOpacity)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderSliverOpacity)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$owner#0', (args) => (args[0] as _$RenderSliverOpacity)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$attached#0', (args) => (args[0] as _$RenderSliverOpacity)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderSliverOpacity)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderSliverOpacity)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderSliverOpacity)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderSliverOpacity)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderSliverOpacity)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$layer#0', (args) => (args[0] as _$RenderSliverOpacity)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$debugLayer#0', (args) => (args[0] as _$RenderSliverOpacity)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderSliverOpacity)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderSliverOpacity)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderSliverOpacity)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderSliverOpacity)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderSliverOpacity)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$child#0', (args) => (args[0] as _$RenderSliverOpacity)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$opacity=#1', (args) { (args[0] as _$RenderSliverOpacity)._super$opacity = args[1] as double; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$alwaysIncludeSemantics=#1', (args) { (args[0] as _$RenderSliverOpacity)._super$alwaysIncludeSemantics = args[1] as bool; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$geometry=#1', (args) { (args[0] as _$RenderSliverOpacity)._super$geometry = args[1] as SliverGeometry?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_sliver.dart::RenderSliverOpacity::\$super\$parentData=#1', (args) { (args[0] as _$RenderSliverOpacity)._super$parentData = args[1] as ParentData?; return args[1]; });
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderSliverOpacity).handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; },
