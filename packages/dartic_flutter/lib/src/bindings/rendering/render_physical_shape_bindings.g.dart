...
class _$RenderPhysicalShape extends RenderPhysicalShape implements DarticObjectHolder {
  _$RenderPhysicalShape(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?, clipper: superArgs[1] as CustomClipper<ui.Path>, clipBehavior: superArgs[2] as ui.Clip, elevation: superArgs[3] as double, color: superArgs[4] as ui.Color, shadowColor: superArgs[5] as ui.Color);
...
/// private class.
Object createRenderPhysicalShapeBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderPhysicalShape(dispatch, obj, superArgs);
...
abstract final class RenderPhysicalShapeBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderPhysicalShape(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$hitTest#2', (args) => (args[0] as _$RenderPhysicalShape)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$paint#2', (args) { (args[0] as _$RenderPhysicalShape)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderPhysicalShape)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$toString#1', (args) => (args[0] as _$RenderPhysicalShape)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$attach#1', (args) { (args[0] as _$RenderPhysicalShape)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$detach#0', (args) { (args[0] as _$RenderPhysicalShape)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$performLayout#0', (args) { (args[0] as _$RenderPhysicalShape)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderPhysicalShape)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderPhysicalShape)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$dispose#0', (args) { (args[0] as _$RenderPhysicalShape)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$setupParentData#1', (args) { (args[0] as _$RenderPhysicalShape)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderPhysicalShape)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderPhysicalShape)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderPhysicalShape)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderPhysicalShape)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderPhysicalShape)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderPhysicalShape)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderPhysicalShape)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderPhysicalShape)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderPhysicalShape)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderPhysicalShape)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderPhysicalShape)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderPhysicalShape)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderPhysicalShape)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderPhysicalShape)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderPhysicalShape)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderPhysicalShape)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderPhysicalShape)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderPhysicalShape)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderPhysicalShape)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderPhysicalShape)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$performResize#0', (args) { (args[0] as _$RenderPhysicalShape)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderPhysicalShape)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderPhysicalShape)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderPhysicalShape)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderPhysicalShape)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderPhysicalShape)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$handleEvent#2', (args) { (args[0] as _$RenderPhysicalShape)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderPhysicalShape)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugPaint#2', (args) { (args[0] as _$RenderPhysicalShape)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderPhysicalShape)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderPhysicalShape)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$reassemble#0', (args) { (args[0] as _$RenderPhysicalShape)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$redepthChild#1', (args) { (args[0] as _$RenderPhysicalShape)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderPhysicalShape)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$adoptChild#1', (args) { (args[0] as _$RenderPhysicalShape)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$dropChild#1', (args) { (args[0] as _$RenderPhysicalShape)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$visitChildren#1', (args) { (args[0] as _$RenderPhysicalShape)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderPhysicalShape)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderPhysicalShape)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderPhysicalShape)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$layout#2', (args) { (args[0] as _$RenderPhysicalShape)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderPhysicalShape)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderPhysicalShape)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderPhysicalShape)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderPhysicalShape)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderPhysicalShape)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderPhysicalShape)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderPhysicalShape)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$paintsChild#1', (args) => (args[0] as _$RenderPhysicalShape)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderPhysicalShape)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderPhysicalShape)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderPhysicalShape)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderPhysicalShape)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderPhysicalShape)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderPhysicalShape)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderPhysicalShape)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderPhysicalShape)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderPhysicalShape)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$toStringShort#0', (args) => (args[0] as _$RenderPhysicalShape)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderPhysicalShape)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderPhysicalShape)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderPhysicalShape)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderPhysicalShape)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$describeForError#2', (args) => (args[0] as _$RenderPhysicalShape)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ...
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$clipper#0', (args) => (args[0] as _$RenderPhysicalShape)._super$clipper);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$clipBehavior#0', (args) => (args[0] as _$RenderPhysicalShape)._super$clipBehavior);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$hasSize#0', (args) => (args[0] as _$RenderPhysicalShape)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$size#0', (args) => (args[0] as _$RenderPhysicalShape)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderPhysicalShape)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$constraints#0', (args) => (args[0] as _$RenderPhysicalShape)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$paintBounds#0', (args) => (args[0] as _$RenderPhysicalShape)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderPhysicalShape)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$parentData#0', (args) => (args[0] as _$RenderPhysicalShape)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$depth#0', (args) => (args[0] as _$RenderPhysicalShape)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$parent#0', (args) => (args[0] as _$RenderPhysicalShape)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderPhysicalShape)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugCreator#0', (args) => (args[0] as _$RenderPhysicalShape)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderPhysicalShape)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderPhysicalShape)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderPhysicalShape)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderPhysicalShape)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$owner#0', (args) => (args[0] as _$RenderPhysicalShape)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$attached#0', (args) => (args[0] as _$RenderPhysicalShape)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderPhysicalShape)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderPhysicalShape)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderPhysicalShape)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderPhysicalShape)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderPhysicalShape)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderPhysicalShape)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$layer#0', (args) => (args[0] as _$RenderPhysicalShape)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugLayer#0', (args) => (args[0] as _$RenderPhysicalShape)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderPhysicalShape)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderPhysicalShape)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderPhysicalShape)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderPhysicalShape)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderPhysicalShape)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$child#0', (args) => (args[0] as _$RenderPhysicalShape)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$elevation=#1', (args) { (args[0] as _$RenderPhysicalShape)._super$elevation = args[1] as double; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$shadowColor=#1', (args) { (args[0] as _$RenderPhysicalShape)._super$shadowColor = args[1] as ui.Color; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$color=#1', (args) { (args[0] as _$RenderPhysicalShape)._super$color = args[1] as ui.Color; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$clipper=#1', (args) { (args[0] as _$RenderPhysicalShape)._super$clipper = args[1] as CustomClipper<ui.Path>?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$clipBehavior=#1', (args) { (args[0] as _$RenderPhysicalShape)._super$clipBehavior = args[1] as ui.Clip; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$size=#1', (args) { (args[0] as _$RenderPhysicalShape)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderPhysicalShape::\$super\$parentData=#1', (args) { (args[0] as _$RenderPhysicalShape)._super$parentData = args[1] as ParentData?; return args[1]; });
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#1': (args) => (args[0] as RenderPhysicalShape).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
        ...
        'handleEvent#2': (args) { (args[0] as RenderPhysicalShape).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
