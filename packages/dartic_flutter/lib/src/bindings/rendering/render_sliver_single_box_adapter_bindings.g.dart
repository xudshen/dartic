...
class _$RenderSliverSingleBoxAdapter extends RenderSliverSingleBoxAdapter implements DarticObjectHolder {
  _$RenderSliverSingleBoxAdapter(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?);
...
/// private class.
Object createRenderSliverSingleBoxAdapterBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderSliverSingleBoxAdapter(dispatch, obj, superArgs);
...
abstract final class RenderSliverSingleBoxAdapterBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderSliverSingleBoxAdapter(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$setupParentData#1', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$setChildParentData#3', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$setChildParentData(args[1] as RenderObject, args[2] as SliverConstraints, args[3] as SliverGeometry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$hitTestChildren#3', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$hitTestChildren(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$childMainAxisPosition#1', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$childMainAxisPosition(args[1] as RenderBox));
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$paint#2', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$paint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$toString#1', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$performResize#0', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$hitTest#3', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$hitTest(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$hitTestSelf#2', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$hitTestSelf(mainAxisPosition: args[1] as double, crossAxisPosition: args[2] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$calculatePaintOffset#3', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$calculatePaintOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$calculateCacheOffset#3', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$calculateCacheOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$childCrossAxisPosition#1', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$childCrossAxisPosition(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$childScrollOffset#1', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$childScrollOffset(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$getAbsoluteSizeRelativeToOrigin#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$getAbsoluteSizeRelativeToOrigin());
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$getAbsoluteSize#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$getAbsoluteSize());
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$debugPaint#2', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$debugPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$handleEvent#2', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$reassemble#0', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$dispose#0', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$redepthChild#1', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$adoptChild#1', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$dropChild#1', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$visitChildren#1', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$attach#1', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$detach#0', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$layout#2', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$paintsChild#1', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$toStringShort#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$describeForError#2', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$hitTestBoxChild#4', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$hitTestBoxChild(args[1] as BoxHitTestResult, args[2] as RenderBox, mainAxisPosition: args[3] as double, crossAxisPosition: args[4] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$applyPaintTransformForBoxChild#2', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$applyPaintTransformForBoxChild(args[1] as RenderBox, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$hashCode#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$hashCode);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$ensureSemantics#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$ensureSemantics);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$constraints#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$geometry#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$geometry);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$paintBounds#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$centerOffsetAdjustment#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$centerOffsetAdjustment);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$parentData#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$depth#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$parent#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$debugCreator#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$owner#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$attached#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$layer#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$debugLayer#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$child#0', (args) => (args[0] as _$RenderSliverSingleBoxAdapter)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$geometry=#1', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$geometry = args[1] as SliverGeometry?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$parentData=#1', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$layer=#1', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver.dart::RenderSliverSingleBoxAdapter::\$super\$child=#1', (args) { (args[0] as _$RenderSliverSingleBoxAdapter)._super$child = args[1] as RenderBox?; return args[1]; });
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderSliverSingleBoxAdapter).handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; },
