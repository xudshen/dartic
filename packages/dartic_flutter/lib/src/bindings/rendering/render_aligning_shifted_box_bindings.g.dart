...
class _$RenderAligningShiftedBox extends RenderAligningShiftedBox implements DarticObjectHolder {
  _$RenderAligningShiftedBox(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(alignment: superArgs[0] as AlignmentGeometry, textDirection: superArgs[1] as TextDirection?, child: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as RenderBox?);
...
/// private class.
Object createRenderAligningShiftedBoxBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderAligningShiftedBox(dispatch, obj, superArgs);
...
abstract final class RenderAligningShiftedBoxBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderAligningShiftedBox(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$alignChild#0', (args) { (args[0] as _$RenderAligningShiftedBox)._super$alignChild(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderAligningShiftedBox)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$toString#1', (args) => (args[0] as _$RenderAligningShiftedBox)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderAligningShiftedBox)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderAligningShiftedBox)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderAligningShiftedBox)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderAligningShiftedBox)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderAligningShiftedBox)._super$computeDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$paint#2', (args) { (args[0] as _$RenderAligningShiftedBox)._super$paint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderAligningShiftedBox)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$setupParentData#1', (args) { (args[0] as _$RenderAligningShiftedBox)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderAligningShiftedBox)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderAligningShiftedBox)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderAligningShiftedBox)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderAligningShiftedBox)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderAligningShiftedBox)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderAligningShiftedBox)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderAligningShiftedBox)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderAligningShiftedBox)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderAligningShiftedBox)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderAligningShiftedBox)._super$debugAdoptSize(args[1] as Size));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderAligningShiftedBox)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderAligningShiftedBox)._super$getDistanceToBaseline(args[1] as TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderAligningShiftedBox)._super$getDistanceToActualBaseline(args[1] as TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderAligningShiftedBox)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderAligningShiftedBox)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$performResize#0', (args) { (args[0] as _$RenderAligningShiftedBox)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$performLayout#0', (args) { (args[0] as _$RenderAligningShiftedBox)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$hitTest#2', (args) => (args[0] as _$RenderAligningShiftedBox)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderAligningShiftedBox)._super$hitTestSelf(args[1] as Offset));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderAligningShiftedBox)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderAligningShiftedBox)._super$globalToLocal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderAligningShiftedBox)._super$localToGlobal(args[1] as Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$handleEvent#2', (args) { (args[0] as _$RenderAligningShiftedBox)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderAligningShiftedBox)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugPaint#2', (args) { (args[0] as _$RenderAligningShiftedBox)._super$debugPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderAligningShiftedBox)._super$debugPaintSize(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderAligningShiftedBox)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderAligningShiftedBox)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$reassemble#0', (args) { (args[0] as _$RenderAligningShiftedBox)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$dispose#0', (args) { (args[0] as _$RenderAligningShiftedBox)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$redepthChild#1', (args) { (args[0] as _$RenderAligningShiftedBox)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderAligningShiftedBox)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$adoptChild#1', (args) { (args[0] as _$RenderAligningShiftedBox)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$dropChild#1', (args) { (args[0] as _$RenderAligningShiftedBox)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$visitChildren#1', (args) { (args[0] as _$RenderAligningShiftedBox)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$attach#1', (args) { (args[0] as _$RenderAligningShiftedBox)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$detach#0', (args) { (args[0] as _$RenderAligningShiftedBox)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderAligningShiftedBox)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderAligningShiftedBox)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderAligningShiftedBox)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$layout#2', (args) { (args[0] as _$RenderAligningShiftedBox)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderAligningShiftedBox)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderAligningShiftedBox)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderAligningShiftedBox)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderAligningShiftedBox)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderAligningShiftedBox)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderAligningShiftedBox)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderAligningShiftedBox)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$paintsChild#1', (args) => (args[0] as _$RenderAligningShiftedBox)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderAligningShiftedBox)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderAligningShiftedBox)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderAligningShiftedBox)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderAligningShiftedBox)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderAligningShiftedBox)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderAligningShiftedBox)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderAligningShiftedBox)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderAligningShiftedBox)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderAligningShiftedBox)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderAligningShiftedBox)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$toStringShort#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderAligningShiftedBox)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderAligningShiftedBox)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderAligningShiftedBox)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$describeForError#2', (args) => (args[0] as _$RenderAligningShiftedBox)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderAligningShiftedBox)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderAligningShiftedBox)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$resolvedAlignment#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$resolvedAlignment);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$alignment#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$alignment);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$textDirection#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$textDirection);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$hashCode#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$hashCode);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$hasSize#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$size#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$constraints#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$paintBounds#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$parentData#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$depth#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$parent#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugCreator#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$owner#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$attached#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$layer#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugLayer#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$child#0', (args) => (args[0] as _$RenderAligningShiftedBox)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$alignment=#1', (args) { (args[0] as _$RenderAligningShiftedBox)._super$alignment = args[1] as AlignmentGeometry; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$textDirection=#1', (args) { (args[0] as _$RenderAligningShiftedBox)._super$textDirection = args[1] as TextDirection?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$size=#1', (args) { (args[0] as _$RenderAligningShiftedBox)._super$size = args[1] as Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$parentData=#1', (args) { (args[0] as _$RenderAligningShiftedBox)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderAligningShiftedBox)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$layer=#1', (args) { (args[0] as _$RenderAligningShiftedBox)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/shifted_box.dart::RenderAligningShiftedBox::\$super\$child=#1', (args) { (args[0] as _$RenderAligningShiftedBox)._super$child = args[1] as RenderBox?; return args[1]; });
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderAligningShiftedBox).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
