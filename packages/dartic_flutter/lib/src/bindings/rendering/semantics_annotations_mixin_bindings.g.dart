...
class _$SemanticsAnnotationsMixin implements SemanticsAnnotationsMixin, DarticObjectHolder {
  _$SemanticsAnnotationsMixin(this._dispatch, this.$darticObject, List<Object?> superArgs);
  ...
  void initSemanticsAnnotations({required SemanticsProperties properties, required bool container, required bool explicitChildNodes, required bool excludeSemantics, required bool blockUserActions, required ui.Locale? localeForSubtree, required ui.TextDirection? textDirection}) {
    ...
    if (identical(_$r, notOverridden)) {
      throw UnsupportedError('Abstract method initSemanticsAnnotations must be overridden in dartic code');
    }
  }
  ...
  SemanticsProperties get properties {
    ...
    if (identical(r, notOverridden)) {
      throw UnsupportedError('Abstract getter properties must be overridden in dartic code');
    }
  ...
  bool get container {
    ...
    if (identical(r, notOverridden)) {
      throw UnsupportedError('Abstract getter container must be overridden in dartic code');
    }
    return r as bool;
  }
  ...
  bool get explicitChildNodes {
    ...
    if (identical(r, notOverridden)) {
      throw UnsupportedError('Abstract getter explicitChildNodes must be overridden in dartic code');
    }
    return r as bool;
  }
  ...
  bool get excludeSemantics {
    ...
    if (identical(r, notOverridden)) {
      throw UnsupportedError('Abstract getter excludeSemantics must be overridden in dartic code');
    }
    return r as bool;
  }
  ...
  bool get blockUserActions {
    ...
    if (identical(r, notOverridden)) {
      throw UnsupportedError('Abstract getter blockUserActions must be overridden in dartic code');
    }
    return r as bool;
  }
  ...
  ui.Locale? get localeForSubtree {
    ...
    if (identical(r, notOverridden)) {
      throw UnsupportedError('Abstract getter localeForSubtree must be overridden in dartic code');
    }
  ...
  set properties(SemanticsProperties value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'properties', value)) {
      throw UnsupportedError('Abstract setter properties must be overridden in dartic code');
    }
  }
  ...
  set container(bool value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'container', value)) {
      throw UnsupportedError('Abstract setter container must be overridden in dartic code');
    }
  }
  ...
  set explicitChildNodes(bool value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'explicitChildNodes', value)) {
      throw UnsupportedError('Abstract setter explicitChildNodes must be overridden in dartic code');
    }
  }
  ...
  set excludeSemantics(bool value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'excludeSemantics', value)) {
      throw UnsupportedError('Abstract setter excludeSemantics must be overridden in dartic code');
    }
  }
  ...
  set blockUserActions(bool value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'blockUserActions', value)) {
      throw UnsupportedError('Abstract setter blockUserActions must be overridden in dartic code');
    }
  }
  ...
  set localeForSubtree(ui.Locale? value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'localeForSubtree', value)) {
      throw UnsupportedError('Abstract setter localeForSubtree must be overridden in dartic code');
    }
  }
  ...
  set textDirection(ui.TextDirection? value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'textDirection', value)) {
      throw UnsupportedError('Abstract setter textDirection must be overridden in dartic code');
    }
  }
...
/// private class.
Object createSemanticsAnnotationsMixinBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$SemanticsAnnotationsMixin(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$SemanticsAnnotationsMixin(dispatch, darticObject, superArgs),
    );
  }
