...
class _$RenderSliverWithKeepAliveMixin implements RenderSliverWithKeepAliveMixin, DarticObjectHolder {
  _$RenderSliverWithKeepAliveMixin(this._dispatch, this.$darticObject, List<Object?> superArgs);
...
/// private class.
Object createRenderSliverWithKeepAliveMixinBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderSliverWithKeepAliveMixin(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderSliverWithKeepAliveMixin(dispatch, darticObject, superArgs),
    );
  }
