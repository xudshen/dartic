...
class _$RenderErrorBox extends RenderErrorBox implements DarticObjectHolder {
  _$RenderErrorBox(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(superArgs[0] as String);
...
/// private class.
Object createRenderErrorBoxBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderErrorBox(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderErrorBox(dispatch, darticObject, superArgs),
    );
    ...
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderErrorBox)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderErrorBox)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderErrorBox)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderErrorBox)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$paint#2', (args) { (args[0] as _$RenderErrorBox)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$toString#1', (args) => (args[0] as _$RenderErrorBox)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$setupParentData#1', (args) { (args[0] as _$RenderErrorBox)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderErrorBox)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderErrorBox)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderErrorBox)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderErrorBox)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderErrorBox)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderErrorBox)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderErrorBox)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderErrorBox)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderErrorBox)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderErrorBox)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderErrorBox)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderErrorBox)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderErrorBox)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderErrorBox)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderErrorBox)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderErrorBox)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderErrorBox)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$performResize#0', (args) { (args[0] as _$RenderErrorBox)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$performLayout#0', (args) { (args[0] as _$RenderErrorBox)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$hitTest#2', (args) => (args[0] as _$RenderErrorBox)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderErrorBox)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderErrorBox)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderErrorBox)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderErrorBox)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$handleEvent#2', (args) { (args[0] as _$RenderErrorBox)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderErrorBox)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugPaint#2', (args) { (args[0] as _$RenderErrorBox)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderErrorBox)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderErrorBox)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderErrorBox)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderErrorBox)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$reassemble#0', (args) { (args[0] as _$RenderErrorBox)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$dispose#0', (args) { (args[0] as _$RenderErrorBox)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$redepthChild#1', (args) { (args[0] as _$RenderErrorBox)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderErrorBox)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$adoptChild#1', (args) { (args[0] as _$RenderErrorBox)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$dropChild#1', (args) { (args[0] as _$RenderErrorBox)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$visitChildren#1', (args) { (args[0] as _$RenderErrorBox)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$attach#1', (args) { (args[0] as _$RenderErrorBox)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$detach#0', (args) { (args[0] as _$RenderErrorBox)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderErrorBox)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderErrorBox)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderErrorBox)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$layout#2', (args) { (args[0] as _$RenderErrorBox)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderErrorBox)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderErrorBox)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderErrorBox)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderErrorBox)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderErrorBox)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderErrorBox)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderErrorBox)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$paintsChild#1', (args) => (args[0] as _$RenderErrorBox)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderErrorBox)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderErrorBox)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderErrorBox)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderErrorBox)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderErrorBox)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderErrorBox)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderErrorBox)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderErrorBox)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderErrorBox)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderErrorBox)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$toStringShort#0', (args) => (args[0] as _$RenderErrorBox)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderErrorBox)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderErrorBox)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderErrorBox)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderErrorBox)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$describeForError#2', (args) => (args[0] as _$RenderErrorBox)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ...
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$constraints#0', (args) => (args[0] as _$RenderErrorBox)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$paintBounds#0', (args) => (args[0] as _$RenderErrorBox)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderErrorBox)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$parentData#0', (args) => (args[0] as _$RenderErrorBox)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$depth#0', (args) => (args[0] as _$RenderErrorBox)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$parent#0', (args) => (args[0] as _$RenderErrorBox)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderErrorBox)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugCreator#0', (args) => (args[0] as _$RenderErrorBox)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderErrorBox)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderErrorBox)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderErrorBox)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderErrorBox)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$owner#0', (args) => (args[0] as _$RenderErrorBox)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$attached#0', (args) => (args[0] as _$RenderErrorBox)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderErrorBox)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderErrorBox)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderErrorBox)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderErrorBox)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderErrorBox)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$layer#0', (args) => (args[0] as _$RenderErrorBox)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugLayer#0', (args) => (args[0] as _$RenderErrorBox)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderErrorBox)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderErrorBox)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderErrorBox)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderErrorBox)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderErrorBox)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/error.dart::RenderErrorBox::\$super\$size=#1', (args) { (args[0] as _$RenderErrorBox)._super$size = args[1] as ui.Size; return args[1]; });
