...
class _$RenderDecoratedBox extends RenderDecoratedBox implements DarticObjectHolder {
  _$RenderDecoratedBox(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(decoration: superArgs[0] as Decoration, position: superArgs[1] as DecorationPosition, configuration: superArgs[2] as ImageConfiguration, child: identical(superArgs[3], darticAbsent) ? null : superArgs[3] as RenderBox?);
  ...
  set _super$position(DecorationPosition value) { super.position = value; }
...
/// private class.
Object createRenderDecoratedBoxBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderDecoratedBox(dispatch, obj, superArgs);
...
abstract final class RenderDecoratedBoxBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderDecoratedBox(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$detach#0', (args) { (args[0] as _$RenderDecoratedBox)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$dispose#0', (args) { (args[0] as _$RenderDecoratedBox)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderDecoratedBox)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$paint#2', (args) { (args[0] as _$RenderDecoratedBox)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderDecoratedBox)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$toString#1', (args) => (args[0] as _$RenderDecoratedBox)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$setupParentData#1', (args) { (args[0] as _$RenderDecoratedBox)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderDecoratedBox)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderDecoratedBox)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderDecoratedBox)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderDecoratedBox)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderDecoratedBox)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderDecoratedBox)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderDecoratedBox)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderDecoratedBox)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderDecoratedBox)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderDecoratedBox)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderDecoratedBox)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderDecoratedBox)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderDecoratedBox)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderDecoratedBox)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderDecoratedBox)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderDecoratedBox)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderDecoratedBox)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderDecoratedBox)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderDecoratedBox)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderDecoratedBox)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$performResize#0', (args) { (args[0] as _$RenderDecoratedBox)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$performLayout#0', (args) { (args[0] as _$RenderDecoratedBox)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$hitTest#2', (args) => (args[0] as _$RenderDecoratedBox)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderDecoratedBox)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderDecoratedBox)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderDecoratedBox)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderDecoratedBox)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$handleEvent#2', (args) { (args[0] as _$RenderDecoratedBox)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderDecoratedBox)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugPaint#2', (args) { (args[0] as _$RenderDecoratedBox)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderDecoratedBox)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderDecoratedBox)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderDecoratedBox)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$reassemble#0', (args) { (args[0] as _$RenderDecoratedBox)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$redepthChild#1', (args) { (args[0] as _$RenderDecoratedBox)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderDecoratedBox)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$adoptChild#1', (args) { (args[0] as _$RenderDecoratedBox)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$dropChild#1', (args) { (args[0] as _$RenderDecoratedBox)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$visitChildren#1', (args) { (args[0] as _$RenderDecoratedBox)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$attach#1', (args) { (args[0] as _$RenderDecoratedBox)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderDecoratedBox)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderDecoratedBox)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderDecoratedBox)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$layout#2', (args) { (args[0] as _$RenderDecoratedBox)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderDecoratedBox)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderDecoratedBox)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderDecoratedBox)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderDecoratedBox)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderDecoratedBox)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderDecoratedBox)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderDecoratedBox)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$paintsChild#1', (args) => (args[0] as _$RenderDecoratedBox)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderDecoratedBox)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderDecoratedBox)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderDecoratedBox)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderDecoratedBox)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderDecoratedBox)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderDecoratedBox)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderDecoratedBox)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderDecoratedBox)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderDecoratedBox)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderDecoratedBox)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$toStringShort#0', (args) => (args[0] as _$RenderDecoratedBox)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderDecoratedBox)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderDecoratedBox)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderDecoratedBox)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderDecoratedBox)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$describeForError#2', (args) => (args[0] as _$RenderDecoratedBox)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderDecoratedBox)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderDecoratedBox)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$computeSizeForNoChild#1', (args) => (args[0] as _$RenderDecoratedBox)._super$computeSizeForNoChild(args[1] as BoxConstraints));
    ...
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$constraints#0', (args) => (args[0] as _$RenderDecoratedBox)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$paintBounds#0', (args) => (args[0] as _$RenderDecoratedBox)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderDecoratedBox)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$parentData#0', (args) => (args[0] as _$RenderDecoratedBox)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$depth#0', (args) => (args[0] as _$RenderDecoratedBox)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$parent#0', (args) => (args[0] as _$RenderDecoratedBox)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderDecoratedBox)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugCreator#0', (args) => (args[0] as _$RenderDecoratedBox)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderDecoratedBox)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderDecoratedBox)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderDecoratedBox)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderDecoratedBox)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$owner#0', (args) => (args[0] as _$RenderDecoratedBox)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$attached#0', (args) => (args[0] as _$RenderDecoratedBox)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderDecoratedBox)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderDecoratedBox)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderDecoratedBox)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderDecoratedBox)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderDecoratedBox)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderDecoratedBox)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$layer#0', (args) => (args[0] as _$RenderDecoratedBox)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugLayer#0', (args) => (args[0] as _$RenderDecoratedBox)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderDecoratedBox)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderDecoratedBox)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderDecoratedBox)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderDecoratedBox)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderDecoratedBox)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$child#0', (args) => (args[0] as _$RenderDecoratedBox)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$decoration=#1', (args) { (args[0] as _$RenderDecoratedBox)._super$decoration = args[1] as Decoration; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$position=#1', (args) { (args[0] as _$RenderDecoratedBox)._super$position = args[1] as DecorationPosition; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$configuration=#1', (args) { (args[0] as _$RenderDecoratedBox)._super$configuration = args[1] as ImageConfiguration; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$size=#1', (args) { (args[0] as _$RenderDecoratedBox)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderDecoratedBox::\$super\$parentData=#1', (args) { (args[0] as _$RenderDecoratedBox)._super$parentData = args[1] as ParentData?; return args[1]; });
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderDecoratedBox).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
