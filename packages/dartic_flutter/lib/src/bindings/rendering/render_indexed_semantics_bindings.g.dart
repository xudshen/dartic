...
class _$RenderIndexedSemantics extends RenderIndexedSemantics implements DarticObjectHolder {
  _$RenderIndexedSemantics(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?, index: superArgs[1] as int);
...
/// private class.
Object createRenderIndexedSemanticsBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderIndexedSemantics(dispatch, obj, superArgs);
...
abstract final class RenderIndexedSemanticsBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderIndexedSemantics(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderIndexedSemantics)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderIndexedSemantics)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$toString#1', (args) => (args[0] as _$RenderIndexedSemantics)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$setupParentData#1', (args) { (args[0] as _$RenderIndexedSemantics)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderIndexedSemantics)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderIndexedSemantics)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderIndexedSemantics)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderIndexedSemantics)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderIndexedSemantics)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderIndexedSemantics)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderIndexedSemantics)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderIndexedSemantics)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderIndexedSemantics)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderIndexedSemantics)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderIndexedSemantics)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderIndexedSemantics)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderIndexedSemantics)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderIndexedSemantics)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderIndexedSemantics)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderIndexedSemantics)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderIndexedSemantics)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderIndexedSemantics)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderIndexedSemantics)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderIndexedSemantics)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$performResize#0', (args) { (args[0] as _$RenderIndexedSemantics)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$performLayout#0', (args) { (args[0] as _$RenderIndexedSemantics)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$hitTest#2', (args) => (args[0] as _$RenderIndexedSemantics)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderIndexedSemantics)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderIndexedSemantics)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderIndexedSemantics)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderIndexedSemantics)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderIndexedSemantics)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$handleEvent#2', (args) { (args[0] as _$RenderIndexedSemantics)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderIndexedSemantics)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugPaint#2', (args) { (args[0] as _$RenderIndexedSemantics)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderIndexedSemantics)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderIndexedSemantics)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderIndexedSemantics)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$reassemble#0', (args) { (args[0] as _$RenderIndexedSemantics)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$dispose#0', (args) { (args[0] as _$RenderIndexedSemantics)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$redepthChild#1', (args) { (args[0] as _$RenderIndexedSemantics)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderIndexedSemantics)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$adoptChild#1', (args) { (args[0] as _$RenderIndexedSemantics)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$dropChild#1', (args) { (args[0] as _$RenderIndexedSemantics)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$visitChildren#1', (args) { (args[0] as _$RenderIndexedSemantics)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$attach#1', (args) { (args[0] as _$RenderIndexedSemantics)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$detach#0', (args) { (args[0] as _$RenderIndexedSemantics)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderIndexedSemantics)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderIndexedSemantics)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderIndexedSemantics)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$layout#2', (args) { (args[0] as _$RenderIndexedSemantics)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderIndexedSemantics)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderIndexedSemantics)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderIndexedSemantics)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderIndexedSemantics)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderIndexedSemantics)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderIndexedSemantics)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderIndexedSemantics)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$paint#2', (args) { (args[0] as _$RenderIndexedSemantics)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$paintsChild#1', (args) => (args[0] as _$RenderIndexedSemantics)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderIndexedSemantics)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderIndexedSemantics)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderIndexedSemantics)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderIndexedSemantics)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderIndexedSemantics)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderIndexedSemantics)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderIndexedSemantics)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderIndexedSemantics)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderIndexedSemantics)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$toStringShort#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderIndexedSemantics)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderIndexedSemantics)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderIndexedSemantics)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$describeForError#2', (args) => (args[0] as _$RenderIndexedSemantics)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderIndexedSemantics)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderIndexedSemantics)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$computeSizeForNoChild#1', (args) => (args[0] as _$RenderIndexedSemantics)._super$computeSizeForNoChild(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$index#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$index);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$hashCode#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$hashCode);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$hasSize#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$size#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$constraints#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$paintBounds#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$parentData#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$depth#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$parent#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugCreator#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$owner#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$attached#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$layer#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugLayer#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$child#0', (args) => (args[0] as _$RenderIndexedSemantics)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$index=#1', (args) { (args[0] as _$RenderIndexedSemantics)._super$index = args[1] as int; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$size=#1', (args) { (args[0] as _$RenderIndexedSemantics)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$parentData=#1', (args) { (args[0] as _$RenderIndexedSemantics)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderIndexedSemantics)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$layer=#1', (args) { (args[0] as _$RenderIndexedSemantics)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderIndexedSemantics::\$super\$child=#1', (args) { (args[0] as _$RenderIndexedSemantics)._super$child = args[1] as RenderBox?; return args[1]; });
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderIndexedSemantics).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
