...
class _$RenderClipRRect extends RenderClipRRect implements DarticObjectHolder {
  _$RenderClipRRect(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?, borderRadius: superArgs[1] as BorderRadiusGeometry, clipper: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as CustomClipper<ui.RRect>?, clipBehavior: superArgs[3] as ui.Clip, textDirection: identical(superArgs[4], darticAbsent) ? null : superArgs[4] as ui.TextDirection?);
...
/// private class.
Object createRenderClipRRectBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderClipRRect(dispatch, obj, superArgs);
...
abstract final class RenderClipRRectBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderClipRRect(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$hitTest#2', (args) => (args[0] as _$RenderClipRRect)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$paint#2', (args) { (args[0] as _$RenderClipRRect)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderClipRRect)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$toString#1', (args) => (args[0] as _$RenderClipRRect)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$attach#1', (args) { (args[0] as _$RenderClipRRect)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$detach#0', (args) { (args[0] as _$RenderClipRRect)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$performLayout#0', (args) { (args[0] as _$RenderClipRRect)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderClipRRect)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$dispose#0', (args) { (args[0] as _$RenderClipRRect)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$setupParentData#1', (args) { (args[0] as _$RenderClipRRect)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderClipRRect)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderClipRRect)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderClipRRect)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderClipRRect)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderClipRRect)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderClipRRect)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderClipRRect)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderClipRRect)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderClipRRect)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderClipRRect)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderClipRRect)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderClipRRect)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderClipRRect)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderClipRRect)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderClipRRect)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderClipRRect)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderClipRRect)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderClipRRect)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderClipRRect)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderClipRRect)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$performResize#0', (args) { (args[0] as _$RenderClipRRect)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderClipRRect)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderClipRRect)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderClipRRect)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderClipRRect)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderClipRRect)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$handleEvent#2', (args) { (args[0] as _$RenderClipRRect)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderClipRRect)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugPaint#2', (args) { (args[0] as _$RenderClipRRect)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderClipRRect)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderClipRRect)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderClipRRect)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$reassemble#0', (args) { (args[0] as _$RenderClipRRect)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$redepthChild#1', (args) { (args[0] as _$RenderClipRRect)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderClipRRect)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$adoptChild#1', (args) { (args[0] as _$RenderClipRRect)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$dropChild#1', (args) { (args[0] as _$RenderClipRRect)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$visitChildren#1', (args) { (args[0] as _$RenderClipRRect)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderClipRRect)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderClipRRect)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderClipRRect)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$layout#2', (args) { (args[0] as _$RenderClipRRect)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderClipRRect)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderClipRRect)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderClipRRect)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderClipRRect)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderClipRRect)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderClipRRect)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderClipRRect)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$paintsChild#1', (args) => (args[0] as _$RenderClipRRect)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderClipRRect)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderClipRRect)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderClipRRect)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderClipRRect)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderClipRRect)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderClipRRect)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderClipRRect)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderClipRRect)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderClipRRect)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$toStringShort#0', (args) => (args[0] as _$RenderClipRRect)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderClipRRect)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderClipRRect)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderClipRRect)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderClipRRect)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$describeForError#2', (args) => (args[0] as _$RenderClipRRect)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderClipRRect)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderClipRRect)._super$debugValidateChild(args[1] as RenderObject));
    ...
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$size#0', (args) => (args[0] as _$RenderClipRRect)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderClipRRect)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$constraints#0', (args) => (args[0] as _$RenderClipRRect)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$paintBounds#0', (args) => (args[0] as _$RenderClipRRect)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderClipRRect)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$parentData#0', (args) => (args[0] as _$RenderClipRRect)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$depth#0', (args) => (args[0] as _$RenderClipRRect)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$parent#0', (args) => (args[0] as _$RenderClipRRect)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderClipRRect)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugCreator#0', (args) => (args[0] as _$RenderClipRRect)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderClipRRect)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderClipRRect)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderClipRRect)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderClipRRect)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$owner#0', (args) => (args[0] as _$RenderClipRRect)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$attached#0', (args) => (args[0] as _$RenderClipRRect)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderClipRRect)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderClipRRect)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderClipRRect)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderClipRRect)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderClipRRect)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderClipRRect)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$layer#0', (args) => (args[0] as _$RenderClipRRect)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugLayer#0', (args) => (args[0] as _$RenderClipRRect)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderClipRRect)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderClipRRect)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderClipRRect)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderClipRRect)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderClipRRect)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$child#0', (args) => (args[0] as _$RenderClipRRect)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$borderRadius=#1', (args) { (args[0] as _$RenderClipRRect)._super$borderRadius = args[1] as BorderRadiusGeometry; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$textDirection=#1', (args) { (args[0] as _$RenderClipRRect)._super$textDirection = args[1] as ui.TextDirection?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$clipper=#1', (args) { (args[0] as _$RenderClipRRect)._super$clipper = args[1] as CustomClipper<ui.RRect>?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$clipBehavior=#1', (args) { (args[0] as _$RenderClipRRect)._super$clipBehavior = args[1] as ui.Clip; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$size=#1', (args) { (args[0] as _$RenderClipRRect)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderClipRRect::\$super\$parentData=#1', (args) { (args[0] as _$RenderClipRRect)._super$parentData = args[1] as ParentData?; return args[1]; });
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#1': (args) => (args[0] as RenderClipRRect).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
        ...
        'handleEvent#2': (args) { (args[0] as RenderClipRRect).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
