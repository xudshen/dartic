...
class _$RenderSemanticsGestureHandler extends RenderSemanticsGestureHandler implements DarticObjectHolder {
  _$RenderSemanticsGestureHandler(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(child: identical(superArgs[0], darticAbsent) ? null : superArgs[0] as RenderBox?, onTap: identical(superArgs[1], darticAbsent) ? null : superArgs[1] as GestureTapCallback?, onLongPress: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as GestureLongPressCallback?, onHorizontalDragUpdate: identical(superArgs[3], darticAbsent) ? null : superArgs[3] as GestureDragUpdateCallback?, onVerticalDragUpdate: identical(superArgs[4], darticAbsent) ? null : superArgs[4] as GestureDragUpdateCallback?, scrollFactor: superArgs[5] as double, behavior: superArgs[6] as HitTestBehavior);
  ...
  @override
  Set<ui.SemanticsAction>? get validActions {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'validActions');
    if (identical(r, notOverridden)) return super.validActions;
    return r as Set<ui.SemanticsAction>?;
  }
  ...
  @override
  double get scrollFactor {
    final r = _dispatch.get($darticObject.bridge ?? $darticObject, $darticObject, 'scrollFactor');
    if (identical(r, notOverridden)) return super.scrollFactor;
    return r as double;
  }
  ...
  @override
  set validActions(Set<ui.SemanticsAction>? value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'validActions', value)) {
      super.validActions = value;
    }
  }
  ...
  set onHorizontalDragUpdate(GestureDragUpdateCallback? value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'onHorizontalDragUpdate', value)) {
  ...
  set onVerticalDragUpdate(GestureDragUpdateCallback? value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'onVerticalDragUpdate', value)) {
  ...
  set scrollFactor(double value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'scrollFactor', value)) {
  ...
  Set<ui.SemanticsAction>? get _super$validActions => super.validActions;
  ...
  set _super$validActions(Set<ui.SemanticsAction>? value) { super.validActions = value; }
  ...
  set _super$onHorizontalDragUpdate(GestureDragUpdateCallback? value) { super.onHorizontalDragUpdate = value; }
  set _super$onVerticalDragUpdate(GestureDragUpdateCallback? value) { super.onVerticalDragUpdate = value; }
  set _super$scrollFactor(double value) { super.scrollFactor = value; }
...
/// private class.
Object createRenderSemanticsGestureHandlerBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderSemanticsGestureHandler(dispatch, obj, superArgs);
...
abstract final class RenderSemanticsGestureHandlerBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderSemanticsGestureHandler(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$toString#1', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$hitTest#2', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$setupParentData#1', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$performResize#0', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$performLayout#0', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$handleEvent#2', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugPaint#2', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$reassemble#0', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$dispose#0', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$redepthChild#1', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$adoptChild#1', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$dropChild#1', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$visitChildren#1', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$attach#1', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$detach#0', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$layout#2', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$paint#2', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$paintsChild#1', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$toStringShort#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$describeForError#2', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$computeSizeForNoChild#1', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$computeSizeForNoChild(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$validActions#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$validActions);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$onTap#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$onTap);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$onLongPress#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$onLongPress);
    ...
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$constraints#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$paintBounds#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$parentData#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$depth#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$parent#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugCreator#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$owner#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$attached#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$layer#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugLayer#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$child#0', (args) => (args[0] as _$RenderSemanticsGestureHandler)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$validActions=#1', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$validActions = args[1] == null ? null : (args[1] as Set).cast<ui.SemanticsAction>(); return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$onTap=#1', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$onTap = args[1] as GestureTapCallback?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$onLongPress=#1', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$onLongPress = args[1] as GestureLongPressCallback?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$onHorizontalDragUpdate=#1', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$onHorizontalDragUpdate = args[1] as GestureDragUpdateCallback?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$onVerticalDragUpdate=#1', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$onVerticalDragUpdate = args[1] as GestureDragUpdateCallback?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$scrollFactor=#1', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$scrollFactor = args[1] as double; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$behavior=#1', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$behavior = args[1] as HitTestBehavior; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$size=#1', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderSemanticsGestureHandler::\$super\$parentData=#1', (args) { (args[0] as _$RenderSemanticsGestureHandler)._super$parentData = args[1] as ParentData?; return args[1]; });
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'toString#1': (args) => (args[0] as RenderSemanticsGestureHandler).toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel),
        ...
        'handleEvent#2': (args) { (args[0] as RenderSemanticsGestureHandler).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
