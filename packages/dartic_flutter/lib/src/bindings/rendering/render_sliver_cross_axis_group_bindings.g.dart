...
class _$RenderSliverCrossAxisGroup extends RenderSliverCrossAxisGroup implements DarticObjectHolder {
  _$RenderSliverCrossAxisGroup(this._dispatch, this.$darticObject, List<Object?> superArgs);
...
/// private class.
Object createRenderSliverCrossAxisGroupBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderSliverCrossAxisGroup(dispatch, obj, superArgs);
...
abstract final class RenderSliverCrossAxisGroupBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderSliverCrossAxisGroup(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$setupParentData#1', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$childMainAxisPosition#1', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$childMainAxisPosition(args[1] as RenderSliver));
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$childCrossAxisPosition#1', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$childCrossAxisPosition(args[1] as RenderSliver));
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$performLayout#0', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$paint#2', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$paint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$applyPaintTransform(args[1] as RenderSliver, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$hitTestChildren#3', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$hitTestChildren(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$toString#1', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$performResize#0', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$hitTest#3', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$hitTest(args[1] as SliverHitTestResult, mainAxisPosition: args[2] as double, crossAxisPosition: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$hitTestSelf#2', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$hitTestSelf(mainAxisPosition: args[1] as double, crossAxisPosition: args[2] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$calculatePaintOffset#3', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$calculatePaintOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$calculateCacheOffset#3', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$calculateCacheOffset(args[1] as SliverConstraints, from: args[2] as double, to: args[3] as double));
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$childScrollOffset#1', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$childScrollOffset(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$getAbsoluteSizeRelativeToOrigin#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$getAbsoluteSizeRelativeToOrigin());
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$getAbsoluteSize#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$getAbsoluteSize());
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$debugPaint#2', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$debugPaint(args[1] as PaintingContext, args[2] as Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$handleEvent#2', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$reassemble#0', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$dispose#0', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$redepthChild#1', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$adoptChild#1', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$dropChild#1', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$visitChildren#1', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$attach#1', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$detach#0', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$layout#2', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$paintsChild#1', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$toStringShort#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$describeForError#2', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$insert#2', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$insert(args[1] as RenderSliver, after: identical(args[2], darticAbsent) ? null : args[2] as RenderSliver?); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$add#1', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$add(args[1] as RenderSliver); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$addAll#1', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$addAll(args[1] == null ? null : (args[1] as List).cast<RenderSliver>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$remove#1', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$remove(args[1] as RenderSliver); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$removeAll#0', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$removeAll(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$move#2', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$move(args[1] as RenderSliver, after: identical(args[2], darticAbsent) ? null : args[2] as RenderSliver?); return null; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$childBefore#1', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$childBefore(args[1] as RenderSliver));
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$childAfter#1', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$childAfter(args[1] as RenderSliver));
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$hashCode#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$hashCode);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$ensureSemantics#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$ensureSemantics);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$constraints#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$geometry#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$geometry);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$paintBounds#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$centerOffsetAdjustment#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$centerOffsetAdjustment);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$parentData#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$depth#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$parent#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$debugCreator#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$owner#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$attached#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$layer#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$debugLayer#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$childCount#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$childCount);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$firstChild#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$firstChild);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$lastChild#0', (args) => (args[0] as _$RenderSliverCrossAxisGroup)._super$lastChild);
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$geometry=#1', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$geometry = args[1] as SliverGeometry?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$parentData=#1', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/sliver_group.dart::RenderSliverCrossAxisGroup::\$super\$layer=#1', (args) { (args[0] as _$RenderSliverCrossAxisGroup)._super$layer = args[1] as ContainerLayer?; return args[1]; });
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderSliverCrossAxisGroup).handleEvent(args[1] as PointerEvent, args[2] as SliverHitTestEntry); return null; },
