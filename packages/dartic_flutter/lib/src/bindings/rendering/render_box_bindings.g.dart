...
class _$RenderBox extends RenderBox implements DarticObjectHolder {
  _$RenderBox(this._dispatch, this.$darticObject, List<Object?> superArgs);
...
/// private class.
Object createRenderBoxBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderBox(dispatch, obj, superArgs);
  ...
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderBox(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$setupParentData#1', (args) { (args[0] as _$RenderBox)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderBox)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderBox)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderBox)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderBox)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderBox)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderBox)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderBox)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderBox)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderBox)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderBox)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderBox)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderBox)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderBox)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderBox)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderBox)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderBox)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderBox)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderBox)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderBox)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderBox)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$performResize#0', (args) { (args[0] as _$RenderBox)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$performLayout#0', (args) { (args[0] as _$RenderBox)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$hitTest#2', (args) => (args[0] as _$RenderBox)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderBox)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderBox)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderBox)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderBox)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderBox)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$handleEvent#2', (args) { (args[0] as _$RenderBox)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderBox)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugPaint#2', (args) { (args[0] as _$RenderBox)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderBox)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderBox)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderBox)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderBox)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$toString#1', (args) => (args[0] as _$RenderBox)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$reassemble#0', (args) { (args[0] as _$RenderBox)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$dispose#0', (args) { (args[0] as _$RenderBox)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$redepthChild#1', (args) { (args[0] as _$RenderBox)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderBox)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$adoptChild#1', (args) { (args[0] as _$RenderBox)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$dropChild#1', (args) { (args[0] as _$RenderBox)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$visitChildren#1', (args) { (args[0] as _$RenderBox)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$attach#1', (args) { (args[0] as _$RenderBox)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$detach#0', (args) { (args[0] as _$RenderBox)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderBox)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderBox)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderBox)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$layout#2', (args) { (args[0] as _$RenderBox)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderBox)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderBox)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderBox)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderBox)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderBox)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderBox)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderBox)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$paint#2', (args) { (args[0] as _$RenderBox)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$paintsChild#1', (args) => (args[0] as _$RenderBox)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderBox)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderBox)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderBox)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderBox)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderBox)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderBox)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderBox)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderBox)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderBox)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderBox)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$toStringShort#0', (args) => (args[0] as _$RenderBox)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderBox)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderBox)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderBox)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderBox)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$describeForError#2', (args) => (args[0] as _$RenderBox)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderBox)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$hasSize#0', (args) => (args[0] as _$RenderBox)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$size#0', (args) => (args[0] as _$RenderBox)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderBox)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$constraints#0', (args) => (args[0] as _$RenderBox)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$paintBounds#0', (args) => (args[0] as _$RenderBox)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderBox)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$parentData#0', (args) => (args[0] as _$RenderBox)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$depth#0', (args) => (args[0] as _$RenderBox)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$parent#0', (args) => (args[0] as _$RenderBox)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderBox)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugCreator#0', (args) => (args[0] as _$RenderBox)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderBox)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderBox)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderBox)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderBox)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$owner#0', (args) => (args[0] as _$RenderBox)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$attached#0', (args) => (args[0] as _$RenderBox)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderBox)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderBox)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderBox)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderBox)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderBox)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderBox)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$layer#0', (args) => (args[0] as _$RenderBox)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugLayer#0', (args) => (args[0] as _$RenderBox)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderBox)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderBox)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderBox)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderBox)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderBox)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$size=#1', (args) { (args[0] as _$RenderBox)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$parentData=#1', (args) { (args[0] as _$RenderBox)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderBox)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$layer=#1', (args) { (args[0] as _$RenderBox)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/box.dart::RenderBox::\$super\$hashCode#0', (args) => (args[0] as _$RenderBox)._super$hashCode);
  }
