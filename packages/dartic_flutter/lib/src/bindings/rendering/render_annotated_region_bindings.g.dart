...
class _$RenderAnnotatedRegion extends RenderAnnotatedRegion<Object> implements DarticObjectHolder {
  _$RenderAnnotatedRegion(this._dispatch, this.$darticObject, List<Object?> superArgs) : super(value: superArgs[0] as Object, sized: superArgs[1] as bool, child: identical(superArgs[2], darticAbsent) ? null : superArgs[2] as RenderBox?);
  ...
  set sized(bool value) {
    if (!_dispatch.set($darticObject.bridge ?? $darticObject, $darticObject, 'sized', value)) {
      super.sized = value;
    }
  }
  ...
  set _super$value(Object value) { super.value = value; }
  set _super$sized(bool value) { super.sized = value; }
...
/// private class.
Object createRenderAnnotatedRegionBridge(
        DarticDispatch dispatch, DarticObject obj, List<Object?> superArgs) =>
    _$RenderAnnotatedRegion(dispatch, obj, superArgs);
...
abstract final class RenderAnnotatedRegionBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      ...
      bridgeFactory: (dispatch, darticObject, superArgs) =>
          _$RenderAnnotatedRegion(dispatch, darticObject, superArgs),
    );
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$paint#2', (args) { (args[0] as _$RenderAnnotatedRegion)._super$paint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$dispose#0', (args) { (args[0] as _$RenderAnnotatedRegion)._super$dispose(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$toString#1', (args) => (args[0] as _$RenderAnnotatedRegion)._super$toString(minLevel: identical(args[1], darticAbsent) ? DiagnosticLevel.info : args[1] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$setupParentData#1', (args) { (args[0] as _$RenderAnnotatedRegion)._super$setupParentData(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$getMinIntrinsicWidth#1', (args) => (args[0] as _$RenderAnnotatedRegion)._super$getMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$computeMinIntrinsicWidth#1', (args) => (args[0] as _$RenderAnnotatedRegion)._super$computeMinIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$getMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderAnnotatedRegion)._super$getMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$computeMaxIntrinsicWidth#1', (args) => (args[0] as _$RenderAnnotatedRegion)._super$computeMaxIntrinsicWidth(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$getMinIntrinsicHeight#1', (args) => (args[0] as _$RenderAnnotatedRegion)._super$getMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$computeMinIntrinsicHeight#1', (args) => (args[0] as _$RenderAnnotatedRegion)._super$computeMinIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$getMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderAnnotatedRegion)._super$getMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$computeMaxIntrinsicHeight#1', (args) => (args[0] as _$RenderAnnotatedRegion)._super$computeMaxIntrinsicHeight(args[1] as double));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$getDryLayout#1', (args) => (args[0] as _$RenderAnnotatedRegion)._super$getDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$computeDryLayout#1', (args) => (args[0] as _$RenderAnnotatedRegion)._super$computeDryLayout(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$getDryBaseline#2', (args) => (args[0] as _$RenderAnnotatedRegion)._super$getDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$computeDryBaseline#2', (args) => (args[0] as _$RenderAnnotatedRegion)._super$computeDryBaseline(args[1] as BoxConstraints, args[2] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugCannotComputeDryLayout#2', (args) => (args[0] as _$RenderAnnotatedRegion)._super$debugCannotComputeDryLayout(reason: identical(args[1], darticAbsent) ? null : args[1] as String?, error: identical(args[2], darticAbsent) ? null : args[2] as FlutterError?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugAdoptSize#1', (args) => (args[0] as _$RenderAnnotatedRegion)._super$debugAdoptSize(args[1] as ui.Size));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugResetSize#0', (args) { (args[0] as _$RenderAnnotatedRegion)._super$debugResetSize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$getDistanceToBaseline#2', (args) => (args[0] as _$RenderAnnotatedRegion)._super$getDistanceToBaseline(args[1] as ui.TextBaseline, onlyReal: identical(args[2], darticAbsent) ? false : args[2] as bool));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$getDistanceToActualBaseline#1', (args) => (args[0] as _$RenderAnnotatedRegion)._super$getDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$computeDistanceToActualBaseline#1', (args) => (args[0] as _$RenderAnnotatedRegion)._super$computeDistanceToActualBaseline(args[1] as ui.TextBaseline));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugAssertDoesMeetConstraints#0', (args) { (args[0] as _$RenderAnnotatedRegion)._super$debugAssertDoesMeetConstraints(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$markNeedsLayout#0', (args) { (args[0] as _$RenderAnnotatedRegion)._super$markNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$performResize#0', (args) { (args[0] as _$RenderAnnotatedRegion)._super$performResize(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$performLayout#0', (args) { (args[0] as _$RenderAnnotatedRegion)._super$performLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$hitTest#2', (args) => (args[0] as _$RenderAnnotatedRegion)._super$hitTest(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$hitTestSelf#1', (args) => (args[0] as _$RenderAnnotatedRegion)._super$hitTestSelf(args[1] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$hitTestChildren#2', (args) => (args[0] as _$RenderAnnotatedRegion)._super$hitTestChildren(args[1] as BoxHitTestResult, position: args[2] as ui.Offset));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$applyPaintTransform#2', (args) { (args[0] as _$RenderAnnotatedRegion)._super$applyPaintTransform(args[1] as RenderObject, args[2] as Matrix4); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$globalToLocal#2', (args) => (args[0] as _$RenderAnnotatedRegion)._super$globalToLocal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$localToGlobal#2', (args) => (args[0] as _$RenderAnnotatedRegion)._super$localToGlobal(args[1] as ui.Offset, ancestor: identical(args[2], darticAbsent) ? null : args[2] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$handleEvent#2', (args) { (args[0] as _$RenderAnnotatedRegion)._super$handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugHandleEvent#2', (args) => (args[0] as _$RenderAnnotatedRegion)._super$debugHandleEvent(args[1] as PointerEvent, args[2] as HitTestEntry<HitTestTarget>));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugPaint#2', (args) { (args[0] as _$RenderAnnotatedRegion)._super$debugPaint(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugPaintSize#2', (args) { (args[0] as _$RenderAnnotatedRegion)._super$debugPaintSize(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugPaintBaselines#2', (args) { (args[0] as _$RenderAnnotatedRegion)._super$debugPaintBaselines(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugPaintPointers#2', (args) { (args[0] as _$RenderAnnotatedRegion)._super$debugPaintPointers(args[1] as PaintingContext, args[2] as ui.Offset); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugFillProperties#1', (args) { (args[0] as _$RenderAnnotatedRegion)._super$debugFillProperties(args[1] as DiagnosticPropertiesBuilder); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$reassemble#0', (args) { (args[0] as _$RenderAnnotatedRegion)._super$reassemble(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$redepthChild#1', (args) { (args[0] as _$RenderAnnotatedRegion)._super$redepthChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$redepthChildren#0', (args) { (args[0] as _$RenderAnnotatedRegion)._super$redepthChildren(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$adoptChild#1', (args) { (args[0] as _$RenderAnnotatedRegion)._super$adoptChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$dropChild#1', (args) { (args[0] as _$RenderAnnotatedRegion)._super$dropChild(args[1] as RenderObject); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$visitChildren#1', (args) { (args[0] as _$RenderAnnotatedRegion)._super$visitChildren((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$attach#1', (args) { (args[0] as _$RenderAnnotatedRegion)._super$attach(args[1] as PipelineOwner); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$detach#0', (args) { (args[0] as _$RenderAnnotatedRegion)._super$detach(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$markParentNeedsLayout#0', (args) { (args[0] as _$RenderAnnotatedRegion)._super$markParentNeedsLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$markNeedsLayoutForSizedByParentChange#0', (args) { (args[0] as _$RenderAnnotatedRegion)._super$markNeedsLayoutForSizedByParentChange(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$scheduleInitialLayout#0', (args) { (args[0] as _$RenderAnnotatedRegion)._super$scheduleInitialLayout(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$layout#2', (args) { (args[0] as _$RenderAnnotatedRegion)._super$layout(args[1] as Constraints, parentUsesSize: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugRegisterRepaintBoundaryPaint#2', (args) { (args[0] as _$RenderAnnotatedRegion)._super$debugRegisterRepaintBoundaryPaint(includedParent: identical(args[1], darticAbsent) ? true : args[1] as bool, includedChild: identical(args[2], darticAbsent) ? false : args[2] as bool); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$updateCompositedLayer#1', (args) => (args[0] as _$RenderAnnotatedRegion)._super$updateCompositedLayer(oldLayer: args[1] as OffsetLayer?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$markNeedsCompositingBitsUpdate#0', (args) { (args[0] as _$RenderAnnotatedRegion)._super$markNeedsCompositingBitsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$markNeedsPaint#0', (args) { (args[0] as _$RenderAnnotatedRegion)._super$markNeedsPaint(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$markNeedsCompositedLayerUpdate#0', (args) { (args[0] as _$RenderAnnotatedRegion)._super$markNeedsCompositedLayerUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$scheduleInitialPaint#1', (args) { (args[0] as _$RenderAnnotatedRegion)._super$scheduleInitialPaint(args[1] as ContainerLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$replaceRootLayer#1', (args) { (args[0] as _$RenderAnnotatedRegion)._super$replaceRootLayer(args[1] as OffsetLayer); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$paintsChild#1', (args) => (args[0] as _$RenderAnnotatedRegion)._super$paintsChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$getTransformTo#1', (args) => (args[0] as _$RenderAnnotatedRegion)._super$getTransformTo(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$describeApproximatePaintClip#1', (args) => (args[0] as _$RenderAnnotatedRegion)._super$describeApproximatePaintClip(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$describeSemanticsClip#1', (args) => (args[0] as _$RenderAnnotatedRegion)._super$describeSemanticsClip(args[1] as RenderObject?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$scheduleInitialSemantics#0', (args) { (args[0] as _$RenderAnnotatedRegion)._super$scheduleInitialSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$describeSemanticsConfiguration#1', (args) { (args[0] as _$RenderAnnotatedRegion)._super$describeSemanticsConfiguration(args[1] as SemanticsConfiguration); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$sendSemanticsEvent#1', (args) { (args[0] as _$RenderAnnotatedRegion)._super$sendSemanticsEvent(args[1] as SemanticsEvent); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$clearSemantics#0', (args) { (args[0] as _$RenderAnnotatedRegion)._super$clearSemantics(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$markNeedsSemanticsUpdate#0', (args) { (args[0] as _$RenderAnnotatedRegion)._super$markNeedsSemanticsUpdate(); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$visitChildrenForSemantics#1', (args) { (args[0] as _$RenderAnnotatedRegion)._super$visitChildrenForSemantics((a) => (args[1] as Function)(a)); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$assembleSemanticsNode#3', (args) { (args[0] as _$RenderAnnotatedRegion)._super$assembleSemanticsNode(args[1] as SemanticsNode, args[2] as SemanticsConfiguration, (args[3] as Iterable).cast<SemanticsNode>()); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$toStringShort#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$toStringShort());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$toStringDeep#4', (args) => (args[0] as _$RenderAnnotatedRegion)._super$toStringDeep(prefixLineOne: identical(args[1], darticAbsent) ? '' : args[1] as String, prefixOtherLines: identical(args[2], darticAbsent) ? null : args[2] as String?, minLevel: identical(args[3], darticAbsent) ? DiagnosticLevel.debug : args[3] as DiagnosticLevel, wrapWidth: identical(args[4], darticAbsent) ? 65 : args[4] as int));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$toStringShallow#2', (args) => (args[0] as _$RenderAnnotatedRegion)._super$toStringShallow(joiner: identical(args[1], darticAbsent) ? ', ' : args[1] as String, minLevel: identical(args[2], darticAbsent) ? DiagnosticLevel.debug : args[2] as DiagnosticLevel));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugDescribeChildren#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$debugDescribeChildren());
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$showOnScreen#4', (args) { (args[0] as _$RenderAnnotatedRegion)._super$showOnScreen(descendant: identical(args[1], darticAbsent) ? null : args[1] as RenderObject?, rect: identical(args[2], darticAbsent) ? null : args[2] as ui.Rect?, duration: identical(args[3], darticAbsent) ? Duration.zero : args[3] as Duration, curve: identical(args[4], darticAbsent) ? Curves.ease : args[4] as Curve); return null; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$describeForError#2', (args) => (args[0] as _$RenderAnnotatedRegion)._super$describeForError(args[1] as String, style: identical(args[2], darticAbsent) ? DiagnosticsTreeStyle.shallow : args[2] as DiagnosticsTreeStyle));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$toDiagnosticsNode#2', (args) => (args[0] as _$RenderAnnotatedRegion)._super$toDiagnosticsNode(name: identical(args[1], darticAbsent) ? null : args[1] as String?, style: identical(args[2], darticAbsent) ? null : args[2] as DiagnosticsTreeStyle?));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugValidateChild#1', (args) => (args[0] as _$RenderAnnotatedRegion)._super$debugValidateChild(args[1] as RenderObject));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$computeSizeForNoChild#1', (args) => (args[0] as _$RenderAnnotatedRegion)._super$computeSizeForNoChild(args[1] as BoxConstraints));
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$value#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$value);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$sized#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$sized);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$alwaysNeedsCompositing#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$alwaysNeedsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$hasSize#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$hasSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$size#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$size);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$semanticBounds#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$semanticBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$constraints#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$constraints);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$paintBounds#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$paintBounds);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugDisposed#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$debugDisposed);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$parentData#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$parentData);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$depth#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$depth);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$parent#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$parent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$semanticsParent#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$semanticsParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugCreator#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$debugCreator);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugDoingThisResize#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$debugDoingThisResize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugDoingThisLayout#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$debugDoingThisLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugCanParentUseSize#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$debugCanParentUseSize);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugLayoutParent#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$debugLayoutParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$owner#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$owner);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$attached#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$attached);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugNeedsLayout#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$debugNeedsLayout);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugDoingThisLayoutWithCallback#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$debugDoingThisLayoutWithCallback);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$sizedByParent#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$sizedByParent);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugDoingThisPaint#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$debugDoingThisPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$isRepaintBoundary#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$isRepaintBoundary);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$layer#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$layer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugLayer#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$debugLayer);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$needsCompositing#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$needsCompositing);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugNeedsPaint#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$debugNeedsPaint);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugNeedsCompositedLayerUpdate#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$debugNeedsCompositedLayerUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugNeedsSemanticsUpdate#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$debugNeedsSemanticsUpdate);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugSemantics#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$debugSemantics);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$child#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$child);
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$value=#1', (args) { (args[0] as _$RenderAnnotatedRegion)._super$value = args[1] as Object; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$sized=#1', (args) { (args[0] as _$RenderAnnotatedRegion)._super$sized = args[1] as bool; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$size=#1', (args) { (args[0] as _$RenderAnnotatedRegion)._super$size = args[1] as ui.Size; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$parentData=#1', (args) { (args[0] as _$RenderAnnotatedRegion)._super$parentData = args[1] as ParentData?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$debugCreator=#1', (args) { (args[0] as _$RenderAnnotatedRegion)._super$debugCreator = args[1]; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$layer=#1', (args) { (args[0] as _$RenderAnnotatedRegion)._super$layer = args[1] as ContainerLayer?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$child=#1', (args) { (args[0] as _$RenderAnnotatedRegion)._super$child = args[1] as RenderBox?; return args[1]; });
    ctx.registerBinding('package:flutter/src/rendering/proxy_box.dart::RenderAnnotatedRegion::\$super\$hashCode#0', (args) => (args[0] as _$RenderAnnotatedRegion)._super$hashCode);
  }
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        ...
        'handleEvent#2': (args) { (args[0] as RenderAnnotatedRegion).handleEvent(args[1] as PointerEvent, args[2] as BoxHitTestEntry); return null; },
