...
abstract final class PictureRasterizationExceptionBindings {
  static void register(DarticPluginContext ctx) {
    ctx.registerClass(
      name: 'dart:ui::PictureRasterizationException',
      type: PictureRasterizationException,
      test: (o) => o is PictureRasterizationException,
      methods: methodMap(),
