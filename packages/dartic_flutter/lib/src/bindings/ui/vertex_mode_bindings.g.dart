...
abstract final class VertexModeBindings {
  ...
  static Map<String, Object? Function(List<Object?>)> methodMap() => {
        'toString#0': (args) => (args[0] as VertexMode).toString(),
        'hashCode#0': (args) => (args[0] as VertexMode).hashCode,
        'index#0': (args) => (args[0] as VertexMode).index,
        '==#1': (args) => (args[0] as VertexMode) == (args[1] as Object),
        '_#fromFields#2': (args) => VertexMode.values[args[1] as int],
      };
}
